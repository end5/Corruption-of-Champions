	...
	else if (eventNo == 2012)
	{
		...
		if (player.gender == 1 || player.gender == 3)
		{
			...
			if (player.cocks.length == 1)
			{
				...
				//New PG
				outputText("The tendrils encircling your genitals do not release; instead they pull tighter, one of the tiny plant's appendages penetrating your urethra, squirming up the cum slicked passage with uncomfortable slowness. You lay there, too weak to resist it or fight, hoping that whatever the plant is doing won't hurt much. You feel it twisting and coiling inside you... until it stops. You feel a sharp pinch, and then it withdraws, seemingly satisfied. The tendrils unwrap, allowing the plant to spring back up, exposing your still over-engorged and sensitive member.\n\n", false);
				//New PG
			...
			else
			{
				...
				outputText("You cum, and cum, and cum, the evidence of your pleasure devoured by the plant's sucking, squeezing gullet. The orgasm drags on for what feels like forever, your " + player.legs() + " eventually giving out, your hips the only muscle that seems to work as they twitch into the air, as if begging for more. You are milked of a few last big spurts, at last collapsing.\n\n", false);
				outputText("The tendrils encircling your genitals do not release; instead they pull tighter, one of each plant's tiny appendages penetrating your urethras, squirming up your cum slicked passages with uncomfortable slowness.  You lay there, too weak to resist it or fight, hoping that whatever the plants are doing won't hurt much. You feel it twisting and coiling inside you... until it stops. You feel a sharp pinch, and then it withdraws, seemingly satisfied. The tendrils unwrap, allowing the plants to spring back up, exposing your still over-engorged and sensitive members.\n\n", false);
				outputText("You lay there for some time until your muscle control returns, your cock still slightly over-large ", false);
				if (player.balls >= 2)
					outputText("and your " + ballsDescriptLight() + " ", false);
				else
...
/*
	...
	else if (eventNo == 2149)
	{
		...
		{
			outputText("You offer Jojo the chance to stay at your camp, but before you can finish your sentence he shakes his head 'no' and stalks off into the woods, remembering.", false);
			doNext(13);
			return;
		}
