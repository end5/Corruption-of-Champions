...
export let dungeonLoc: number = 0;

// To save shitting up a lot of code...
export let inRoomedDungeon: boolean = false;
export let inRoomedDungeonResume: () => void = null;

// Used to restrict random drops from overlapping uniques
export let plotFight: boolean = false;
export let timeQ: number = 0;
export let campQ: boolean = false;
