...
export class PerkLib {
    ...
    */
    ...
    public static Berzerker: PerkType = mk("Berzerker", "Berzerker",
        "[if(player.str>=75)" +
    ...
    public static Regeneration: PerkType = mk("Regeneration", "Regeneration",
    ...
    public static Regeneration2: PerkType = mk("Regeneration 2", "Regeneration 2",
    ...
    private static mk(id: string, name: string, desc: string, longDesc: string = null): PerkType {
