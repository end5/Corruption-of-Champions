...
export let conditionalOptions: Record<string, any> =
{
    ...
    breastrows(thisPtr: any): any { return game.player.breastRows.length; },
    biggesttitsize(thisPtr: any): any { return game.player.breastRows.biggestTitSize(); },
    ...
    hasvagina(thisPtr: any): any { return game.player.vaginas.length > 0; },
    ...
    hasbreasts(thisPtr: any): any { return (game.player.breastRows.biggestTitSize() >= 1); },
    ...
    issquirter(thisPtr: any): any { return (game.player.vaginas.wetness() >= 4); },
    ...
    hasnipplecunts(thisPtr: any): any { return game.player.breastRows.hasFuckableNipples(); },
