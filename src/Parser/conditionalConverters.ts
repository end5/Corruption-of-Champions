...
export let conditionalOptions: Record<string, any> =
{
    ...
    breastrows(thisPtr: any): any { return game.player.breasts.length; },
    biggesttitsize(thisPtr: any): any { return game.player.breasts.biggestTitSize(); },
    ...
    hasbreasts(thisPtr: any): any { return (game.player.breasts.biggestTitSize() >= 1); },
    ...
    hasnipplecunts(thisPtr: any): any { return game.player.breasts.hasFuckableNipples(); },
