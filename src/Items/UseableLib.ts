...
export class UseableLib {

    public B_CHITN = new SimpleUseable("B.Chitn", "B.Chitn", "a large shard of chitinous plating", 6,
    ...
    public GLDSTAT = new SimpleUseable("GldStat", "GldStat", "a golden statue", 600,
    ...
    public GREENGL = new SimpleUseable("GreenGl", "GreenGl", "a clump of green gel", 6,
    ...
    public T_SSILK = new SimpleUseable("T.SSilk", "T.SSilk", "a bundle of tough spider-silk", 6,
