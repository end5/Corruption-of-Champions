...
export class ConsumableLib {
    ...
    public BC_BEER: SimpleConsumable = mk("BC Beer", "BC Beer", "a mug of Black Cat Beer", function(player: Player): void { Niamh.blackCatBeerEffects(player); }, "A capped mug containing an alcoholic drink secreted from the breasts of Niamh.  It smells tasty.", 1);
    public BEEHONY: Consumable = new BeeHoney(false, false);
    public BIMBOCH: SimpleConsumable = mk("BimboCh", "BimboCh", "a bottle of bimbo champagne", curry(function(player: Player): void { Niamh.bimboChampagne(player, true, true); }), null, 1);
