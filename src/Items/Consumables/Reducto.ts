...
//		override public function hasSubMenu():Boolean { return true; } //Only GroPlus and Reducto use this.
		 ...
		 public  useItem():boolean {
			var rdtBalls:() => void	= (game.player.balls > 0 && game.player.ballSize > 1 ? reductoBalls : null);
			var rdtBreasts:() => void	= (game.player.breastRows.length > 0 && game.player.biggestTitSize() > 0 ? reductoBreasts : null);
			var rdtButt:() => void	= (game.player.buttRating > 1 ? reductoButt : null);
			var rdtClit:() => void	= (game.player.vaginas.length > 0 && game.player.clitLength > 0.25 ? reductoClit : null);
			var rdtCock:() => void	= (game.player.cockTotal() > 0 && game.player.biggestCockArea() > 6 ? reductoCock : null);
			var rdtHips:() => void	= (game.player.hipRating > 2 ? reductoHips : null);
