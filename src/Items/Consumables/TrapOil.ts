...
export function trapOil(player: Player): void {
    clearOutput();
    ...
    if (player.breastRows.biggestTitSize() > 1 && rand(4) == 0 && changes < changeLimit) {
        ...
        while (temp < player.breastRows.length) {
            if (player.breastRows[temp].breastRating > 70)
                ...
                player.breastRows[temp].breastRating -= rand(3) + 10;
            else if (player.breastRows[temp].breastRating > 30)
                player.breastRows[temp].breastRating -= rand(3) + 7;
            else if (player.breastRows[temp].breastRating > 15)
                player.breastRows[temp].breastRating -= rand(3) + 4;
            else
                player.breastRows[temp].breastRating -= 2 + rand(2);
