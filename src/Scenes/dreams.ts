...
export function dreamSelect(): boolean {
    ...
    if (dreamtemp > 5) {
        ...
        // Exgartuboobs
            ...
            outputText("You awake with a start.  Your " + game.player.breastDescript(0) + " jiggles grumpily.", false);
        }
        // Exgartucock
        else if (daydream == 9) {
