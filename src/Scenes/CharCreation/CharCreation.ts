...
let customPlayerProfile: () => void;

export function newGamePlus(): void {
...
export function newGameGo(): void {
    ...
    const silly: boolean = flags[kFLAGS.SILLY_MODE_ENABLE_FLAG];
    const easy: boolean = flags[kFLAGS.EASY_MODE_ENABLE_FLAG];
    const sprite: boolean = flags[kFLAGS.SHOW_SPRITES_FLAG];
...
function customName(arg: string): () => void {
    switch (arg) {
...
function specialName(arg: string): () => void {
    switch (arg) {
...
function buildSlenderFemale(): void {
    player.str -= 1;
    player.spe += 1;
...
function buildAverageMale(): void {
...
function buildAverageFemale(): void {
...
function buildCurvyFemale(): void {
    player.spe -= 2;
    player.str += 1;
    player.tou += 1;
...
function buildTomboyishFemale(): void {
    player.str += 1;
    player.spe -= 1;
...
function chooseComplexion(): void {
    clearOutput();
...
function setComplexion(choice: string): void { // And choose hair
...
function chooseEndowment(clear: boolean): void {
...
function confirmEndowmentStrength(): void {
    clearOutput();
...
function confirmEndowmentThoughness(): void {
    clearOutput();
...
function confirmEndowmentSpeed(): void {
    clearOutput();
...
function confirmEndowmentSmarts(): void {
    clearOutput();
...
function confirmEndowmentLibido(): void {
    clearOutput();
...
function confirmEndowmentTouch(): void {
    clearOutput();
...
function confirmEndowmentBigCock(): void {
    clearOutput();
...
function confirmEndowmentMessyOrgasms(): void {
    clearOutput();
...
function confirmEndowmentBigBreasts(): void {
    clearOutput();
...
function confirmEndowmentBigClit(): void {
    clearOutput();
...
function confirmEndowmentFertile(): void {
    clearOutput();
...
function confirmEndowmentWetVagina(): void {
    clearOutput();
...
function setEndowmentStrength(): void {
    player.str += 5;
    player.tone += 7;
    player.thickness += 3;
...
function setEndowmentToughness(): void {
    player.tou += 5;
    player.tone += 5;
    player.thickness += 5;
...
function setEndowmentSpeed(): void {
    player.spe += 5;
    player.tone += 10;
...
function setEndowmentSmarts(): void {
    player.inte += 5;
    player.thickness -= 5;
...
function setEndowmentLibido(): void {
    player.lib += 5;
    player.perks.create(PerkLib.Lusty, 0.25, 0, 0, 0);
    chooseHistory();
}

function setEndowmentTouch(): void {
    player.sens += 5;
    player.perks.create(PerkLib.Sensitive, 0.25, 0, 0, 0);
    chooseHistory();
}

function setEndowmentBigCock(): void {
    player.femininity -= 5;
...
function setEndowmentMessyOrgasms(): void {
    player.femininity -= 2;
...
function setEndowmentBigBreasts(): void {
    player.femininity += 5;
...
function setEndowmentBigClit(): void {
    player.femininity -= 5;
    player.clitLength = 1;
...
function setEndowmentFertile(): void {
    player.femininity += 5;
    player.fertility += 25;
    player.hipRating += 2;
...
export function chooseHistory(): void {
    clearOutput();
...
function confirmHistory(choice: PerkType): void {
    clearOutput();
    switch (choice) {
...
function completeCharacterCreation(): void {
    if (customPlayerProfile != null) {
        customPlayerProfile();
        doNext(arrival);
        return;
...
function arrivalPartThree(): void {
    clearOutput();
    hideUpDown();
    dynStats("lus", -30);
...
function customVahdunbrii(): void {
    player.breastRows.createBreastRow();
    player.vaginas.createVagina();
    player.breastRows[0].breastRating = 3;
    player.clitLength = .5;
