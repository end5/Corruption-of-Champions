...
export function impGangAI(): void {
    ...
    if (rand(2) == 0) {
        outputText("\nOne of the tiny demons latches onto one of your " + legs(player) + " and starts humping it.  You shake the little bastard off and keep fighting!", false);
        dynStats("lus", 1);
    }
    combatRoundOver();
}
...
// Bukkake:
export function impGangBukkake(): void {
    ...
    while (hits > 0) {
        ...
        // Determine if evaded
        else if (player.perks.findByType(PerkLib.Evade) >= 0 && rand(100) < 30) {
            damage = rand(4);
        ...
        // Determine if cat'ed
        else if (player.perks.findByType(PerkLib.Flexibility) >= 0 && rand(100) < 15) {
            damage = rand(4);
        ...
        // (2-6 hits for +10 lust each!) (-5 lust per successful hit)
            ...
            if (damage == 1) outputText("Your " + allBreastsDescript(player) + " are coated with thick demonic spunk!\n", false);
            ...
            if (damage == 3) outputText("Seed lands in your " + hairDescription(player) + ", slicking you with demonic fluid.\n", false);
            ...
            dynStats("lus", (7 + int(player.lib / 40 + player.cor / 40)));
        }
        monster.lust -= 5;
        hits--;
    }
...
export function loseToThisShitPartII(): void {
    ...
    if (player.gender == 1 || (player.gender == 3 && rand(2) == 0)) {
        ...
        outputText(" and squeeze, forcing " + sMultiCockDesc(player) + " to inflate to readiness.  Deep inside your " + assholeDescript(player) + ", the tentacle starts to rub against your prostate.  It caresses the male organ on each side and pauses to squeeze the center of it, pushing a few drops of sticky cum from your trembling " + Appearance.cockNoun(CockTypesEnum.HUMAN) + ".\n\n", false);
...
export function useVala(): void {
    ...
    // HERMY WORMY
        ...
        outputText("The fairy's rose-scented honeypot glistens with thick beads of clear liquid that well and dribble down her inner thighs, but you're too clever to just eat out every wet and waiting fairy girl you happen to find in demonic dungeons, so you elect for a safer, less potentially drug-filled route for your carnal satisfaction. Glancing around the room, your eyes settle on the long, wooden pegging table in one corner of the room. You snatch a large, loose stone from the ground as you head over to it and fold your arms under your " + allBreastsDescript(player) + " as you shop amongst the lacquered, intensely detailed wooden cocks set into the device. This one is far too small, that one is the wrong shape, one by one, you weed them out until you settle on a huge, minotaur-shaped dildo, over a foot and a half long and nearly six inches wide at the flared head. Grinning, you take the stone and carefully tap the bottom of the board until the peg starts wobbling loose. Using both hands, you yank the fire-hardened wooden dildo from its socket and hold it triumphantly over your head. You swing it in the air, experimentally, but decide that beating demons unconscious with a minotaur's dick would just be silly.\n\n", false);
...
export function useValaPtII(): void {
    spriteSelect(85);
    outputText("", true);
    hideUpDown();
    fatigue(5, 0);
    ...
    // VAGOOZLES
        ...
        outputText("She squeals in delight and her knees wobble, the force of your thrust almost knocking her head into the wall she's shackled next to. You work the frightful dildo further into the girl's drooling snatch until a mere 9 inches protrudes from her bright pink cunny. You smear more of the girl's lubrication along the exposed shaft and turn your back to the fairy. Bending down, you slowly rub your " + buttDescription(player) + " against the smaller, rounded base of the minotaur cock. Though your end is veiny and sheathed, it lacks the broad flare of the cock head, so you press your " + vaginaDescript(player, 0) + " against it and brace your hands on your " + legs(player) + ". Rolling your ass up and down, you let your own excitement-thick lube smear the rounded end before you take a step backwards, toward the fairy. The bulb slides past your cheeks and presses against your vaginal entrance, its girth as exciting as it is frightening. You take a deep breath, but before you're ready, the impaled fairy bucks backward and drives the dildo into your unprepared cunt, provoking a cry of surprise.\n\n", false);

        outputText("You quickly recover and thrust backwards, driving more of the dildo inside your clenching walls while also slamming the fairy's slick box in lusty punishment for her over-eagerness. She giggles and humps right back, driving another inch into you, your uterus aflame with the delicious stimulation of the bumpy, uneven veins carved into the smooth cock-base. Before long, the two of you have a rhythm, driving the makeshift double-ended dildo into each other until you end up ass-to-ass, your " + buttDescription(player) + " smacking heavily against the fey girl's supple rear. A large puddle of girl cum has begun forming on the floor, each wet slap of your cunts splashing more of the warm, clear liquid between the two of you. You can feel your orgasm building a knot in your gut and you bite your lower lip as you ride her more forcefully, slamming yourself down on the veiny cock, driving the flared head deeper into the fairy's body. She tries to jackhammer it right back, mind lost in eternal lust, until you can feel the rounded base pushing against your cervix, blissful pain coursing through your lower body.\n\n", false);

        outputText("You clutch your " + allBreastsDescript(player) + " and squeeze the " + nippleDescription(player, 0) + " until they hurt, the agony giving you strength to drive the dildo back into the fairy. It's a losing battle, you realize, when she cums before you do, pulsing walls locking down and squeezing the dildo out, by painful inches, deeper into your " + vaginaDescript(player, 0) + " until the base is so far against your gut that it's pushed into your womb with a toe-curling, wet pop. You silently scream in ecstasy and agony, unable to believe that the frail fairy managed to fuck your womb with your own toy. Your strength falters and you slump down, sliding off the shaft with soothing regret, your cervix clenching wildly, still spasming from the obscene intruder. You roll onto your back, fairy cum all around you, even now dripping down the lube-slick cock still sticking out of the girl's sex, flared glans keeping it locked inside of her. You jill your " + clitDescription(player) + " for a few minutes afterward, just enjoying the afterglow, lapping at the dripping sprite cum that dribbles onto your face from the fairy's shivering, dick-stuffed cunt. Gradually, your strength returns and you rise, skin slick from the cum pool you've been basking in. You remind yourself to clean your " + player.armorName + " after this is over, sliding into them with damp, squishing noises. Giving your drooling fairy girl's ass a slap on the way out, you head back into the dungeon- you've got demons to stomp.\n\n", false);
    }
    // HERPY DERPY HERMY
    else if (player.gender == 3) {
        ...
        outputText("You quickly recover and prepare your second surprise. Reaching around your " + hipDescription(player) + ", you grab your stiffening " + cockDescript(game.player, 0) + " and pull it backwards, until it's just under the dildo connecting the two of you. With a thrust backwards, you jam your dick into her drooling pussy, while driving more of the dildo inside your clenching walls, slamming the fairy's distended rosette in lusty punishment for her over-eagerness. She giggles and humps right back, driving another inch of your shaft into her rectum and your uterus, your love-canal aflame with the delicious stimulation of the bumpy, uneven veins carved into the smooth cock-base. Before long, the two of you have a rhythm, driving the makeshift double-ended dildo into each other and thrusting your tail-like " + cockDescript(game.player, 0) + " into the fairy until you end up ass-to-ass, your " + buttDescription(player) + " smacking heavily against the fey girl's supple rear. A large puddle of girl cum has begins to form on the floor, each wet slap splashing more of the warm, clear liquid between the two of you. You can feel your orgasm building a knot in your gut and you bite your lower lip as you make your thrusts more forceful, slamming yourself into her violated nethers, the fairy's body as bloated from the minotaur dildo as from your own girth. She, in turn, is just as consumed by lust and tries to jackhammer right back into you, until you can feel the rounded wooden base pushing against your cervix, the mouth of her own womb slamming against your cockhead, blissful pain coursing through your lower body.\n\n", false);

        outputText("You clutch your " + allBreastsDescript(player) + " and squeeze the " + nippleDescription(player, 0) + " until they hurt, the agony giving you strength to drive the dildo back into the fairy. She cums before you do, her pulsing walls locking down and driving the dildo out, inch by painful inch, deeper into your body until the base is so far against your gut that it is pushed into your furthest recesses with a toe-curling, wet slap. You silently scream in ecstasy and agony, unable to believe that the frail fairy managed to fuck your womb with your own toy. Your strength redoubles and you thrust back, your " + cockDescript(game.player, 0) + " penetrating her spongy, well-used cervix, her womb sucking you inside it. You release the knotted tension, spraying your spunk deep inside her. You slap your " + buttDescription(player) + " against hers with each pulsing load, your pussy clenching at the dildo stuffing it even as your empty your seed into the chained slave.  You try to go limp, but the double penetrated girl keeps you from pulling out, both holes clenching you against her until every last drop of your sperm has filled her greedy womb. Fairy cum drips down your length, while the flared tip deep inside her large intestine keeps your pussy twitching against her posterior. You jill your " + clitDescription(player) + " for a few minutes afterward, just enjoying the afterglow as your strength returns and the fairy's body unclenches, releasing you from your breeder's embrace, the minotaur dildo still halfway up her ass. You remind yourself to clean your " + player.armorName + " after this is over, sliding into them with wet, squishing noises. Giving your drooling fairy girl's rump a slap on the way out, you head back into the dungeon- you've got demons to stomp.", false);
    }
...
// [Free]
export function freeValazLooseCoochie(): void {
    spriteSelect(85);
    outputText("", true);
...
export function healValaPartTwoTheHealingHealsOfRevenge(): void {
    spriteSelect(85);
    outputText("", true);
...
// [Sex]
export function ValaGetsSexed(): void {
    spriteSelect(85);
    outputText("", true);
    // (Herm/Male)
    if (player.cocks.length > 0) {
...
export function valaGetsSexedPtDuece(): void {
    spriteSelect(85);
    outputText("", true);
    hideUpDown();
    player.orgasm();
    fatigue(5, 0);
    if (player.cocks.length > 0) {
        const x: number = player.cocks.cockThatFits(60);
...
// [Reject]
export function rejectFuckingVala(): void {
    spriteSelect(85);
    outputText("", true);
    if (flags[kFLAGS.TIMES_PC_DEFEATED_VALA] == 0) {
        ...
        if (flags[kFLAGS.TIMES_PC_DEFEATED_VALA_AND_RAEPED] > 0) outputText("  You smirk in wonder at the horny little slut.  You guess you'll have to put her back into her place and give her another dose of 'love'.", false);
        outputText("\n\n", false);
...
export function loseToVala(): void {
    spriteSelect(85);
...
// Fight Loss-
// (Herm)
export function loseToValaAsHerm(): void {
    spriteSelect(85);
    outputText("", true);
...
export function loseToValaAsMaleIITight(): void {
    spriteSelect(85);
    outputText("", true);
    // (tight ass)
    // 	if(player.ass.analLooseness <= 1) {
    outputText("\"<i>It will never please them like that,</i>\" she scolds. \"<i>You must be made more to their liking or they will never grant you endless joy.</i>\" She grinds her button-stiff clit against your abdomen as she lowers you toward the smallest peg on the rail, an uncarved, lacquered wooden nub an inch wide and three inches long, barely larger than a finger. You try to attack the fairy before she can plug you in, but she simply drops you the rest of the way, and what should've been a relatively painless insertion becomes agonizing as you hit the peg and three inches of hardened wood fill your " + assholeDescript(player) + ". You gasp and try to get off the device, but the fairy has already grabbed you again and pulls you back into the air. You clench your muscles as you look at the far end of the ladder in horrified fascination at a wooden carving that would shame a minotaur. The fairy moves up a couple of notches.", false);
...
export function loseToValaMaleIILoose(): void {
    spriteSelect(85);
    outputText("", true);
    // (loose ass)
    outputText("\"<i>Sluts are trained well,</i>\" she sighs, happily. \"<i>This one knows only the pleasures of the masters, now.</i>\" The peg under you would be above average on a normal human- easily 7 inches long and two inches wide. Your " + assholeDescript(player) + " clenches and you writhe in the fairy's arms, but she lets gravity do her dirty work, lowering you onto the human-sized wooden cock, the varnished surface pulling apart your " + buttDescription(player) + " and sliding into your nethers with an uncomfortable tight sensation. Despite the humiliation of the rape, the pressure on your prostate begins pumping blood into your " + cockDescript(game.player, 0) + ", turning your body into a traitor. You don't dare try to pull off, for fear of the damage it might do to your anus, and you are forced to sit in shame on the wooden erection. The girl flutters down and laps at your stiffening cock, trying as hard as she can not to mount you then and there. Her hungry tongue takes some of the building pain from you. Finally, she decides you've had enough and lifts you into the air, but to your dismay, she takes you another few notches down the line.", false);
...
// Fight Loss-
// (Female)
export function loseToValaFemale(): void {
    spriteSelect(85);
    outputText("", true);
...
// BAD END 1-
// (Fairy)
export function badEndValaNumber1(): void {
    spriteSelect(85);
    outputText("", true);
...
export function badEndValaNumber2Pt2(): void {
    spriteSelect(85);
    outputText("", true);
...
// Fight Win-
export function fightValaVictory(): void {
    spriteSelect(85);
    outputText("", true);
    outputText("The fairy girl collapses, well-drilled obedience robbing her limbs of their fight. She squirms to a crouching bow, fully accepting you as her new " + mf(player, "Master", "Mistress") + ". The warped fae's empty eyes look up at you, her face a mask of rapture as she anxiously awaits her punishment, wagging her butt in the air as lubrication gushes down her thighs. It seems being defeated has excited the broken creature to a breeding frenzy. Her endurance must be incredible to be this frisky after your battle.", false);
...
export function leftValaAlone(): void {
    spriteSelect(85);
    outputText("", true);
    // first post meeting
...
// [Heal]
export function tryToHealVala(): void {
    spriteSelect(85);
    outputText("", true);
    // (Without Pure Honey)
...
export function tryToHealValaWHoney2(): void {
    spriteSelect(85);
    outputText("", true);
...
export function useValaOHYEAHKOOLAIDPTII(): void {
    spriteSelect(85);
    outputText("", true);
    hideUpDown();
    // m2
    if (player.gender == 1) {
        outputText("Before she can get any tighter, you figure it's time to loosen her back up. Grabbing fistfuls of her hair, you thrust forward, violently, slamming the Vala's head against the stone wall. \"<i>Fuck!</i>\" She shrieks in delight. \"<i>More, more!</i>\" All too happy to comply, you begin ramming her harder, the crushing pressure of her swollen labia milking your cock with every motion. The giant fairy is all too happy to help your rough treatment, and begins to slap her ass back into you, in time with your thrusts, giggling aimlessly between her disjointed pleas for you to cum inside her. You grab her wobbling chest, figuring her bloated breasts are the best handholds you're going to find on the malnourished girl, and are rewarded with an ecstatic cry from the fairy. She clenches down on your " + cockDescript(game.player, 0) + " as she orgasms, her pulsing depths making you dig your fingers deeper into her supple flesh. Rocking against her at a painful pace, you grit your teeth and begin to dig your fingers into her mounds, their fluid depths yielding to your passionate throes. Her nipples swell and burst with milk, white cream spraying at your feet with each thrust, and you slide your hands down to pull at the lactating pink flesh, each burst of pale alabaster filling your lust to bursting.\n\n", false);

        outputText("You cannot keep up your frenzied pace for long, and the fairy's drug-tightened cunt finally takes its prize as your orgasm shudders from your loins. You scream in pleasure and slam her whole body against the wall, lifting her off the ground and holding the side of her face on the molding stone. Every muscle in your body strains as you crush the thin girl's frame between your twitching form and the dungeon wall, " + hipDescription(player) + " bucking in time to each of your pulsing loads. Vala lets her body be used like a cocksleeve, drinking in the abuse as much as your ejaculate. She twitches, limply, against you and cums again, whispering desperate imperatives to fuck her harder and fill her with your sweet seed.\n\n", false);

        outputText("Finally spent, you step back and toss the girl off of your " + cockDescript(game.player, 0) + ", letting her fall back into a slump against the wall, dangling from her manacles. A wicked thought crosses your mind and you step back to the alchemy table. Grabbing armfuls of hexagonal bottles, you flip the girl around, exposing her drooling, empty face and her sore, gushing breasts. You plug a bottle up to her lips and she begins sucking at it automatically, perhaps believing it's a dick in some corner of her ravaged mind. Vala quaffs the Ovi Elixir gratefully, then a second, then a third. By the time you've finished pouring the stuff down her throat, her body has already begun changing. The elixir has pounced on your seed and forced her ovulation, rapidly accelerating the speed of conception. Her tummy pouts, then bloats as your sperm impregnates the fairy in seconds. Her abdomen swells violently, and you suspect that force-feeding her so much so quickly may have resulted in twins or triplets. She moans in blissful pregnancy, her already disproportioned tits gurgling with even greater milky weight. If there was any doubt as to if she could stand under her own power before, it's gone now- even your strength wouldn't be able to move the breeding cow that you've turned her into. Knowing your luck, however, she'll have given birth by the time you check in next.", false);
    }
    // f2
    else if (player.gender == 2) {
        outputText("She squeals in delight and her knees wobble, the force of your thrust almost knocking her head into the wall she's shackled next to. You work the huge dildo further into the girl's drooling snatch until a mere 9 inches remains protruding from her bright pink cunny. You smear more of the girl's lubrication along the exposed shaft and turn your back to the fairy. Bending down, you slowly rub your " + buttDescription(player) + " against the smaller, rounded base of the minotaur cock. Though your end is veiny and sheathed, it lacks the broad flare of the cock head, so you press your " + vaginaDescript(player, 0) + " against it and brace your hands on your knees. Rolling your ass up and down, you let your own excitement-thick lube smear the rounded end before you take a step backwards, toward the fairy. The bulb slides past your " + assholeDescript(player) + " and presses against your vaginal entrance, its girth exciting and frightening. You take a deep breath, but before you're ready, Vala bucks backward and drives the dildo into your unprepared cunt, provoking a cry of surprise.", false);

        outputText("You quickly recover and thrust backwards, driving more of the dildo inside your clenching walls while also slamming the fairy's slick box in lusty punishment for her overeagerness. She giggles and humps right back, driving another inch into you, your " + vaginaDescript(player, 0) + " aflame with the delicious stimulation of the bumpy, uneven veins carved into the smooth cock-base. Before long, the two of you have a rhythm, driving the makeshift double-ended dildo into each other until you end up ass-to-ass, your " + buttDescription(player) + " smacking heavily against the fey girl's supple rear. A large puddle of girl cum has begun forming on the floor, each wet slap of your cunts splashing more of the warm, clear liquid between the two of you. You can feel your orgasm building a knot in your gut and you bite your lower lips as you make your thrusts more forceful, more insistent, slamming yourself down on the veiny cock, driving the flared head deeper into the fairy's body. She, in turn, is just as consumed by lust and tries to jackhammer it right back, until you can feel the rounded base pushing against your cervix, blissful pain coursing through your lower body.\n\n", false);

        outputText("You clutch your " + allBreastsDescript(player) + " and squeeze your " + nippleDescription(player, 0) + " until it hurts, the agony giving you strength to drive the dildo back into the fairy, but it's a losing battle. Vala cums before you do, her pulsing walls locking down and driving the dildo out, inch by painful inch, deeper into your body until the base is so far against your gut that it is pushed into your womb with a toe-curling pop. You silently scream in ecstasy and agony, unable to believe that the frail fairy managed to fuck your womb with your own toy. Your strength falters and you slump down, sliding off the shaft with soothing regret, your cervix clenching wildly, still spasming from its penetration. You roll onto your back, fairy cum all around you, even now dripping down the lube-slick cock still sticking out of the girl's pussy, flared tip keeping it locked inside of her. You jill your " + clitDescription(player) + " for a few minutes afterward, just enjoying the afterglow, lapping at the dripping sprite cum that dribbles onto your face from the fairy's shivering, dick-stuffed cunt. Gradually, your strength returns and you rise, skin slick with the cum pool you've been basking in. You give Vala's ass a slap on your way out- a reward for your favorite brainless fairy.", false);
    }
    // h2
    else {
        outputText("She squeals in delight and her knees wobble, the force of your thrust almost knocking her head into the wall she's shackled next to. You work the frightful dildo further past the girl's gaping spincter until a mere 9 inches remains protruding from Vala's bright pink hole. You smear more of the girl's lubrication along the exposed shaft and turn your back to the fairy. Bending down, you slowly rub your " + buttDescription(player) + " against the smaller, rounded base of the minotaur cock. Though your end is veiny and sheathed, it lacks the broad flare of the cock head, so you press your own pussy against it and brace your hands on your knees. Rolling your ass up and down, you let your own excitement-thick lube smear the rounded end before you take a step backwards, toward the fairy. The bulb slides past your butt cheeks and presses against your vaginal entrance, its girth exciting and frightening. You take a deep breath, but before you're ready, the impaled fairy bucks backward and drives the dildo into your unprepared " + vaginaDescript(player, 0) + ", provoking a cry of surprise.\n\n", false);

        outputText("You quickly recover and prepare your second surprise. Reaching behind you, you grab your stiffening " + cockDescript(game.player, 0) + " and push it backwards, until it's just under the dildo connecting the two of you. With a thrust backwards, you punch your dick into her drooling pussy, while driving more of the dildo inside your clenching walls, slamming the fairy's colon in lusty punishment for her overeagerness. She giggles and humps right back, driving another inch of your shaft into her cunny, your " + vaginaDescript(player, 0) + " aflame with the delicious stimulation of the bumpy, uneven veins carved into the smooth cock-base. Before long, the two of you have a rhythm, driving the makeshift double-ended dildo into each other and thrusting your tail-like cock into Vala until you end up ass-to-ass, your " + buttDescription(player) + " smacking heavily against the fey girl's supple rear. A large puddle of girl cum has begun forming on the floor, each wet slap splashing more of the warm, clear liquid between the two of you. You can feel your orgasm building a knot in your gut and you bite your lower lips as you make your thrusts more forceful, more insistent, slamming yourself into her violated nethers, the fairy's body as bloated from half of the minotaur dildo as from your own girth. She, in turn, is just as consumed by lust and tries to jackhammer it right back, until you can feel the rounded wooden base pushing against your cervix, her own inner barrier slamming against your cockhead, blissful pain coursing through your lower body.\n\n", false);

        outputText("You clutch your " + allBreastsDescript(player) + " and squeeze your " + nippleDescription(player, 0) + " until they hurt, the agony giving you strength to drive the dildo back into the fairy, but it's a losing battle. Vala cums before you do, her pulsing walls locking down and driving the dildo out, inch by painful inch, deeper into your body until the base is so far against your gut that it is pushed into your womb with a toe-curling pop. You silently scream in ecstasy and agony, unable to believe that the frail fairy managed to fuck your womb with your own toy. Your strength redoubles and you thrust back, your " + cockDescript(game.player, 0) + " penetrating her spongy, well-used cervix, her womb sucking you inside it. You release the knotted tension, spraying your spunk deep inside her. You slap your " + buttDescription(player) + " against hers with each pulsing load, your " + vaginaDescript(player, 0) + " clenching at the dildo stuffing it even as your empty your seed into the chained slave.  You try to go limp, but the double penetrated girl keeps you from pulling out, both of Vala's milking holes pining you against her until every last drop of your sperm has filled her greedy womb. Fairy cum drips down your length, while the flared tip deep inside her large intestine keeps your pussy twitching against her posterior. You jill your " + clitDescription(player) + " for a few minutes afterward, just enjoying the afterglow as your strength returns and the fairy's body unclenches, releasing you from your breeder's embrace, the minotaur dildo still halfway up her ass. You give your fairy girl's rump a slap on the way out- a reward for her brood mother-sized hips.\n\n", false);
    }
    // DAH END
    player.orgasm();
    dynStats("cor", 1);
...
// [Wake]
export function wakeValaUpBeforeYouGoGo(): void {
    spriteSelect(85);
    outputText("", true);
    // (Male)
    if (player.gender == 1) {
    ...
    // (Herm)
        ...
        outputText("Your " + multiCockDescriptLight(player) + " is getting hard from the display, and you figure it'd be easier to satisfy the girl if you filled her from multiple holes. Reaching up again, you pull down a different hose, this time selecting a dildo that looks like an amalgam of several dick types. It's flared, like a horse's, knotted at the base, like a dog's, bulbous in the middle, like a lizard's, and barbed all along, like a cat's. You have no idea what kind of cum is filling this one, but you kind of want to see what'll pop out of the broken fairy. Hauling it down, you slide the hose behind you, threading it around your " + buttDescription(player) + ", along your " + vaginaDescript(player, 0) + ", and under your " + multiCockDescriptLight(player) + ". You bring your shaft to her gaping cunt and rub along her oozing labia, the puffy flesh inflamed with her desire. Slowly, you begin to slide your " + cockDescript(game.player, 0) + " in first, letting her walls adjust to your girth, before pressing the dildo-nozzle into her twitching hole. The pressure of the strangely warm metal drives the fairy crazy, and her steady guzzle from the bowl becomes frantic gulps, her belly beginning to show a paunch from her meal. You let the girl's crystal cum soak the chimera-cock before feeding it into her slavering pussy, inches at a time. The girl's brood mother hips are so wide that you manage to penetrate her recesses with both cocks, though her abdomen stretches violently as the two cocks work their way deeper into her.", false);
    }
    dynStats("lus", 999);
    // [Next]
...
export function wakeMeUpBeforeValaGoGosPtII(): void {
    spriteSelect(85);
    outputText("", true);
    hideUpDown();
    // m2
    if (player.gender == 1) {
        outputText("", true);
        outputText("You spot an unsecured set of chained manacles on the floor and an idea strikes you. Vala still sliding along your shaft, you bend down and grab the fetters, snapping one around the girl's neck like a collar. With a shudder at the cold, you lift the fairy up and lock the other end of the shackles around the root of your " + cockDescript(game.player, 0) + ", steel snapping around your base tightly. The makeshift cock-ring works perfectly as your " + hipDescription(player) + " quiver, your body trying to orgasm but denied release by the metal loop. The fairy, meanwhile, thrashes atop your groin, the chain of her collar swinging between her tits, buffeting them with enough force to spray small white streams as she rides you. Her purple hair glimmers pink in the dull light of the dungeon as it bounces right along with her rocking hips. Even the diminished pulses of sunlight streaming from her stained and tattooed skin seems brighter as she is filled labia to cervix by your straining fuckpole.\n\n", false);

        outputText("She moans in a series of small, cute gasps and her pussy clenches your " + cockDescript(game.player, 0) + " as tightly as the makeshift cock-ring. You savor the sweet shivers that run up her spritely body, fingers clenching around your arms and legs wrapping about your " + buttDescription(player) + " to slam deeper, even taking the chained shackle at your base into her cumming slit. It feels like a flood is released from the fairy's gaping box, warm fluid splashing around your bulging length and raining down to leave a thin, clear puddle under you. You bite your lip and slide your fingers into her vice-like pussy, to unhook the shackle around your cock, and the added insertion gives the girl enough to cum again, her body shaking violently against yours, squirting her hot girl cum over your hand. Vala notices what you're trying to do and she slams down onto your hand with added force, making it difficult to spring the catch. The pressure in your loins is getting painful now, and you lean against a wall, using both hands to try to unclap the fetters around your " + cockDescript(game.player, 0) + ". Between her wings and the chain, she manages to stay firmly locked onto your root, grinding orgasmically as more fingers push past her pulsing lips and fumble at the cock-ring.\n\n", false);
    ...
    // f2
        ...
        outputText("You close your eyes and run your tongue into her groin with teasing flicks and probing touches, exploring her nethers and lapping up the constant flow of fae cum that dribbles from her perpetually wet body. She shifts in the air, but her clenching thighs keep you from seeing anything but her juicy snatch. When a hot, humid panting puffs against your " + vaginaDescript(player, 0) + ", you realize she must've done a 180 in the air, wings keeping her in a vertical 69. She descends on your pussy with relish, savoring the taste of your moist body. Her needy tongue is as delicately thin as the rest of her body, but it is LONG. She threads it into your depths and you buck your hips as it just keeps going deeper and deeper. You moan into her abdomen and flatten your own tongue to bring as much roughness against her twitching walls as you can, trying to get the little minx off before she sucks your orgasm from you.\n\n", false);

        outputText("It's a hopeless race, however, as she quickly zeros in on your g-spot, curling her tongue to coil thickly inside of you. You grab Vala's purple hair and crush her head into your crotch, adorable button nose grinding against your " + clitDescription(player) + ", momentarily distracting you from the fairy's pussy as she tongue-rapes yours. When you cum, your body tenses and you hold your breath as your " + hipDescription(player) + " threaten to draw the small girl's whole head into your " + vaginaDescript(player, 0) + ". You hear a slurping and realize she's drinking your girl cum. The thought is enough to remind you about the fairy slit at eye-level just as she cums from the taste of your body. She squirts wildly into your face, small jets of hot, sticky liquid spraying into your mouth, over your cheeks, and into your eyes.\n\n", false);
...
export function isValaAtBar(): boolean { return (flags[kFLAGS.FREED_VALA] != 0 && game.time.hours >= 12 && game.time.hours <= 21); }

// Purified Fairy
export function purifiedFaerieBitchBar(): boolean {
...
// [Vala]
export function chooseValaInBar(): void {
    spriteSelect(60);
    let cumBath: () => void = null;
    if (player.cocks.length > 0) cumBath = valaCumBath;
    clearOutput();
    menu();
    // (First meeting)
    ...
    else if (game.time.hours == 20 && rand(2) == 0 && player.cocks.length > 0) {
        kinathisValaStuff();
        return;
    }
    else {
...
// [You]
export function cleansedValaFuckHerBrainsOut(): void {
    spriteSelect(60);
    outputText("", true);
    // [Male/Herm Growth scene]
    if (player.cocks.length > 0) {
        outputText("You don't even have to speak, she reads your desire as plainly as you can read hers. She flutters her wings in eager anticipation as she slides her hands up your chest and over your arms, thumbs tracing the curve of your muscles while fingertips dance across your " + skinFurScales(player) + ". With anxious quickness, she gently caresses your body with every breath. Vala leans in to kiss your neck and shoulders while shifting to straddle you, her enormous breasts hotter than her kisses as she presses into you. She savors the nearness for a long moment, just feeling your heartbeat against hers, sighing happily in your arms, before she wraps her legs around your waist and begins to grind her ass into your crotch. Time has not abated the torrential flow of clear lube leaking from her aroused pussy, and your lower body is soaked by her rose-petal labia, her ample rear spreading the warm liquid across your lap and over your stiffening length. You hiss in teased excitement and reach your hands across her broad, breeder's hips to clutch her bubble-bottom cheeks. She rocks up and down, her drooling lower lips sucking at your shaft with each motion, heat pouring out of her cunny.\n\n", false);

        outputText("Feeling your straining body, hard against hers, she runs a hand through her purple hair, spilling it across half of her face. \"<i>I want you to enjoy this as much as I will.</i>\" Vala reaches a hand between her legs and slides against your abdomen, guiding your " + cockDescript(game.player, 0) + " into her pussy. The fae's labia practically breathes the heat of her uterus across your twitching shaft and you slide through her well-lubricated depths with a moist sigh, her inhuman snatch tight with her passionate yearning. She rocks back and forth barely an inch at a time, but it's enough to ignite a manic need in your loins. ", false);
        // [2 dicks-
        if (player.cocks.length > 1) outputText("\"<i>Fairies don't exactly crap rainbows, but we're not quite like normal humans either,</i>\" she grins, taking your " + cockDescript(game.player, 1) + " and pressing it against her pudgy butt, her pink sphincter loosening just enough to slip your cockhead inside the fairy's body before it clenches down. It almost feels like she's got a hand inside of her ass; the walls ripple with expert coordination, rings of muscle clenching and loosening with a dexterity that takes the breath from you. Your tip, sealed just inside her posterior, is milked with a tight grace that has your body twitching before you realize it.  ", false);
        // 3+ dicks-
        if (player.cocks.length >= 3) outputText("Vala takes a deep breath, letting the feeling of your meat inside her gut stoke the fires of lust growing in her belly. \"<i>I think there's a little room left, if you're game,</i>\" she whispers, moving to your " + cockDescript(game.player, 2) + ". She bites her lower lip and forces herself down on it, squeezing your two shafts together in her well-lubed love tunnel. The feeling of your straining lengths inside her triple-stuffed body is an ecstatic agony that robs you of words and your body thrusts helplessly, Vala's breeder hips grinding in fleshy ripples, her lower torso swollen with cock.  ", false);
        ...
        outputText("She coos into your ear as her as muscles release her vice-like grip long enough to slam her rump down on the rest of your length, swallowing every inch in the blink of an eye, her body swelling up with your girth. Parked at your base, she clenches again and begins to stroke your cock", false);
        if (player.cocks.length > 1) outputText("s", false);
...
// Part 2
export function cleansedValaFuckHerBrainsOutPtII(): void {
    spriteSelect(60);
    outputText("", true);
    // dicks + growth
    if (player.cocks.length > 0) {
        outputText("Vala leans way back and grabs the edge of the stool while she locks her legs behind your waist, the fairy's startling strength pinning the two of you together. She slaps her generous butt onto your dick in long, slow motions, making sure you feel every inch of her rippling passage", false);
...
// [You]
export function cleansedValaRepeatBrainFucking(): void {
    spriteSelect(60);
    outputText("", true);
    outputText("She flashes a beautiful smile and tells the bartender that she'll be taking her break early. Grabbing you by the hand, she rushes to the stockroom and sheds her dress without any trace of her former shame about her tattooed back. When you're too slow taking off your " + player.armorName + ", she helps, deft hands made all the quicker by eagerness. When the two of you are naked, she pushes you onto the well-worn stool and sits in your lap, staring into your eyes with a small smile.", false);
    // [Next] (go to Growth scene)
    doNext(cleansedValaFuckHerBrainsOut);
}

// [Fairies]
export function faerieOrgyFuck(): void {
    spriteSelect(60);
    outputText("", true);
...
// [Female]
export function faerieOrgyFuckFemaleContinue(): void {
    spriteSelect(60);
    outputText("", true);
    outputText("The fairy girl lands at the edge of the bed, settling on her knees and resting her weighty chest on the mattress. Leaning in, she spreads your " + legs(player) + " with warm, delicate hands, fingertips stroking the insides of your thighs. You shiver and hug your arms under your breasts, a little nervous about this 'forest magic.' One of the fairies flutters down to Vala and hands her a pale white lily petal with a tittering giggle. The larger fairy takes the soft white bloom and, whispering a silken word to it, licks the cream-colored surface. Slithering further between your legs, she reaches your " + vaginaDescript(player, 0) + " and brushes the petal against your " + clitDescription(player) + " with a teasing caress. Then, much to your surprise, she places it on the tip of her forefinger and slides it into your pussy. You gasp, the petal's soft surface rubbing your inner walls with a warmth you were unprepared for. Vala presses lightly on a spot inside your vagina and you lose your breath as the tremor of a small orgasm rumbles through your gut. Without explanation, the fairy barmaid takes a rose petal and repeats the process, another orgasm seizing you and leaving you panting. \"<i>Normally we only need the one petal, but since you and I are so much larger than the average fairy, I had my sisters bring lots. All for you,</i>\" she whispers, coyly.\n\n", false);

    // [If the Player has unlocked Scylla's Addiction Counseling event]
    if (flags[kFLAGS.TIMES_SCYLLA_ADDICT_GROUP_EXPLOITED] + flags[kFLAGS.SCYLLA_TIMES_SHARED_IN_ADDICT_GROUP] + flags[kFLAGS.SCYLLA_MILK_THERAPY_TIMES] + flags[kFLAGS.SCYLLA_CUM_THERAPY_TIMES] + flags[kFLAGS.SCYLLA_SEX_THERAPY_TIMES] > 0) outputText("Another fairy flies toward Vala and you blink through the building lusty haze when you recognize the little girl. Wearing a slightly slutty crystalline gown of translucent gossamer, you recognize Pastie, the fairy from Scylla's addiction counseling meeting. When you call out to her, she bashfully waves back. \"<i>Hey, uh, " + player.short + ". It's kinda weird seeing you outside of the meetings. How are you? How have things been?</i>\" She looks at your naked, reclined form on the bed and blushes. \"<i>Oh, right, right. Um. I'm just helping out Vala, you know. Sisters and all. Uh. I'm... I'm going to just give her this petal and get something to drink, okay? All this sobriety is making this really uncomfortable for me.</i>\" The other fairies laugh and Pastie hands off her blossom before zipping out of the room, probably to steal someone's drink downstairs.\n\n", false);
...
export function valaCumBath(): void {
    ...
    if (flags[kFLAGS.VALA_CUMBATH_TIMES] == 0) {
        ...
        if (player.cumQ() < 2000) {
            ...
            // IF BALLS:
            if (player.balls > 0) outputText("  Your balls react immediately, filling with a cold weight that nearly knocks you to your ass.  Your [armor] bulges obscenely as the sack hanging between your legs fills with liquid pressure that squeezes your bloating flesh.");
        ...
        // OR [If the player's cum production is over X]
            ...
            outputText("[pg]In response, you cup the pale girl's chin and flash a sly smile of your own.  Arching a " + player.hairColor + " eyebrow, you assure her that won't be a problem.  Vala's hands sink down to your crotch, fey fingers pushing aside your [armor] to encircle your swelling member.  \"<i>I don't doubt it,</i>\" she purrs, lightly tracing the crest of your [cock]'s head.");
            // [IF BALLS:
            if (player.balls > 0) outputText("  The fairy's hands slide a bit further and she turns up her palms to cup your [balls], her thin fingers delicately massaging the heft of your over-burdened sac.  \"<i>I don't know who's more excited, me or these guys,</i>\" she teases, drawing you into another passionate embrace.  Grasping your testicles just tightly enough to send a shiver of pleasure across the back of your neck, she wets her lips and whispers, \"<i>Who am I kidding?  No one wants this more than me.</i>\"");
...
export function valaCumBath2(): void {
    spriteSelect(60);
    clearOutput();
...
// Big Vala Intro
export function valaBigYou(): void {
    clearOutput();
...
export function bigValaDomsPC(): void {
    clearOutput();
    outputText("Vala tilts her head to the side, causing a gust of displaced air to blow your " + hairDescription(player) + " wildly.  \"<i>Giving the maiden a chance to lead?  You're so sweet!</i>\"  She tickles your chin with one immense fingertip.  \"<i>But you had better give it your all, you adorable rascal, you.</i>\"");
    ...
    // {Herm:}
        ...
        if (player.cocks.biggestCockArea() >= 150) outputText("  If only you weren't so big!  You're compressed so tightly by your enclosing [armor], and even though you're rock-hard, you're a fraction of your full size.  If only you could get out of your gear and fuck her!");
    }
    // {Genderless}
    else {
...
export function bigValaLicksOffDudes(): void {
    clearOutput();
    ...
    if (player.cocks.length > 1) outputText("s");
    outputText(" until ");
    if (player.cocks.length == 1) outputText("it slides");
    else outputText("they slide");
    outputText(" inside her");
    if (player.cocks.biggestCockArea() >= 200) outputText(", the immense length sucked in by a surprising burst of suction");
    outputText(".");
    ...
    if (player.cocks.biggestCockArea() < 200) outputText("smothering your relatively tiny pecker");
    else outputText("wrapping up your immense pecker");
    if (player.cocks.biggestCockArea() >= 400) outputText(", even as it hangs partway down her throat");
    ...
    if (player.cocks.biggestCockArea() >= 400) outputText(", cock partway down her throat");
    ...
    if (player.balls > 0) outputText(", [balls] clenching against Vala's tongue");
...
export function valaVapulaThreesome(): void {
    // {First Meeting}
...
export function valaDommyVapula3Some(): void {
    clearOutput();
    valaVapulaThreesome();
    ...
    if (!player.cocks.length > 0) outputText("buckling on your demonic strap-on");
    ...
    if (!player.cocks.length > 0) outputText("dildo");
    ...
    if (player.cocks.length > 0) outputText("seed");
...
export function valaLoveyVapula3Some(): void {
    ...
    if (!player.cocks.length > 0) outputText(", and you buckle on your demonic strap-on, just in case");
    ...
    if (!player.cocks.length > 0) outputText("the dildo");
    ...
    if (!player.cocks.length > 0) outputText("that exotic dildo");
    ...
    if (!player.cocks.length > 0) outputText("spurting dildo");
    else outputText("[cock smallest]");
...
export function kinathisValaStuff(): void {
    ...
    if (player.cocks.length > 1) outputText("most appealing phallus");
    ...
    outputText("Playing her way down your cock, the fey-girl gently licks up and down, sucking along your cumvein before coming back to the " + cockHead(player, x) + " of your meaty prick.");
    ...
    outputText("\n\nNot wanting to wait a moment longer, you surge forward, pushing your " + cockDescript(game.player, x) + " between her  thighs, the " + cockHead(player, x) + " gently probing the small tight sex that lay between them, her fey-honey oozing from the womanly flower like sweet nectar from the most exotic of plants.  The touch of your meaty masculinity against her puffy, sensitive nethers draws a gentle gasp from the excited woman.  Taking hold of her hips, you push forward and sink your aching, throbbing spear into her tender, needy body.  ");
    // [cockarea <17:
    if (player.cocks.cockArea(x) < 17) outputText("Despite her size, you slide in easily, her wet, slippery pussy taking you in and squeezing you in a velvety embrace.  \"<i>Yessss, it's in, it's in!  Mmmm, come to me hero, come to Vala,</i>\" she croons to you, beckoning  you to take her.");
    else if (player.cocks.cockArea(x) < 30) outputText("\"<i>Ahhh...  yesss, it's in!  Ohh...  come to me hero, come to Vala and fill her with your love!</i>\" she croons to you, beckoning  you to take her.");
    ...
    if (player.cocks.cockArea(x) > 17) outputText("  Her hot little body stretches around your girthy prick, distending her belly as you sheath your throbbing arousal into her.");

    outputText("\n\nYour hands roam over her as you buck your hips into your fairy lover, your hands groping her round ass, her massive milky mammaries swaying and jiggling from your hard thrusts.  The bounce and ripple of her creamy udders is too much to bear, their hypnotic shakes drawing your hands to them, squeezing and manhandling those luscious orbs.  Spurts of rich milk splash across your " + skinFurScales(player) + " as you pinch and squeeze her nipples.  The rough touches, the pinching, the squeezes and gropes draw long moans and groans from the panting, lusty fairy.  Your fey-lover murmurs your name as you take her, beckoning you for more, for you to keep fucking her and to make her scream.  \"<i>Haa haa, ohhhh, yessss fuck me, fuck Vala’s tight little cunt!  Give me all your burning love!</i>\" she pants and cries out as she bucks her hips up to you, her arms reaching up to hold onto you as you start to speed up your thrusts.");
...
// [next]
export function valaPartIIWaifuLove(): void {
    clearOutput();
    game.time.hours = 6;
    game.time.days++;
