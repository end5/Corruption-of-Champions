...
else if(player.hasVagina()) outputText("your " + clitDescript());
...
//Vagina:
if(player.hasVagina()) outputText("  Cumming hard, your " + clitDescript() + " releases a liberal stream of juices down the vine that fucks you, dissolving into the appendage as you moan in furious release.");
...
(if breasts: pulling on your nippleDescript(0) as she bucks her head back in utter bliss. You let out a pained cry and twist her nipples in response, soliciting a similar reaction from her. Both of	 you grin manically at each other, and you lower yourself to give her a quick kiss before rising back up into your straddling position, eager to abuse her cock until you get her sweet splooge inside of you)
...
(if vagina and/or cock: (vaginaDescript(0)/   /and/ multiCockDescriptLight(game.player)/
...
(vaginaDescript(0)/ multiCockDescriptLight(game.player)/ assholeDescript(0) ).
...
(multiCockDescriptLight(game.player)/ vaginaDescript(0)/assholeDescript( ) )
