...
export function processJackFrostEvent(): void {
    ...
    // Jojo
    else if ((player.effects.findByType(StatusAffects.PureCampJojo) >= 0 || jojoScene.campCorruptJojo()) && flags[kFLAGS.JACK_FROST_PROGRESS] <= 4) {
        // Pure
    ...
    // Marble (Written by TDM himself)
    else if (flags[kFLAGS.JACK_FROST_PROGRESS] <= 7 && player.effects.findByType(StatusAffects.CampMarble) >= 0) {
