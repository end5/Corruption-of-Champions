...
export function meetJackFrostInTheMountains():void {
	clearOutput();
...
//[=No=]
export function noJizzingInMyCampPlease():void {
	clearOutput();
...
//[=Yes=]
export function jizzSnowOnMyCampPlease():void {
	clearOutput();
...
//Back in camp
export function processJackFrostEvent():void {
	hideUpDown();
	clearOutput();
...
//[=Lick Boobs and Finger Pussy=]
//All sexes!
export function kihaXmasFingering():void {
	clearOutput();
...
//[=Pen Ass=]
//PC needs a cock.
export function penetradeCorruptJojoAss():void {
	clearOutput();
...
//[=Ride Cock=]
//PC needs vagina
export function rideCorruptJojoCock():void {
	clearOutput();
...
//[=Spank and Finger Ass=]
//Available to all.
export function spankNFingerCorruptJojoAss():void {
	clearOutput();
