...
export function christmasEncounterAngelJunk(): void {
    clearOutput();
    menu();
    // [Not Christmas]
...
export function dontExploreGatsChristmasTale(): void {
    clearOutput();
    // i. No
...
// ii. Yes
export function encounterQuoteUnquoteAngel(): void {
    clearOutput();
    if (!isHolidays()) {
...
// 5. Solution
export function findTheWindUpKey(): void {
    clearOutput();
...
export function giveThatBitchAKeyYo(): void {
    clearOutput();
    // if in time!
    if (flags[kFLAGS.GATS_ANGEL_TIME_TO_FIND_KEY] < 150) {
        ...
        addButton(1, "FuckSoldier", theWorstEndingEverDotJPG);
...
// 6. Corrupt End #1
export function theWorstEndingEverDotJPG(): void {
    clearOutput();
...
export function fuckTheAngelBadEnd(): void {
    clearOutput();
...
export function fuckTheAngelBadEndPartII(): void {
    clearOutput();
...
// 8. Good End
export function goodEndForChristmasMiracleICant(): void {
    clearOutput();
...
export function goodEndForChristmasMiracleICantII(): void {
    clearOutput();
...
// If Leave
export function goodEndLeaveBeforeSexings(): void {
    clearOutput();
...
// If Stay
export function stayForPretendNTRGoodWinjobSex(): void {
    clearOutput();
...
// [Conclusion]
export function conclusionOfGiantessGoodEnd(): void {
    clearOutput();
