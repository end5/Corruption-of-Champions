...
export function poniesYN(): boolean {
    if (player.lowerBody == LowerBodyType.CENTAUR && date.date == 1 && date.month == 3 && flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00118] == 0) {
        outputText("", true);
...
// ----------Next Page-----------
export function leavePonies(): void {
    outputText("", true);
...
export function approachPonies(): void {
    outputText("", true);
...
export function derpPolitely(): void {
    outputText("", true);
...
export function derpCreepy(): void {
    outputText("", true);
...
export function derpyParty(): void {
    outputText("", true);
    ...
    player.lowerBody = LowerBodyType.PONY;
