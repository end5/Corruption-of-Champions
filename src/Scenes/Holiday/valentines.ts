...
export function crazyVDayShenanigansByVenithil(): void {
    clearOutput();
...
// [Help them] :
export function helpValentinesDay(): void {
    clearOutput();
...
// [next]
export function helpValentinesDayII(): void {
    clearOutput();
...
export function helpValentinesDayIII(): void {
    clearOutput();
...
// ([Go home])
export function goHomeFromVDay(): void {
    clearOutput();
...
// ([Scylla])
export function goVisitScyllaVday(): void {
    clearOutput();
...
// SCYLLA EVENT
export function goVisitScyllaVdayII(): void {
    clearOutput();
...
export function goVisitScyllaVdayIII(): void {
    clearOutput();
...
export function cuddleWithScyllaVDay(): void {
    clearOutput();
...
// [Make out]
export function makeOutWithScyllaVDay(): void {
    clearOutput();
...
export function makeOutWithScyllaVDayII(): void {
    clearOutput();
...
// [Feed Her!]
export function feedScyllaVDay(): void {
...
// ([Abby]
export function goVisitAbbyVday(): void {
    clearOutput();
...
// ABYLON EVENT
export function goVisitAbby(): void {
    clearOutput();
    ...
    outputText("\n\n\"<i>Ahhh, I see.  " + mf(player, "He", "She") + ", the hero, saving a nun from the evil clutches of the demonic overlord!  She says thank you through growin' monstrous curves and providing extra sloppy blowjobs!  Dat right?</i>\"  You giggle a bit at that interpretation, and say it's not really all that far from the truth, although it is cheapening things... as is her previous interpretation of \"<i>Marethian kinkyness</i>\" cheapening love somewhat.  Abby brings a hand to her lips.  \"<i>Well, she does, at least, LOOK like she could do some... stuff... to a cock.</i>\"  She says, blushing, before you detour that train of thought with a question on how she's gotten herself here.");
...
// {PLEASURE HER}
// {This option doesn't require any sexual endowments whatsoever}
export function pleasureAbbyVDay(): void {
    clearOutput();
    ...
    // ([Naga tongue]
    if (player.tongueType == TongueType.SNAKE) outputText("  Your fingers make it into her pussy alongside your tongue, and the prehensile thing, longer and more flexible than a human's, ravages the insides of her pussy, tasting everywhere as Abby shakes in her orgasm.  Her pussy eagerly tries to milk both your fingers and your tongue, clenching and gripping at them as it drips her pussy juices all over your face.  Abby screams out in a loud, uninhibited orgasm at last, expressing her ecstasy.");
    // ([Demon/Dragon Tongue]
    else if (player.tongueType == TongueType.DEMONIC) outputText("  Abylon shakes in excitement, pleasure, and fear as you extend your inhuman tongue to reach deep into the recesses of her pussy.  She cannot hold out a moment longer, her cunt gripping your inhuman muscle tightly, the hole and muscles inside quivering as you can taster her orgasmic juices with every single point of your tongue.  She screams, shudders and moans, tongue lolling out from the intense pleasure as you force your own tongue to roll around inside her and stretch her in multiple ways. Only you holding her stops Abylon from slumping forward, it seems...");
    // ([Human tongue]
...
// ([Pastie])
export function goVisitPastyVDay(): void {
    clearOutput();
...
export function pastieValentineIntro(choice: string = ""): void {
    clearOutput();
    if (choice == "vag") {
...
// PASTIE EVENT
export function valentineDrinkPastie(itype: ItemType): void {
    clearOutput();
...
// [RubDick]
export function rubPastieOnYourWangDawg(): void {
    clearOutput();
    ...
    if (player.balls > 0) outputText("  Your [balls] lurch, " + skin(player) + " contracting as liquid passion rises within you.");
    outputText("  Your [ass] clenches in anticipation, heralding your climax, so you slide the fairy up your shaft, pulling free from the grip of her arms and legs, holding the confused girl directly in front of your " + multiCockDescriptLight(player) + " while loosing your grasp to bear her entire, curvaceous form to the open air.  With a shuddering gasp, you erupt your intoxicating cream directly into the fey girl, your orgasm");
    // low cum production:
...
// [Pussy Dive]
export function goForAPushayDivePasty(): void {
    clearOutput();
