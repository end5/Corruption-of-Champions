...
export class CorruptedDriderScene {
    ...
    private victoryVSDriderStickDickInSpinneret(): void {
        ...
        if (player.biggestTitSize() >= 3) outputText("  The semi-sticky stuff soaks into the cleavage of your " + allBreastsDescript(player) + ", the feeling surprisingly enjoyable.  You even knead the web in a bit, biting your bottom lip from the sensation.", false);
    ...
    private loseVSDriderAndVaginallyImpreggleOvi(): void {
        ...
        if (!player.isTaur()) outputText("Her fingers then move to the sides of your head, lacing webbing through your hair and sticking it firmly to the ground. More vulnerable than ever, you can't lift your head without ripping your hair from your scalp in chunks.", false);
            ...
            if (player.biggestTitSize() > 4) outputText("With pain and then a pop, your " + allBreastsDescript(player) + " squash out to the sides as she presses your torso into your knees.  ", false);
        ...
        if (player.biggestTitSize() > 3) outputText("  Venom dribbles down the cleavage of your " + biggestBreastSizeDescript(player) + " as she approaches your vulnerable face.  Her own quartet of matronly tits comes to rest on them as her torso appears over their horizon.", false);
        outputText("\n\n", false);
