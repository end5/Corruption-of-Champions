...
export class CorruptedDriderScene {
    ...
    private winDriderPCDickInSpiderCunt(): void {
        ...
        outputText("Compelled by your body's instincts, you draw back your " + hipDescript() + " to expose the bulk of your pussy-soaked shaft.  The spider-woman moans disappointedly, her voice filled with so much wanton desire that your " + cockHead(player, x) + " twitches in response.  You fondle the drider's lower pair of breasts with both hands, circling and squeezing the delectable mounds while you begin to repeatedly impale her squelching pussy, watching the upper row of pale breasts bounce and jiggle above your busy fingers.", false);
    ...
    private winDriderPCDickInSpiderCunt2(): void {
        ...
        outputText("You collapse into the dirt, not even caring that it stinks of dried cum and girl-jizz.  You've completely emptied out every speck of sperm from your " + ballsDescriptLight() + ", and you even kept going for a while after that.  It wasn't until " + sMultiCockDesc(game.player) + " went soft at last that you found enough peace to lie down.  ", false);
    ...
    private victoryVSDriderRideOviVaginal(): void {
        ...
        outputText("  You gasp, arching your back and sliding your " + vaginaDescript() + " forward, as if your quim could somehow devour the entire length on its own.\n\n", false);
    ...
    private victoryVSDriderRideOviAnal(): void {
        ...
        outputText("The spider's look of ", false);
        if (monster.HP < 1) {
            outputText("hate fades slightly when she sees you eyeing her ovipositor, and with a sigh of annoyance, allows the segmented organ to slowly slide out from her body.  It grows to just over two feet in length, swaying sinuously in the air, though you can tell it isn't completely engorged yet.  Still, your " + assholeDescript(), false);
            if (player.hasCock()) outputText(" and " + sMultiCockDesc(game.player) + " twitch", false);
            else outputText(" twitches", false);
            outputText(" at the thought of trying to pack all of that meaty, alien pole inside you.\n\n", false);
        }
        ...
        if (player.hasVagina()) {
            outputText("  Your " + vaginaDescript(0) + " quivers", false);
            if (player.wetness() >= 3) outputText(" and drips", false);
            outputText(" sympathetically with the sensation, and your " + clitDescript() + " peeks from the wet lips.", false);
        }
        ...
        outputText(".  Without warning, the ovipositor dilates, pulling your " + assholeDescript() + " even wider.  An explosion of warmth goes off in your guts, and you realize that your term as an incubator has begun with a sense of perverse delight.\n\n", false);
    ...
    private victoryVSDriderStickDickInSpinneret(): void {
        ...
        if (player.balls > 0) outputText(", even giggling a little as your " + ballsDescriptLight() + " slap against her nose", false);
        outputText(".\n\n", false);
    ...
    private loseVSDriderAndGetFuckedANDAnalImpreggegity(): void {
        ...
        outputText("You look at her with fear, but your " + hipDescript() + " start to twitch against her, rubbing your " + cockHead(player, x) + " up and down the slippery slit.  A slow exhale of pleasure escapes the spider's purple lips while her legs squeeze tighter against you, trying to push your " + cockDescript(game.player, x) + " home.  The drider gasps when at last, you slip between her juicy outer labia, slurping deep into her cunny with a lurid squelch.  Finally held within her depths, your muscles all slacken, save for those you need to pump your hips against her, futilely trying to fuck her hot quim even though you have zero leverage.\n\n", false);
        ...
        outputText("The strange organ keeps forcing its way deeper, slipping the steadily-widening, rib-like segments of its bulk into your " + assholeDescript() + ".  ", false);
    ...
    public birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY(): void {
        ...
        if (player.hasVagina()) {
            ...
            outputText(" into the dirt, getting off along with your " + assholeDescript() + ".  ", false);
        }
    ...
    public driderPregVagBirth(): void {
        ...
        if (player.biggestTitSize() >= 2) {
            outputText("One drider girl cautiously makes her way over to you.  Her legs tickle your stomach as she climbs up to one of your " + breastDescript(game.player, 0) + ".  Grasping the flesh tightly in her tiny hands she begins to suckle at your " + nippleDescript(0) + ".", false);
