...
export class CorruptedDriderScene {
    ...
    private winDriderPCDickInSpiderCunt(): void {
        ...
        else outputText("Your " + game.player.cockDescript(x) + " seems to bulge inside her, giving itself over to the silken caresses of her glorious vagina.", false);
        ...
        else outputText("No, that's not right.  You're not some rutting beast, you're the champion.  Sure, you've got your " + game.player.cockDescript(x) + " locked hilt-deep inside her squirming slit, but that doesn't mean you're some kind of " + player.mf("stud", "slut") + " who jumps on a cunt without a second thought, does it?  You blink your eyes while you try to think.  She does have a point though, if you hadn't been in such a hurry for some sex, you wouldn't be sagging into her tits and feeling so awfully relaxed.\n\n", false);
        ...
        outputText("A plaintive whining, almost exactly like that of an animal, vocalizes subconsciously.  Your " + game.player.cockDescript(x) + " feels afire, constantly leaking pre-cum while you're held immobile in your spidery mistress' arms; you lick your lips and start to beg, mumbling out your desire to cum for her, anything for her, so long as she lets your dick orgasm again and again.  You want to climax so bad, but you want her to control your cock so much more.  It's always getting you in trouble, and it feels so good to let her use you as her cum-drooling mount.\n\n", false);
        ...
        outputText("You mewl out an affirmation, forgetting how to speak with all the venom pumping through you and the mind-crushing levels of arousal pouring out of your " + game.player.cockDescript(x) + ".\n\n", false);
    ...
    private victoryVSDriderRideOviVaginal(): void {
        ...
        if (monster.HP < 1) {
            ...
            if (player.hasCock()) outputText(" and " + game.player.sMultiCockDesc() + " twitch", false);
        ...
        if (player.hasCock()) {
            outputText("  Your own " + game.player.multiCockDescriptLight() + " retaliate", false);
    ...
    private victoryVSDriderRideOviAnal(): void {
        ...
        if (player.hasCock()) {
            outputText("  The warm organ brushes past your prostate, the slippery caress making " + game.player.sMultiCockDesc() + " dribble a ", false);
        ...
        if (player.hasCock()) outputText("while your " + game.player.multiCockDescriptLight() + " dribbles white, wasted goo onto the black and " + monster.hairColor + " striped carapace below", false);
    ...
    private victoryVSDriderStickDickInSpinneret(): void {
        ...
        outputText("\n\n", false);
        outputText("Your lust sated, you disengage from her with a little pop, leaving her to lick her lips happily and groan unintelligible babble.  You wipe your " + game.player.cockDescript(x) + " off on her hair to clean it off a bit, then redress and head out.  With a glance at the snoozing drider over your shoulder, you head out of the smelly swamp and start back towards camp.", false);
        player.orgasm();
        dynStats("cor", .5);
        cleanupAfterCombat();
    }
    ...
    private loseVSDriderAndVaginallyImpreggleOvi(): void {
        ...
        if (player.hasCock() && monster.nipplesPierced > 0) outputText("  Chains brush over " + game.player.sMultiCockDesc() + " as her chest passes your crotch.", false);
        ...
        if (player.hasCock()) outputText("  Even your " + game.player.cockDescript(0) + " spurts some pre-cum of its own.", false);
    ...
    private loseVSDriderAndGetFuckedANDAnalImpreggegity(): void {
        ...
        outputText("", true);
        if (player.lust > 99) outputText("Unable to resist the desire coursing through your body, you strip off your " + player.armorName + " and start stroking " + game.player.sMultiCockDesc() + ", displaying it in the hope that it will draw the drider's attention, while at the same time just trying to get yourself off and attain release.", false);
        else {
            ...
            if (player.cockTotal() > 1) outputText("s", false);
            outputText(" to the air.  She squeezes " + game.player.oMultiCockDesc() + " in her hand and pumps it, smiling while you stiffen and twitch precipitously in her grasp.", false);
        }
        ...
        if (monster.nipplesPierced > 0) outputText(", the crossed chains digging into your " + game.player.chestDesc(), false);
        ...
        outputText("Lines of webbing burst from the arachnid abdomen, snapping into tree limbs before pulling taut.  The drider's eight legs clitter and clack, four of them folding around your back while your world rotates 90 degrees.  The two of you are pulled into the trees by the sticky strands, hanging sideways, almost upside-down, in the leaves.  The four-eyed monster-girl blinks asynchronously and smiles, shifting you slightly to bring " + game.player.oMultiCockDesc() + " against her moist lips.  You exhale, an intense, animalistic thrill shivering through you from the feeling of having your " + game.player.cockDescript(x) + " lodged in a woman's entrance.  She leans down and bites into your neck, releasing a surge of toxin into your bloodstream.  It boils like fire, making you twitch and squirm in her many-limbed clutches.  The pain fades quickly, but in its place it leaves behind a molten, liquid lust, filling " + game.player.sMultiCockDesc() + " to its absolute maximum size, as hard as it can possibly be.\n\n", false);
        ...
        outputText("You look at her with fear, but your " + hipDescript() + " start to twitch against her, rubbing your " + player.cockHead(x) + " up and down the slippery slit.  A slow exhale of pleasure escapes the spider's purple lips while her legs squeeze tighter against you, trying to push your " + game.player.cockDescript(x) + " home.  The drider gasps when at last, you slip between her juicy outer labia, slurping deep into her cunny with a lurid squelch.  Finally held within her depths, your muscles all slacken, save for those you need to pump your hips against her, futilely trying to fuck her hot quim even though you have zero leverage.\n\n", false);
        ...
        outputText("  You shudder from the anal violation and twist against the legs holding you in place, but with your " + game.player.cockDescript(x) + " locked inside her, it's a useless endeavor.  It isn't shaped like a dick, and besides, that's currently dripping on your belly.  Oh gods... she mentioned eggs.\n\n", false);
        ...
        outputText("  Once it gets deep enough to push on your prostate, an upsurge of pleasure hits you hard enough to make " + game.player.sMultiCockDesc() + " dribble.  You moan against the drider's neck, pulsing pathetically inside the spider-woman's slit.  You know you'll soon be giving her exactly what she wants - all of it - and there's nothing you can do about it.\n\n", false);
        ...
        outputText("The egg travels further up your butt, eventually flowing out the end of her stalk-like organ to rest deep in your digestive tract, ensconced in a bubble of slime.  Before you can adjust to this new sensation, another egg slips through your now-widened ring.  It squishes past your anal g-spot, rubbing it just as hard as the first, but before it even finishes traveling up your intestines, a third egg is forced inside you.  " + game.player.SMultiCockDesc() + " begins to cum wildly, squirting and leaking a torrent of jizz.  The first few ropes blast out with incredible force, hosing down her cunt", false);
        if (player.cockTotal() > 1) outputText(" and belly", false);
        outputText(".  Then, the constant application and release of pressure on your prostate utterly destroys the orgasmic timing of your muscles' contractions, making " + game.player.sMultiCockDesc() + " release a weak, but constant trickle of cum.\n\n", false);

        outputText("You quickly lose track of how many of the drider's eggs have gone inside you.  Feeling the numerous bulges in your abdomen, you give up entirely.  Your ass is going to be full of eggs and you've probably cum enough for her to make a whole 'nother batch.  Shuddering while the ovipositor is withdrawn, you sag, exhausted, barely realizing that the drider is hosing down your " + game.player.chestDesc() + " with her arachnid herm-spunk, the nodules ringing her dick pulsing in time with the blasts of thick spooge.  Some sticks to your chin, but you're so drained from your rough treatment that you barely react.\n\n", false);
    ...
    public birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY(): void {
        ...
        if (player.hasCock()) outputText(game.player.SMultiCockDesc() + " stays limp, but drools a heavy flow of semen, puddling up a nice thick batch of your pleasure alongside your goo-pile.  ", false);
        if (player.hasVagina()) {
    ...
    public driderPregVagBirth(): void {
        ...
        if (player.biggestTitSize() >= 2) {
            outputText("One drider girl cautiously makes her way over to you.  Her legs tickle your stomach as she climbs up to one of your " + game.player.breastDescript(0) + ".  Grasping the flesh tightly in her tiny hands she begins to suckle at your " + nippleDescript(0) + ".", false);
    ...
    private buttFuckADriderOhBaby(): void {
        ...
        outputText("Now that she's calmed down, you give her a hard shove, putting her on her drider-belly so you're not nearly thrown off her every other moment.  With that done, you put your hands on her human back, pushing her forward and exposing her human-like bubble-butt, seated just above where woman meets spider. Greedily, you pull her cheeks apart, revealing the tiny star of her puckered asshole.  You pull your " + game.player.cockDescript(x) + " out of your " + player.armorName + ", already hardening from the thought of you pounding her tight little backdoor.\n\n", false);

        outputText("\"<i>Oh, you want that hole, do you? How very kinky,</i>\" the drider chides, but you aren't fooled by her tone – you can see her anus relaxing, preparing itself for your arrival.  With a grin, you grab your " + game.player.cockDescript(x) + " and push it against her tight hole, leaning into the penetration until you feel it slip past her sphincter and into her hot, snug passage.  As you slide more and more of your cockmeat into her, you reach up from her cheeks and grope her breasts, squeezing her pert nipples between your fingers as you finally bottom out.  Since you can go no further up her butt, you start to piston your hips forward, slapping your hips to her ass with short, forceful strokes.\n\n", false);
        ...
        outputText("Without warning, the drider cums.  She cries out and grabs her fully-engaged corrupted cock, hosing down the trees in front of her with spider-cum as her butt squeezes down on your " + game.player.cockDescript(x) + ", milking your dick with her anal passage.  You pick up the tempo of your fucking to break-pelvis speeds, ramming your cock into her backdoor and letting loose a torrent of your spunk, shooting it deep inside her", false);
        // (if Vagina:
        if (player.hasVagina()) {
        ...
        outputText("Finally done, you pull out of the drider, collapsing on her spider-back with a contented sigh.  Completely insensate after the anal ravaging you just gave her, the drider poses no threat as you leisurely gather " + game.player.sMultiCockDesc() + " back into your " + player.armorName + " and lower yourself off her cum-soaked abdomen.  You give her a final, playful ass slap as you dismount before heading back to camp.", false);
