...
export function driderEncounter(): void {
    spriteSelect(77);
    outputText("", true);
    ...
    // repeat intro:
        ...
        if (player.tailType > TailType.NONE) outputText("tail ", false);
...
// *Victory Intro: (done)
export function defeatDriderIntro(): void {
    spriteSelect(77);
    outputText("", true);
    ...
    let buttFuckBUTTFUCKBUTTTFUCKBUTTFUCK: () => void = null;
    if (player.cocks.cockThatFits(monster.analCapacity()) >= 0) buttFuckBUTTFUCKBUTTTFUCKBUTTFUCK = buttFuckADriderOhBaby;
    let vagFuck: () => void = null;
    let fuckSpinner: () => void = null;
    let careful: () => void = null;
    if (player.cocks.length > 0 && player.lust >= 33) {
        ...
        if (player.cocks.cockThatFits(12) >= 0) {
...
// Lose to drider
export function loseToDrider(): void {
    spriteSelect(77);
    ...
    // SELECT SCENE HERE
    const choice: number = select[rand(select.length)];
...
function winDriderPCDickInSpiderCunt(): void {
    ...
    if (player.cocks.length > 1) {
        ...
        if (player.cocks.length > 2) outputText("es fan out to the side, forgotten while you give yourself over to the silken caresses of her glorious vagina.", false);
    ...
    else outputText("Your " + cockDescript(game.player, x) + " seems to bulge inside her, giving itself over to the silken caresses of her glorious vagina.", false);
    outputText("  The more you fuck the arachnid hussy's wanton slit, the more animated she becomes, until she finally breaks her wordless silence by crying, \"<i>Yes " + mf(player, "master", "mistress") + ", dominate me!  I've been such a naughty bitch.  Use me like your cheap whore!  Fuck my holes full of cum, and leave me defiled in a puddle of spunk-laced mud!</i>\"\n\n", false);
    ...
    outputText("While you're distracted by the repeated contrast of tension and relief emanating from " + sMultiCockDesc(game.player) + ", the drider leans up and kisses your neck, humming against your throat as you squirt the last of your orgasmic goop into her vagina.  You slump into her arms, spent by the effort of fucking her so fast and cumming so hard.  As you lie there, her lips sucking hard enough to leave hickeys on your neck with every crushing, passionate kiss, you feel the patterns of glossy fluid tingling on your " + skin(player) + ".  A jolt of fear runs up your spine, and you try to push away from her envenomed affections.  It doesn't work!  You can barely lift your arms, let alone pull out of the amorous arachnid's embrace!\n\n", false);

    outputText("\"<i>Mmmmm,</i>\" hums the drider into your collarbone, smearing more of her toxic lip-gloss onto you as she goes.  \"<i>Such a good " + mf(player, "master", "mistress") + "!  You punished me so well!  Now just relax... I've been dripping out a special venom that'll help you teach me the rest of my lesson, and I need to make sure that every... single... drop... slips inside that sexy bloodstream of yours.</i>\"\n\n", false);

    outputText("You wiggle futilely, using the last of your strength to try to break free, but it's no use - she's too strong, or the venom has made you too weak.  Dimly, you're aware of your " + cockDescript(game.player, x) + " pulsating inside her, hard as iron and burning hot with lust, even though you just came.  The spider-woman continues to kiss you, and with every peck of her lips, you feel yourself sagging deeper into her embrace until you lay your head down on her breast, your only movements the slight twitches of your body as it tries to deal with the poison-induced need to copulate.  You feel the warmth of her breath on your neck when she stops, cradling you in her arms.\n\n", false);

    outputText("The drider cocks her head to the side so you can see her luminous " + monster.skinTone + " eyes boring into you while she whispers, \"<i>Don't try to fight it, dear.  While there's enough of my normal venom in there to keep your " + cockDescript(game.player, x) + " hard enough to cum a few more times for me, the real magic is in the secondary chemicals my demonic friends were kind enough to teach me how to excrete.  You can feel it relaxing your muscles can't you?  Well, the beauty is that it isn't just your muscles relaxing... your mind is getting nice and relaxed too.  So open and pliable that you'll soon be a horny puddle of putty for me to play with.</i>\"\n\n", false);
    ...
    else outputText("No, that's not right.  You're not some rutting beast, you're the champion.  Sure, you've got your " + cockDescript(game.player, x) + " locked hilt-deep inside her squirming slit, but that doesn't mean you're some kind of " + mf(player, "stud", "slut") + " who jumps on a cunt without a second thought, does it?  You blink your eyes while you try to think.  She does have a point though, if you hadn't been in such a hurry for some sex, you wouldn't be sagging into her tits and feeling so awfully relaxed.\n\n", false);
    ...
    if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 1) outputText("  Exgartuan mumbles telepathicaly, \"<i>Fuck yes I do, but I wanna see how this plays out.</i>\"", false);
    ...
    outputText("A plaintive whining, almost exactly like that of an animal, vocalizes subconsciously.  Your " + cockDescript(game.player, x) + " feels afire, constantly leaking pre-cum while you're held immobile in your spidery mistress' arms; you lick your lips and start to beg, mumbling out your desire to cum for her, anything for her, so long as she lets your dick orgasm again and again.  You want to climax so bad, but you want her to control your cock so much more.  It's always getting you in trouble, and it feels so good to let her use you as her cum-drooling mount.\n\n", false);
...
function winVSDriderTakeItsCockInCunt(): void {
    ...
    outputText("Avoiding the desperate drider's spindly legs, you walk around to grab onto her limp torso, pulling it over until she lands on her back with her lewd figure in full display.  The girl pauses hesitantly, cupping one of her heaving tits in her hand while placing a finger to her lips with the other as she waits for you to make your move - in her current state, it's unlikely she can retaliate even if she wanted to.  The drider's corrupted cock twitches with excitement, a thick rod standing tall amidst the collapsed heap of its owner.  A bead of pre-cum oozes from the tip as evidence of your quick work, reminding you it would be rude to leave the job unfinished.  Swaying your " + hipDescription(player) + " enticingly, you move slowly down towards her lower torso, reaching over and propping yourself on top of the spider-woman with your " + buttDescription(player) + " pressing against her slick devil-dick.  You look into her eager eyes, the aroused pet almost screaming for relief with her pained stare and the equally responsive cock grinding along your " + vaginaDescript(player, 0) + ".  Reaching behind you, you grab the base of her member and pull, eliciting a yelp and an involuntary thrust from your victim that almost forces her tip inside.  It misses, however, and instead slips out in front of you, the nubs of her cock pushing along your lips and accidentally brushing along your " + clitDescription(player) + ".  You stifle a moan - she'll pay for that.\n\n", false);

    outputText("Holding on to the top portion of the drider's thick member, you squeeze her in between your upper legs, pressing the demonic dong against your labia and inner thighs, both hot with desire.  Sliding upwards, you begin to bounce on top of the drider in a cowgirl-like position, grinding against her length while your " + buttDescription(player) + " slaps against her soaking pussy with every downward thrust.  The arachnid-morph convulses and moans along with your movements, unable to handle the feeling of your warmth against her heated member and the expertise of your hands fondling her tip, your fingers soaked with her leaking pre.  Riding your new pet victoriously, you make sure that the spider-woman can't escape the confines of your " + hipDescription(player) + ".\n\n", false);
    ...
    if (player.vaginalCapacity() < monster.cocks.cockArea(0)) outputText("bottoms out", false);
...
function victoryVSDriderRideOviVaginal(): void {
    ...
    outputText("Vocalizing like an animal, you climax over and over in a seemingly endless rut, swiveling your hips while your muscles milk the ovipositor, practically pulling the eggs into your hungry womb.  When the last one is packed tightly into your uterus, your " + vaginaDescript(player) + " keeps milking it, a hollow ring of disappointment penetrating your fog as you realize the pleasure has come to an end.  The thick, egg-laying organ slowly shrivels, shrinking down enough that it slides free.  As it's pulled out, a river of slime comes with it, released to pour out of your overstuffed cooch.\n\n", false);
...
function victoryVSDriderRideOviAnal(): void {
    ...
    outputText("The spider's look of ", false);
    if (monster.HP < 1) {
        outputText("hate fades slightly when she sees you eyeing her ovipositor, and with a sigh of annoyance, allows the segmented organ to slowly slide out from her body.  It grows to just over two feet in length, swaying sinuously in the air, though you can tell it isn't completely engorged yet.  Still, your " + assholeDescript(player), false);
        if (player.cocks.length > 0) outputText(" and " + sMultiCockDesc(game.player) + " twitch", false);
        else outputText(" twitches", false);
        outputText(" at the thought of trying to pack all of that meaty, alien pole inside you.\n\n", false);
    }
    ...
    outputText("Climbing over the drider's bulbous body, you bend over to present your " + buttDescription(player) + " to the twitching ovipositor, beckoning her to slide inside your twitching " + assholeDescript(player) + " as you stand atop its owner.  The sprawled-out spider looks up past all of her body to watch you, leaving you waiting.  Nothing happens at first.  You're just there, ass in the air and waiting to be violated, encouraging it on your own terms, but she doesn't do anything at all.  She simply watches you.  It isn't until a scowl of irritation makes its way across your face that she acts.\n\n", false);
    ...
    if (player.cocks.length > 0) outputText(" and your prostate", false);
    ...
    if (player.cocks.length > 0) outputText(" and milk your prostate as they push past", false);
    outputText(".\n\n", false);
...
function victoryVSDriderStickDickInSpinneret(): void {
    ...
    outputText("Any satisfaction the drider could have gleaned is quickly replaced with complete trepidation as you swivel her spinneret toward you, grabbing your " + cockDescript(game.player, x) + " and lining it up with the onyx protrusion.  She manages to choke out a protest before you plunge into the depths, the tight recesses squeezing you wonderfully.  A strangled, gurgly scream peals from the oversensitized girl, both her arms and legs flailing about.  You push up to your pelvis into her spinneret, then slowly—so slowly—draw back, the sensation leaving the drider to claw deep divots into the mossy ground.  You draw out to the " + cockHead(player, x) + ", then thrust back in, taking your sweet time with the motions.  Her eyes roll back into her head, and another gurgle rumbles in her throat.  You have to wonder if she can even form coherent thoughts, in this state.  No matter; she insulted you, after all.  She begins hissing something through her clenched teeth, and while unintelligible at first, you can eventually make out, \"<i>Fuck you... fuck you... fuck you...</i>\" like some sort of vulgar mantra.\n\n", false);
    ...
    if (player.breastRows.biggestTitSize() >= 3) outputText("  The semi-sticky stuff soaks into the cleavage of your " + allBreastsDescript(player) + ", the feeling surprisingly enjoyable.  You even knead the web in a bit, biting your bottom lip from the sensation.", false);
    ...
    if (player.cocks.length > 1) {
        ...
        if (player.cocks.length > 2) outputText("cocks give ", false);
    ...
    outputText("\n\n", false);
    outputText("Your lust sated, you disengage from her with a little pop, leaving her to lick her lips happily and groan unintelligible babble.  You wipe your " + cockDescript(game.player, x) + " off on her hair to clean it off a bit, then redress and head out.  With a glance at the snoozing drider over your shoulder, you head out of the smelly swamp and start back towards camp.", false);
    player.orgasm();
    dynStats("cor", .5);
    cleanupAfterCombat();
}
...
function loseVSDriderGetAnalledOvi(): void {
    spriteSelect(77);
    outputText("", true);
    outputText("You fall to the ground, defeated by the agile arachnid-woman as she slowly advances towards you, her engorged clit growing larger and larger as it throbs in your direction.  You've managed to find yourself crumpled face down in the dirt, your " + buttDescription(player) + " in full display of the aroused drider while she grins lustfully at your broken figure.  Grunting, you begin to pull yourself off the ground, only to hear your attacker 'tsk' before feeling the warm stickiness of her web launch upon your limbs, gluing your hands to your ankles and leaving you completely vulnerable.  You struggle against the bindings, but to no avail.  Lifting your head, you turn to see the drider stroking her now fully-enlarged demon cock, replacing the hardened clit that once adorned her moist pussy.\n\n", false);
...
function loseVSDriderAndVaginallyImpreggleOvi(): void {
    ...
    if (!player.isNaga()) outputText("pull your own " + feet(player) + " apart", false);
    ...
    if (!player.isNaga()) {
        ...
        outputText(legs(player) + " and pinning you in that prone, separated position", false);
    }
    ...
    if (!player.isTaur()) outputText("Her fingers then move to the sides of your head, lacing webbing through your hair and sticking it firmly to the ground. More vulnerable than ever, you can't lift your head without ripping your hair from your scalp in chunks.", false);
        ...
        if (player.breastRows.biggestTitSize() > 4) outputText("With pain and then a pop, your " + allBreastsDescript(player) + " squash out to the sides as she presses your torso into your knees.  ", false);
    ...
    if (player.cocks.length > 0 && monster.nipplesPierced > 0) outputText("  Chains brush over " + sMultiCockDesc(game.player) + " as her chest passes your crotch.", false);
    outputText("  Her fangs trail teasingly along your belly, her fingers crawling up your sides.", false);
    if (player.breastRows.biggestTitSize() > 3) outputText("  Venom dribbles down the cleavage of your " + biggestBreastSizeDescript(player) + " as she approaches your vulnerable face.  Her own quartet of matronly tits comes to rest on them as her torso appears over their horizon.", false);
    outputText("\n\n", false);
    ...
    if (player.cocks.length > 0) outputText("  Worse still, its blood-swollen protuberance is met with no reaction from the drider.", false);
    ...
    if (player.cocks.length > 0) outputText("  Even your " + cockDescript(game.player, 0) + " spurts some pre-cum of its own.", false);
...
function loseVSDriderAndGetFuckedANDAnalImpreggegity(): void {
    ...
    outputText("", true);
    if (player.lust > 99) outputText("Unable to resist the desire coursing through your body, you strip off your " + player.armorName + " and start stroking " + sMultiCockDesc(game.player) + ", displaying it in the hope that it will draw the drider's attention, while at the same time just trying to get yourself off and attain release.", false);
    else {
        outputText("You slump down, too beat up to mount an effective defense, let alone stay up on your " + feet(player) + ".  The drider skitters over to you and effortlessly peels you out of your " + player.armorName + ", exposing your ", false);
        if (player.lust < 50) outputText("soft", false);
        else outputText("hard", false);
        outputText("member", false);
        if (player.cocks.length > 1) outputText("s", false);
        outputText(" to the air.  She squeezes " + oMultiCockDesc(game.player) + " in her hand and pumps it, smiling while you stiffen and twitch precipitously in her grasp.", false);
    }
    ...
    if (monster.nipplesPierced > 0) outputText(", the crossed chains digging into your " + chestDesc(game.player), false);
    ...
    outputText("Lines of webbing burst from the arachnid abdomen, snapping into tree limbs before pulling taut.  The drider's eight legs clitter and clack, four of them folding around your back while your world rotates 90 degrees.  The two of you are pulled into the trees by the sticky strands, hanging sideways, almost upside-down, in the leaves.  The four-eyed monster-girl blinks asynchronously and smiles, shifting you slightly to bring " + oMultiCockDesc(game.player) + " against her moist lips.  You exhale, an intense, animalistic thrill shivering through you from the feeling of having your " + cockDescript(game.player, x) + " lodged in a woman's entrance.  She leans down and bites into your neck, releasing a surge of toxin into your bloodstream.  It boils like fire, making you twitch and squirm in her many-limbed clutches.  The pain fades quickly, but in its place it leaves behind a molten, liquid lust, filling " + sMultiCockDesc(game.player) + " to its absolute maximum size, as hard as it can possibly be.\n\n", false);
    ...
    outputText("You look at her with fear, but your " + hipDescription(player) + " start to twitch against her, rubbing your " + cockHead(player, x) + " up and down the slippery slit.  A slow exhale of pleasure escapes the spider's purple lips while her legs squeeze tighter against you, trying to push your " + cockDescript(game.player, x) + " home.  The drider gasps when at last, you slip between her juicy outer labia, slurping deep into her cunny with a lurid squelch.  Finally held within her depths, your muscles all slacken, save for those you need to pump your hips against her, futilely trying to fuck her hot quim even though you have zero leverage.\n\n", false);
    ...
    if (player.cocks.length > 1) outputText(" and belly", false);
    outputText(".  Then, the constant application and release of pressure on your prostate utterly destroys the orgasmic timing of your muscles' contractions, making " + sMultiCockDesc(game.player) + " release a weak, but constant trickle of cum.\n\n", false);

    outputText("You quickly lose track of how many of the drider's eggs have gone inside you.  Feeling the numerous bulges in your abdomen, you give up entirely.  Your ass is going to be full of eggs and you've probably cum enough for her to make a whole 'nother batch.  Shuddering while the ovipositor is withdrawn, you sag, exhausted, barely realizing that the drider is hosing down your " + chestDesc(game.player) + " with her arachnid herm-spunk, the nodules ringing her dick pulsing in time with the blasts of thick spooge.  Some sticks to your chin, but you're so drained from your rough treatment that you barely react.\n\n", false);
...
export function birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY(): void {
    spriteSelect(77);
...
export function driderPregVagBirth(): void {
    ...
    if (player.eyeType != EyeType.FOUR_SPIDER_EYES) outputText("  Suddenly she flops forward, leaning against your eyebrows and causing you to cross your eyes in an attempt to focus on her.  She seems confused by the way your eyes are different to hers.", false);
    ...
    if (player.cocks.length > 0) outputText(" and raging hard on", false);
...
function buttFuckADriderOhBaby(): void {
    ...
    outputText("Now that she's calmed down, you give her a hard shove, putting her on her drider-belly so you're not nearly thrown off her every other moment.  With that done, you put your hands on her human back, pushing her forward and exposing her human-like bubble-butt, seated just above where woman meets spider. Greedily, you pull her cheeks apart, revealing the tiny star of her puckered asshole.  You pull your " + cockDescript(game.player, x) + " out of your " + player.armorName + ", already hardening from the thought of you pounding her tight little backdoor.\n\n", false);

    outputText("\"<i>Oh, you want that hole, do you? How very kinky,</i>\" the drider chides, but you aren't fooled by her tone – you can see her anus relaxing, preparing itself for your arrival.  With a grin, you grab your " + cockDescript(game.player, x) + " and push it against her tight hole, leaning into the penetration until you feel it slip past her sphincter and into her hot, snug passage.  As you slide more and more of your cockmeat into her, you reach up from her cheeks and grope her breasts, squeezing her pert nipples between your fingers as you finally bottom out.  Since you can go no further up her butt, you start to piston your hips forward, slapping your hips to her ass with short, forceful strokes.\n\n", false);
    ...
    else if (player.cocks.length > 1) outputText(" as", false);
    if (player.cocks.length > 1) {
        outputText(" your spare cock", false);
        if (player.cocks.length == 2) outputText(" coats", false);
        else outputText("s coat", false);
        outputText(" her human back with a thick white layer of spooge", false);
    }
    outputText(".\n\n", false);

    outputText("Finally done, you pull out of the drider, collapsing on her spider-back with a contented sigh.  Completely insensate after the anal ravaging you just gave her, the drider poses no threat as you leisurely gather " + sMultiCockDesc(game.player) + " back into your " + player.armorName + " and lower yourself off her cum-soaked abdomen.  You give her a final, playful ass slap as you dismount before heading back to camp.", false);
