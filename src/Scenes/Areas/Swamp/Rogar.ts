...
((Scenario 4, [Frot]))*/
        ...
        // ((Ro'gar phase = 1)) (edited)
            ...
            if (player.biggestTitSize() >= 2 && player.lib >= 50) {
                ...
                if (player.inte <= 30) {
                    ...
                    if (player.hasVagina()) outputText("  When you witnessed him make that other beast submit with strength alone it created a demanding need in your " + vaginaDescript() + " during the match, and the memory is doing much the same now.", false);
                    // ((if player has cock(s))
                    if (player.hasCock()) outputText("  You feel " + game.player.sMultiCockDesc() + " shift as you remember how hard you got from behind the tree, finding yourself absent mindedly stroking yourself with an open palm as pre-cum soaks through your clothing.", false);
    ...
    private waitForChunkyOrcLoe(): void {
        ...
        if (flags[kFLAGS.ROGAR_PHASE] == 0) {
            ...
            // ((If libido is 50 or more))
                ...
                if (player.hasVagina()) {
                    outputText("  Your " + vaginaDescript(0) + " starts to quiver as the warm water rolls over its lips, moistening in excitement as your skin is rubbed over by strong hands.  Your chest heaves as it relaxes to his touch, your " + nippleDescript(0) + "s becoming stiff under his rubbing.", false);
                ...
                else if (player.hasCock()) outputText("  " + game.player.SMultiCockDesc() + " stirs to life, making it obvious how much you are enjoying the rub down, then begins to drool with lust.  Through lidded eyes you faintly make out Ro'gar's toothy smirk becoming a hungry grin.", false);
    ...
    private okayBroLetsHaveAGayCarwash(): void {
        ...
        if (player.hasCock()) outputText(game.player.sMultiCockDesc(), false);
        else if (player.hasVagina()) outputText("your " + vaginaDescript(0), false);
        else outputText("your " + assholeDescript(), false);
        ...
        // ((androgynous or masculine and breasts <= A-cup))
            ...
            // (else if Dirt Mc Girt = 2)
                ...
                if (player.gender == 2 || player.gender == 0) {
                    ...
                    outputText("  " + game.player.SMultiCockDesc() + " gets a caress from him as he explores, arousing it to mild stiffness.  \"<i>" + player.short + ",</i>\" he grunts.  \"<i>Ah hope ah'll be seein' more of ya.</i>\"  Ro'gar breaks the contact and tips back the remains of his drink while you ", false);
    ...
    public rogarPhaseFour(): void {
        ...
        if ((player.biggestTitSize() >= 2) && flags[kFLAGS.ROGAR_WARNING] == 0) {
            ...
            if (player.biggestTitSize() >= 2) outputText(" and your " + game.player.chestDesc(), false);
        ...
        // (andro or masculine with tits <= A)
            ...
            if (player.gender == 2 || player.gender == 0) {
                ...
                outputText("  " + game.player.SMultiCockDesc() + " trembles under his strong touch, as he increases the pressure and looks into your eyes meaningfully.  ", false);
    ...
    private loseButtGinity(): void {
        ...
        // (([Get Anal] Scenario 1b: Get fucked (normal)))
            ...
            outputText("  You can feel his demanding tongue pressing into your mouth and coaxing moans from the wanton entrance.  His hand slides down your waist to cup your " + buttDescript() + " in his strong grip.  Ro'gar breaks the kiss with a devious grin.  \"<i>Let's get you out of these clothes.</i>\"  His voice rumbles deep in his chest, the resonations vibrating against your skin.  He takes the initiative and pulls off your garments, leaving you completely nude in his lap.  One of the orc's hands wanders over your body, playing with your nipples while the other slides down toward your " + game.player.multiCockDescriptLight() + ".  Ro'gar's head nestles in the nape of your neck, gently nipping at your skin and reddening it with a slight sting.  Where he nibbles he quickly follows with a tender lap of warm tongue over the abused flesh, bringing slight shudders through your body as his smooth tusks rub over you.\n\n", false);

            outputText("You are left panting for breath from Ro'gar's continued teasing, your skin on fire from every touch as his thin oil smears over it.  You spread your legs lewdly on Ro'gar's lap, blood rushing south as you feel yourself stiffen and throb - though you aren't the only one sporting wood, as you soon feel Ro'gar's hot manhood pressed up to your side.  He groans into your shoulder, bucking his hips to hump your flesh.  Pre-cum dribbles from Ro'gar's swollen cockhead and smears you in his need.  \"<i>Come here,</i>\" he whispers directly into your ear.  His hands grip your bottom as he pulls you closer to face him.  Your chest presses to his as you straddle Ro'gar's hips.  Ro'gar's throbbing ten inches of man meat tucks between the cheeks of your " + buttDescript() + ". He gives you a playful wink, bucking his hips to bounce you in his lap.  The feeling of his hot, thick length rubbing over your " + assholeDescript() + "  and wetting it with copious pre makes you gasp like a bitch in heat.  The dripping orc spooge snakes down in between your cheeks, and you feel your body shudder with anticipation; Ro'gar lets the liquid pour over his own hard-on.  \"<i>My favorite boy ready for the ride of his life?</i>\"  He grins impishly as he grips the head of his thick, uncut orc cock and pushes it against your boy cunt.  A gasp of pleasure escapes your lips and your hands clasp onto Ro'gar's shoulders, wriggling your " + buttDescript() + " over the green mile.\n\n", false);

            outputText("With a buck of Ro'gar's hips his slick cockhead slips into your " + assholeDescript() + ".  Your lips part wide, letting out a sharp gasp as he nestles within you.  \"<i>Git ridin', boy!</i>\" he barks, with a hard smack against your " + buttDescript() + ".  You yelp at the rough treatment, easing yourself down slowly to slide Ro'gar's stiff flesh further into you, and feel yourself growing hard as the throbbing manhood stretches you open.  " + game.player.SMultiCockDesc() + " swells with blood as it brushes against Ro'gar's stomach, and the sensitive urethra picks up a thin layer of his slime from his skin, making you burn with sensitivity.  Your hips shift into Ro'gar's body more, rubbing your " + game.player.multiCockDescriptLight() + " tightly against him.", false);
            ...
            // (else)
                ...
                outputText("  You cry out as Ro'gar finds your sweet spot.  \"<i>Now I got yer button, boy,</i>\" he snickers, wearing his usual predatory grin, the sharp, jagged teeth on full display as you shudder from the relentless pounding against your " + buttDescript() + ".  The sound of flesh smacking flesh is loud in your ears as you squirm from Ro'gar's cock.  Each thrust drives you mad with pleasure, your mind in a lust-induced haze as your prostate is prodded and poked.", false);
                // [(If player has balls)
                if (player.balls > 0) outputText("  You feel your " + ballsDescriptLight() + " pull up tight in your sack as your labored breath comes out in pants.", false);
    ...
    private fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim(): void {
        ...
        if (player.cor > 70 && player.hasVagina()) outputText("Ro'gar flicks his tongue toward your " + game.player.multiCockDescriptLight() + ", but you have a better idea and nudge him lower to guide him to your " + vaginaDescript() + ".  His eyes look up at you in confusion.  You can tell he'd rather not have his face buried there by the way he moves his mouth away, but you urge him on; telling him to get licking, you push your hips down over his face.  With his head caught between your legs and the bed his mouth presses to your " + vaginaDescript(0) + "without a choice.  His whimpers of displeasure bring a grin to your face as you rub over his mouth with your netherlips.  He reluctantly flicks his tongue out to lap over your mound.  You shiver at the attention, growing moist and slick as you drip over Ro'gar's mouth.  The orc gives a whine of disgust as you rudely force him to pleasure your pussy, and you let out a loud moan as his unwilling licks turn you on; excited, you stroke your " + game.player.cockDescript(0) + ".  Ro'gar focuses his attention on that instead, watching you grow stiff and swollen, his eyes following your pumping hand.  You generously rub the slick, drooling pre-cum over " + game.player.sMultiCockDesc() + ", your vaginal walls clenching around his tongue as you pleasure yourself, working the goo over your flesh with your hand.  You look down and grin devilishly at him.\n\n", false);
        // (If player doesn't have vagina but has 70+ corruption)
        else if (player.cor > 70) outputText("Ro'gar flicks his tongue over your " + game.player.multiCockDescriptLight() + ", but you have a better idea and nudge him lower to guide him to your " + assholeDescript() + " .  With a lusty growl Ro'gar attacks your pucker, tongue swirling over the surface and coaxing a pleased moan from your lips.  You grow stiff with arousal, bringing a hand down your shaft to answer your burning lust with a few teasing strokes.  You smear the pre-cum pouring out of your " + game.player.multiCockDescriptLight() + " into an even coating of spunk as you work your hand.  Ro'gar looks over at the pumping hand and soon becomes distracted from his work, his tongue pressed lazily against your " + assholeDescript() + ".  You look down and grin devilishly at him.\n\n", false);

        outputText("Pulling back off of Ro'gar's face, you feel your entire body twitch in anticipation.  You press your " + hipDescript() + " against his muscled ass, lining your aroused member up against his tight rear while your hands grope over the firm muscled cheeks, spreading them apart eagerly.\n\n", false);
        ...
        // ((If cock is between 18 and 4 inches))
            ...
            // (If horse cock)
            else if (player.cocks[0].cockType == CockTypesEnum.HORSE) outputText("  The flared head of your " + game.player.cockDescript(0) + " nestles in Ro'gar's hole.  His breath quickens as you push in, the girthy, flared head stretching Ro'gar's insides impossibly.  You simply thrust and buck you way deeper within the green pucker to force more of your lengthy shaft past that olive rosebud each time.\n\n", false);
            // (If dog cock)
            ...
            outputText("\n\nYou grip his hips and begin a steady pace, slapping flesh loudly against his muscled ass.  His thick, powerful legs twitch in the air as you pound into his orcish hole, and the orc's toes curl visibly with each brutal thrust you make into him.  You groan as his musk makes your " + game.player.multiCockDescriptLight() + " throb all the more within him.  To further his humiliation, you whisper in his pointed ear how good he feels wrapped around your length.  He blushes a lime green before you make him groan out your name with a rough smack over his ass.", false);
            ...
            // [(if multiple cock)
            if (player.cockTotal() > 1) outputText("  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro'gar's body.  In seconds he resembles a well-paid whore beneath your " + game.player.multiCockDescriptLight() + ".", false);
            outputText("\n\n", false);
        }
        // end right fit path
    ...
    private kinkyWithDaOrc(): void {
        ...
        outputText("at Ro'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your " + buttDescript() + " receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your " + player.armorName + " to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your " + nippleDescript(0) + "s, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro'gar's mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro'gar's blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  \"<i>Such a perdy face yer makin', " + player.short + ".  Yer lookin' at me like a proper slut, an' it's makin' me hard seein' ya so needy to be bred.</i>\"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as " + game.player.sMultiCockDesc() + " oozes and throbs against the sheets, making the fabric damp with your lust.\n\n", false);
        ...
        outputText("You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to pound your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + game.player.multiCockDescriptLight() + " and glaze your belly with pre-cum.", false);
        if (player.hasLongTail() > 0 || player.isNaga()) outputText("  Your tail, still gripping Ro'gar's arm, squeezes tight.", false);
        // (If player has balls)
    ...
    private rubdubWithDaOrcWithoutDucky(): void {
        ...
        outputText("Without any hesitation you straddle the orc's hips again, his engorged orc cock brushing against the bare skin of your " + buttDescript() + ". Your hands get to work smearing the relaxing oil over Ro'gar's body. The orc stares at you with a lurid gaze as you massage his bulging pectorals, teasing his darkened nipples with your fingers. You grin feeling Ro'gar's thick cock pressing more against your " + buttDescript() + " as his chest rumbles under your hands.\n\n", false);
        outputText("\"<i>You're good at this " + player.short + ", have you done this before?</i>\" Ro'gar purrs as you work over his abdominals, tracing over every gap with your fingertips, the oils glistening over your lover's body. Ro'gar's hips buck gently, bumping your " + buttDescript() + " with his throbbing cock with a chuckle, his mouth curls into a coy smile. You watch as Ro'gar reaches his arms back, resting his head on his hands as he bares his underarm and pits.\n\n", false);
