...
private  rogarFuckMenu():void {
	spriteSelect(86);
	var getAnal:() => void = null;
	var giveAnal:() => void = null;
	var frot:() => void = null;
	var brodown:() => void = null;
        var getTied:() => void = null;
	var rubdub:() => void = null;
