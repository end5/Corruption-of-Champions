...
export class AntsScene implements TimeAwareInterface {
    ...
    private birfingSexWithAntsForDasLadies(): void {
        ...
        // If PC has (a) Dick(s), that are less than 42 inches:
        if (player.cockTotal() > 0 && player.cockThatFits(42) >= 0) outputText("\n\nWithout warning, Phylla begins to alternate between giving your " + clitDescript() + " oral and sucking your " + multiCockDescriptLight(game.player) + "; the dual stimulation overwhelms you as she devilishly teases your sexes.");
