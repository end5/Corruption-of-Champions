...
export class Naga extends Monster {
    ...
    protected nagaPoisonBiteAttack(): void {
        ...
        if (player.effects.findByType(StatusAffects.NagaVenom) < 0) {
            ...
            if (player.spe > 4) {
                ...
                player.effects.create(StatusAffects.NagaVenom, 3, 0, 0, 0);
            }
            else {
                player.effects.create(StatusAffects.NagaVenom, 0, 0, 0, 0);
    ...
    protected nagaConstrict(): void {
        ...
        player.effects.create(StatusAffects.NagaBind, 0, 0, 0, 0);
    ...
    protected nagaTailWhip(): void {
        ...
        // [if evaded]
        if ((player.perks.findByType(PerkLib.Evade) && rand(6) == 0)) {
