...
export class Wanderer {
    ...
    public wandererRouter(): void {
        ...
        if (player.effects.findByType(StatusAffects.MeetWanderer) < 0) {
            ...
            player.effects.create(StatusAffects.MeetWanderer, 0, 0, 0, 0);
        }
        // Repeat offense!
        else {
            // Chosen demon ending
    ...
    private wandererDemonEpilogue(): void {
        ...
        if (player.effects.findByType(StatusAffects.WandererDemon) >= 0) {
            // First time...
            if (player.effects.getValue1Of(StatusAffects.WandererDemon) == 0) {
            ...
            // Second Encounter
            else if (player.effects.getValue1Of(StatusAffects.WandererDemon) == 1) {
    ...
    private wandererEpilogueHuman(): void {
        ...
        if (player.effects.findByType(StatusAffects.WandererHuman) >= 0) {
            // Human Epilogue 1
            if (player.effects.getValue1Of(StatusAffects.WandererHuman) == 0) {
