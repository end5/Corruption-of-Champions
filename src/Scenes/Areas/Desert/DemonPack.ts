...
export class DemonPack extends Monster {
    ...
    public defeated(hpVictory: boolean): void {
        ...
        if (this.effects.findByType(StatusAffects.phyllafight) >= 0) {
            doNext(AntsScene.consolePhylla);
        } else if (hpVictory) {
            cleanupAfterCombat();
        } else {
