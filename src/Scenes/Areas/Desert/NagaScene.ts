...
export function nagaEncounter(): void {
    ...
    if (player.lowerBody == LowerBodyType.NAGA) {
        ...
        // chick secks
            ...
            outputText("You untangle the end of your tail from hers and bring it up between the two of you, sliding it between your " + breastDescript(game.player, 0) + " and inserting it sensually into your mouth. You suck on the end, making sure to coat it liberally before bringing it down to the naga's awaiting slit.\n\n", false);
