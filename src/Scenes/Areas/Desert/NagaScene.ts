...
export class NagaScene {
    ...
    public nagaFUCKSJOOOOOO(): void {
        ...
        if ((player.perks.findByType(PerkLib.BimboBrains) >= 0 || player.perks.findByType(PerkLib.FutaFaculties) >= 0) && player.hasVagina()) {
            ...
            // [If Lactating]
            if (player.lactationQ() >= 50 && player.biggestLactation() >= 1) outputText("Your warm milk is leaking from your " + nippleDescription(player, 0) + "s the entire time, coating your skin and soaking her hands. At one point, she withdraws a hand and licks the milk from it. You can only assume that she liked it, as she begins to focus even more on your breasts.\n\n", false);
            // -------
