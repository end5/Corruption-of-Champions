...
export class NagaScene {
        ...
        if (player.hasVagina()) {
            ...
            if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                ...
                if (monster.lust > 99) {
                    ...
                    outputText("She begins to gently toy with your " + clitDescript() + " using the very end of her tail, flicking it back and forth. You can't help but start moaning softly yourself. You respond by slowly teasing two of your fingers inside her waiting pussy, slowly beginning to move them in and out. As you begin to accelerate the motion of your fingers, the naga steps it up as well, sliding the tip of her tail inside your " + vaginaDescript(0) + ".  ", false);
    ...
    public nagaFUCKSJOOOOOO(): void {
        ...
        if ((player.findPerk(PerkLib.BimboBrains) >= 0 || player.findPerk(PerkLib.FutaFaculties) >= 0) && player.hasVagina()) {
            ...
            outputText("The naga lifts you from her body with her tail, placing you onto the warm sand where she had been laying. She moves her own body above yours, her tail buried deep inside your " + vaginaDescript(0) + " the entire time. She holds you in place with one hand, her other hand moving to resume playing with your " + allBreastsDescript(player) + ". She moves her head in, her hot breath washing over your neck, and looks up into your eyes for a moment. She smiles, giggles, and then wraps her mouth around your " + nippleDescript(0) + ", letting her slender tongue tickle your sensitive areola.\n\n", false);
            // -----
        ...
        // too)
            ...
            // (Cock too big)
                ...
                // (if PC has balls)
                if (player.balls > 0) {
                    outputText("She shifts one of her hands down from your " + cockDescript(game.player, 0) + ", to your " + ballsDescriptLight() + ", cupping them in her slick palm.  ", false);
                }
