...
export function wormToggle(): void {
    spriteSelect(76);
    clearOutput();
...
export function infestOrgasm(): void {
    spriteSelect(76);
...
export function wormAttack(): void {
    spriteSelect(76);
    // Dodged!
...
export function wormsEntice(): void {
    spriteSelect(76);
    // FAIL
    if (rand(2) == 0) {
...
export function playerInfest(): void {
    spriteSelect(76);
...
export function nightTimeInfestation(): void {
