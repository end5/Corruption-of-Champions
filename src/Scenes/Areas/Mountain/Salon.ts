...
export class Salon implements TimeAwareInterface {
    ...
    private gloryholeMinotaur(): void {
        ...
        if (player.breasts.biggestTitSize() > 1) outputText("hold up ");
    ...
    private minotaurCumBukkakeInSalon(): void {
        ...
        if (player.breasts.biggestTitSize() >= 2) {
            ...
            if (player.breasts.biggestTitSize() < 6) outputText("Even so, you can't quite get your breasts the entire way around him, so you make up for it by pressing it harder into you with your busy hands.  ", false);
        ...
        if (player.breasts.biggestTitSize() >= 2) outputText("tit-fucking ", false);
        ...
        if (player.breasts.biggestTitSize() >= 2) outputText("The sudden girth change sends an enticing ripple through your " + allBreastsDescript(player) + " that's pleasurable enough to make you moan into his steadily-widening urethra.  ", false);
