...
export class InfestedHellhoundScene {
    ...
    public infestedHellhoundLossRape(): void {
        ...
        if (player.totalCocks() > 0 && player.findStatusAffect(StatusAffects.Infested) >= 0) {
            ...
            // (HP)
            else outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-sharp teeth easily sink into your " + player.armorName + " before tearing away the offending armor, exposing your " + assDescript() + " and " + multiCockDescriptLight(game.player) + ".  A cold mountain breeze blows across your now-exposed " + player.skinDesc + ", reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity. With a brutal lunge it knocks you off your " + feet(player) + " and onto your back.\n\n", false);
        ...
        // [PLAYER'S COCKS ARE BIG ENOUGH TO BE INFECTED]
            ...
            // (HP)
                ...
                outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your " + player.armorName + " before tearing it off, exposing your " + assDescript() + " and " + multiCockDescriptLight(game.player) + ".  A cold mountain breeze blows across your now exposed " + player.skinDesc + ", reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity.  With a brutal lunge it knocks you off your " + feet(player) + " and onto your back.\n\n", false);
            }
