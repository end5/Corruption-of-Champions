...
private  minervaTalkSelect(bath:boolean = true):void {
	var choices:any[] = [talkingToMinervaAboutBackstory];
...
private  fuckMinervasAsshole():void {
	clearOutput();
	spriteSelect(95);
	var x:number = player.cockThatFits(minervaACapacity());
	...
	outputText("\n\nYou draw yourself back, dragging your " + game.player.cockDescript(x) + " inch by inch through her grinding, squeezing walls, then thrust yourself firmly back inside her.  You repeat the process again, and then again, picking up speed as you pull and push.  The siren's lyrical moans slowly start to fill the air, her body rocking with your thrusts, pressing and grinding her pierced nipples against the ground as you pound her slick rear.  The longest of her cock tentacles manage to reach back and grabs hold of your " + game.player.cockDescript(x) + ", feverishly stroking you as you thrust into her.  The naughty little things sting you hard, oozing their aphrodisiac venom into your " + game.player.cockDescript(x) + " instinctively.  You cry out, shivering as the potent venom immediately streams through your body, setting your blood aboil with lust, and causing you to piston into her ass with ever-increasing speeds.  More and more toxin floods you, combining with the incredible sensations of her anal walls gripping and squeezing you to turn you into a mindlessly rutting beast.");
...
private  minervaCowgirlSex():void {
	clearOutput();
	spriteSelect(95);
	var x:number = player.cockThatFits(minervaVCapacity());
	if(x < 0) x = player.smallestCockIndex();
	flags[kFLAGS.TIMES_MINERVA_SEXED]++;
	...
	outputText("\n\nWith a smile, you gently remove your clothes and put them aside, giving Minerva a chance to see your naked body.  Your " + game.player.cockDescript(x) + " already starting to stiffen, you lie back down on the ground, patiently waiting for the siren to make the first move.  You don't have to do so for long, as soon, Minerva's tight tube-top and short shorts are pulled off, her firm, pierced DD's bouncing free of their fabric prison.  Clearly excited by the thrill of actually having regular sex, you can see her male endowment quickly growing hard between her legs, the forearm-length appendage ready to go despite the fact it won't be used for the main event.  Looking down at you, Minerva approaches, swaying her hips to and fro.  She kneels down, crawling over you like some predator, one of her hands briefly stroking your " + game.player.cockDescript(x) + " before sliding up to feel your [chest].  \"<i>I promise not to get too excited,</i>\" she says before grabbing hold of your maleness and stroking it again.  Bringing her own male organ up against yours, her tentacles encircle your " + game.player.cockDescript(x) + ", stinging it with her potent venom to really get you fired up as she teases you.  \"<i>This stuff is always floating around in me - that's why I get so damn hard so fast...  I hope you like my special venom.</i>\"");
	
	outputText("\n\nYou groan softly, feeling the venom already coursing through you.  Your " + game.player.cockDescript(x) + " surges erect, the venom-induced lust making you swell larger than usual, ready for her to do with as she pleases, your limbs numb and useless from the lust-inducing toxins coursing through your body.  You are completely helpless and at her mercy...  And part of you seems to like that.");
	
	outputText("\n\nMinerva seems to enjoy seeing you helpless like this, as her dick seems to just get harder and harder while her tentacles caress your member, though they no longer sting; instead, they just tease you with their slick and gentle touch.  \"<i>You like that, don't you?  You're so hard I can feel your need growing more and more.  You want my tight pussy so badly,</i>\" she says with a lecherous grin before rising her body up and pressing against your " + game.player.cockDescript(x) + " with her surprisingly cool cunt.  Already her lips are soaked, her slick juices running down your dick as she teases you even further.");
	...
	outputText("\n\nYou moan and shudder, shivering violently as Minerva's poisons boil through your blood and countless tendrils stoke your lust to a fever pitch.  Your brain seethes and roils with pleasure as you are surrounded, engulfed.  You don't think you can hold back from cumming for very long, and gasp a warning to the siren that you will cum inside her if she isn't careful.  Clearly hearing your response, a sinister grin grows on Minerva's face as two of her longest and strongest tentacles wrap around the base of your " + game.player.cockDescript(x) + " and squeeze tightly, \"<i>Ah-ah-ah... no cumming for you, not until I get mine... I'm the one in charge, here, remember?</i>\"");
	outputText("\n\nYou can't help but beg and plead for her to show mercy on you, you can't bear this much longer!  Unfortunately for you, the only response you get from Minerva is a smirk, and the tentacles tightening around your throbbing maleness as she draws you in deeper.  The venom and the aggressive treatment makes your dick swell even more, stretching her tight squirming walls around you, the sensation drawing a sharp gasp and soft moan from your siren lover.  The siren's balls come to a rest just above your " + game.player.cockDescript(x) + ", the heavy, swollen orbs a reminder that she is enjoying this just as much as you.");
	
	outputText("\n\nBiting her lip, she pushes down harder, sinking her soothingly cool pussy down until your whole cock is engulfed in her tight, cilia-filled snatch.  \"<i>Mmm, oh yesss... don't you just love how your " + game.player.cockDescript(x) + " stretches me... and all those little things in there, stroking you like little tongues.  Tell me how much you need to cum.  Tell me and I'll let you blow your pent-up load deep inside me.  I doubt you could get me pregnant, I'm probably too unstable to breed with someone like you.  Or maybe you'd like to take a gamble and try?  Do it, fill my pussy with your cum!</i>\"");
	...
	if(player.cumQ() >= 500) {
		...
		outputText(" the base of your " + game.player.cockDescript(x) + ", stinging you again and again like an overzealous jellyfish, pumping more of her aphrodisiac venom into your genitals in mind-numbing quantities.");
...
private  minervaLapSex():void {
	...
	//PC herm: 
	if(player.gender == 3) outputText("  One of her hands trail down to your hard herm " + game.player.cockDescript(x) + ", stroking you softly.");
...
private  letMinervaSuckYouOff():void {
	...
	//If naga: 
	if(player.isNaga()) outputText(" lounge against the rock, spreading open your protective slit and letting your " + game.player.cockDescript(x) + " hang free.");
	else outputText(" sit down, spreading your [legs] and opening up the crotch of your [armor] to the air, letting your " + game.player.cockDescript(x) + " hang free.");
	
	outputText("\n\nAnxious and ready, Minerva looks down at you before kneeling, placing a hand on your [hips] as she takes hold of your " + game.player.cockDescript(x) + " and slowly starts to stroke it.  Her eyes looking up at you, she leans in and starts to gently lick your hardening flesh with the tip of her tongue.  Under her careful, deliberate attentions your manhood is quickly brought to full attention.");
	...
	outputText("\n\nWith your " + game.player.cockDescript(x) + " firmly captured by her tongue, Minerva leans down, opening her mouth wide and taking you inside its cool, wet confines, even as her tongue squeezes you and slides around your warm, sensitive flesh.  Looking up at you with a playful twinkle in her eyes, she starts to suck and squirm her tongue around on you, the long, prehensile appendage switching between licking over your throbbing cockmeat and squeezing it in a snakelike embrace.");
	
	outputText("\n\nPuckering her glossy black lips, Minerva starts to bob her head, taking in more and more of you with each downwards motion");
	//If cockarea 50+:
	if(player.cockArea(x) >= 50) outputText(", your huge cock deep inside her mouth, and soon far down her throat.  With some difficulty, her slightly angular nose presses down against your crotch, every inch of your " + game.player.cockDescript(x) + " trapped inside her cool, wet mouth and throat");
	outputText(".");
	...
	outputText("\n\nGripping Minerva's head tightly, you let out a long deep moan, your " + game.player.cockDescript(x) + " bloating with each ejaculation.  Eager to please, Minerva does her best to drink down every drop you give her, her hands gripping your [hips] and pressing her nose against your crotch, puckering her full black lips around your [sheath].");
