...
function minervaVCapacity(): number {
    return 90;
}
function minervaACapacity(): number {
    return 100;
}
function minervaRomanced(): boolean {
...
function minervaAppearance(): void {
    clearOutput();
    spriteSelect(95);
...
export function encounterMinerva(): void {
...
// Basic intros
// 1-1 First Encounter.
function firstMinervaEncounter(): void {
    clearOutput();
    ...
    // If Sophie Bimbo=0:
    if (flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] == 0 && flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00283] == 0 && !SophieFollowerScene.sophieFollower()) outputText(" that matronly harpy, Sophie");
...
// [Ignore Path]
function ignoreMinervasPath(): void {
    clearOutput();
...
// [Take Path]
function takeMinervasPath(): void {
    clearOutput();
    spriteSelect(95);
...
function followMinerva(): void {
    ...
    menu();
    addButton(9, "Leave", leaveMinervasFirstEncounter);
    // addButton(0,"Appearance",minervaAppearance);
    addButton(1, "Talk", minervaTalkSelect);
...
function leaveMinervasFirstEncounter(): void {
    clearOutput();
    spriteSelect(95);
...
function repeatEncounterMinerva(): void {
    clearOutput();
    spriteSelect(95);
...
function minervaThirdPlusEncounter(): void {
    clearOutput();
    spriteSelect(95);
...
function minervaAfterFiveTalksRomancing(): void {
    clearOutput();
    spriteSelect(95);
...
// [Flight]
function goForASkyRideWithMinervaHeartBaring(): void {
    clearOutput();
    spriteSelect(95);
...
// Opening her heart
function minervaOpensHerHeartAndDisplaysHerVentricals(): void {
    clearOutput();
    spriteSelect(95);
...
// Kiss
function yeahSureMinervaILikeYouAndShit(): void {
    clearOutput();
    spriteSelect(95);
...
// [Reject]
function rejectMinervasLove(): void {
    clearOutput();
    spriteSelect(95);
...
// [Land]
function dontFlyWithWithMeYouCrazyBitch(): void {
    clearOutput();
    spriteSelect(95);
...
function repeatableMinervaRomanceScene(): void {
    clearOutput();
    spriteSelect(95);
...
function minervaTalkSelect(bath: boolean = true): void {
    const choices: any[] = [talkingToMinervaAboutBackstory];
...
function talkingToMinervaAboutBackstory(): void {
    clearOutput();
    spriteSelect(95);
    // PART 1
    if (flags[kFLAGS.MINERVA_BACKSTORY] == 0) {
...
// 3-2 Talk Scene 2 - talks about the spring
// -repeatable
function talkAboutTheSpringWithMinerva(): void {
    clearOutput();
    spriteSelect(95);
...
// 3-3 Talking Scene 3 - talks about her shark girl daughter
function talkWithMinervaAboutSharkGirlDaughter(): void {
    clearOutput();
    spriteSelect(95);
    // - requires that backstory has been told
    // - if already romanced Minerva shamefully confesses she may have fathered a granddaughter with her first daughter -repeatable
...
// 3-4 Talk Scene 4 - talks about her corruption
// - romance yes only or if you trick her into thinking you love her. - Repeatable until Minerva is purified or corrupted
function talkToMinervaAboutHerCorruption(): void {
    clearOutput();
    spriteSelect(95);
...
// 3-5 Motherhood
// -talks about how she wishes to be a real mother, have an actual loving family and not made from being raped- repeatable
function minervaMotherhood(): void {
    clearOutput();
    spriteSelect(95);
...
// 3-6 Bath Time - romance only
function bathTimeTalkWithMinerva(): void {
    clearOutput();
    spriteSelect(95);
...
// [Yes]
function bathTimeWithMinerva(): void {
    clearOutput();
    spriteSelect(95);
...
function minervaSexMenu(display: boolean = true): void {
    if (display) {
        clearOutput();
        spriteSelect(95);
        ...
        if (flags[kFLAGS.TIMES_MINERVA_SEXED] == 0) {
            ...
            // PC female, add: "
            if (player.vaginas.length > 0) outputText("  Would you mind how we do it?  You're the one asking, so... would you want me to fuck your ass?  Or... do you want me to try to fit between those sexy hips of yours?");
            outputText("</i>\"");
        }
        ...
        // {Repeated/No romance:
            ...
            if (player.vaginas.length > 0) outputText("  Since you don't seem to mind... would you like me to fuck your ass or to squeeze into your cute cunny?");
            outputText("</i>\"");
        }
        // Romanced:
        else {
            ...
            // PC female, add:
            if (player.vaginas.length > 0) outputText("  I'd be happy to pound that cute butt of yours and stuff your hot pussy - which would you rather have, my dear?");
            outputText("</i>\"");
        }
    }
    menu();
...
function fuckMinervasAsshole(): void {
    clearOutput();
    spriteSelect(95);
    ...
    if (player.vaginas.length > 0) outputText(" and your [vagina]");
    ...
    outputText("\n\nYou draw yourself back, dragging your " + cockDescript(game.player, x) + " inch by inch through her grinding, squeezing walls, then thrust yourself firmly back inside her.  You repeat the process again, and then again, picking up speed as you pull and push.  The siren's lyrical moans slowly start to fill the air, her body rocking with your thrusts, pressing and grinding her pierced nipples against the ground as you pound her slick rear.  The longest of her cock tentacles manage to reach back and grabs hold of your " + cockDescript(game.player, x) + ", feverishly stroking you as you thrust into her.  The naughty little things sting you hard, oozing their aphrodisiac venom into your " + cockDescript(game.player, x) + " instinctively.  You cry out, shivering as the potent venom immediately streams through your body, setting your blood aboil with lust, and causing you to piston into her ass with ever-increasing speeds.  More and more toxin floods you, combining with the incredible sensations of her anal walls gripping and squeezing you to turn you into a mindlessly rutting beast.");
...
function minervaCowgirlSex(): void {
    clearOutput();
    spriteSelect(95);
    ...
    outputText("\n\nWith a smile, you gently remove your clothes and put them aside, giving Minerva a chance to see your naked body.  Your " + cockDescript(game.player, x) + " already starting to stiffen, you lie back down on the ground, patiently waiting for the siren to make the first move.  You don't have to do so for long, as soon, Minerva's tight tube-top and short shorts are pulled off, her firm, pierced DD's bouncing free of their fabric prison.  Clearly excited by the thrill of actually having regular sex, you can see her male endowment quickly growing hard between her legs, the forearm-length appendage ready to go despite the fact it won't be used for the main event.  Looking down at you, Minerva approaches, swaying her hips to and fro.  She kneels down, crawling over you like some predator, one of her hands briefly stroking your " + cockDescript(game.player, x) + " before sliding up to feel your [chest].  \"<i>I promise not to get too excited,</i>\" she says before grabbing hold of your maleness and stroking it again.  Bringing her own male organ up against yours, her tentacles encircle your " + cockDescript(game.player, x) + ", stinging it with her potent venom to really get you fired up as she teases you.  \"<i>This stuff is always floating around in me - that's why I get so damn hard so fast...  I hope you like my special venom.</i>\"");

    outputText("\n\nYou groan softly, feeling the venom already coursing through you.  Your " + cockDescript(game.player, x) + " surges erect, the venom-induced lust making you swell larger than usual, ready for her to do with as she pleases, your limbs numb and useless from the lust-inducing toxins coursing through your body.  You are completely helpless and at her mercy...  And part of you seems to like that.");

    outputText("\n\nMinerva seems to enjoy seeing you helpless like this, as her dick seems to just get harder and harder while her tentacles caress your member, though they no longer sting; instead, they just tease you with their slick and gentle touch.  \"<i>You like that, don't you?  You're so hard I can feel your need growing more and more.  You want my tight pussy so badly,</i>\" she says with a lecherous grin before rising her body up and pressing against your " + cockDescript(game.player, x) + " with her surprisingly cool cunt.  Already her lips are soaked, her slick juices running down your dick as she teases you even further.");

    outputText("\n\nFinally, she ends your torment and brings your " + cockHead(player, x) + " to her refreshingly wet entrance before pushing down, letting you penetrate her with agonizing slowness, her longer tentacles still stroking and caressing your length as she pulls you into the vicelike grip of her snatch.  Inside, you can feel smaller tendrils starting to caress and squeeze you, clearly another trait she was gifted with from the shark girls.");
    ...
    outputText("\n\nYou moan and shudder, shivering violently as Minerva's poisons boil through your blood and countless tendrils stoke your lust to a fever pitch.  Your brain seethes and roils with pleasure as you are surrounded, engulfed.  You don't think you can hold back from cumming for very long, and gasp a warning to the siren that you will cum inside her if she isn't careful.  Clearly hearing your response, a sinister grin grows on Minerva's face as two of her longest and strongest tentacles wrap around the base of your " + cockDescript(game.player, x) + " and squeeze tightly, \"<i>Ah-ah-ah... no cumming for you, not until I get mine... I'm the one in charge, here, remember?</i>\"");
    outputText("\n\nYou can't help but beg and plead for her to show mercy on you, you can't bear this much longer!  Unfortunately for you, the only response you get from Minerva is a smirk, and the tentacles tightening around your throbbing maleness as she draws you in deeper.  The venom and the aggressive treatment makes your dick swell even more, stretching her tight squirming walls around you, the sensation drawing a sharp gasp and soft moan from your siren lover.  The siren's balls come to a rest just above your " + cockDescript(game.player, x) + ", the heavy, swollen orbs a reminder that she is enjoying this just as much as you.");

    outputText("\n\nBiting her lip, she pushes down harder, sinking her soothingly cool pussy down until your whole cock is engulfed in her tight, cilia-filled snatch.  \"<i>Mmm, oh yesss... don't you just love how your " + cockDescript(game.player, x) + " stretches me... and all those little things in there, stroking you like little tongues.  Tell me how much you need to cum.  Tell me and I'll let you blow your pent-up load deep inside me.  I doubt you could get me pregnant, I'm probably too unstable to breed with someone like you.  Or maybe you'd like to take a gamble and try?  Do it, fill my pussy with your cum!</i>\"");
    ...
    if (player.cumQ() >= 500) {
        ...
        outputText(" the base of your " + cockDescript(game.player, x) + ", stinging you again and again like an overzealous jellyfish, pumping more of her aphrodisiac venom into your genitals in mind-numbing quantities.");
        if (player.vaginas.length > 0) outputText("  A few even slither down into your [vagina] to sting you there as well, making sure you are, at least temporarily, turned into a sex-hungry beast.");
    }
...
function minervaLapSex(): void {
    ...
    // PC herm:
    if (player.gender == 3) outputText("  One of her hands trail down to your hard herm " + cockDescript(game.player, x) + ", stroking you softly.");
    ...
    // Nonvirgin:
    if (!player.vaginas.hasVirginVagina()) outputText("  The thick siren prick plunges into your soaked cunt and fills your sweltering hole with her oddly cool cock, both of you groaning in delightful pleasure.");
    // Virgin:
...
function goDownOnAHermAndLoveItYouDirtySlutYou(): void {
    clearOutput();
    spriteSelect(95);
    flags[kFLAGS.TIMES_MINERVA_SEXED]++;
...
// Balls
function lickMinervasBalls(): void {
    clearOutput();
    spriteSelect(95);
...
function noBallsMinervaAndContinuation(clear: boolean = true): void {
    ...
    // if demonic tongue:
    if (player.tongueType == TongueType.DEMONIC) outputText(", your perversely prehensile tongue slowly retracting from her quivering quim, rubbing and teasing as it comes out and nearly sending the overly sensitive herm into another climax");
    outputText(".");
...
function letMinervaSuckYouOff(): void {
    let x: number = player.cocks.cockThatFits(minervaVCapacity());
    if (x < 0) x = player.cocks.smallestCockIndex();
    clearOutput();
    spriteSelect(95);
    ...
    // If naga:
    if (player.isNaga()) outputText(" lounge against the rock, spreading open your protective slit and letting your " + cockDescript(game.player, x) + " hang free.");
    else outputText(" sit down, spreading your [legs] and opening up the crotch of your [armor] to the air, letting your " + cockDescript(game.player, x) + " hang free.");
    ...
    outputText("\n\nWith your " + cockDescript(game.player, x) + " firmly captured by her tongue, Minerva leans down, opening her mouth wide and taking you inside its cool, wet confines, even as her tongue squeezes you and slides around your warm, sensitive flesh.  Looking up at you with a playful twinkle in her eyes, she starts to suck and squirm her tongue around on you, the long, prehensile appendage switching between licking over your throbbing cockmeat and squeezing it in a snakelike embrace.");
    ...
    outputText("\n\nGripping Minerva's head tightly, you let out a long deep moan, your " + cockDescript(game.player, x) + " bloating with each ejaculation.  Eager to please, Minerva does her best to drink down every drop you give her, her hands gripping your [hips] and pressing her nose against your crotch, puckering her full black lips around your [sheath].");
...
function fuckMinervaWithHerHandsBehindHerBack(): void {
    let x: number = player.cocks.cockThatFits(minervaVCapacity());
    if (x < 0) x = player.cocks.smallestCockIndex();
    clearOutput();
    spriteSelect(95);
...
function pcGetsEatenOutByMinerva(): void {
    clearOutput();
    spriteSelect(95);
    outputText("Thinking about just what kind of heated, heart-pounding, lusty fun you want to have with your siren lover, your eyes look the shark-like harpy up and down, taking in her features.  Starting with her long legs, and moving up to her wide, flared hips, your eyes travel past the thick bulge in her shorts, going up her scarred belly to the siren's perky DD-cup breasts before finally reaching her face.");
    ...
    outputText("\n\n");
    // If dick:
    if (player.vaginas.length > 0) outputText("Thanks to her handy stimulation, your musky maleness throbs and dilates along your femininity, the thick cockvein feeding your bloating member as your seed rushes out, splattering up and onto Minerva's back, defiling her smooth skin with your fertility.  ");
...
export function loseToMinerva(): void {
    clearOutput();
    spriteSelect(95);
    // PC loss by physical
    if (player.HP < 1) {
...
export function beatUpDatSharpie(): void {
    clearOutput();
    spriteSelect(95);
    // Win by damage
    if (monster.HP < 1) {
...
function eatSomethingYouCunt(): void {
    clearOutput();
    spriteSelect(95);
    // Acquiring:
...
*/
// Spring Water
function getADrinkYouBitch(): void {
    clearOutput();
    spriteSelect(95);
