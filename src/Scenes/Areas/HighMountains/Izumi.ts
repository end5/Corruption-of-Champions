...
export class Izumi extends Monster {
    ...
    public constructor() {
        ...
        this.breastRows.createBreastRow(Appearance.breastCupInverse("FF")); // The doc mentions her breasts would be around D/DD on a "normal human" so err, winging this shit
    ...
    public straightJab(): void {
        ...
        let damage: number = int((str + 175) - rand(player.tou) - player.armorDef);
    ...
    public chokeSlamDamage(): void {
        ...
        const damage: number = int((str + 225) - rand(player.tou) - player.armorDef);
        ...
        if (brokeFree) {
            ...
            if (rand(2) == 0) {
                ...
                if (player.cocks.length > 0) {
                    ...
                    if (player.cocks.length > 1) outputText(" they get");
                    else outputText(" it gets");
                    outputText(", the more insistently your");
                    if (player.cocks.length > 1) outputText(" erections throb");
    ...
    public titSmotherWait(): void {
        ...
        dynStats("lus", player.lib / 10 + 5 + rand(5));
