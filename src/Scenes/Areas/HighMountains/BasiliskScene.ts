...
export class BasiliskScene {
    ...
    private basiliskBadEnd(): void {
        ...
        if (player.gender == 3) outputText("  You moan through your still throat as you feel blood rushing to your groin, your " + game.player.multiCockDescriptLight() + " stiffening and your " + vaginaDescript(0) + " beginning to drip.", false);
        if (player.gender == 1) outputText("  You moan through your still throat as you feel blood rushing to your groin, your " + game.player.multiCockDescriptLight() + " stiffening.", false);
    ...
    private basiliskAdvantageHarpy(): void {
        ...
        // Male/Herm:
        if (player.hasCock()) {
            outputText("The harpy's eyes zero in on your erect cock greedily.  Stepping back from you she raises her head and lets out a screech which echoes around the mountains; as answering calls roll back to her she closes in, threads her arms around your neck and scalp and kisses you roughly. She pushes her golden lips against yours and squeezes her rough bird tongue into your mouth.  You feel your lips tingle and you raggedly moan against the savage frenching, her hot breath pushing down your throat as she circles your still tongue with her own, before exploring further down towards your tonsils.  By the time she has finished with you your whole body feels like it is glowing red from the effect of her lipstick, " + game.player.sMultiCockDesc() + " straining.\n\n", false);
