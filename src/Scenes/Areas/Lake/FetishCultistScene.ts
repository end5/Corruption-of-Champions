...
export class FetishCultistScene extends AbstractLakeContent {
    ...
    public cultistRapesYou(): void {
        ...
        if (rand(2) == 0 && !sexed) {
            ...
            if (player.vaginas.length > 0 && player.cocks.length > 0) {
                ...
                outputText("After a minute of this, she stops you and says, \"<i>Good; I am now ready to have you inside of me, toy.  Lie down and start fingering your " + vaginaDescript(0) + " while I use the " + multiCockDescriptLight(game.player) + " that I keep you here for.</i>\"\n\n", false);
                outputText("With your hands slightly trembling in anticipation, you lie down and grab at your very erect " + multiCockDescriptLight(game.player) + " just before you slip your fingers into your " + vaginaDescript(0) + ", ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your " + cockDescript(game.player, 0) + ", moaning in pleasure.  Her interior is so familiar and so wonderful.  You increase the pace that your fingers plunge into your depths, moaning in the way you know your mistress loves. She starts to rock back and forth, your " + cockDescript(game.player, 0) + " bringing her to the height of ecstasy. ", false);
    ...
    public fetishCultistHasAMilkFetish(): void {
        ...
        outputText("Soon her thong becomes wet with arousal and her mouth comes off your " + nippleDescript(0) + " to ask, \"<i>Please " + mf(player, "Master", "Mistress") + ", will you fix the aching in my loins?</i>\"\n\n", false);
