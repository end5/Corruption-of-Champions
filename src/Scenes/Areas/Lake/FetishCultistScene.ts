 ...
 */
	...
	export class FetishCultistScene extends AbstractLakeContent
	{
		...
		public  cultistRapesYou():void
		{
			...
			if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR || player.lowerBody == LOWER_BODY_TYPE_NAGA) {
				...
				//Naga
					...
					//boy's surprise
						...
						outputText("your " + multiCockDescriptLight() + " poke out of your pelvic slit, growing to full erectness.  You strain against your bonds, desperate to bring release to ", false);
						if (player.totalCocks() > 1) outputText("each of ", false);
						outputText("your " + multiCockDescriptLight() + ", but there is nothing you can do and you keeper laughs at you.  \"<i>Oh so eager to bury that eager cock of yours inside my snatch?  Too bad, I'm the one who gets to choose what goes in there, and it's not your cock.</i>\" she says to you, clearly enjoying the frustration you're going through.\n\n", false);
					}
					//girl's surprise
			...
			if (rand(2) == 0 && !sexed) {
				...
				if (player.cocks.length > 0 && !changed) {
					...
					outputText("\n\nThe nurse stops humming before setting the syringe aside and climbs on top of your legs. She giggles softly before lowering herself and taking your " + cockDescript(0) + " between her breasts and starts rubbing and playing with them while running your " + cockDescript(0) + " up and down between them.  It is an exquisite experience having her tit fuck you, and you notice that she seems to be enjoying it just as much as you are.  It doesn't take long for her ministrations to make you cum between her breasts, and cum you do.  You cum and cum and cum, much more than you usually would.  Satisfied, the nurse rises from you and says, \"<i>That should do it, in the future you won't produce as much cum when you orgasm as you just did, but you should be producing at a more natural level.  For now, I've got to go take care of another patient. Don't you do anymore running about until I get back, ok?  I'll be back to check on your progress as soon as I'm able!</i>\"  She gives you a wink, and turns to walk out the door.", false);
				...
				if (player.vaginas.length > 0 && player.cocks.length > 0) {
					...
					outputText("After a minute of this, she stops you and says, \"<i>Good; I am now ready to have you inside of me, toy.  Lie down and start fingering your " + vaginaDescript(0) + " while I use the " + multiCockDescriptLight() + " that I keep you here for.</i>\"\n\n", false);
					outputText("With your hands slightly trembling in anticipation, you lie down and grab at your very erect " + multiCockDescriptLight() + " just before you slip your fingers into your " + vaginaDescript(0) + ", ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your " + cockDescript(0) + ", moaning in pleasure.  Her interior is so familiar and so wonderful.  You increase the pace that your fingers plunge into your depths, moaning in the way you know your mistress loves. She starts to rock back and forth, your " + cockDescript(0) + " bringing her to the height of ecstasy. ", false);
		...
		public  playerRapesCultist():void
		{
			...
			if (monster.armorName == "pervy nun's clothing") {
				...
				if (player.cocks.length > 0 && (player.gender != 3 || rand(2))) {
					...
					outputText(multiCockDescriptLight() + " into her waiting love hole.  ", false);
					if (player.cocks.length > 1) {
						outputText("You thrust once, before using one of your hands to guide the second of your " + multiCockDescriptLight() + " inside her.  You are rather surprised at how easily she seems to accommodate your size", false);
				...
				//(if player has a dick)
				if (player.cocks.length > 0 && (player.gender != 3 || rand(2))) {
					outputText("Telling her that she is going to please you whether she wants to or not, you reveal your " + multiCockDescriptLight() + ".  She screams for help and starts struggling against your grip, but you tell her that no one is going to save her now.  Easily overpowering her, you force her to the ground with no care for her comfort and start tearing off her clothes.  Once you have a clear view of her love hole, you look back up at her face and see that she has stopped struggling and is now crying.  ", false);
					//[if not corrupted] 
		...
		private  plugSwimsuitVag():void
		{
			...
			outputText("When you push your " + cockDescript(x) + " inside her, she goes absolutely insane underneath you.  She squirms and wriggles all over your " + cockDescript(x) + ", as you ", false);
			...
			outputText("After all the foreplay, the two of you are already reaching your peaks thanks to her incredible, tight cunt and its ministrations to your member.  The cultist is screaming in pleasure, telling you to look at her, to fondle her, and to fuck her; you happily oblige her.  Her interior contracts about your " + cockDescript(x) + " as you loose the proof of your orgasm deep inside her.", false);
		...
		public  fetishCultistHasAMilkFetish():void
		{
			...
			if (player.hasCock()) {
				...
				outputText("our " + multiCockDescriptLight() + " becomes fully erect as it rubs up against her warm ass cheeks, which is enough to fulfill its desire.   Her cum bubbles into the palm of your hand while your cum drizzles her ass with sticky whiteness.\n\n", false);
			}
			//[ELSE Pussy]
