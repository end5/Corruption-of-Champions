...
export class FetishCultistScene extends AbstractLakeContent {
    ...
    public cultistRapesYou(): void {
        ...
        if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR || player.lowerBody == LOWER_BODY_TYPE_NAGA) {
            ...
            // Naga
                ...
                // boy's surprise
                    ...
                    outputText("your " + game.player.multiCockDescriptLight() + " poke out of your pelvic slit, growing to full erectness.  You strain against your bonds, desperate to bring release to ", false);
                    if (player.totalCocks() > 1) outputText("each of ", false);
                    outputText("your " + game.player.multiCockDescriptLight() + ", but there is nothing you can do and you keeper laughs at you.  \"<i>Oh so eager to bury that eager cock of yours inside my snatch?  Too bad, I'm the one who gets to choose what goes in there, and it's not your cock.</i>\" she says to you, clearly enjoying the frustration you're going through.\n\n", false);
                }
                // girl's surprise
        ...
        if (rand(2) == 0 && !sexed) {
            ...
            if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                ...
                if (player.cockTotal() > 0) outputText("  As you see your " + game.player.multiCockDescriptLight() + ", 'incredibly large' is the only qualifier you can think of.", false);
            }
            outputText("\n\n", false);
            ...
            if (player.cocks.length > 0 && !changed) {
                ...
                outputText("\n\nShe briefly steps out of the room before returning with a syringe.  \"<i>It'll be ok, the good news is that the pain for this injection will quickly subside, just take nice easy breaths and you'll be fine.  In fact, you might find this quite enjoyable after the first hurdle.  I'll even get to have some fun after.</i>\"  Smiling again, she takes hold of your " + game.player.cockDescript(0) + " and pushes the needle into the base of it.  The nurse starts humming a pleasant tune, while you try to cry out in pain into the gag and struggle against the bindings.  However, they prove to be quite secure, and you can't do anything about the pain you feel spreading throughout your " + game.player.multiCockDescriptLight() + ".  Thankfully, it doesn't take very long before the nurse pulls the needle out and, to your immense relief, the pain quickly subsides.");
                outputText("\n\nThe nurse stops humming before setting the syringe aside and climbs on top of your legs. She giggles softly before lowering herself and taking your " + game.player.cockDescript(0) + " between her breasts and starts rubbing and playing with them while running your " + game.player.cockDescript(0) + " up and down between them.  It is an exquisite experience having her tit fuck you, and you notice that she seems to be enjoying it just as much as you are.  It doesn't take long for her ministrations to make you cum between her breasts, and cum you do.  You cum and cum and cum, much more than you usually would.  Satisfied, the nurse rises from you and says, \"<i>That should do it, in the future you won't produce as much cum when you orgasm as you just did, but you should be producing at a more natural level.  For now, I've got to go take care of another patient. Don't you do anymore running about until I get back, ok?  I'll be back to check on your progress as soon as I'm able!</i>\"  She gives you a wink, and turns to walk out the door.", false);
            ...
            if (player.vaginas.length > 0 && !changed) {
                ...
                outputText("Soon you have a fully formed " + game.player.cockDescript(0) + " standing tall and proud where your old femininity used to lie.  The nurse sets the syringe aside and climbs on top of your legs. She giggles softly before lowering herself and taking your " + game.player.cockDescript(0) + " between her breasts and starts rubbing and playing with them while running your " + game.player.cockDescript(0) + " between them.  It is an exquisite experience having her tit fuck your brand new " + game.player.cockDescript(0) + ", and you notice that she seems to be enjoying it just as much as you are.  It doesn't take long for her ministrations to make you cum between her breasts, and cum you do.  Satisfied, the nurse rises from you and says \"<i>Looks to me like its working properly.  For now, I've got to go take care of another patient. Don't you do anymore running about until I get back, ok?  I'll be back to check on your progress as soon as I'm able!</i>\"  She gives you a wink, and turns to walk out the door.", false);
                dynStats("sen", 3);
                changed = true;
                player.genderCheck();
                changedCock = true;
            ...
            if (player.gender == 0 && !changed) {
                ...
                player.createCock();
                outputText("Soon you have a fully formed " + game.player.cockDescript(0) + " standing tall and proud where your bare crotch used to lie.  The nurse sets the syringe aside and climbs on top of your legs. She giggles softly before lowering herself and taking your " + game.player.cockDescript(0) + " between her breasts and starts rubbing and playing with them while running your " + game.player.cockDescript(0) + " between them.  It is an exquisite experience having her tit fuck your brand new " + game.player.cockDescript(0) + ", and you notice that she seems to be enjoying it just as much as you are.  It doesn't take long for her ministrations to make you cum between her breasts, and cum you do.  Satisfied, the nurse rises from you and says \"<i>That was fun, maybe later we can practice more.  For now, I've got to go take care of another patient. Don't you do anymore running about until I get back, ok?  I'll be back to check on your progress as soon as I'm able!</i>\"  She gives you a wink, and turns to walk out the door.", false);
                dynStats("sen", 3);
                changed = true;
                player.genderCheck();
                changedCock = true;
            ...
            if (player.vaginas.length > 0 && player.cocks.length > 0) {
                outputText("You see your " + player.armorName + " becoming a nice, comfortable outfit of a white shirt and black pants that make you look well-suited to work in a manor... if they didn't have an exposed crotch and butt that puts your " + game.player.multiCockDescriptLight() + ", your " + vaginaDescript(0) + ", and your " + buttDescript() + " on full display.  Any undergarments you had are now gone.\n\n", false);
                ...
                outputText("After a minute of this, she stops you and says, \"<i>Good; I am now ready to have you inside of me, toy.  Lie down and start fingering your " + vaginaDescript(0) + " while I use the " + game.player.multiCockDescriptLight() + " that I keep you here for.</i>\"\n\n", false);
                outputText("With your hands slightly trembling in anticipation, you lie down and grab at your very erect " + game.player.multiCockDescriptLight() + " just before you slip your fingers into your " + vaginaDescript(0) + ", ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your " + game.player.cockDescript(0) + ", moaning in pleasure.  Her interior is so familiar and so wonderful.  You increase the pace that your fingers plunge into your depths, moaning in the way you know your mistress loves. She starts to rock back and forth, your " + game.player.cockDescript(0) + " bringing her to the height of ecstasy. ", false);
                // [if player has 2 dicks]
                if (player.cocks.length == 2) outputText("Your " + game.player.cockDescript(1) + " rubs against her skin pleasantly.  ", false);
                // [if player has more than 2 dicks]
                if (player.cocks.length > 2) outputText("The rest of your " + game.player.multiCockDescriptLight() + " rubs against her skin pleasantly.  ", false);
                ...
                if (player.cocks.length > 0 && (player.vaginas.length == 0 || rand(2) == 0)) {
                    outputText("  You see that your " + player.armorName + " have become a nice looking, if simple, frilled white shirt and bow tie along with black pants and matching shoes.  They make you look like you would be at home in a manor attending the needs of a noble, if it were not for the flaps on the front and back of your pants that give easy access to your " + game.player.multiCockDescriptLight(), false);
                    ...
                    outputText("After a minute of this, she stops you and says, 'Good, I am now ready to have you inside of me boy.  Show me your " + game.player.multiCockDescriptLight() + " that I keep you here for.'\n\n", false);
                    outputText("With a cry of joy you lift the front flap on your pants revealing your very erect " + game.player.multiCockDescriptLight() + " and lie on the ground ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your " + game.player.cockDescript(0) + " moaning in pleasure.  Her interior is so familiar and so wonderful.  ", false);
                    ...
                    outputText("She starts to rock back and forth, your " + game.player.cockDescript(0) + " bringing her to the height of pleasure. ", false);
                    if (player.cocks.length == 2) outputText("Your " + game.player.cockDescript(1) + " rubs against her skin pleasantly.  ", false);
                    if (player.cocks.length > 2) outputText("The rest of your " + game.player.multiCockDescriptLight() + " rub against her skin pleasantly.  ", false);
                ...
                // (variant 2: maid, requires vagina)
                    ...
                    if (player.cocks.length > 0) outputText(", your " + game.player.multiCockDescriptLight() + ",", false);
                    ...
                    // [if player has a dick]
                    if (player.cocks.length > 0) outputText("You feel a desire rising in your erect " + game.player.multiCockDescriptLight() + " but you ignore it; that's not what your mistress told you to play with.  ", false);
    ...
    public playerRapesCultist(): void {
        ...
        if (monster.armorName == "pervy nun's clothing") {
            ...
            if (player.cocks.length > 0 && (player.gender != 3 || rand(2))) {
                ...
                outputText(game.player.multiCockDescriptLight() + " into her waiting love hole.  ", false);
                if (player.cocks.length > 1) {
                    outputText("You thrust once, before using one of your hands to guide the second of your " + game.player.multiCockDescriptLight() + " inside her.  You are rather surprised at how easily she seems to accommodate your size", false);
            ...
            // (if player has a dick)
            if (player.cocks.length > 0 && (player.gender != 3 || rand(2))) {
                outputText("Telling her that she is going to please you whether she wants to or not, you reveal your " + game.player.multiCockDescriptLight() + ".  She screams for help and starts struggling against your grip, but you tell her that no one is going to save her now.  Easily overpowering her, you force her to the ground with no care for her comfort and start tearing off her clothes.  Once you have a clear view of her love hole, you look back up at her face and see that she has stopped struggling and is now crying.  ", false);
                // [if not corrupted]
                ...
                outputText("Filled with new determination, you push your " + game.player.cockDescript(0) + " into her love hole and start to rape her roughly.  Despite the tears, she starts moaning, clearly enjoying the rough treatment.  A little while into the rape, she starts to move against you, almost lovingly.  It is quite clear that she has a lot of experience, but is giving you free reign to do whatever you want.   Feeling in complete control, you decide that this game isn't too bad.  Before long you reach your orgasm and you blow your load deep inside her.", false);
            ...
            // (if player has a vagina)
                ...
                outputText("Telling her that she is going to please you whether she wants to or not, you reveal your " + vaginaDescript(0) + ".  Pushing your " + clitDescript() + " to her mouth, you order her to lick you if she wants you to leave her mother alone.  ", false);
    ...
    private plugSwimsuitVag(): void {
        ...
        outputText("She nods at you and turns around shivering even harder.  You step forward and put your hands on her shoulders, then start to run them over her body, while your " + game.player.multiCockDescriptLight() + " pokes her in the back.  \"<i>Oh fuck me, I need you to fuck me now!</i>\" she screams.  Grinning, you push her to the ground and grip her pert, bouncing breasts.  You push her bathing suit to the side so that you have access to her waiting snatch.  You assure her that you'll be fucking her all right, all while you tease and play with her exposed body.\n\n", false);

        outputText("When you push your " + game.player.cockDescript(x) + " inside her, she goes absolutely insane underneath you.  She squirms and wriggles all over your " + game.player.cockDescript(x) + ", as you ", false);
        ...
        outputText("After all the foreplay, the two of you are already reaching your peaks thanks to her incredible, tight cunt and its ministrations to your member.  The cultist is screaming in pleasure, telling you to look at her, to fondle her, and to fuck her; you happily oblige her.  Her interior contracts about your " + game.player.cockDescript(x) + " as you loose the proof of your orgasm deep inside her.", false);
    ...
    private swimsuitVibrators(): void {
        ...
        if (player.vaginalCapacity() <= 30) {// PC does not have a very loose or looser vagina)
            ...
            outputText("she puts the vibrating toy to the entrance to your " + vaginaDescript(0) + ".  The next instant leaves you on your back as the cultist roughly shoves the thing inside you, forcing you to painfully stretch around the toy.", false);
            // if (PC was a virgin)
        ...
        // It fits!
            ...
            outputText("It doesn't take much longer for you to let loose the proof of your orgasm onto the magically humming rod between your legs.  At the same time, you suddenly feel a cool liquid spray the inside of the furnace that is your " + vaginaDescript(0) + " and the vibrator spills out of you along with ", false);
    ...
    public fetishCultistHasAMilkFetish(): void {
        outputText("", true);
        outputText("You remove your " + player.armorName + ", standing naked in front of the beaten fetish-girl with your lactating " + game.player.breastDescript(0) + " dripping milk. You pick the cultist up and sit down on the ground with her resting on your lap, her soft warm ass up against your thighs. You hold the nipple up to her mouth; she suckles on it without the slightest sign of rebellion.\n\n", false);
        ...
        if (player.hasCock()) {
            ...
            outputText("our " + game.player.multiCockDescriptLight() + " becomes fully erect as it rubs up against her warm ass cheeks, which is enough to fulfill its desire.   Her cum bubbles into the palm of your hand while your cum drizzles her ass with sticky whiteness.\n\n", false);
        }
        // [ELSE Pussy]
