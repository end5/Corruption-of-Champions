...
export class FetishZealot extends Monster {
    ...
    private zealotSpecial1(): void {
        ...
        if (armorName == LEATHER_CLOTHES) {
            ...
            outputText("The Zealot turns around and gives you a full view of his tight leather clad body.  He smacks his ass and says \"<i>You like what you see, don't you " + mf(player, "stud", "slut") + "?</i>\"  You can't help but be incredibly aroused by the scene.", false);
        }
