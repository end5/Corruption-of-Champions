...
function urethraFuckDatGiantCock(): void {
    ...
    if (player.cocks.length > 0) outputText(" and your " + multiCockDescriptLight(game.player));
...
function mockDatTurtleGirl(): void {
    ...
    if (player.cocks.length > 0) outputText(" as you cum in your [armor]");
...
function badEndPartTwo(): void {
    ...
    if (player.tongueType == TongueType.SNAKE) outputText("  Your snaky forked tongue begins lashing about, flicking at the nipple tip in your mouth while rubbing at the underside of it, urging the tender spot to give up a drop of the heavenly white liquid.");
    // [If PC has demonic/dragon tongue]
    else if (player.tongueType > TongueType.HUMAN) {
    ...
    if (kaijuCock()) {
        ...
        buttChange(player, 500, true, true, false);
