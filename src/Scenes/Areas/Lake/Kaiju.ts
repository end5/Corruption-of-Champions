...
export class Kaiju extends AbstractLakeContent {
    ...
    private insultTheKaijuFirstMeeting(): void {
        ...
        if (kaijuCock()) {
            ...
            if (player.findStatusAffect(StatusAffects.KnowsWhitefire) >= 0 && (player.findPerk(PerkLib.BloodMage) < 0 && player.fatigue + spellCost(30) > 100)) {
    ...
    private letKaijuHaveWayWithYou(): void {
        ...
        else if (player.gender == 1) outputText(multiCockDescriptLight(game.player));
    ...
    private urethraFuckDatGiantCock(): void {
        ...
        if (player.hasCock()) outputText(" and your " + multiCockDescriptLight(game.player));
    ...
    private badEndPartTwo(): void {
        ...
        if (player.tongueType == TONUGE_SNAKE) outputText("  Your snaky forked tongue begins lashing about, flicking at the nipple tip in your mouth while rubbing at the underside of it, urging the tender spot to give up a drop of the heavenly white liquid.");
        // [If PC has demonic/dragon tongue]
        else if (player.tongueType > TONUGE_HUMAN) {
        ...
        if (player.hasCock()) outputText("  More tentacles arrive and begin to wrap around your " + multiCockDescriptLight(game.player) + ", slowly jacking you off to the tempo set by the cocks in your ass and mouth, wracking you with further pleasure.");
