...
//Defeat – Female
		...
		{
			outputText("", true);
			outputText("You sway, finding it difficult to maintain your balance. When you fall, your " + buttDescript() + " splashes wetly in the enveloping folds of the goo-girl's eager slime. You weakly hold your hand up to keep her back, but the wide-eyed victor disregards the gesture with playful disdain. She slithers against you, moist muck slurping at your flesh with a hungry heat. Her semi-solid hands take yours, pulling your arms apart to bare your chest. She cranes her dripping head around your shoulders, skillfully removing your " + player.armorName + " with only her mouth. Your " + game.player.chestDesc() + " heave as the irrepressible heat of the slime sears your " + nippleDescript(0) + "s until beads of sweat well up on your " + player.skin() + " and trickle down your curves, leaving a wet sheen over your body.\n\n", false);
...
//VICTORY
		public  beatUpGoo():void
		{
			...
			if (player.gender == 0 || player.lust < 33) {
				...
				var sex4S:string = "";
				var sex4N:() => void =null;
				var valeria:() => void = valeria.valeriaAndGooThreeStuff;
...
//Victory – Male
		private  gooMaleRape(type:number = 1):void
		{
			...
			if (player.cocks[x].cockLength < 24) {
				...
				outputText("Noticing your hardening length, the goo-girl claps her hands in gushing pleasure and gently pushes you back onto your " + buttDescript() + ". Rubbing her moist cheek against yours, she slides down your " + game.player.chestDesc() + " and perches over your groin. Slowly, she moves back and forth, stroking your shaft with the perky wetness of her stiff nipples. She hovers over your manhood for a moment before dropping down, her sloping cleavage stroking your cock between her slimy pillows with a slurping squelch. Pressing her balled-up fists to either side, she squeezes your " + game.player.cockDescript(x) + " between her breasts and begins to slowly pump your stiffening organ. The natural lubrication of her gooey skin makes the tit-fuck pleasantly slick, softness sucking your flesh with wet gulps as she rolls from base to tip, your cockhead popping between her cleavage at a brisk pace, cooled by the air for only a moment before it is swallowed once more by the seething heat of her chest. Through her transparent skin, you can see your " + game.player.cockDescript(x) + " being massaged by the gooey embrace of her tits. Your body trembles to the precipice of an orgasm, muscle spasms and a shortness of breath makes each pump of your slime-oiled hardness more exquisite than the last, as if the girl's murky breasts were pulling the air from your lungs.\n\n", false);
