...
export class TamainsDaughtersScene implements TimeAwareInterface {
    ...
    private fuckYoDaughtersHomie(): void {
        ...
        if (tamaniPresent) forest.tamaniScene.tamaniKnockUp(); // If she wasn't pregnant she will be now
        knockUpDaughters();
    ...
    private legTamanisDaughtersRAEPYou(): void {
        ...
        if (primary >= 0) {
            ...
            if (tamaniPresent) {
                ...
                flags[kFLAGS.TAMANI_TIMES_HYPNOTISED]++;
                // preggo up tamani
                forest.tamaniScene.tamaniKnockUp();
            }
            // NO TAMANI:
            else {
                // (SMALL PACK)
            ...
            // [Tamani is There]
                ...
                if (cocks > 2) {
                    ...
                    if (player.breasts.biggestLactation() >= 1) {
                        ...
                        if (player.breasts.biggestLactation() < 2) outputText("leak", false);
                        else if (player.breasts.biggestLactation() < 3) outputText("drip", false);
                        else if (player.breasts.biggestLactation() < 5) outputText("spew", false);
