    ...
    */
    ...
    private tamaniFirstTimeConsentual(): void {
        ...
        if (player.cockArea(0) <= 90) {
            outputText("Tamani breaks the kiss and gives you a coy smile as she shimmies down your body, dropping her moist cunt onto your " + game.player.cockDescript(0) + "'s " + player.cockHead() + ".  She swings her hips in a little circle, teasing you with her moist entrance as your drug-enhanced pre-cum bubbles and drools around her lips, mixing with her own copious fluids as it flows down your length", false);
            ...
            outputText("All good things eventually end, and with a sigh you pull the insensate goblin slut free of your " + game.player.cockDescript(0) + ", watching a river of whiteness drain from between her thighs.  You set her down and the escaping jism suddenly stops, the remainder held inside by some kind of reflex.  Tamani giggles and pats her still pregnant-looking belly, \"<i>Wasn't the sample nice?  Come see me when your dick has had a chance to recover and we can do this again, and again, and again.  You're practically hooked already aren't you " + player.mf("stud", "hun") + "?</i>\"\n\n", false);
            ...
            // [CORRUPT]
            if (player.cor > 66) outputText("  Your " + game.player.cockDescript(0) + " twitches at the thought, ready and wanting more.", false);
        }
        // (TOO BIG)
        else {
            outputText("Tamani breaks your sloppy kiss and shimmies down your body, clutching tightly to your " + game.player.cockDescript(0) + " and " + player.skinDesc + " as she settles down lower on your groin.  The goblin somehow manages to turn herself around so that is she is hanging upside-down, with her legs and arms clutching tightly to your member while her tongue ", false);
            if (player.hasSheath()) {
    ...
    private tamaniMaleRepeatEncounter(): void {
        ...
        if (pregnancy.isPregnant || flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] > 0) outputText("While exploring, you're startled by the feeling of tiny hands stroking the insides of your thighs.  You look down and find Tamani there, grinning wolfishly,  \"<i>Ready for another fuck, big " + player.boyGirl() + "?\"\n\n", false);
        // (ELSE)
    ...
    public tamaniSexLetHer(): void {
        ...
        if (game.inCombat) {
            ...
            if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                ...
                else outputText("You stumble, hooves weaving drunkenly as " + game.player.sMultiCockDesc() + " ache and drool with need.  ", false);
        ...
        // Voluntary submission
            ...
            // Taur
            if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                outputText("You meekly undress and ask Tamani how she would like to take you today.  She titters and slowly walks around you, taking her time, taking in your formidable equine body and your " + game.player.multiCockDescriptLight() + ". \"<i>All this, for little ol' me,</i>\" she breathes. She sounds more tantalized than daunted. \"<i>Stand still for me, horsie,</i>\" she commands. Unable to see her any more behind your flank, you do as she says. You feel a pair of tiny hands on your back thigh and then a small but dense weight climbing steadily towards your groin. You bite back laughter at the ticklish sensation.\n\n", false);
            }
            else {
        ...
        if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
            ...
            if (player.cocks[0].cockLength <= 18) {
                outputText("Before you can get too far she stops and agonizingly shifts her attention; you feel her transfer her weight to her hands, and then the rough but soft bottoms of her feet work their way down to the other end of your " + game.player.cockDescript(0) + ", pressing against your inner thighs. The wet velvet sensation of her snatch envelopes your head and then slowly works its way down your shaft. Before she can bottom out, Tamani stops, teasingly and slowly withdraws until once again your head is pressed against her sopping entrance. She begins to work her thighs, smearing herself against the end of your straining cock with increasing urgency until she squeals in orgasm, slathering her juices onto your tip. Then, with a sigh and a snicker and again with agonising slowness, she works herself down onto your " + game.player.cockDescript(0) + ". ", false);
                // No balls:
            ...
            // If >18 Inches
                ...
                outputText("Before you can get too far she stops and agonizingly shifts her attention; you feel her rough but soft bottoms of her feet work their way down to the other end of your " + game.player.cockDescript(0) + ". Hanging onto the base of your member she begins to rub her plump, diminutive form along the bottom of it, her tits and thighs caressing your length. ", false);
                if (player.balls == 0) outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics.\n\n", false);
                ...
                outputText("\"<i>Go on then,</i>\" she breathes eventually. \"<i>I guess you've had enough. Cum for Mistress Tamani, " + player.mf("stud", "slut") + ". Cover me from head to toe.</i>\" As she says this, she walks her hands down your belly, positions herself directly over your head, uses her own lubrication to rub her feet furiously down your " + game.player.cockDescript(0) + " and then, with one last evil giggle, sticks her tongue directly into your urethra.\n\n", false);

                // Low cum:
                if (player.cumQ() < 1200) {
                    outputText("With a ragged sigh, you reach your peak. Your first blast of jizz goes straight into Tamani's mouth, but you feel the goblin nimbly and hastily changing her position so that the very tip of your " + game.player.cockDescript(0) + " can feel her moist snatch. Being teased for so long makes the sensation incredible, and it feels like entire minutes go by whilst you stand there, sweat dripping off you as you cum over and over again until your cock is doing nothing but flexing mindlessly.\n\n", false);
        ...
        // Not-taurs
            ...
            outputText("She gets down on all fours, crawling up your legs until her gloss-covered lips reach your " + game.player.multiCockDescriptLight() + ".   Warm wetness slides along your length as the gobbo-slut gets you slick and wet with her saliva.   It has quite the effect on you, turning your " + game.player.cockDescript(0) + " into a hard trembling pleasure-center.  You sigh, enjoying the attention but more than ready to release your pent-up sexual need into the willing girl.\n\n", false);
            // (fits)
            if (player.cockArea(0) <= 90) {
                outputText("Tamani turns about, dragging her wet gash across you and giving you a nice view of her plump butt-cheeks.  The soft skin of her palms squeezes around you as she lifts you up, positioning your " + game.player.cockDescript(0) + " against her womanhood.   She grinds against your " + player.cockHead() + ", her folds slowly parting to take you.  Slowly, inch after inch of dickflesh sinks into her amazingly elastic yet tight pussy.  ", false);
                ...
                if (player.cumQ() < 250) outputText(".  I really enjoy our fucks " + player.mf("stud", "hun") + ", and I can't wait to 'bump' into you again.", false);
                    ...
                    else outputText(game.player.cockDescript(0) + " fills back up with cum, ok?", false);
                }
                outputText("</i>\"\n\n", false);
                // Combat end:
                if (game.inCombat) {
            ...
            // (Doesnt fit)
                ...
                else outputText(game.player.cockDescript(0), false);
                ...
                outputText("Tamani rocks back and forth, sliding herself against your " + game.player.cockDescript(0) + ", humping it lewdly as your veins rub her hard little nub of a clit.  She pants, making sure to keep giving you sultry looks over her shoulder, licking her glossy lips as she brutally teases you.  You can feel her getting off over and over as she grinds, sliding faster and faster on your shaft.   For your part, your " + game.player.cockDescript(0) + " begins making a puddle of pre-cum on your belly as the dildo's drug-like cum affects you, making you feel horny and hot.\n\n", false);
                outputText("The kinky goblin dominatrix on your " + game.player.cockDescript(0) + " leans even further forwards, angling the dildo in your " + assholeOrPussy(player) + " upwards to squeeze your ", false);
    ...
    public tamaniSexLost(): void {
        ...
        else outputText("Somehow the ring fits onto you perfectly, as if it was made exactly for your " + game.player.cockDescript(0) + ", though it remains painfully tight.\n\n", false);
    ...
    public tamaniSexWon(): void {
        ...
        if (player.cockArea(x) <= 90) {
            ...
            outputText("It's too tempting of a target to resist.  You open your " + player.armorName + " and allow your " + game.player.multiCockDescriptLight() + " to flop free.  You're already hard from the enticing display, and in a moment you're pressing against her lust-slicked pussy", false);
        ...
        // Too big? Jerk off with feet and bukkake
            ...
            if (player.cumQ() >= 250) outputText("  You continue working your " + game.player.cockDescript(x) + " with her supple feet, watching your dripping spooge froth and bubble as you continue to pump more onto the sassy wench.", false);
    ...
    private tamaniPregnantFuck(): void {
        ...
        // (Doesn't Fit)
            ...
            else outputText("jacking the base of your " + game.player.cockDescript(0) + " with her feet", false);
            ...
            outputText("Tamani grinds on you a bit longer before staggering up and stretching.  She pauses to get a narrow bottle and abruptly jams the end into your urethra.  With one practiced motion, she squeezes your " + game.player.cockDescript(0) + " from bottom to top, squeezing the last of your spoo into the container.  She pops it free, corks it, and pockets it.  She pats her pockets and explains, \"<i>A few of the girls back home aren't pregnant, and I thought you might like to help contribute to the local slut population.  Don't worry though baby, I'll always own your cock.</i>\"\n\n", false);
    ...
    public getRapedByTamaniYouHypnoSlut(): void {
        ...
        // [DOESNT FIT]
            ...
            outputText(game.player.cockDescript(0) + ".  Her warmth spreads over the " + player.cockHead() + " of your " + game.player.cockDescript(0) + ", but will go no further.  You tug harder on her bouncing backside, but you're simply too large to fit inside your wife's beautiful pussy.  She turns around and places a small hand ", false);
            if (player.biggestTitSize() < 1) outputText("on your chest ", false);
            else outputText("between your " + game.player.breastDescript(0) + " ", false);
            outputText(" and commands, \"<i>Stop, you're just too big of a man for Tamani to do it the old fashioned way.</i>\"\n\n", false);

            outputText("Disgruntled but obedient, you stop your vaginal assault and release your wife.  It seems she has another way for your aching " + game.player.cockDescript(0) + " to perform its duties anyway.  Tamani turns around and pulls out some clear tubing, along with a floppy, flexible sheath while she explains, \"<i>I'll just have to get you off and let you pump all your babies into me with this!</i>\"\n\n", false);

            outputText("Her small, dextrous fingers wrap the upper half of your ", false);
            if (cocks > 1) outputText("primary ", false);
            outputText(game.player.cockDescript(0) + " inside the sheath, constricting it inside the tight, transparent material.  You sigh while you endure the treatment, disappointed you won't get to feel her clenching about you as you pour sperm into her fertile womb. She finishes up, slowly pushing the tube up her gorgeous, feminine hole until you're certain it'll be depositing your precious cargo into her deepest recesses. Tamani claps her hands together excitedly, \"<i>I haven't had a man big enough to use this with until you.  Oh husband, you're going to love this, just lie back for Tamani, okay?</i>\"\n\n", false);

            outputText("You do as you are told, like a good husband, and Tamani stays close, bound to you by a flexible, artificial umbilical.  She sits next to you, propping her feet up onto your " + game.player.cockDescript(0) + ".   The goblin doesn't have any shoes on her green-tinted feet, and in spite of the rough living conditions, they're softer than her hands, and nearly as dextrous.  You look over at her, questioningly at first, though it shifts to confused happiness as she begins stroking her left foot up and down your length.  Your wife shifts her right leg underneath you, and curls her toes around to interlock them with her left.\n\n", false);
            ...
            if (cocks > 1) {
                if (cocks == 2) outputText("  Your other" + game.player.cockDescript(1), false);
                else outputText("  Each of your other " + game.player.multiCockDescriptLight(), false);
            ...
            outputText("Tamani smiles as she pulls the tube out and stands up.  White jism and clear feminine fluids drool down her thighs, and your mistress couldn't be happier.  She peels her device off your still-dripping " + game.player.cockDescript(0) + ", pats it affectionately, and says, \"<i>You're such a wonderful husband.  I can't wait to see how you get along with your new daughters!</i>\"\n\n", false);
