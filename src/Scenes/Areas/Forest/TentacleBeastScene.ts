        ...
        if (player.biggestLactation() >= 3.5 && player.gender > 0) {
            ...
            // Pussy
                ...
                if (player.cockTotal() > 0) {
                    outputText(vaginaDescript(0) + " and " + multiCockDescriptLight(game.player), false);
