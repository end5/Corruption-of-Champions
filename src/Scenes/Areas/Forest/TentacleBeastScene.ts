...
export function tentacleLossRape(): void {
    ...
    if (player.breastRows.biggestLactation() >= 3.5 && player.gender > 0) {
        ...
        if (player.gender == 2) {
            ...
            if (cuntChange(player, 20, true)) outputText("\n", false);
            outputText("\n", false);
        }// HERMS
        if (player.gender == 3) {
...
function tentacleRapeContinuation(): void {
    ...
    if (player.gender == 1) {
        ...
        cuntChange(player, player.vaginalCapacity() * .76, true);
