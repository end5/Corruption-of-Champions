...
export class Faerie {
    ...
    private faerieCaptureHJ(): void {
        ...
        if (player.isTaur()) {
            ...
            else if (player.statusAffectv1(StatusAffects.FaerieFucked) < 15) outputText("The faerie burps and laughs drunkenly, patting the side of your " + leg(player) + " and slurring, \"<i>Oh by Marae's ripe titsh!  I needed that.  Do you thhink you could catsch me again?  I love feeling your cum coating my body.</i>\"\n\n", false);
