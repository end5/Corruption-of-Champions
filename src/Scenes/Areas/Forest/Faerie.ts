    ...
    if (player.cocks.length > 0 && (!player.vaginas.length > 0 || rand(2) == 0)) {
        ...
        if (rand(player.spe / 2) + player.effects.getValue1Of(StatusAffects.FaerieFucked) > 15) {
            if (player.effects.getValue1Of(StatusAffects.FaerieFucked) < 5) {
                ...
                outputText("It would be cute if she wasn't dressed up like such a slut.  You bet you could get her to help pleasure you, but she might not like it.  Or you could be a nice " + guyGirl(player) + " and let her go...\n\nDo you force her to pleasure you?", false);
            }
            else if (player.effects.getValue1Of(StatusAffects.FaerieFucked) < 10) {
            ...
            else if (player.effects.getValue1Of(StatusAffects.FaerieFucked) < 15) {
        ...
        if (player.lust >= 90) {
            ...
            if (player.cocks.length == 1) outputText("your dick", false);
...
function faerieRAEP(): void {
    ...
    else player.effects.addValue(StatusAffects.FaerieFemFuck, 1, 1);
    ...
    if (player.effects.getValue1Of(StatusAffects.FaerieFemFuck) == 1) outputText("She juices herself and screams, \"<i>Let me goooooooo,</i>\" trying to sound outraged instead of turned on, but the tiny girl's body gives away the lie.", false);
    else if (player.effects.getValue1Of(StatusAffects.FaerieFemFuck) <= 5) outputText("She juices herself and moans, \"<i>Stop teasing meeeeee,</i>\" doing her best to wriggle back against you, as if she could somehow impale herself on your digit.", false);
    ...
    // Special Taurness
    if (player.isTaur()) {
        outputText("\n\nYou bop the tiny Faerie on the head to daze her briefly, then place her on a branch. You back yourself up against the tiny creature, lifting your tail so she can see your " + vaginaDescript(player, 0) + ". The scent washes toward her and you hear a high pitched giggle; evidently that was more than enough to give her quite the contact high.  You feel a strange sensation in your slit as she slides her legs inside you and wraps her arms around your " + clitDescription(player) + ".\n\n", false);

        // [If cock-like clit:
        if (player.clitLength >= 3) {
            outputText("The tiny fae begins jerking your clit like a cock, squeezing her arms tightly around you and sliding in and out of your " + vaginaDescript(player, 0) + ". Her motions are frenetic and unpredictable, but incredibly pleasurable.  She starts licking at your " + clitDescription(player) + " as your femcum runs down it, which only serves to make her more excited. She gets so excited that her legs start kicking wildly as she screams \"<i>Swim! Swim! Swim! Swim!</i>\" over and over again.  ", false);
            // [Small amount of cum:
            if (player.vaginas[0].vaginalWetness <= VaginaWetness.WET) outputText("The fae giggles more and more as the fluid seeps about her and your " + vaginaDescript(player, 0) + " ripples. She hugs your " + clitDescription(player) + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a small puddle of femcum.\n\n", false);
            // [Normal amount of cum:
            else if (player.vaginas[0].vaginalWetness <= VaginaWetness.DROOLING) outputText("The fae giggles more and more as the fluid squirts about her and your " + vaginaDescript(player, 0) + " ripples. She hugs your " + clitDescription(player) + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a puddle of femcum.\n\n", false);
            // [Huge amount of cum:
        ...
        // [All other clits:
            ...
            outputText("The tiny fae rubs her hands around your " + clitDescription(player) + " as if entranced by it. Your body responds by pumping out more femcum, which she laps up happily.  She starts laughing maniacally and banging on your clit like a drum, periodically yelling out \"<i>CONGA!</i>\" for some reason. The strange ministrations feel incredible though, and you feel your love canal squeezing down on the faerie's tiny body.  ", false);
            // [Small amount of cum:
            if (player.vaginas[0].vaginalWetness <= VaginaWetness.WET) outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid seeps about her and your " + vaginaDescript(player, 0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a small puddle of femcum.\n\n", false);
            // [Normal amount of cum:
            else if (player.vaginas[0].vaginalWetness <= VaginaWetness.DROOLING) outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid squirts around her and your " + vaginaDescript(player, 0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a puddle of femcum.\n\n", false);
            // [Huge amount of cum:
            else outputText("You cum suddenly, and wetly. The fae tries desperately to hold on to your " + clitDescription(player) + " but the amount of fluid overwhelms her and she's sent spiralling to the ground into a huge puddle of your fluid, her giggling frame floating on the surface as her legs kick about erratically.\n\n", false);
        }
    }
    // Non-Taurs
    else {
        outputText("\n\nYou release the lower portion of your " + player.armorName + ", revealing your aroused slit to the faerie.  ", false);
        if (player.effects.getValue1Of(StatusAffects.FaerieFemFuck) < 4) outputText("Her mood immediately shifts from panic to desire, and she licks her lips hungrily, locking her eyes onto your feminine folds.", false);
        ...
        if (player.vaginas[0].vaginalWetness >= VaginaWetness.SLAVERING) outputText("releasing a tiny squirt", false);
        else if (player.vaginas[0].vaginalWetness >= VaginaWetness.DROOLING) outputText("dribbling juices", false);
        else if (player.vaginas[0].vaginalWetness >= VaginaWetness.WET) outputText("growing so slippery the faerie nearly loses her footing", false);
        else outputText("feeling yourself moistening with need", false);
        outputText(" from the tiny touches.\n\n", false);

        // (small) <= .50\"
        if (player.clitLength <= .5) {
            outputText("She pulls apart your lips, revealing your tiny bud and repositioning herself to plant her feet inside you.  The flawless skin of her thighs pulls another gasp of pleasure from your lips.  They squeeze tightly around your " + clitDescription(player) + ", scissoring her gash across its sensitive surface.   You squirm, too engrossed in the rough grinding your button is receiving to worry about the faerie.   She clings to you, hanging on for dear life as your crotch nearly throws her free.  During the gyrations, she's slammed back into the " + clitDescription(player) + ", instantly penetrated by the nub with a wet 'schlick'.\n\n", false);
            outputText("Squealing and bouncing as she hangs on tightly, the faerie noisily orgasms around your clit, squirting her own fluids into your aching " + vaginaDescript(player, 0) + ".  The fluid tingles, and you shove your fingers in, smearing the sticky-sweet faerie-cum through your passage.   Before you can get far with it, your own orgasm goes off, squeezing your fingers and rippling around them, trying to milk your hand as if it was a dick.  Your legs go weak and wobbly, forcing you down on your " + buttDescription(player) + " as the waves of pleasure flow through you, soaking the faerie in girlcum.\n\n", false);
        }
        // (medium) <= .1.25\"
        else if (player.clitLength <= 1.25) {
            outputText("She watches, entranced as your " + clitDescription(player) + " hardens, poking between your lips, flushed with blood like a tiny cock.   The faerie swivels around, planting her dainty butt squarely on your snatch, sinking down a bit into the folds as she wraps her legs around the pulsating 'shaft'.   She hugs it, pressing it between her tiny breasts and licking it up and down, making you moan and squirm from unexpected stimulation of your most sensitive area.\n\n", false);
            outputText("You spread your " + legs(player) + ", careful not to dislodge the faerie as she releases the " + clitDescription(player) + " and stands up, placing her dripping gash against the tip.   A quick plunge later and she's bottomed out, pressing her hips into the opening of your " + vaginaDescript(player, 0) + " her feet slipping over the outer folds as she tries to maintain her balance.   You start rocking back and forth happily, bouncing the faerie up and down.  She moans, cute and barely audible, but sexy in a way that makes your sopping fuckhole even wetter.\n\n", false);
            outputText("She orgasms on you, squirting copiously, drenching your " + clitDescription(player) + " and " + vaginaDescript(player, 0) + " in clear faerie-fluid.  It tingles, wicking into your button and soaking into your snatch, enhancing every sensation.  You can feel the cool forest air as it flows over your vulva, seeming to stroke you, and without any chance of holding yourself back, you plunge your fingers into your " + vaginaDescript(player, 0) + ", immediately orgasming from the penetration, not even noticing the exhausted faerie sliding off the large clit and slipping partway into your cunt.\n\n", false);
        }
        // (streeeetch – large) <= 4.5\"
        else if (player.clitLength <= 4.5) {
            outputText("Entranced by the growing " + clitDescription(player) + ", the faerie caresses her body, watching your love-button swell up, not stopping until it looks too huge for her tiny frame.  She climbs in a circle around it, awestruck by the size and majesty of your cock-like button.    She looks up at you, aroused but worried, saying, \"<i>You're so... BIG.  Oh goddess, I want to feel it inside me!</i>\"\n\n", false);
            outputText("She grabs hold of its slippery surface with both hands and jumps, lifting her lower body up before gravity yanks it back down onto the tip of your " + clitDescription(player) + ".  The tip barely slips in, despite the slippery wetness of the faerie.   She screams, though in pleasure or pain you cannot be sure.  You reason that it must be pleasure, because the faerie is wiggling her hips and grabbing hold of the rest of your " + clitDescription(player) + ", straining to pull herself further down the fem-cock.  Her belly starts to distort, displaying the cylindrical bulge on her tummy, expanding and contracting slightly as each of your heart-beats works through your clit.\n\n", false);
            outputText("In time, she manages to fully impale herself, quivering in orgasm as she gets off from the vibrations your pounding heart sends through your " + clitDescription(player) + ".  Her tongue lolls out and her eyes roll back, shut down by the extreme penetration, pain, and pleasure of the act.  You feel her cum soaking into you, sliding down into your slit and making your sensitive slit tingle.  Watching her get off is all it takes to bring you to orgasm with her, and the walls of your " + vaginaDescript(player, 0) + " clamp down hungrily, contracting and gushing fluids over the faerie as she lies there, impaled on your crotch like a perverted ornament.\n\n", false);
        }
        // (too big) (else – hump dat shit)
        else {
            outputText("Entranced by your swollen " + clitDescription(player) + ", the faerie watches it slowly erect, filling with blood like a smooth over-sensitive cock.  She tentatively touches it, gasping and pulling back when it twitches in response.   With a look of awe, she turns to you and says, \"<i>There's no way I could take this beautiful monster, but I know I can make it feel good!</i>\"\n\n", false);
            outputText("She jumps onto it, making it bounce in the air as it takes her relatively insubstantial weight.  Embracing it in a full-body hug, she starts grinding on it, smearing her thick faerie juices into the clit and giggling every time you twitch from the feeling.  You squirm, sinking down from the raw sensation, your " + legs(player) + " giving out underneath you.   Grabbing hold of a stump, you try to steady yourself, but the faerie humping your " + clitDescription(player) + " is interfering with your motor ability, and you slump into the forest loam, happily twitching as orgasm washes over you.\n\n", false);
            outputText("Your " + clitDescription(player) + " jumps, throwing the tiny woman off.  She slips and scrabbles across the surface of your " + vaginaDescript(player, 0) + ", sliding into your soaking gash.  She's squeezed tightly, sloshed around in the wetness of your orgasm.   The faerie's eyes cross, as she grows dizzy and battered in the sizzling whirlpool that is your groin.\n\n", false);
        }
    }
    // [OH SHIT ITS OVER, POOR BITCH CRAWLS OUT ALL STONE ON GIRLCUM]
    // [FIRST TIME]
    if (player.effects.getValue1Of(StatusAffects.FaerieFemFuck) == 1) {
    ...
    // [REPEAT LOW]
    else if (player.effects.getValue1Of(StatusAffects.FaerieFemFuck) <= 5) {
        outputText("The faerie slowly drags herself out of your " + vaginaDescript(player, 0) + ", smiling broadly with her eyes dilated wide.  She slips off you, dropping to the ground and giggling, \"<i>Everything feels so soft.  Mmmm that was fun!</i>\"\n\n", false);
...
function faerieDoNothing(): void {
    ...
    if (player.nippleLength >= 1) {
        ...
        if (player.breastRows.biggestLactation() > 1) outputText("A squirt of milk shoots inside her, making the faerie moan. She looks up at you with lusty, slitted eyes, squeezing her legs together to draw more from you.\n\n", false);
    ...
    if (player.clitLength >= 1.0 && player.clitLength <= 4.5 && player.vaginas.length > 0 && rand(2) == 0) {
        ...
        if (player.vaginas[0].vaginalWetness >= VaginaWetness.DROOLING) outputText("You drench the poor faerie completely in your female juices, soaking her hair and body. Overwhelmed and spent, you drop her to the ground and catch your breath. She licks up what's around her face, but is too weak to do anything else but lie in the dirt.\n\n", false);
    ...
    if (player.nippleLength > 3 || player.breastRows.biggestTitSize() <= 2) {
...
function faerieCaptureHJ(): void {
    ...
    outputText("", true);
    if (player.effects.getValue1Of(StatusAffects.FaerieFucked) < 15) {
    ...
    outputText("You let her loose and she hovers in place, as if pondering her one last chance to escape.  She sighs and looks back up, blushing fiercely as she lands on your hip and gazes down at the bulge of your groin.  You can't help but laugh as she slips under your " + player.armorName + ", crawling across your sensitive thigh towards your " + multiCockDescriptLight(game.player) + ".\n\n", false);
    // Taurs get a special scene!
    if (player.isTaur()) {
        outputText("The tiny Faerie climbs on top of your " + cockDescript(game.player, 0), false);
        if (player.cocks.length > 0) outputText("largest " + Appearance.cockNoun(CockTypesEnum.HUMAN), false);
        ...
        outputText("She smashes onto the end of your " + multiCockDescriptLight(game.player) + " and grasps at it. Her face crushes into your urethra as her tiny legs wrap themselves around the tip. Your wildly flailing cock starts to grow larger as your orgasm approaches, but the faerie doesn't notice as she happily drinks up your pre.\n\n", false);
        // [No testicles:
        if (player.balls == 0) outputText("Your tiny globules of semen go straight into her open mouth and she sucks them down gleefully before falling with a splat onto the pre soaked ground.\n\n", false);
            ...
            // [Normal amount of cum:
            else if (player.cumQ() < 200) outputText("Your semen washes into her face and she loses her grip on your " + multiCockDescriptLight(game.player) + ". She falls with a splat onto the pre soaked ground and you spray her with periodic spurts of fresh cum.\n\n", false);
            // [Huge amount of cum:
            else outputText("Your semen collides with her face and she is propelled off of your cock onto the pre soaked ground. Your " + ballsDescriptLight(player) + " continue pumping out cum like a hose until she's almost swimming in it.\n\n", false);
        }
        player.orgasm();
        dynStats("lib", -.5);
        // Epilogue!
        if (player.effects.getValue1Of(StatusAffects.FaerieFucked) < 10) outputText("The faerie burps and giggles again before glaring up at you, accusing you with a mildly unfocused glare and asking, \"<i>Did you know we get drunk on cum?  Caushe I TRY SO HARRD not to get meshed up like this.</i>\"\n\n", false);
        else if (player.effects.getValue1Of(StatusAffects.FaerieFucked) < 15) outputText("The faerie burps and laughs drunkenly, patting the side of your " + leg(player) + " and slurring, \"<i>Oh by Marae's ripe titsh!  I needed that.  Do you thhink you could catsch me again?  I love feeling your cum coating my body.</i>\"\n\n", false);
        ...
        if (player.effects.getValue1Of(StatusAffects.FaerieFucked) < 15) outputText("She licks her fingers and rolls around laughing, \"<i>Hehe, who caresh!  I'm happy! WHEEEEE!</i>\"\n\n", false);
    ...
    // Non-taurs
        ...
        else if (player.cocks[0].cockType == CockTypesEnum.HORSE) outputText("climbs atop your " + cockDescript(game.player, 0) + ", hanging onto your ring of prepuce and wrapping her legs as far around your horse-like maleness as she can.  ", false);
        else if (player.cocks[0].cockType == CockTypesEnum.DEMON) outputText("climbs atop your " + cockDescript(game.player, 0) + ", hanging on to the corrupted nubs and nodules as she threads her legs between them, squeezing you tightly as she hangs on.  You can feel her wet gash sitting atop a particularly sensitive bump, teasing you with a tiny cunt you'll never be able to penetrate.  ", false);
        else if (player.cocks[0].cockType == CockTypesEnum.TENTACLE) outputText("climbs onto your squirming " + cockDescript(game.player, 0) + ", wrapping her legs tightly around it as it wiggles and writhes with excitement.  Unbidden, it curls around and rubs its reddish-purple head against her face like an animal.  She gives it a gentle squeeze and licks it.  ", false);
