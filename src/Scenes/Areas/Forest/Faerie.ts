...
export class Faerie {
    ...
    private faerieRAEP(): void {
        ...
        // Non-Taurs
            ...
            // (medium) <= .1.25\"
                ...
                outputText("You spread your " + legs(player) + ", careful not to dislodge the faerie as she releases the " + clitDescript() + " and stands up, placing her dripping gash against the tip.   A quick plunge later and she's bottomed out, pressing her hips into the opening of your " + vaginaDescript(0) + " her feet slipping over the outer folds as she tries to maintain her balance.   You start rocking back and forth happily, bouncing the faerie up and down.  She moans, cute and barely audible, but sexy in a way that makes your sopping fuckhole even wetter.\n\n", false);
            ...
            // (too big) (else – hump dat shit)
                ...
                outputText("She jumps onto it, making it bounce in the air as it takes her relatively insubstantial weight.  Embracing it in a full-body hug, she starts grinding on it, smearing her thick faerie juices into the clit and giggling every time you twitch from the feeling.  You squirm, sinking down from the raw sensation, your " + legs(player) + " giving out underneath you.   Grabbing hold of a stump, you try to steady yourself, but the faerie humping your " + clitDescript() + " is interfering with your motor ability, and you slump into the forest loam, happily twitching as orgasm washes over you.\n\n", false);
    ...
    private faerieDoNothing(): void {
        ...
        if (player.nippleLength >= 1) {
            ...
            if (player.hasVagina()) outputText("With your other hand you start diddling your " + vaginaDescript(0) + ", adding your own soft moans to hers.  ", false);
