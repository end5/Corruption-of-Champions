    ...
    private tentacleEntwine(): void {
        ...
        if (player.effects.findByType(StatusAffects.TentacleBind) < 0) {
            ...
            // Fail
                ...
                // Female Version:
                else if (player.vaginas.length > 0) outputText("The creature quickly positions a long tentacle with a single sucker over your clitoris. You feel the power of the suction on you, and your body quickly heats up.  Your clit engorges, prompting the beast to latch the sucker onto your " + clitDescription(player) + ".\n", false);
                // Genderless
