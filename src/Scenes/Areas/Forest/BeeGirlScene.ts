...
export class BeeGirlScene {
        ...
        if (player.isTaur()) {
            ...
            if (player.longestCockLength() >= 100 || player.gender == 0) {
                ...
                if (player.gender == 1) {
                    ...
                    outputText("your engorged " + multiCockDescriptLight(game.player) + " and jerk it off violently, cumming again and again as the bee-girl violates your " + assholeDescript() + ".  ", false);
                    // [Without testicles:
                ...
                // [Herm (bypasses the bucking scene):
                    ...
                    outputText("You grasp your engorged " + multiCockDescriptLight(game.player) + " and jerk it off violently, cumming again and again as the bee-girl violates your " + assholeDescript() + " and your " + vaginaDescript(0) + " pumps out enough femcum to drench your hind legs.  ", false);
                    // [Without testicles:
    ...
    */
    ...
    private beeMaidenPlay(): void {
        clearOutput();
        spriteSelect(6);
        outputText("You nod to her and walk up to the flower.  She moves a bit to the side and pats the spot next to her.  You first slip out of your " + player.armorName + ", then sit your " + assDescript() + " next to her.  ");
        if (player.cor <= 33)
        ...
        if (player.hasVagina()) {
            ...
            outputText("Just having her chitin covered fingers playing around with your " + buttDescript() + " feels great, and it’s worth just staying there for a few moments.  Still, best to get to the main course you figure, and move your finger to the edge of her rear entrance.  You gently poke at the entrance to for a moment to help her get ready for your invasive activities.  Your insectoid lover gives no such time to prepare, and simply shoves her wet digit as deep as she can into your " + assholeDescript() + ".\n\n");
        ...
        if (player.isTaur()) {
            ...
            if (player.HP < 1) {
                ...
                // [Herm:
                    ...
                    outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + sMultiCockDesc(game.player) + " to go rock hard and your " + vaginaDescript(0) + " to squirt fluid behind you.\n\n", false);
            ...
            // Lust:
                ...
                if (player.gender == 1 && player.balls > 0) {
                    ...
                    outputText("She continues pumping into you as you pass out, " + sMultiCockDesc(game.player) + " and " + ballsDescriptLight() + " aching.  The combined scent of cum and honey completely overwhelms you.", false);
                }
                // [Male without testicles:
                ...
                // [Herm:
                    ...
                    outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + sMultiCockDesc(game.player) + " to go rock hard and your " + vaginaDescript() + " to squirt fluid behind you.\n\n", false);
                    ...
                    outputText("She seems to understand your problem though and, wanting to help you with your needs, begins to massage your " + vaginaDescript() + " with her 'feet' while periodically stroking the back of your " + cockDescript(game.player, 0) + ".\n\n", false);
    ...
    private rapeTheBeeGirlWithADick(): void {
        ...
        if (player.isTaur()) {
            ...
            outputText("The sweet substance causes your hindquarters to heat up. You feel your " + assholeDescript() + " pucker and " + sMultiCockDesc(game.player) + " grow, dripping pre onto the ground. At the same time, your thoughts start to get fuzzy and you have to fight off the sensation to throw the bee down and fuck her wildly.\n\n", false);
            ...
            if (player.cockArea(x) <= monster.vaginalCapacity()) {
                ...
                outputText("The sensation is incredible; her muscles spasm and milk your " + cockDescript(game.player, x) + " while the object in your " + assholeDescript() + " (which you think is probably her ovipositor) begins pumping fluids into you, all while your genitals are vibrated unceasingly.", false);
                // Has testicles:
        ...
        // Male 2
            ...
            outputText("Letting go of her arms, you grip the base of her abdomen for leverage and let her arms and legs slide around you as your pace increases. You feel her abdomen pressing against your rear as you drive into her, the pressure in your " + ballsDescriptLight() + " building as her pussy tightens around you. With a groan you cum, your hot seed gushing inside of her. She clenches you tightly, her pussy milking your " + cockDescript(game.player, x) + " for every ounce, until the sticky white fluid is pouring from around your " + cockDescript(game.player, x) + ". Exhausted from the battle and the fuck, she relaxes and collapses on the ground, panting heavily and half-conscious.", false);
            player.orgasm();
            cleanupAfterCombat();
        }
    }
    ...
    private rapeABeeGirlWithYourVagina(): void {
        ...
        if (player.isTaur()) {
            ...
            outputText("You make your intentions clear by sliding the " + player.armorName + " from your torso and stroking your " + chestDesc(game.player) + ". As you slide your hands around your chest and play with your " + nippleDescript(0) + "s, you begin to moan sensually. Your own ministrations cause your " + vaginaDescript(0) + " to heat up and you feel small dribbles of femcum slowly slide down your hind legs. Responding to your arousal, your tail starts to wave about on its own to spread your musky scent and your " + assholeDescript() + " begins to open and close.\n\n", false);
    ...
    private futaRapesBeeGirl(): void {
        ...
        else outputText("as you disrobe, revealing your " + allBreastsDescript(player) + ", " + vaginaDescript(0) + ", and " + multiCockDescriptLight(game.player) + ".  ", false);
        ...
        // BALLZ
        if (player.balls >= 2) {
            if (player.ballSize < 5) outputText("Your " + ballsDescriptLight() + " droop into her eyes, blinding and humiliating her in equal measure.  ", false);
