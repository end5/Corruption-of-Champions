    ...
    if (player.isTaur()) {
        ...
        if (player.HP < 1) {
            ...
            // [Herm:
                ...
                outputText("The sensations prove too much for your massively engorged " + Appearance.cockNoun(player.cocks[0].cockType) + " and sopping " + vaginaDescript(player, 0) + " to take and you begin to shake violently, incapable of touching it as one is trapped underneath you with the weight of the bee-girl preventing you from getting the leverage needed to hump the hard ground and the other is hopelessly out of reach.\n\n", false);
        ...
        // Lust:
            ...
            // [Herm:
                ...
                outputText("The sensation proves too much for your massively engorged " + Appearance.cockNoun(player.cocks[0].cockType) + " and " + vaginaDescript(player, 0) + " to take and you begin to shake violently, incapable of touching it as one is trapped underneath you with the weight of the bee-girl preventing you from getting the leverage needed to hump the hard ground and the other is hopelessly out of reach.\n\n", false);
...
function beeGirlRapeForTheDistinguishedGentleman(): void {
    ...
    // [(if dick)
    if (player.cocks.length > 0) outputText("stroke your " + Appearance.cockNoun(CockTypesEnum.HUMAN), false);
...
function beeAlternate(): void {
    ...
    if (rand(2) == 0) {
        ...
        if (player.cocks.length >= 3) {
            outputText("  Her battered " + Appearance.vaginaDescript(monster, 0) + " grips down on your dual " + multiCockDescriptLight(game.player) + "s tightly, draining you of every drop she can.  Rivers of white begin to leak from her abused holes and mingle with her own release as it trails down her abdomen and drips off it slowly onto the forest floor.", false);
