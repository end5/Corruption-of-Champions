...
export class BeeGirlScene {
    ...
    private beeEncounterSelect(clearScreen: boolean = true): void {
        ...
        const isBeeMorph: boolean = player.race() == "bee-morph";
    ...
    private beeEncounterAfraidRepeatSex(): void {
        ...
        if (player.cocks.length > 0) {
            outputText("gently running her fingers along your " + multiCockDescriptLight(game.player) + " bringing " + (player.cocks.length > 1 ? "them" : "it") + " to full hardness" + (player.hasVagina() ? ", " : " and "));
        }
        if (player.hasVagina()) {
    ...
    */
    ...
    public rapeTheBeeGirl(): void {
        ...
        if (player.cor >= 75 && player.str >= 60 && (player.tongueType == TONUGE_SNAKE || player.cocks.length > 0 || player.hasVagina() || player.biggestTitSize() >= 4)) {
    ...
    private rapeTheBeeMultiCockStuff(): void {
        ...
        if (player.cocks.length >= 5 && player.biggestTitSize() > 2
    ...
    private rapeABeeGirlWithYourVagina(): void {
        ...
        if (player.isTaur()) {
            ...
            // [Fuckable nipples:
            if (player.hasFuckableNipples()) outputText("  Not even repeated penetration of your " + nippleDescription(player, 0) + "s seems to bring the relief you need.", false);
            outputText("\n\n", false);
            ...
            // [Breasts >D:
            if (player.biggestTitSize() > 4) outputText("Her legs release your head and she falls back, knocking into your " + allBreastsDescript(player) + " and causing them to jiggle lewdly. You grab her before she hits the ground, surprised at how light she is.", false);
            // [Breasts <=C:
    ...
    private futaRapesBeeGirl(): void {
        ...
        if (player.breastRows.length > 0) {
            if (player.biggestTitSize() >= 2) outputText("You free a hand to tend to your " + allBreastsDescript(player) + " and aching nipples, alternating between squeezing your female flesh and tugging on your erect nipples.  ", false);
        }
        outputText("\n\n", false);
        // New PG
    ...
    private beeGirlRapeForTheDistinguishedGentleman(): void {
        ...
        else if (player.hasVagina()) outputText("rub your " + vaginaDescript(player, 0), false);
        ...
        if (player.cocks.length > 0 || player.lactationQ() >= 100 || player.wetness() >= 5) outputText(" and spray your sticky fluids all over her tortured groin", false);
        outputText(".\n\n", false);
