...
export class BeeGirlScene {
    ...
    private beeEncounterAfraidFirstTimeSex(): void {
        ...
        if (cockIndex >= 0) {
            if (player.hasVagina()) {
                outputText("You smile at her as she examines your " + game.player.multiCockDescriptLight() + " and your " + vaginaDescript(0) + " and ask her which of your toys she wants to play with.  She looks up at you and licks her luscious black lips before whispering to you, <i>“Both.”</i> and pushes you onto your back.  In a flash she is hovering over top of you, upside down.  She takes a firm hold of your " + game.player.multiCockDescriptLight() + " and gives it a few initial strokes while simultaneously using her long flexible tongue to probe and explore your " + vaginaDescript(0) + ".  Astounded by the talents of this bee girl, you can do nothing but push yourself up against her, desperate for more of this incredible stimulation.\n\n");
                outputText("The handmaiden seems to think that you need more stimulation too.  She promptly buries her face and tongue as far inside your " + vaginaDescript(0) + " as possible, while simultaneously bringing your " + game.player.cockDescript(0) + " to her exotic breasts and crushing it between them.  You cry out in dismay and grip the petals of the giant flower you’re spread eagle on.  You look up at your bee lover, who is now hovering at about a forty five degree angle above you while kicking her lower legs back and forth in amusement.  Soon she starts to pump her body up and down to stimulate your " + game.player.cockDescript(0) + " trapped between her love pillows, while also maneuvering her long insectoid tongue around inside your " + vaginaDescript(0) + ".\n\n");
            ...
            outputText("  Your unearthly partner proceeds to use one hand to massage and tweek your " + clitDescript() + ", while the other moves to play with your " + game.player.chestDesc() + ".  Not wanting to be left behind, you bring your own ministrations into the mix on the bee girl’s own chest, and her currently neglected honeypot.  In moments, she gasps from the multitude of different sensations, and grabs onto your body in the same way you just were holding onto hers.\n\n");
    ...
    private beeEncounterAfraidRepeatSex(): void {
        ...
        if (player.hasCock()) {
            outputText("gently running her fingers along your " + game.player.multiCockDescriptLight() + " bringing " + (player.cocks.length > 1 ? "them" : "it") + " to full hardness" + (player.hasVagina() ? ", " : " and "));
        }
        if (player.hasVagina()) {
    ...
    private beeEncounterWithExgartuan(): void {
        outputText(", bending into a smile as she sees you approach.  Standing, she welcomes you in, her wings giving a small buzz as her arms spread open for a welcoming embrace.\n\n");
        if (rand(2) == 0) {
            outputText("Your " + game.player.cockDescript(0) + " wriggles free of your " + player.armorName + ", as you keep walking forward.  A bodiless voice yells, \"<i>Honeypot, honeypot, ME LOOOOVE HONEYPOOOOOT!</i>\"\n\n");
            outputText("The bee-girl's eyes widen at the sight, shocked by your over-endowed form being dragged towards her as if there were a magnet in your " + game.player.cockDescript(0) + ".  She presses herself against the flower's petals, terrified and afraid to put up any meaningful resistance.  The nagging voice pipes up, \"<i>So are we gonna rape her or what, " + player.short + "?  I need some honeyyy!</i>\"\n\n");
            ...
            outputText("The bee-girl's eyes widen at the sight,  shocked by your over-endowed form being dragged towards her as if there were a magnet in your " + game.player.cockDescript(0) + ".   She flutters into the air and aims her stinger towards you, ready to fight!");
            // start combat
        ...
        if (player.isTaur()) {
            ...
            if (player.longestCockLength() >= 100 || player.gender == 0) {
                ...
                if (player.gender == 1) {
                    ...
                    outputText("your engorged " + game.player.multiCockDescriptLight() + " and jerk it off violently, cumming again and again as the bee-girl violates your " + assholeDescript() + ".  ", false);
                    // [Without testicles:
                ...
                // [Herm (bypasses the bucking scene):
                    ...
                    outputText("You grasp your engorged " + game.player.multiCockDescriptLight() + " and jerk it off violently, cumming again and again as the bee-girl violates your " + assholeDescript() + " and your " + vaginaDescript(0) + " pumps out enough femcum to drench your hind legs.  ", false);
                    // [Without testicles:
                    ...
                    if (player.cumQ() < 100) outputText("You spurt out more cum than you thought your " + ballsDescriptLight() + " could hold. White speckles the base of the tree and tiny puddles form underneath you as you groan in satisfaction.\n\n", false);
                    // [Huge cum amount:
                    else outputText(game.player.SMultiCockDesc() + " goes off like a firehouse, coating the base of the tree along with a number of the ones behind it. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                }
            ...
            // Route 1
                ...
                // [Male:
                if (player.gender == 1) outputText("Your inability to reach your engorged " + game.player.multiCockDescriptLight() + " quickly becomes a problem as the pleasure from the bee-maiden's scent courses through you. You ache to be tended to, gushing out pre.", false);
                // [Female:
                ...
                // [Herm:
                else if (player.gender == 3) outputText("Your inability to reach your engorged " + game.player.multiCockDescriptLight() + " quickly becomes a problem as the pleasure from the bee maiden's scent courses through you. It aches to be tended to, gushing out pre. Your " + clitDescript() + " quivers, desperate for contact as your vagina starts reflexively rippling, trying to milk the cock it isn't going to get.", false);
                // [With breasts:
                if (player.biggestTitSize() > 1) {
                    outputText("  You begin pounding away at your " + game.player.allBreastsDescript() + " in an attempt to alleviate the pressure in your inaccessible groin.", false);
                    // [Fuckable breasts:
                ...
                // [Male:
                if (player.gender == 1) {
                    outputText("Her legs wrap around your body and her 'feet' clasp onto your " + game.player.multiCockDescriptLight() + ". The strangeness of the sensation doesn't register though as just the contact is enough to send you over the edge.  ", false);
                    // [Without testicles:
                    if (player.balls == 0) outputText("You cum violently, your " + game.player.multiCockDescriptLight() + " quivering and spasming.  ", false);
                    // [With testicles:
                    else outputText("You cum violently, your " + game.player.multiCockDescriptLight() + " quivering and spasming while semen erupts from the tip.  ", false);
                    // [Little-normal cum amount:
                ...
                // [Herm:
                    ...
                    // [Same as female followed by:]
                        ...
                        outputText("Thinking you're still not satisfied, she lowers her 'feet' slightly and she begins to rub your " + game.player.multiCockDescriptLight() + ".  ", false);
    ...
    */
    ...
    private seduceBeeGirl(): void {
        ...
        if (player.gender == 3) {
            ...
            outputText("Pulling back, she releases your " + game.player.cockDescript(0) + ", now slick with her saliva. She lies on her back, her legs spread wide with he abdomen laying flat against the ground. Her hands urge you forward, and you follow immediately. Her body is soft and accepting, and you quickly slide the head of your " + game.player.cockDescript(0) + " into her pussy lips, a mutual moan escaping from both of your lips. Pushing further in, the bee-girl wraps her arms around you, holding you against her as you begin to thrust. Each push makes her wetter, the slickness making your cock slide faster and faster. She arches her back and you feel the tip of her stinger against your " + vaginaDescript(0) + ". Before you can protest, it pushes in, gently but quickly, until it pierces your cervix.\n\n", false);
    ...
    public beeRapesYou(): void {
        ...
        if (player.isTaur()) {
            ...
            if (player.HP < 1) {
                ...
                outputText("With you thoroughly incapacitated, she walks up to your front and smears your " + game.player.chestDesc() + " with honey. The scent wafts up to your nose and your mind begins to go blank. Your tongue tries to reach for the sweet substance, but can't. You whimper at her, desperate for the taste of the mind altering honey. She obliges you by splashing some onto your face and you quickly begin lapping at it with your tongue.\n\n", false);
                // Male with testicles:
                if (player.gender == 1 && player.balls > 0) {
                    outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + game.player.sMultiCockDesc() + " to go rock hard.\n\n", false);
                    ...
                    outputText("Chitin covered arms begin stroking and scraping at you as you close your eyes as hard as possible, having exhausted your face of the mind numbing honey. Your pain and lust filled mind comes up with an idea and you quickly act; rubbing your sticky " + game.player.chestDesc() + " against the tree before swinging your head down violently and gnawing at it.\n\n", false);
                ...
                // [Herm:
                    ...
                    outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + game.player.sMultiCockDesc() + " to go rock hard and your " + vaginaDescript(0) + " to squirt fluid behind you.\n\n", false);
            ...
            // Lust:
                ...
                outputText("She tests the insides of your ass for a bit before pulling her arm out and your hind legs start to quake as your desires aren't satisfied. You feel her stroke your hindquarters, encouraging you to lie down. You happily do so, using the tree as support.  With you safely down, she walks up to your front and smears your " + game.player.chestDesc() + " with honey. The scent wafts up to your nose and your mind begins to go blank. Your tongue tries to reach for the sweet substance, but can't. You whimper at her, desperate for the taste of the mind altering honey. She obliges you by holding a handful of the thick elixir to your mouth and you lap at it eagerly. Once you've consumed a fair amount she spreads more onto your face and giggles cutely as you stretch your tongue to lick at it.\n\n", false);
                // [Male with testicles:
                if (player.gender == 1 && player.balls > 0) {
                    outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + game.player.sMultiCockDesc() + " to go rock hard.\n\n", false);

                    outputText("She can't see that, of course, and busies herself with inserting her ovipositor into your " + assholeDescript() + ". Its thick lubrication allows it quick entrance, and soon she's pumping her fluids into your bowels. The sensation proves too much for your massively engorged " + game.player.multiCockDescriptLight() + " to take and you begin to shake violently, incapable of touching ", false);
                    ...
                    outputText("She continues pumping into you as you pass out, " + game.player.sMultiCockDesc() + " and " + ballsDescriptLight() + " aching.  The combined scent of cum and honey completely overwhelms you.", false);
                }
                // [Male without testicles:
                    ...
                    outputText("She continues pumping into you as you pass out, " + game.player.sMultiCockDesc() + " aching and the scent of honey overwhelming you.\n\n", false);
                }
                // [Female:
                else if (player.gender == 2) {
                    outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing your " + vaginaDescript(0) + " to squirt fluid behind you.\n\n", false);
                ...
                // [Herm:
                    ...
                    outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + game.player.sMultiCockDesc() + " to go rock hard and your " + vaginaDescript() + " to squirt fluid behind you.\n\n", false);
                    ...
                    outputText("She seems to understand your problem though and, wanting to help you with your needs, begins to massage your " + vaginaDescript() + " with her 'feet' while periodically stroking the back of your " + game.player.cockDescript(0) + ".\n\n", false);
    ...
    public rapeTheBeeGirl(): void {
        ...
        if (player.hasCock()) {
            outputText("(You could fuck her with " + game.player.oMultiCockDesc() + ".)\n", false);
            cock = rapeTheBeeGirlWithADick;
        }
        if (player.cockTotal() > 1) {
            outputText("(You could use more than one of your " + game.player.multiCockDescriptLight() + " on her.)\n", false);
    ...
    private rapeTheBeeMultiCockStuff(): void {
        ...
        if (player.cockTotal() >= 5 && player.biggestTitSize() > 2
            ...
            outputText("As you approach, she starts to edge away, her battered wings flapping in a futile attempt to escape.  Reaching her, you grip her wrists before she can fight back, squeezing tightly as her struggling increases. Forcing her onto her back, you hold her wrists tightly in one hand to allow you to pull off your " + player.armorName + ", freeing your " + game.player.multiCockDescript() + " and " + vaginaDescript(0) + ".  She gasps at the alien sight of your multiple 'stingers', while you take a moment to decide what's going to go where.\n\n", false);
            outputText("You shift a bit upward, your brace of " + game.player.multiCockDescriptLight() + " sliding above the bee-girl's slick honey pot.  For a moment she breathes a sigh of relief, then gasps as two of your manhoods press against her front and back doors at once.\n\n", false);
            ...
            outputText("Unhindered, you start to fuck her.  Her pussy tightens and convulses around your " + game.player.cockDescript(0) + ", her ample honey dribbling down onto your lowermost shaft and adding a little more lube on every thrust into the tight heat of her ass.  Her whimpers turn to moans, her scent shifting from fear to lust as the bee-girl discovers the unexpected pleasure of being reamed in both holes at once.  You keep your breathing steady, listening to her moans grow more lustful with every thrust and more needy every time you pull back in preparation for another.  Soon you've fucked all thought of resistance out of her, in favor of squealing with glee every time your mighty cock forces a little deeper into her tight honey pot.\n\n", false);
            outputText("Letting go of her arms, you grip the base of her abdomen for leverage and let her arms and legs slide around you as your pace increases.  You show her how to press her breasts together against your " + game.player.cockDescript(0) + ", and she obliges, rubbing them back and forth as you fuck her.  With your jiggling breasts added to the mix, it becomes even more enjoyable, your " + game.player.breastDescript(0) + " mashing against hers.  The milk leaking out of your immense jugs runs down your bodies and adds further to the ocean of fluids forming between your hips.\n\n", false);
        ...
        if (player.cockTotal() == 2 && rand(2) == 0) {
            outputText("The bee-girl turns around, scampering across the floor to try to escape. As you close in to your prey you can feel your " + game.player.multiCockDescriptLight() + " harden and rise up at the sight of her form and you swiftly grab on to her abdomen and hold fast. She screams in futility as you flip her over and greedily look across her body.\n\n", false);
            outputText("Forcing her onto her back, you hold her wrists tightly in one hand to allow you to pull off your " + player.armorName + ", freeing your " + game.player.multiCockDescriptLight() + ". The bee-girl opens her eyes for a scant moment and realizes what's about to happen. She tries one more time to plead for you to let her escape as your " + game.player.multiCockDescriptLight() + " slide up and down against her nectar-drenched pussy lips. Your grin widens as you penetrate her roughly in one savage stroke, taking her with one of them. Screaming and squirming, the bee-girl struggles.  Your right hand braces against her flapping arms to settle them to the ground as you push in once again. Letting her know just how little control she has against your will, you lean forward, planting her hands against the ground and licking her cheek as your " + game.player.multiCockDescriptLight() + " push up deep inside her. Looking into her eyes, you see a faint glimmer of defiance, and under your body you feel her shifting slightly, muscles growing firm and tense. The realization hits you, and you manage to shift before her stinger comes into contact with you. Moving your knee, you pin her thick ", false);
            ...
            outputText("You decide that it's time to bring your other gift into play. Atop the bee-girl you fire in one more stroke of your " + game.player.cockDescript(0) + " and then you run your free hand from her black lips across her breast and across her abdomen before you rest it on her clit. You tweak her sensitive spot along with the strokes from your intruding member and then when the rush of nectar and cum juices from her pussy seem up to the task you grab hold of your other " + game.player.cockDescript(1) + " and forcefully ram it into her pussy right below your first entry.\n\n", false);
    ...
    private rapeTheBeeGirlWithADick(): void {
        ...
        if (player.isTaur()) {
            ...
            outputText("Pulling back, you consider her for a moment. She watches as you slip out of your " + player.armorName + ", licking her lips at the sight of your " + game.player.chestDesc() + ". Once your torso is free you reach down again and pick up the bee maiden. She's surprisingly light and you lift her with ease, feeling her legs wrap around you as you hug and kiss her.\n\n", false);
            ...
            outputText("The sweet substance causes your hindquarters to heat up. You feel your " + assholeDescript() + " pucker and " + game.player.sMultiCockDesc() + " grow, dripping pre onto the ground. At the same time, your thoughts start to get fuzzy and you have to fight off the sensation to throw the bee down and fuck her wildly.\n\n", false);
            ...
            if (player.cockArea(x) <= monster.vaginalCapacity()) {
                outputText("She looks under your arm toward your manhood and seems delighted by the sight of your " + game.player.cockDescript(x) + ". Her body swings about your torso with the help of her wings and she crawls down your back toward your rear. You lift your tail and allow the bee maiden to examine your " + assholeDescript() + ", sliding her fingers around the edge and teasing at it.", false);
                // Has testicles:
                if (player.balls > 0) outputText("  Her other hand slides down and begins to massage your " + ballsDescriptLight() + ", squeezing and tugging gently at your scrotum. Her tongue joins them, sliding in and out of your ass before wrapping around your sack. You feel incredible and your " + game.player.cockDescript(x) + " drips pre, forming a puddle on the ground.", false);
                // No testicles:\
                else outputText("Her other hand starts pulling it open and soon her tongue joins them, sliding in and out of your ass delicately. Your " + game.player.cockDescript(x) + " quivers with anticipation and you swish your tail happily.", false);
                outputText("\n\n", false);
                ...
                outputText("You get your answer as a hot, wet, vice wraps around your " + game.player.cockDescript(x) + " and whatever is inside your ass pushes slightly further in. It feels good, but you know that even with her surprising strength she wouldn't be able to hold on if you tried driving into her. Thinking this defeats the purpose somewhat you're about to propose that some other arrangement be considered when she starts to buzz.\n\n", false);
                ...
                outputText("The sensation is incredible; her muscles spasm and milk your " + game.player.cockDescript(x) + " while the object in your " + assholeDescript() + " (which you think is probably her ovipositor) begins pumping fluids into you, all while your genitals are vibrated unceasingly.", false);
                // Has testicles:
            ...
            // Cock too long to penetrate her:
                ...
                outputText("She looks under your arm toward your manhood but seems disappointed at your " + game.player.cockDescript(x) + "'s large size. . Her body swings about your torso with the help of her wings and she crawls down your back toward your rear. You lift your tail and allow the bee maiden to examine your " + assholeDescript() + ", sliding her fingers around the edge and teasing at it. Her tongue licks at you but you can tell her mind is elsewhere and you wonder what the problem is.\n\n", false);
                ...
                outputText("She doesn't though, as with a buzz her body swings about beneath you. As she slides sideways, one arm is pulled off for a moment, long enough to catch your " + game.player.cockDescript(x) + " between her body and your own, before catching onto your other flank. Her abdomen slides up behind your rear legs and you feel something latch onto your " + assholeDescript() + ", but are unable to do anything about it or even see what it is.\n\n", false);
                ...
                outputText("Your " + game.player.cockDescript(x) + " feels wonderful though, pumping out fluid and swelling with more and more blood.", false);
                // Has testicles:
                ...
                if (player.tallness * (5 / 6) < player.cocks[player.longestCock()].cockLength) {
                    outputText("  Her tongue wraps around your " + game.player.cockDescript(x) + " and starts jerking off the small section it can reach. The wet ring feels amazing and you decide to help her efforts by gripping the head of your member and playing with it yourself. Soon though, your cock trembles as the familiar sensation of orgasm begins creeping up on you.", false);
                }
                // Other cocks:
                else outputText("  Her tongue wraps around your " + game.player.cockDescript(x) + " and slides up and down the small area it can reach before flicking about at the tip of your urethra. Her expert licking feels amazing and it's not long before your feel the familiar sensation of orgasm creeping up on you.", false);
                outputText("\n\n", false);

                outputText("With all the combined sensations your " + game.player.cockDescript(x) + " begins to unload. ", false);
                ...
                outputText("\n\nShe releases you from her grasp and lands with a wet thud on the ground. Looking down, you see that her vibrating against your " + game.player.cockDescript(x) + " was enough to get her off, a lot. She's lying in a puddle of mixed sexual fluids and honey, unconscious after what must have been an extreme effort on her part.", false);
            ...
            if (player.isTaur()) outputText("as your " + game.player.cockDescript(x) + " hardens under your belly.", false);
            else outputText("as you disrobe, revealing your " + game.player.cockDescript(x) + " to her.", false);
            ...
            if (player.cockTotal() == 2) outputText("cramming your " + game.player.multiCockDescript() + " into her, double-stuffing the poor bee-slut with your double dongs.  ", false);
            if (player.cockTotal() >= 3) outputText("cramming two out of your " + num2Text(player.cockTotal()) + " " + game.player.multiCockDescript() + "s into her, double-stuffing the poor bee-slut with double the dicks.  ", false);
            ...
            // sex
            outputText("You begin pounding away at her, splattering honey over her thighs with your enthusiastic fucking.  Her passage is unlike anything you've ever had before.  It's tight, but overly slick and textured with small nubs and bumps that tease and caress in wonderful ways.   Her muscles clamp and squeeze her vaginal entrance tightly, turning it into an organic cock-ring.  You hold still while her cunt begins twitching and slightly rotating back and forth around your " + game.player.cockDescript(x) + ".    Her head is thrown back in what you assume is an orgasm, her arms mashing her tits together for even more pleasure.  The vacuum seal around your " + game.player.cockDescript(x) + " only gets tighter as her rippling, squeezing, twisting cunt stimulates your over-engorged " + game.player.cockDescript(x) + ".\n\n", false);
            // cum
        ...
        // Male 2
            ...
            outputText("You begin to push forward, sliding your " + game.player.cockDescript(x) + " against the soft folds of her pussy, her whimpers shifting gently into moans. Your grin widens as you penetrate her roughly in one strong stroke, the bee-girl's body tensing underneath you as a squeal leaves her lips. Looking into her eyes, you see a faint glimmer of defiance, and under your body you feel her shifting slightly, muscles growing firm and tense. The realization hits you, and you manage to shift before her stinger comes into contact with you. Moving your knee, you pin her thick abdomen down and remove the threat.\n\n", false);
            outputText("Unhindered, you start to fuck her. Her pussy tightens and convulses around your cock, becoming slick with her juices and your pre-cum. You can smell the sickly combination of nectar, sweat and love juices hanging thickly in the air. Your breathing becomes heavy while her moans get deeper and lust-filled. Her reluctance evaporates, her struggling shifts into more receptive movements against your body, her hips rocking against yours with each thrust, forcing your " + game.player.cockDescript(x) + " deeper into her tight honeypot.\n\n", false);
            outputText("Letting go of her arms, you grip the base of her abdomen for leverage and let her arms and legs slide around you as your pace increases. You feel her abdomen pressing against your rear as you drive into her, the pressure in your " + ballsDescriptLight() + " building as her pussy tightens around you. With a groan you cum, your hot seed gushing inside of her. She clenches you tightly, her pussy milking your " + game.player.cockDescript(x) + " for every ounce, until the sticky white fluid is pouring from around your " + game.player.cockDescript(x) + ". Exhausted from the battle and the fuck, she relaxes and collapses on the ground, panting heavily and half-conscious.", false);
            player.orgasm();
            cleanupAfterCombat();
        }
    }
    ...
    private rapeABeeGirlWithYourVagina(): void {
        ...
        if (player.isTaur()) {
            ...
            outputText("You make your intentions clear by sliding the " + player.armorName + " from your torso and stroking your " + game.player.chestDesc() + ". As you slide your hands around your chest and play with your " + nippleDescript(0) + "s, you begin to moan sensually. Your own ministrations cause your " + vaginaDescript(0) + " to heat up and you feel small dribbles of femcum slowly slide down your hind legs. Responding to your arousal, your tail starts to wave about on its own to spread your musky scent and your " + assholeDescript() + " begins to open and close.\n\n", false);
    ...
    private futaRapesBeeGirl(): void {
        ...
        if (player.isTaur()) outputText("as you idly fondle your " + player.allBreastsDescript() + " as you feel your blood-gorged " + game.player.multiCockDescriptLight() + " swaying under your belly.  ", false);
        else outputText("as you disrobe, revealing your " + player.allBreastsDescript() + ", " + vaginaDescript(0) + ", and " + game.player.multiCockDescriptLight() + ".  ", false);
        ...
        outputText("Happy with your victim's compliance, you grind harder into her face.  Allowing your hands a bit of freedom, you begin to stroke your already erect " + game.player.cockDescript(0), false);
        ...
        outputText("You nearly bounce off her in alarm as her tongue probes deep, pressing against and penetrating your cervix in one slippery stroke.  Being licked from the inside out makes you squeal with equal parts surprise and pleasure, and you mash your " + vaginaDescript(0) + " harder against her in response.  Your hands masturbate your " + game.player.multiCockDescriptLight() + " in time with her licks, the speed gradually increasing to keep pace with the fire of your ever-growing lust.  ", false);
        if (player.cumQ() >= 100) {
            outputText(" More and more pre begins to drip from your " + game.player.cockDescript(0) + ", soaking your ", false);
        ...
        if (player.cumQ() < 25) {
            outputText("You erupt, your " + game.player.cockDescript(0) + " pulsing and spraying ribbons of cum.  You milk your dick hard, pistoning your hand up and down mercilessly, trying to squeeze out every drop.  You watch each burst splatter into the bee-girl's hair and grin cruelly.  ", false);
        ...
        if (player.cumQ() >= 250 && player.cumQ() < 500) {
            outputText("Your " + game.player.cockDescript(0) + " erupts, writhing in your hands from the force of your orgasm as thick ropes of cum burst from you.   Each pulse of juice seems to drag on and on, each nearly as long as a normal man's orgasm.  Looking down, you see the bee's hair and face totally slimed with your cum, and a puddle forming below her.  ", false);
            ...
            outputText("Your " + game.player.cockDescript(0) + " flexes powerfully with each load, until your victim is soaked from the waist up, her breasts and face plastered with goo.  You sigh contentedly and step away, watching the bee scoop up your leavings in both hands, one going to her mouth, the other to her sweet wet snatch.  Giggling to yourself, you walk away, sated.", false);
        }
        if (player.cumQ() >= 500) {
            outputText("Your " + game.player.cockDescript(0) + " erupts like a volcano, shooting a constant thick stream of cum that pulses with each clench of your pelvic muscles.  The pressure only seems to increase as your urethra tries to deal with the huge load your body is producing.  ", false);
    ...
    private beeGirlRapeForTheDistinguishedGentleman(): void {
        ...
        // (if penis)
            ...
            outputText("Seeing the girl's resistance end in an eye-rolling gasp, you decide to get in on the fun too.  With some difficulty you unfasten and shed the bottoms of your " + player.armorName + " with your one free hand and maneuver your " + game.player.cockDescript(0) + " to her now-gushing honeypot.  Considering there's enough foreplay going on with her ovipositor to wet her enough for a minotaur, you unceremoniously slam your " + game.player.cockDescript(0) + " into her.", false);
    ...
    private beeAlternate(): void {
        ...
        if (rand(2) == 0) {
            ...
            // CONTINUE
            outputText("You enjoy loosening the girl up and exploring the depths of her cunt, taking your time.  Eventually, you draw yourself out of her, your " + game.player.cockDescript(x) + " escaping with a wet, slurping sound, dragging a thick drool of honey in its wake.  Taking a moment to inspect your handiwork, you see her pussy gapes wantonly, stretched out of shape by your shaft.", false);
            // New PG
            outputText("\n\n", false);
            // 2nd cock love
            outputText("Taking your slightly smaller " + game.player.cockDescript(y) + " in hand, you slip it in as a replacement.  She's not as tight as she was, poor dear, but just as warm and twice as slick as she was for your first " + game.player.cockDescript(x) + ".  Your larger " + game.player.cockDescript(x) + " slides along the side of her ass, painting the black-and-yellow fur there with her honey and matting it down.  But that's less than satisfying, and glancing down, you notice she has a hole back here that's not getting used.  ", false);
            outputText("Withdrawing from her once more, you set the tip of your largest " + game.player.cockDescript(x) + " against the pucker of her ass.  She squeals and bucks as you press against her sphincter, but it's not long before the ring of muscle surrenders and your honey-soaked " + game.player.cockDescript(x) + " slides into her body.  She whimpers in humiliation, hands clawing at the grass as she shifts her hips to try to get more comfortable around your thickness.  You root around in the exquisite tightness of her ass, enjoying the way she shifts and wriggles under and around you.", false);
            // New PG
            outputText("\n\n", false);
            outputText("Drawing nearly, but not entirely, out of her, you take up your next largest cock and set it back at the entrance of her pussy again, and then thrust with your hips, sinking your largest deep into her ass while spearing her once more, burying your " + game.player.cockDescript(y) + " in her pussy.  She squeals loudly, wings flapping wildly a moment, then goes utterly limp with a whimper of surrender.  Grinning broadly, you begin to piston in and out of her, the sweet perfume of her lust wreathing your nostrils.  The plundering of her nether-regions fills the air with wet, slurping sounds, and soon she is moaning in time with every thrust, antennae quivering with need.  ", false);
            ...
            if (player.cocks.length >= 3) {
                outputText("  Her battered " + Appearance.vaginaDescript(monster, 0) + " grips down on your dual " + game.player.multiCockDescriptLight() + "s tightly, draining you of every drop she can.  Rivers of white begin to leak from her abused holes and mingle with her own release as it trails down her abdomen and drips off it slowly onto the forest floor.", false);
                if (player.cocks.length == 4) outputText("  The " + game.player.cockDescript(3) + " not inside her shakes wildly as you cum; jets of your semen let loose over her abused frame, coating her in white.", false);
                if (player.cocks.length > 4) outputText("  The " + game.player.multiCockDescriptLight() + "s not inside her shake wildly as you cum; jets of your semen let loose over her abused frame, coating her in white.", false);
            }
            // New PG
            outputText("\n\n", false);
            outputText("The both of you smell like sex as you pull free of her with a groan.  You move to kneel over her and use her unstained lips to dry your " + game.player.multiCockDescriptLight() + " one by one.  Her lips part slightly on instinct and you can feel her swallow the globs of jism that coat you.  Once she's done you stand up quickly, ", false);
            if (player.lowerBody != LOWER_BODY_TYPE_CENTAUR) outputText("stuffing your " + game.player.multiCockDescriptLight() + " inside your " + player.armorName, false);
            else outputText("your glorious but spent " + game.player.multiCockDescriptLight() + " dangling under your belly,", false);
    ...
    private nagaRapesPt2TheExtremeContinuationOfAwesome(): void {
        ...
        if (player.gender == 1 || (player.gender == 3 && rand(3) == 0)) {
            ...
            outputText("your " + game.player.multiCockDescriptLight());
            ...
            outputText("your " + game.player.multiCockDescriptLight() + ", slurping soundly and driving you wild; ", false);
            ...
            outputText("even when she takes your " + game.player.cockDescript(0) + " to the hilt, her eyes straining up in their sockets. You watch " + int(player.cocks[0].cockLength) + " inches of " + game.player.cockDescript(0) + " disappear inside her mouth, and the vibrations in her throat tell you that you'd hear her cooing if it wasn't packed tight.\n\n", false);
        ...
        // [Player is herm]
            ...
            outputText("Touching a single index finger to the underside of your captive's chin, you pull with the slightest of forces and watch as she is dutifully drawn to your " + game.player.multiCockDescriptLight() + ", running her lengthy prehensile tongue up and down ", false);
            if (player.cockTotal() > 1) outputText("each of your shafts", false);
            else outputText("your shaft", false);
            outputText(". As the pulsing movement inside your body draws you slowly closer to orgasm, the bee-bitch uses her other hand to draw your " + game.player.cockDescript(0) + " down to an angle so it slides neatly into her throat", false);
            // [if Player cock => 12\"]
