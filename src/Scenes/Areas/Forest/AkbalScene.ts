...
export function akbalDefeated(hpVictory: boolean): void {
    ...
    } else // [Victory via Lust]
    {
        ...
        if (player.lust >= 33 && player.gender > 0) {
            ...
            if (player.vaginas.length > 0 && player.breastRows.biggestTitSize() >= 4 && player.armor instanceof LustyMaidensArmor)
...
function rapeAkbalForcedFemaleOral(): void {
    ...
    // Centaur RAPPUUUUU
        ...
        outputText("Akbal snarls as you shove him back first onto the forest ground.  You look down at him, fully prepared to have your way with his demon dick.  What you see causes your " + vaginaDescript(player, 0) + " to flinch at the thought of what would have happened if you had lost and the demon had used that on you.\n\n", false);
        ...
        outputText("Akbal gives a muffled scream at first but soon he gets the message. His tongue slithers into your " + vaginaDescript(player, 0) + ".  You lift yourself a little; well... you lean forward a bit to let the demon actually breath.  This proves to be the right choice as Akbal is ravenous for your " + vaginaDescript(player, 0) + ".\n\n", false);

        outputText("He drills his tonuge into you, mercilessly attacking your " + clitDescription(player) + " as you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get the weight of your body off of the rest of his face, but you grab his tender furry balls in your hand and he stops before you're forced to do something drastic.\n\n", false);

        outputText("After dropping a line about how he has to make you cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your " + vaginaDescript(player, 0) + ".\n\n", false);
    ...
    // Everybody else
        ...
        outputText("Your scent causes Akbal's growling to quiver.  You lay down before him, grabbing his head and smashing his furry lips into your " + vaginaDescript(player, 0) + ".  The demon, unable to escape his debilitating arousal, begins to lap at your " + vaginaDescript(player, 0) + ".  He twists his lips and drills his tongue into you, mercilessly attacking your " + clitDescription(player) + ", and you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get into position above you, but you force his face back down into your " + vaginaDescript(player, 0) + ".  After dropping a line about how he has to make your cum or get his head ripped off, Akbal whines, obviously distressed at not being able to slip his aching member into your " + vaginaDescript(player, 0) + ".\n\n", false);
...
function rapeAkbal(): void {
    ...
    if (player.lowerBody == LowerBodyType.NAGA) {
        ...
        if (player.cocks.length > 0) {
            ...
            if (player.cocks[primary].cockLength <= 7) {
                outputText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  First you poke it with your finger, causing Akbal to flinch at the sensation.  Taking your " + cockDescript(player, primary) + " in hand you shove in without hesitation or mercy.  The virginally-tight hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + cockDescript(player, primary) + " in and out of the demon's virginally-tight hole, relishing in the way it quivers and squirms around your embedded " + cockDescript(player, primary) + ".\n\n", false);
            }
            // (Md Penis: 8-12 inches)
            else if (player.cocks[primary].cockLength <= 12) {
                outputText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  A light tap of your finger causes the tiny hole to constrict in fear as Akbal's entire body flinches away from you.  You grab your " + cockDescript(player, primary) + " with a cruel smile.\n\n", false);

                outputText("As you shove your " + cockDescript(player, primary) + " into his tight pucker you are not surprised to find your " + cockDescript(player, primary) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n", false);

                outputText("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + cockDescript(player, primary) + " in and out of his pucker with force as the demon cat's howls range from pained to pleased.\n\n", false);
            }
            // (Lg Penis: 13 inches and up)
            else {
                outputText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  A short glance tells you your " + cockDescript(player, primary) + " won't fit... but since when has that stopped you from trying?\n\n", false);
            ...
            // (transition)
            outputText("You rape the jaguar demon's tight hole with steadily mounting force, your " + hipDescription(player) + " smashing into his body with freight train force and causing him to cry out.  Despite this his 15 inch swollen sex organ pumps pre beneath him, letting you know that his pain is mixed with plenty of unwilling pleasure.\n\n", false);

            // (With Fertility/Lots of Jizz Perk)
            if (player.cumQ() > 1000) {
                outputText("The crushing tightness of Akbal's quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  The jaguar demon erupts as well, his body convulsing in time with your still thrusting " + cockDescript(game.player, 0) + ".\n\n", false);
    ...
    // Centaur RAPPUUUUU
        ...
        if (player.cocks.length > 0) {
            ...
            // (Md Penis: 8-12 inches)
                ...
                outputText("As you shove your " + cockDescript(player, primary) + " forward into his virginally-tight pucker you are not surprised to find your " + cockDescript(player, primary) + " barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n", false);

                outputText("After a dozen achingly slow thrusts Akbal's asshole begins to loosen and you begin to saw your " + cockDescript(player, primary) + " in and out of his pucker.  The demon cat's howls range from pained to pleased, obviously enjoying his butt rape more than he is willing to admit.\n\n", false);
            }
            // (Lg Penis: 13 inches and up)
            else {
                outputText("Akbal snarls pitifully as you shove him stomach down against a log. Your " + cockDescript(player, primary) + " leaks at the thought of bringing this \"god\" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal's body jerks away in fear.  There's no way in hell your " + cockDescript(player, primary) + " can fit inside something so incredibly tight but... since when has that stopped you?\n\n", false);
    ...
    if (player.cocks.length > 0) {
        ...
        if (player.cocks.cockArea(0) < 13) {
            outputText("You first poke it with your finger, causing Akbal to flinch at the sensation.  Taking your " + cockDescript(game.player, 0) + " in hand, you shove it in without hesitation or mercy.  The virgin-like hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you're sawing your " + cockDescript(game.player, 0) + " in and out of the demon's tight hole, relishing in the way it quivers and squirms around your embedded " + cockDescript(game.player, 0) + ".\n\n", false);
        }
        // [Medium penis (8-12 inches)]
        else if (player.cocks.cockArea(0) < 25) {
            outputText("A light tap of your finger causes the tiny hole to constrict and Akbal's entire body flinches in fear.  You grab your " + cockDescript(game.player, 0) + " with a cruel smile.  As you shove yourself into his tight pucker, you aren't surprised to find that your " + cockDescript(game.player, 0) + " is barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n", false);
            outputText("After a dozen achingly slow thrusts, Akbal's asshole begins to loosen and you start sawing your " + cockDescript(game.player, 0) + " in and out of his pucker with force. The demon cat's howls fluctuate between yelps of pain and moans of pleasure.\n\n", false);
        }
        // [Large penis (13 inches and up)]
        else {
            outputText("A single look tells you your " + cockDescript(game.player, 0) + " won't fit... but since when has that stopped you from trying?  You slide a single finger against the virginally-tight hole and Akbal flinches. His already tight hole clamps shut in fear, as if doing so will somehow stop the inevitable intrusion.\n\n", false);
            outputText("You twist Akbal's tail into your fist and laugh as a scared whimper escapes from the jaguar demon's throat.  You begin to push your " + cockDescript(game.player, 0) + " in with one hand as you pull Akbal's tail with the other.  The demon whines and howls as you invade his clenching sphincter, forcibly stretching the tight pink hole to a dangerous degree.  You are halted all too soon, barely able to fit more than a foot of your " + cockDescript(game.player, 0) + " into Akbal's virginally-tight hole.  Deciding that's good enough, you pull out before pushing forward again, meeting the same resistance as before.\n\n", false);
            outputText("After what seems like hours of resistance and howling, Akbal's body shudders and his asshole relaxes from complete exhaustion.  Battling with your " + cockDescript(game.player, 0) + " seems to have nearly made him pass out, and he no longer has the energy to resist you.  The jaguar demon's body flinches with your every thrust as you pound him raw – without lube, and without mercy.\n\n", false);
        }
        ...
        // [With Fertility/Lots of Jizz Perk]
        if (player.cumQ() > 1000) {
            outputText("You continue to slide your still-swollen " + cockDescript(game.player, 0) + " inside his quivering hole as you pump massive tons of liquid into the false god's stomach and bowels.  Beneath the two of you, his belly begins to bulge as he is filled to a dangerous degree.\n\n", false);
...
function girlsRapeAkbal(): void {
    ...
    if (player.isTaur()) {
        ...
        if (player.cocks.length > 0)
            outputText(" " + sMultiCockDesc(game.player) + " hanging beneath, twitching in anticipation", false);
    ...
    // {If Pussy is <loose}
    else if (player.vaginalCapacity() < monster.cocks.cockArea(0)) {
        ...
        // {If Goo}
            ...
            outputText("Lifting up your " + leg(player) + ", you firmly place the sole of your foot against his barbed flesh, pressing it against his stomach, forcing the jaguar to let out a low moan which you quickly take advantage of, ", false);

        outputText("stuffing his own tail into his maw.  As he tries to push his tail back out, you remove your " + foot(player) + " pointedly, staring down at the demon. Lifting his hips back up weakly towards you, he meekly begins to suckle on his own appendage, closing his vibrant emerald eyes as you return your attention to his shaft.\n\n", false);
    }
    // {If Pussy >= Loose}
    else {
...
function girlsRapeAkbalPart2(): void {
    ...
    if (player.isTaur()) {
        ...
        if (player.cocks.length > 0)
            outputText(", " + sMultiCockDesc(game.player) + " swinging back and forth, occasionally bumping into his bound legs", false);
    ...
    // TOIGHT
        ...
        // -Page Turn-
        outputText("Judging the silky fur to be slick enough, you yank out the tail from his mouth, pulling it towards your " + vaginaDescript(player) + " lips, teasing your folds with the tip before guiding him in. Taking the hint, the feline squirms his tail, pushing into you as he lifts his hips up once more, purring lightly as he presses himself against your " + foot(player) + ".  His cock is already leaking pre from the tip.  You gasp loudly as his fur bristles inside you, his saliva making your womanhood quiver in need as you feel him slip deeper, coiling and twisting. Making sure not to neglect the feline, you", false);
        // ({If Naga}
        if (player.isNaga())
        ...
        // ({If Herm}
        if (player.gender == 3)
            outputText("stroking " + oMultiCockDesc(game.player) + " roughly, ", false);
        ...
        if (player.cocks.length > 0)
            outputText(" as " + sMultiCockDesc(game.player) + " offers up its bounty, spasming and adding to the mess", false);
        ...
        outputText("Your " + chestDesc(game.player) + " chest heaves as you struggle to gulp air, " + legs(player) + " quivering from the sheer power of the orgasm the cat's tail gave you.  ", false);
...
function loseToAckballllllz(): void {
    ...
    // Centaurs R SPECIALZ
        ...
        buttChange(player, new Akbal().cocks.cockArea(0), true);
        outputText("\n\n", false);
        ...
        outputText("Suddenly Akbal roars as he reaches his climax. You feel his giant cock hosing down your insides, filling you with his corrupted demon seed as he rides out his orgasm. His hips never stop. You feel your own orgasm rising to the surface only to suddenly fizzle out and you realize the corrupted seed inside you is actually stopping you from reaching climax. Akbal, however, sprays his spunk into your " + assholeDescript(player) + " again and again and never slows for a moment. Soon your stomach is obscenely swollen and you even taste cat jizz in your throat. Yet Akbal just keeps going, brutally fucking your helpless body and denying you release.\n\n", false);
    ...
    {
        outputText("Akbal begins to push into you, the barbs on his massive cockhead causing you to howl as your " + assholeDescript(player) + " is forcibly stretched.  His jaguar claws grab your shoulders, and he uses your body as leverage to force his demonic erection into you.\n\n", false);
        outputText("The strain from Akbal's shoving makes you feel like you're going to pass out, yet the pain from his spiked sex organ keeps you conscious. After a while, you realize he's not even fucking you with his entire length; his swollen member is slowly forcing less than half its massive length into your " + assholeDescript(player) + ".\n\n", false);
        outputText("After what seems like hours of Akbal's long cat dick being slowly forced into your " + assholeDescript(player) + ", your body finally gives out. You've become so exhausted from the strain that you can barely even lift your arms.  With a triumphant growl Akbal thrusts forward, his cockhead spikes burying themselves into you.  Without your resistance, they seem to vibrate inside you like twelve little beads, massaging your innards.  The sudden change makes you croon as you widen your " + legs(player) + ", suddenly desperate for more.", false);
    } else if (player.ass.analLooseness < 5) // [Medium pucker]
    {
        outputText("Akbal begins to push into you, the barbs on his massive cockhead causing you to wince as are forcibly stretched.  Without warning, he forces the entirety of his massive length into you in with a snarl.  You almost pass out just from the initial incursion, but as he saws his length in and out, your body reacts of its own accord. You widen your " + legs(player) + " in an attempt to lessen the sudden slicing pressure created by the barbed cock head.  The moment you stop resisting, the barbs start to vibrate; they start to feel more like humming sex beads than the wicked-looking barbs you know are inside you.  You can't suppress the shuddering and groaning coming from your body as you are hit with a tidal wave of ecstasy.", false);
    }
    // [Gaping pucker]
    else {
        outputText("Akbal begins to push into you, the barbs on his massive cockhead causing you to wince.  He bottoms out near-instantly, and he looks up at you with a feral grin.  Akbal begins to pump his engorged sex organ in and out of your " + assholeDescript(player) + " with a steadily mounting force.  You release a groan as the barbs covering Akbal's long cat-dick start to vibrate and begin to feel more like humming sex beads than anything else.  You widen your " + legs(player) + " in response and Akbal snarls as he slams his hips into you, obviously happy that you're able to take his massive length.  The demon seems to forget that he's raping you; he starts giving your neck licks that send shivers throughout your entire body as he roughly fucks you into the forest floor.", false);
    }
    buttChange(player, new Akbal().cocks.cockArea(0), true);
    outputText("\n\n", false);

    outputText("Akbal's embedded cock begins to hum inside you, causing you to cry out as he picks up the pace.  His every thrust is a hammer-like thump against your spread " + legs(player) + ".  Suddenly his thrusts become sloppy, and you feel his giant tool swelling inside you, stretching you out even more.  Akbal roars as he reaches his climax, and you feel his giant cock hosing down your insides, filling you with his corrupted demon seed as he rides out his orgasm.  His hips never stop.  You feel your own orgasm rising to the surface, only to suddenly fizzle out.  It is with horror that you realize that the corrupted seed inside you is actually stopping you from reaching climax.  Akbal, however, sprays his spunk into your " + assholeDescript(player) + " again and again, not slowing for even a moment.  Soon your stomach is obscenely swollen, and you even taste cat jizz in your throat.  Yet Akbal just keeps going, brutally fucking you into the ground.\n\n", false);
...
function akbalSubmit(): void {
    ...
    if (player.lowerBody == LowerBodyType.NAGA) {
        ...
        // (Small/Virgin Pucker)
        if (player.ass.analLooseness < 3) {
            outputText("You feel him poking around your " + assholeDescript(player) + " and quickly realize his member is not only insanely large but its head is covered in a dozen tiny barbs. You grit your teeth, expecting pain and yet, thanks to the weird saliva he slathered your innards with, there is none as his gargantuan member forcibly widens your " + assholeDescript(player) + ".\n\n", false);
        ...
        // (Medium Pucker)
            ...
            outputText("You feel him poking around your " + assholeDescript(player) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. Yet, thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + assholeDescript(player) + ".\n\n", false);

            outputText("Akbal's titanic member stretches your " + assholeDescript(player) + " and makes you groan beneath him, reveling in the slick heat and fullness of your bowels. His saliva heats up, creating a steamy,pleasurable warmth inside your body. As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes. Your body begins to act of its own accord, your " + buttDescription(player) + " grinding against his thrusts as his large sex pump slides in with his trunk slamming into your " + buttDescription(player) + " in rhythmic, echoing claps.", false);
        }
        // (Gapping Pucker - Akbal's dick = 15 inches)
        else {
            outputText("You feel him poking around your " + assholeDescript(player) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. When Akbal begins to penetrate you he is surprised when his trunk suddenly slams into your " + buttDescription(player) + ", the sudden invasion causing you to croon.\n\n", false);

            outputText("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating. The sensation of the vibrating barbs is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you. Akbal wastes no time and begins forcibly fucking your " + assholeDescript(player) + " with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt. You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.", false);
        }
        buttChange(player, monster.cocks.cockArea(0), true);
        outputText("\n\n", false);

        // (ending)
        outputText("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + assholeDescript(player) + ". Your voice rises and falls with his frantic thrusts. Your body is racked by orgasm after orgasm and soon you're lying on your chest and knees in a pool of your own love juices.\n\n", false);
    ...
    if (player.lowerBody == LowerBodyType.CENTAUR) {
        ...
        // (No tail)
            ...
            outputText("  As he makes his way to your hind quarters he grabs your " + buttDescription(player) + ", groping the mass of flesh with one hand and sliding a finger across your exposed " + assholeDescript(player) + ", making you paw the ground with your hooves.", false);
        outputText("\n\n", false);
        // (Transition)

        outputText("The jaguar demon begins pushing you forward with his powerful hips, his demon-cat-dick sliding up the crevice of your " + buttDescription(player) + ".  He steers you towards a tree, forcing you chest-first against the rough bark.\n\n", false);
        ...
        // (If Player has balls)
        if (player.balls > 0)
            outputText("  Akbal slurps his way down to your " + sackDescript(player) + " where he slathers his thick, heated saliva over your orbs, making you groan as your sensitive " + ballsDescriptLight(player) + " are teased and gently juggled by Akbal's masterful tongue.  He sucks both orbs into his mouth.  The sensation sends your eyes to the back of your skull and makes your entire body shiver.", false);
        // (transition)
        ...
        // (Medium Pucker)
            ...
            outputText("You feel him poking around your " + assholeDescript(player) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  Yet,  thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + assholeDescript(player) + ".\n\n", false);
            outputText("Akbal's titanic member stretches your " + assholeDescript(player) + " and makes you groan and claw at the tree he has you pressed against, reveling in the slick heat and fullness of your bowels.  His saliva heats up, creating a steamy yet pleasurable warmth inside your body.  As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes.  You lean back into his thrusts as his trunk begins slamming into your " + buttDescription(player) + " in rhythmic claps that echo throughout the forest.", false);
        }
        // (Gapping Pucker - Remember Akbal's dick is 15 inches)
        else {
            outputText("You feel him poking around your " + assholeDescript(player) + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  When Akbal begins to penetrate you he groans in surprise as his large dick sinks into your " + buttDescription(player) + " easily, the sudden invasion causing you to croon.\n\n", false);
            outputText("The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating.  The sensation is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your " + assholeDescript(player) + " with reckless abandon, his every brutal thrust causing the tree you're shoved up against to shake back and forth.  You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.", false);
        }
        buttChange(player, monster.cocks.cockArea(0), true);
        outputText("\n\n", false);

        // (ending)
        outputText("Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your " + assholeDescript(player) + ".  Your body is racked by orgasm after orgasm and soon the ground beneath your pawing hooves is covered in a thick layer of your own love juices.  Then Akbal releases a harsh growl and you feel the large feline member twitching and swelling inside you.  A growl sounds in your own chest as the hot, corrupted seed of the demon cat shoots into you.  The feeling of the hot, wet warmth being fucked deeper into you is so close to supreme bliss you can scarcely tell the difference.\n\n", false);

        outputText("After a few moments you realize Akbal isn't slowing down.  His piston pumping hips drive right through his orgasm and never stop slamming into your " + buttDescription(player) + ".  He continues until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n", false);
    ...
    // [Player has balls]
        ...
        outputText("Akbal slurps his way down to your " + sackDescript(player) + ", slathering his heated saliva over your orbs and making you groan as your sensitive " + ballsDescriptLight(player) + " are teased and gently juggled by Akbal's masterful tongue.  Your body continually twitches with pleasure from the sensations.  ", false);
    }
    ...
    outputText("You feel him poking around your " + assholeDescript(player) + ", learning quickly that not only is his member insanely large, but its head is covered in dozens of tiny barbs.  ", false);
    // [Small/virgin pucker]
    if (player.ass.analLooseness < 3) {
        outputText("You grit your teeth, expecting pain. However, thanks to the weird saliva he slathered your innards with, you feel none as his gargantuan member forcibly widens your " + assholeDescript(player) + ".", false);
        buttChange(player, monster.cocks.cockArea(0), true);
        outputText("\n\n", false);
    ...
    // [Medium Pucker]
        ...
        outputText("Thanks to the weird saliva he slathered your innards with, you feel no pain as his gargantuan member forcibly widens your " + assholeDescript(player) + ".", false);
        buttChange(player, monster.cocks.cockArea(0), true);
        outputText("\n\n", false);

        outputText("Akbal's titanic member stretching your " + assholeDescript(player) + " makes you groan beneath him, reveling in the slick heat and the fullness of your bowels.  His saliva heats up, creating a steamy and pleasurable warmth inside your body.  As he begins to pump his huge member in and out of you, the barbs covering his head begin to vibrate.  Your body is hit with waves of unbearable pleasure, the wicked-looking barbs acting more like humming sex beads than barbs.  Your body begins to act of its own accord; your " + buttDescription(player) + " grinds against his thrusts as his large sex slides in, his trunk slamming into your " + buttDescription(player) + " with rhythmic claps that echo throughout the forest.\n\n", false);
    }
    // [Gapping Pucker - Remember Akbal's dick is 15 inches]
    else {
        outputText("As Akbal begins to penetrate you, he groans in surprise at how easily his large dick sinks into your " + buttDescription(player) + ", and the sudden invasion causes you to croon.\n\n", false);

        outputText("The weird spit he slathered your insides with instantly heats up, and the barbs covering his cock head suddenly start vibrating.  The vibrating barbs feel like slimy sex beads, spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your " + assholeDescript(player) + " with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt.  You try to meet his deep thrusts, but the jaguar is fucking you with speed and force befitting a cheetah. The constantly vibrating barbs make your body shiver with each hammering blow to your insides.\n\n", false);
    }
    ...
    outputText("After the sensation begins to settle, you realize Akbal isn't slowing down.  His hips carry on with their pistoning right through his orgasm and continually slam into your " + buttDescription(player) + ".  He persists until he's erupted no less than eight times, masterfully working your hole the entire time.\n\n", false);

    outputText("After his final massive eruption, the jaguar demon pulls out. His copious load is released from your happy hole in an oddly satisfying cascade of thick white cream, rushing like a waterfall down your " + legs(player) + ".\n\n", false);
...
function akbalBigButtSubmit(): void {
    ...
    if (player.cocks.length > 0 && player.cumQ() >= 1000)
        outputText("dry, ");
...
function topAkbitchFromBottomDuex(): void {
    ...
    if (player.vaginas.length > 0)
        cuntChange(player, 16, true, true, false);
    else
        buttChange(player, 16, true, true, false);
