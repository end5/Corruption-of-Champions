...
export class KitsuneScene {
    ...
    private kitsuneMaleOrHermMansion(willing: boolean): void {
        ...
        outputText("The three tails recede from [eachCock] with an agonizing slowness as the black-haired girl lowers the voluptuous globes of her ass down against your " + cockDescript(player, player.biggestCockIndex()) + ".  Her hips rise and fall slowly, teasing the underside of your cock with the silky soft flesh of her rear, and the sight of her tattooed hindquarters gently cradling your prick sends fresh blood to your groin.  Your pleasure is only amplified when the blonde begins to stroke and knead it, casting you a sultry smirk as she lowers her lips toward the " + cockHead(player, player.biggestCockIndex()) + ".  Her soft tongue slides warmly along the top edge, traveling from base to tip and back again, each and every movement carefully measured and controlled to tease and excite you.\n\n");
    ...
    private kitsuneShoveHerMansion(willing: boolean = true): void {
        ...
        if (player.gender == 1 || ((player.gender == 3) && flags[kFLAGS.redheadIsFuta] == 0)) {
            ...
            outputText("You edge closer and closer to your climax, shivering with pleasure as pressure builds in your " + ((player.balls > 0) ? ballsDescriptLight(player) : "prostate") + ".  The " + ((player.hasSheath()) ? "sheath" : "base") + " of your " + cockDescript(player, player, player.biggestCockIndex()) + " bulges outwardly as the first thick glob of cum swells through it, forcing its way into the blonde's unprotected womb.  ");
            if (player.cumQ() <= 150) {
            ...
            outputText("\n\nThe blonde casually wades over to the redhead, flipping her onto her back and sliding onto her sister's hips with a haughty smirk.  The poor redhead is pinned under her weight, flushing with wanton desire, her cock twitching needfully between the blonde's ass cheeks.  One of the blonde's tails winds around the " + ((player.hasSheath()) ? "sheath" : "base") + " of your " + cockDescript(player, player.biggestCockIndex()) + ", pulling it into the shimmering tangle of golden coils, and though a fluffy forest obscures your view, you can feel the " + cockHead(player, player.biggestCockIndex()) + " pressing up against the blonde's warm, inviting snatch.\n\n");
            ...
            outputText("You edge closer and closer to your climax, shivering with pleasure as pressure builds in your " + ((player.balls > 0) ? ballsDescriptLight(player) : "prostate") + ".  The " + ((player.hasSheath()) ? "sheath" : "base") + " of your " + cockDescript(player, player.biggestCockIndex()) + " bulges outwardly as the first thick glob of cum swells through it, forcing its way into the blonde's unprotected womb.  ");
            if (player.cumQ() <= 150) {
    ...
    private kitsuneStillHungryMansion(): void {
        ...
        outputText("Still overly sensitive from the exhilarating romp you had just taken part in, your " + cockDescript(player, player.biggestCockIndex()) + " begins to throb and twitch excitedly within the black-haired girl's throat, already being pushed to the limits of your endurance.  ");
        if (flags[kFLAGS.redheadIsFuta] > 0) {
    ...
    private loseFightToHerms(): void {
        ...
        outputText("The pleasure proves too much to bear, even more so after her incessant teasing, and it doesn't take long before you feel your " + ((player.balls > 0) ? ballsDescriptLight(player) : "prostate") + " swelling with the pressure of your climax.  The tail around your " + ((player.hasSheath()) ? "sheath" : "base") + " tightens up considerably, and the kitsune begins to ride you with an even fiercer passion, her expansive cheeks making loud slapping noises each time they slam down on your [hips].\n\n");
    ...
    private blondeKitsuneRapesSmallWangs(): void {
        ...
        outputText("Her lips rise and fall around your spasming prick, low moans vibrating through it each time she pulls back.  You can feel her cheeks pulling inward from the strength of her suction, loud smacks filling the air each time a gap forms in the almost airtight seal of her lips.  She squashes her breasts down as much as she can, lowering her lips to kiss your " + ((player.hasSheath()) ? "sheath" : "base") + ((player.balls > 0) ? " and reaching down to gently stroke your " + ballsDescriptLight(player) : "") + ((player.gender == 3) ? ", one of her long, dextrous fingers sliding into your " + vaginaDescript(player) : "") + "\n\n");
    ...
    private putItInAKitsunesAssWin(): void {
        clearOutput();
        kitsuneSprite();
        const x: number = player.cockThatFits(144);
        ...
        outputText("Sensing your onrushing orgasm, she tightens the ring of her tail around your " + ((player.hasSheath()) ? "sheath" : "base") + ", blocking your orgasm from escaping and trapping blood in your swollen " + cockDescript(game.player, x) + ", making it that much more sensitive.\n\n");
    ...
    private tailJobKitsuneWin(): void {
        ...
        outputText("It is at the height of one such cycle of pleasure and denial that you feel something cool and tingly washing over you, looking down to see the kitsune's lips pursed at " + ((player.balls > 0) ? "the underside of your " + ballsDescriptLight(player) : "the " + ((player.hasSheath()) ? "sheath" : "base") + " of your " + cockDescript(game.player, 0)) + ", gently blowing pale flames across your groin.\n\n");
    ...
    private fuckDraftBlond(): void {
        ...
        outputText("The powerful scent of feminine musk fills the air almost instantly, a viscous puddle spreading between her legs and soaking through the crotch of her robes." + ((player.dogCocks() > 0) || (player.inRut) ? "  As the potent smell fills your nostrils, your " + cockDescript(game.player, x) + " swells in anticipation, reacting instinctively to the scent of a female in heat.  Lurid fantasies of plugging her sloppy snatch with your " + ((player.dogCocks() > 0) ? "knot" : cockDescript(game.player, x)) + " and stuffing her belly full of kits rush into your mind unbidden" + ((player.cor < 20) ? ", disturbing you slightly" : "") + "." : "") + "  Her body trembles and quakes with carnal need, pure animalistic desire burning in her eyes.  As the effects of her chemical-induced heat come into full swing, she struggles to maintain some semblance of rational thought, desperately willing herself to crawl away.\n\n");
    ...
    private getABJFromAFoxGirl(): void {
        clearOutput();
        kitsuneSprite();
        const x: number = player.cockThatFits(108);
        ...
        else outputText("her lips squeezing sensually around the " + ((player.hasSheath()) ? "sheath" : "base") + " each time she goes down you.  Moaning intensely, she closes her eyes and rolls your " + cockDescript(game.player, x) + " back and forth in her mouth, swirling her tongue sensually along it.\n\n");
