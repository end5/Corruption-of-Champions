...
export class KitsuneScene {
    ...
    private blondeKitsuneRapesSmallWangs(): void {
        ...
        outputText("Her tails snake forward, curling around your limbs, and you find yourself pinned, struggling in vain against the uncommonly strong furred coils.  She nods, satisfied with your helplessness, and leans down to gently nuzzle your " + game.player.cockDescript(0) + ", cooing softly and sliding her soft, wet tongue along the underside from base to tip with a small giggle.  Her tongue swirls back and forth along the underside of your " + player.cockHead() + ", wrapping around it and slurping up your slick precum.\n\n");
        ...
        outputText("Her entire body shudders a bit, and you can now feel her soft breasts squashing against your groin as she leans down to lightly kiss the end of your " + game.player.cockDescript(0) + ".  She starts to rock her wide, curvy hips back and forth across your face, grinding her crotch into your mouth and moaning.  The tails that aren't pinning your limbs down gently curl underneath your neck, lifting your head up.  You moan into her pussy as you feel her lips softly wrap around the tip of your shaft, her tongue playing along the " + player.cockHead() + " lightly.  Her lips make a soft smacking noise as she pulls away, and she starts to toy with your member gleefully, stroking it teasingly with her index finger just to feel your reactions trembling up through her loins.\n\n");
        ...
        outputText("\"<i>Mm, hey there lil' guy,</i>\" she says in a singsong voice, wrapping one arm around her breasts to squash them down and hold them in place while gently fiddling with the tip of your " + game.player.cockDescript(0) + " using her index finger.\n\n");
    ...
    private putItInAKitsunesAssWin(): void {
        ...
        outputText("Sensing your onrushing orgasm, she tightens the ring of her tail around your " + ((player.hasSheath()) ? "sheath" : "base") + ", blocking your orgasm from escaping and trapping blood in your swollen " + game.player.cockDescript(x) + ", making it that much more sensitive.\n\n");
    ...
    private tribbingWithAKitsune(): void {
        ...
        outputText("\"<i>Haha, what do you think you're doing, you silly mortal...</i>\" she says, chuckling as you position yourself over her, settling your [butt] down on her splayed thighs, your " + vaginaDescript() + " meshing seamlessly with hers." + ((player.cocks.length > 0) ? game.player.sMultiCockDesc() + " drape" + ((player.cocks.length > 1) ? "s" : "") + " over the plump round cheeks of her prodigious posterior, leaking strands of precum onto her bundle of luxurious tails" + ((monster.hairColor == "red" && flags[kFLAGS.redheadIsFuta] > 0) ? ", while her own member dangles a few inches above her nose." : ".") : "") + "  When your slow, measured grinding resumes, you moan with approval, finding this new position to be much more satisfying.\n\n");
    ...
    private tailJobKitsuneWin(): void {
        ...
        outputText("It is at the height of one such cycle of pleasure and denial that you feel something cool and tingly washing over you, looking down to see the kitsune's lips pursed at " + ((player.balls > 0) ? "the underside of your " + ballsDescriptLight() : "the " + ((player.hasSheath()) ? "sheath" : "base") + " of your " + game.player.cockDescript(0)) + ", gently blowing pale flames across your groin.\n\n");
    ...
    // Blonde-exclusive
    // [Fuck Draft]
    // {all " + game.player.cockDescript(0) + " calls for this scene should prioritize dog cocks; if PC is in Rut, prioritize other animal dicks second, otherwise use the biggest cock.}
    private fuckDraftBlond(): void {
        ...
        outputText("The powerful scent of feminine musk fills the air almost instantly, a viscous puddle spreading between her legs and soaking through the crotch of her robes." + ((player.dogCocks() > 0) || (player.inRut) ? "  As the potent smell fills your nostrils, your " + game.player.cockDescript(x) + " swells in anticipation, reacting instinctively to the scent of a female in heat.  Lurid fantasies of plugging her sloppy snatch with your " + ((player.dogCocks() > 0) ? "knot" : game.player.cockDescript(x)) + " and stuffing her belly full of kits rush into your mind unbidden" + ((player.cor < 20) ? ", disturbing you slightly" : "") + "." : "") + "  Her body trembles and quakes with carnal need, pure animalistic desire burning in her eyes.  As the effects of her chemical-induced heat come into full swing, she struggles to maintain some semblance of rational thought, desperately willing herself to crawl away.\n\n");
        ...
        outputText("You slide your " + game.player.cockDescript(x) + " up between the supple mounds of her ass, groaning in pleasure as she begins to glide her hips back and forth along the shaft, cooing softly.  The warm, moist breath radiating off her sodden vagina caresses your ");
        ...
        outputText("  She raises her hips higher, whimpering a little as she desperately tries to line up your " + game.player.cockDescript(x) + " with her hungry fuckhole.\n\n");
    ...
    private hotdogAnalInKitsuneButtDontLetTailTickleYourNose(): void {
        ...
        outputText("You grip her love handles tightly, sinking your fingertips into the soft, plushy flesh, and eagerly pummel her tight ass, slapping your hips into her bountiful butt cheeks over and over.  Her thighs tense and relax in time with your thrusts, working along with the inner muscles to give your " + game.player.cockDescript(x) + " a sensual massage rivalling that of a master masseuse.  Everything above her waist, however, is utterly relaxed, splayed out into a lewd heap of decadent desire.  The merest hint of a sliver of emerald is visible as her eyes roll into the back of her head, her tongue flopping out of her mouth along with a healthy trail of drool.\n\n");

        outputText("One last slap echoes through the clearing when you slam yourself into her ass for the final time, moaning in ecstasy as your " + game.player.cockDescript(x) + " twitches wildly in climax.  ");
        ...
        if (player.cumQ() <= 150) {
            ...
            outputText("The convulsing muscles of her rectum milk your shaft strongly, heavy rippling sensations squeezing you repeatedly from base to tip as you pour out truly monstrous amounts of seed into her innards, stuffing her with your cloying cum.  A husky groan escapes from her throat as she begins to rise off the ground, the obscene amounts of semen filling her stomach like a balloon as your seed surges through her intestines.  Her hindquarters are raised into the air as she tilts forward on her cum-bloated belly, now filled out to the size of an exercise ball.  At the height of your pleasure, you resume your lustful thrusting, her flesh quivering continuously as you fill her to excess, pressurized jets of semen spurting out around your " + game.player.cockDescript(x) + ".  As the last of your load stuffs her abused asshole, you dig your fingertips into her pliable, cum-streaked flesh and squeeze her ass cheeks together around your shaft.  Her anus clamps down hard around your throbbing rod as you slowly pull back, hungrily milking the last of your load from your urethra.\n\n");
    ...
    private getABJFromAFoxGirl(): void {
        ...
        else outputText("her lips squeezing sensually around the " + ((player.hasSheath()) ? "sheath" : "base") + " each time she goes down you.  Moaning intensely, she closes her eyes and rolls your " + game.player.cockDescript(x) + " back and forth in her mouth, swirling her tongue sensually along it.\n\n");
