...
export class KitsuneScene {
    ...
    private loseToKitsunesWithBallsAndHighCumQ(): void {
        ...
        outputText("Her coy grin turns to one of delighted surprise as her fingertips pass over your " + ballsDescriptLight() + ", giving them a firm but gentle squeeze.  She licks her lips and eagerly pulls your " + player.armorName + " off with a hungry glint in her eyes, lifting up your [cock biggest] and flexing it slightly as though examining it.  She leans down, her face close to your balls, and drinks in their scent with a long, drawn-out sigh.\n\n");
        ...
        outputText("As if to demonstrate her supreme skill with her tongue, she allows her hands to wander freely along your lower body while she continues to bounce and squeeze your balls with her tongue.  " + ((player.gender == 3) ? "The tip snakes down, hugging the curvature of your balls, and then begins to experimentally prod your " + vaginaDescript() + ", gently flicking your clitoris.  " : "") + "Pleasure turns to surprise when you feel her index finger poking around by your " + assholeDescript() + ", and she buries it to the base inside you before you have a chance to formulate a protest.  The sudden intrusion makes your shaft flex, the veins bulging against the surface of the skin as it swells a bit in response.\n\n");
        ...
        if (player.cumQ() <= 2500) {
            outputText("The second that the first streams of salty cream hit her throat, she begins to moan in ecstasy, cupping your balls softly with both hands.  With her lips sealed tight around your shaft, her tongue swirls to and fro inside her mouth, gathering up your thick seed and funneling it into her gullet.  Overcome by gluttonous desire, she draws your shaft into the back of her throat, massaging your " + ballsDescriptLight() + " while she drinks them dry.  She continues to suck down each new stream of cum even after her stomach begins to expand, swelling up with your roiling load.  As your explosive climax begins to slow, she begins to massage the sides of your shaft, squeezing out the last few globs of semen.  Her tongue coils around your length one last time, and she sucks hard, slurping up the last drop with great embellishment.\n\n");
            ...
            outputText("She moans deeply the moment that your first thick streams of seed begin to flow into her throat, cupping your balls softly with both hands.  With her lips sealed tight around your shaft, her tongue swirls to and fro inside her mouth, gathering up your thick seed and funneling it into her gullet.  Overcome by gluttonous desire, she draws your shaft into the back of her throat, massaging your " + ballsDescriptLight() + " while she drinks them dry.  Even as her stomach begins to swell with the added weight of your seed, she never stops sucking down your thick load.  Your explosive climax continues to flow, and although she puts up a valiant effort to swallow it all, a few thick streams manage to escape from the corners of her mouth and nostrils.  As the lengthy orgasm finally begins to wind down, her tongue coils around your length one last time, and she sucks hard, slurping up the last drop with great embellishment.\n\n");
    ...
    private getRapedByRedHeadFutaKitsune(): void {
        ...
        outputText("As she uses your " + ((player.gender >= 2) ? vaginaDescript() : assholeDescript()) + " as her own personal fuckhole, her many tails begin to stroke and tease along your naked body, tickling you with their bristly tips and painting trails of fire across your flesh.  You are caught up in shivers each time one of them crosses one of your erogenous zones, the cool flames tickling and tingling across your most sensitive areas.  Thrashing and wriggling underneath her, you belt out a trembling moan, every muscle in your body resonating with pleasure from the odd contrast of the gentle caress of her tails with the rough pistonlike pounding of her cock.\n\n");
        ...
        outputText("You feel yourself being lifted off the ground slightly, a single tail gliding up and down your back.  Your muscles clench up involuntarily as it brushes against you, and it is almost as though you can make out every vein and wrinkle on the brash redhead's cock now, feeling the rapid throb of her heartbeat through it.  Her cock swells with a thick load of seed, and you can feel slick hot jets of semen flooding your " + ((player.gender >= 2) ? vaginaDescript() : assholeDescript()) + ".  Your insides milk her swollen member of every ounce of futa-jism she has, her hips pumping continuously and sloppily pounding into you like a horny teenager.  Her voluminous load is so immense that you can feel your abdomen begin to swell as pressurized streams of her seed begin to escape, spilling out onto the ground.\n\n");
        outputText("When she finally calms down and pulls out with a satisfied sigh, your " + ((player.gender >= 2) ? vaginaDescript() : assholeDescript()) + " lies agape, a small river of seed slowly pouring out.  Your stomach has swollen to the size of a watermelon, jiggling heavily with the weight of her incredible load of futa-cum.  Her spent cock hangs limply between her thighs, a mixture of cum and feminine juices dripping from the tip.\n\n");
    ...
    private tribbingWithAKitsune(): void {
        ...
        outputText("\"<i>Haha, what do you think you're doing, you silly mortal...</i>\" she says, chuckling as you position yourself over her, settling your [butt] down on her splayed thighs, your " + vaginaDescript() + " meshing seamlessly with hers." + ((player.cocks.length > 0) ? sMultiCockDesc(game.player) + " drape" + ((player.cocks.length > 1) ? "s" : "") + " over the plump round cheeks of her prodigious posterior, leaking strands of precum onto her bundle of luxurious tails" + ((monster.hairColor == "red" && flags[kFLAGS.redheadIsFuta] > 0) ? ", while her own member dangles a few inches above her nose." : ".") : "") + "  When your slow, measured grinding resumes, you moan with approval, finding this new position to be much more satisfying.\n\n");
    ...
    private tailJobKitsuneWin(): void {
        ...
        outputText("It is at the height of one such cycle of pleasure and denial that you feel something cool and tingly washing over you, looking down to see the kitsune's lips pursed at " + ((player.balls > 0) ? "the underside of your " + ballsDescriptLight() : "the " + ((player.hasSheath()) ? "sheath" : "base") + " of your " + cockDescript(game.player, 0)) + ", gently blowing pale flames across your groin.\n\n");

        outputText("The intense tingling is all that you needed, hurtling off the edge and into the full force of your climax.  [EachCock] pulses, the tight rings of fur preventing you from achieving your full release even as your muscles spasm in vain." + ((player.balls > 0) ? "  Thick spunk begins to well up in your " + ballsDescriptLight() + ", making them swell terribly with backed-up seed." : "") + "  Thankfully she seems to tire of teasing you shortly, and withdraws the offending tails.  ");
        if (player.cumQ() <= 150) {
    ...
    private getABJFromAFoxGirl(): void {
        ...
        outputText((((player.balls > 0) || (player.vaginas.length > 0)) ? "  Trailing them across your sides, she " + ((player.balls > 0) ? "cups your " + ballsDescriptLight() + " in her hand, squeezing tightly" + ((player.vaginas.length > 0) ? " and " : "") : "") + ((player.vaginas.length > 0) ? "runs her index finger teasingly along your slit" : "") + "." : ""));
