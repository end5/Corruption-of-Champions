...
// Intro
export function findTheFrogGirl(): void {
    clearOutput();
...
// Laying the Eggs
export function birthFrogEggsAnal(): void {
    ...
    buttChange(player, 80, true, true, false);
...
function superBonusFrogEggsInYerCooch(): void {
    ...
    if (player.tailType > TailType.NONE) outputText(" hooked over your tail,");
...
// Vaginal Egg birth
export function layFrogEggs(): void {
