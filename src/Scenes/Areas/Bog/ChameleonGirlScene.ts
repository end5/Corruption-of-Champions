...
// TIMES_MET_CHAMELEON:int = 561;
		...
		{
			var x:number = rand(player.totalCocks());
			spriteSelect(89);
		...
		private  manFucksChameleonWithBiggishWang():void
		{
			...
			if (player.balls > 0) outputText("your " + ballsDescriptLight() + " clench and ");
			outputText("the semen erupts from the end of your " + game.player.cockDescript(x) + " spilling out hot spunk over her folded tongue.  She gasps audibly and arches her back as the thick ropes of your jizz coat her tongue, shoving her long fingers as far as she possibly can into her dripping pussy, and flashes so brightly pink she nearly glows.");
		...
		private  giveTheChameleonASuccubiMilk():void
		{
			...
			outputText(" your cock aimed for her pillowy tits.  She pushes and squirms beneath you, but cannot get enough leverage to move you.  You take her breasts in your hands and shimmy up her torso towards them, squeezing them around your " + game.player.cockDescript(x) + ".");
