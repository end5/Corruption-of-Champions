...
function nightSuccubiRepeat(): void {
    ...
    if (player.gender == 1) {
        if (player.cor < 66) {
            ...
            if (player.isTaur()) outputText(" crouch between your legs and impale herself on your " + cockDescript(game.player, 0) + " with a wet sound caused by her well-lubricated vulva. Y", false);
            else outputText(" open her womb and quickly consume your " + cockDescript(game.player, 0) + ". She embraces you, entrapping your head in her cleavage as y", false);
            outputText("ou quickly feel her superhuman vaginal muscles work and stroke your " + cockDescript(game.player, 0) + " better than any human woman or pair of hands could ever hope to accomplish. You are helpless as your unholy embrace milks the both of you in an infernal symphony of debauchery. The familiar cramp of an impending ejaculation grips you and your twitching signals the succubus of your approaching climax.\n\n", false);
            if (player.isTaur()) outputText("Pushing on your forelegs, she engulfs even more of your " + cockDescript(game.player, 0), false);
            ...
            if (player.isTaur()) outputText("arches under your belly as you feel your " + cockDescript(game.player, 0) + " bending pleasurably inside her, and", false);
            ...
            outputText(" her contractions milking your " + cockDescript(game.player, 0) + " as fiercely as a maid milks a cow! Another torrent of cum pushes its way out of your body and you let out a moan of pleasure and exhaustion.\n\n", false);
            ...
            if (player.isTaur()) outputText("pushes on your forelegs, impaling herself even deeper on your " + cockDescript(game.player, 0), false);
            ...
            if (player.isTaur()) outputText("She moans inhumanly, and reflexively digs her claws into your forelegs. Searing with lust, the pain means little to you as you only feel the sensation of your body forcing your fluids out of your body and into hers. You press your " + cockDescript(game.player, 0) + " into her", false);
        ...
        if (flags[kFLAGS.CERULEAN_POTION_BAD_END_FUTA_COUNTER] > 10 && player.cor > 50) {
            ...
            if (horseScore(player) + dogScore(player) + nagaScore(player) + goblinScore(player) + sharkScore(player) + minoScore(player) + cowScore(player) > 5) outputText("  All of the other corruptions and changes to your body have faded away as your new form has taken shape.", false);
