...
export class Exgartuan implements TimeAwareInterface {
    ...
    if (player.cor <= 20 && player.perks.findByType(PerkLib.BulgeArmor) >= 0) {
        ...
        if (player.gender == 3) {
            ...
            if (player.balls == 0) {
                ...
                if (player.vaginas[0].vaginalWetness < VaginaWetness.WET) outputText("puffy", false);
                else if (player.vaginas[0].vaginalWetness < VaginaWetness.DROOLING) outputText("glistening", false);
                ...
                if (player.skinType == SkinType.SCALES) outputText("scales", false);
        ...
        if (game.monk >= 5 && player.effects.findByType(StatusAffects.NoJojo) < 0 && flags[kFLAGS.JOJO_DEAD_OR_GONE] == 0) outputText(", and judging by Jojo's high pitched whines, he certainly is,", false);
