    ...
    */
    ...
    public timeChange(): boolean {
        ...
        if (player.effects.findByType(StatusAffects.Exgartuan) >= 0) { // Update Exgartuan stuff
            ...
            if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 1 && (!player.hasCock() || player.cockArea(0) < 100)) { // If too small dick, remove him
            ...
            else if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 2 && player.biggestTitSize() < 12) { // Tit removal
                ...
                if (player.effects.getValue2Of(StatusAffects.Exgartuan) > 0) { // if sleeping, decrement sleep timer.
                    player.effects.addValue(StatusAffects.Exgartuan, 2, -1);
                    if (player.effects.getValue2Of(StatusAffects.Exgartuan) == 0) { // The demon awakens!
                        outputText("\n<b>");
                        exgartuanBored();
                        outputText("</b>\n");
                        needNext = true;
                    ...
                    if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 1) { // Dude stuff
                    ...
                    if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 2 && player.biggestTitSize() >= 12) { // Chick stuff
    ...
    public timeChangeLarge(): boolean {
        if (checkedExgartuan++ == 0 && player.effects.findByType(StatusAffects.Exgartuan) >= 0 && player.effects.getValue2Of(StatusAffects.Exgartuan) == 0 && game.time.hours == 4) {
            ...
            if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 2 && rand(3) == 0) { // Boobgartuan night time surprise!
                outputText("\n");
                boobGartuanSURPRISE();
                return true;
            }
    ...
    private exgartuanInfestTits(): void {
        ...
        outputText("\n\nWell now... this was certainly unexpected.  Perhaps there's a way to be rid of this thing?", false);
        player.effects.create(StatusAffects.Exgartuan, 2, 0, 0, 0);
    }
    ...
    public exgartuanMasturbation(): void {
        ...
        if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 1) {
            ...
            if (player.cor >= 30 && player.cor < 60) outputText("You happily remove your " + player.armorName + ", eager to pleasure yourself.  Your possessed " + cockDescript(game.player, 0) + " throbbs happily.\n\n", false);
            ...
            // high corruption characters
                ...
                outputText("He's so right too.  You could keep making him bigger until it's hard to move and he drags on the ground, but you're sure his demon-magics would entice plenty of corrupted sluts, and haze the minds of any uncorrupted person enough to bring them under the spell of your " + cockDescript(game.player, 0) + ".  Gosh it makes you hot!  Just thinking about having a harem of goblin girls massaging your mighty member while another grinds her eager gash against your tip... you NEED to make this happen.  Perhaps you could breed an army of the little sluts, to bear you around on a litter and squeeze out cum anytime you have the barest hint of lust.\n\n", false);
    ...
    public exgartuanBored(): void {
        ...
        if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 1 && player.cockArea(0) >= 100) {
            ...
            else if (select == 4) outputText("You feel your " + cockDescript(game.player, 0) + " slowly expand and contract, air escaping its urethra and tickling your nether regions.  Did... did your dick just sigh?  Your demon is growing impatient.", false);
            ...
            switch (select) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    outputText("Your arms suddenly hug against your " + chestDesc(game.player) + " of their own accord, the squeeze filling you with a hint of warmth.  The demoness is awake and filling you with longing to be touched and teased.", false);
                    break;
                case 5:
                    outputText("Your " + chestDesc(game.player) + " fidget ominously, a muffled female voice piping up, \"<i>No cloth, metal, latex, or gel can protect you from me, champion.  Give in and caress these cans!</i>\"", false);
                    break;
                case 6:
    ...
    public exgartuanCombatUpdate(): boolean {
        ...
        if (player.effects.getValue1Of(StatusAffects.Exgartuan) == 1) {
            ...
            // (+Lust in combat) for girls
                ...
                switch (select) {
                    case 0:
                        outputText("Thoughts of " + monster.a + monster.short + ", wrapping " + mf(monster, "him", "her") + "self around your throbbing demonic member consume you, flooding your body with lust.", false);
                        if (player.cor < 50) outputText("  You glance down at the sensitive bulge in your " + player.armorName + " and sigh.  Damned demons.", false);
                        break;
                    case 1:
                        outputText("Desire courses through your veins, growing stronger as you watch " + monster.a + monster.short + "'s form.  You somehow realize the desire is artificial, but it doesn't make you want to mount " + mf(monster, "him", "her") + " any less...", false);
                        break;
                    case 2:
                        ...
                        break;
                    case 3:
                        outputText("You really want to end this fight and bend " + monster.a + monster.short + " over... Why is this taking so long, your " + cockDescript(game.player, 0) + " does NOT want to wait!", false);
                        if (player.cor < 50) outputText("  You snap back to reality and curse yourself for falling to the demon's desires.", false);
                        break;
                    case 4:
                        outputText("This fight has gone on long enough; all you really want is to shove your " + cockDescript(game.player, 0) + " into the " + monster.a + monster.short + "'s... Wait, what? Your possessed pecker is getting the better of you.", false);
                        break;
                    case 5:
                        outputText("For a moment, you find it hard to concentrate, visions of impaling the " + monster.a + monster.short + " with your " + cockDescript(game.player, 0) + " etching their way into your mind.  Curse this horny demon!", false);
                        break;
                    case 6:
                        ...
                        break;
                    case 7:
                        outputText("Maybe it would be best to just lay down your arms and strip off your " + player.armorName + ". Just give yourself up to the " + monster.a + monster.short + " and let fate decide. Surely, " + monster.pronoun1 + " would return the gesture by embracing your " + cockDescript(game.player, 0) + " and... Augh!  The demon is again toying with your judgment.", false);
                        break;
                    case 8:
                        outputText("Tight loving assholes and gaping vaginas, slick long red tongues and breasts like fine china.  Succubi and the hot sexings they bring, these are a few of your favorite things!  ...Wait, what?  Was that musing your own?  And why are you absently stroking your " + cockDescript(game.player, 0) + "?", false);
                        break;
                    case 9:
            ...
            // (Taunts Male Foes -enemy lust)
                ...
                switch (select) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        outputText("Your " + cockDescript(game.player, 0) + " squirms around, pushing your " + player.armorName + " out of the way.  Exgartuan barks, \"<i>Why are you bothering my host, fool?  Can't you see my magnificence?  You're nothing compared to me.  Go wank in shame and get out of our way.  We have cunts to fill.</i>\"", false);
                        break;
                    case 3:
                        outputText("The waist of your " + player.armorName + " expands as your " + cockDescript(game.player, 0) + " flies skyward fully erect, \"<i>Tremble in fear, peon! My " + num2Text(player.cocks[0].cockLength) + " inches of might shame that feeble nub between your legs.  We've no time for your slack-jawed awe; go home and be a family man.</i>\"", false);
                        break;
                    case 4:
                        outputText("Disobeying your will, your hands promptly undo your " + player.armorName + ", your " + cockDescript(game.player, 0) + " springing forth and flaring its urethra menacingly at the " + monster.a + monster.short + ", \"<i>You have a dick not even a mother could love.  Has that thing ever graced another living being's flesh?  Run back to your lonely hovel full of unattainable fantasies, and leave the real action to the pros.</i>\"", false);
                        break;
                    case 5:
                        ...
                        break;
                    case 6:
                        outputText("Your " + player.armorName + " unexpectedly opens itself of its own accord, prompting your " + cockDescript(game.player, 0) + " to extend into the open air, \"<i>All the chemicals, potions, and morsels in existence can't help that infinitesimal tool you possess.  The orifices of this world deserve better!  All you are accomplishing this day is their disappointment in delaying the inevitable.</i>\"", false);
                        break;
                    case 7:
                        outputText("All of a sudden, your " + player.armorName + " splays open, your " + cockDescript(game.player, 0) + " quickly slithering up and around your back, stopping uncomfortably close to your face while pointing at your opponent, \"<i>Look at this pitiful cretin, " + player.short + ".  We could be out spreading hot dickings to the wanting cunts of the land.  But, no!  This " + monster.a + monster.short + " desires eradication.  Well, champion...oblige him.</i>\"", false);
                        break;
                }
            ...
            if (monster.totalCocks() > 0) {
                ...
                switch (select) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        outputText("Your " + chestDesc(game.player) + " begin to playfully bounce up and down, making it difficult for you to focus on your fight.  You aren't too worried, however, as the " + monster.a + monster.short + " seems to be hypnotized by the movement.", false);
                        break;
                    case 4:
                        outputText("A sultry woman's voice teases the " + monster.a + monster.short + ", \"<i>There's no need for hostilities, is there?  Merely lay down your arms and come help fondle these marvels of creation.</i>\"  Your " + chestDesc(game.player) + " shimmy for emphasis.", false);
                        break;
                    case 5:
    ...
    public exgartuanArmorShift(): void {
        ...
        if (changed) {
            ...
            if (player.perks.findByType(PerkLib.BulgeArmor) < 0) player.perks.create(PerkLib.BulgeArmor, 0, 0, 0, 0);
        }
    }
    ...
    public exgartuanBeeRape(): void {
        ...
        outputText("\"<i>You sure know your knots!   Speaking of knots, I got an idea...</i>\" exclaims the demon inside your " + cockDescript(game.player, 0) + ".  You wonder at what the demon could have in mind this time as you finish spreading the bee-bitch's legs in preparation.  The scent wafting out from her genitals is unreal, making you simultaneously hungry and incredibly horny.  You pull up the ginormous flanged tip with both hands and rub it over her honey-slicked crotch, mixing your demonic pre-seed with her honey as you smear it all over her downy inner thighs.\n\n", false);
        ...
        outputText("You pull out with a satisfied grunt, enjoying the wet 'schlick' sound your " + cockDescript(game.player, 0) + " makes as it pulls free of the bee-girl's once-tight hole.  Where once there was a honey-coated slit now resides a gaping monster, drooling a gooey mixture of slime and your tainted demonic seed.  Well, maybe her queen will have an easier time packing her full of eggs.\n\n", false);
        ...
        if (player.cor <= 20 && player.perks.findByType(PerkLib.BulgeArmor) >= 0) {
            ...
            if (player.cor < 33) {
                ...
                if (flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] < 5) {
                    ...
                    if (player.biggestTitSize() >= 2) outputText("you squeeze your tits around your " + cockDescript(game.player, 0) + " with your biceps", false);
            ...
            outputText("  Liquid-hot pressure slides over the underside of your " + cockDescript(game.player, 0) + ", licking wetly at the pulsating, need-filled demon-prick.  Your rogue tongue's attentions have the desired effect, and the cries of your pleasure are muffled by your own thick flesh and its rapidly distending urethra.\n\n", false);

            outputText("If someone were watching", false);
            if (monk >= 5 && player.effects.findByType(StatusAffects.NoJojo) < 0 && flags[kFLAGS.JOJO_DEAD_OR_GONE] == 0) outputText(", and judging by Jojo's high pitched whines, he certainly is,", false);
            ...
            if (temp > 500) {
                ...
                if (temp > 2500) outputText("  Back-pressure blasts your " + cockDescript(game.player, 0) + " free from your imprisoning oral cavity along with a fountain of seed while you weakly try to cough out enough spooge to breathe.", false);
            }
            outputText("\n\n", false);
    ...
    private exgartuanBulgeTortureIII(): void {
        ...
        outputText("Your frantic breathing seems to be competing with your pounding heartbeat, acting as if it were emanating from within your skull.  Your hands cling to the dirt and scant pieces of grass below you, unable to stop shaking or heed any of your commands.  Your already obscured vision begins to darken, more and more of the vague blobs fading into darkness.  Your " + legs(player) + " continue their numb strike against you while helping your " + feet(player) + " dig helplessly into the ground.  ...You've run out of ideas, left with an insatiable hunger for sex, a body that refuses to do little more than convulse, and a mound of misfortune where your crotch resides.\n\n", false);
    ...
    private boobgartuanSurprise2(): void {
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            // [if corruption <30]
            if (player.cor < 33) outputText("Your " + chestDesc(game.player) + " brush against the imp's enormous scrotum, causing him to eventually tumble over from the sensation, blocking the impeding entourage of imps behind you.", false);
            // [if corruption ≥30 & <70]
    ...
    private boobgartuanSurprise3(): void {
        ...
        outputText("Thankfully you were more prepared this time, your reflexes heightened enough to keep you from slamming your noggin yet again.  You also felt just where the shove originated from: your " + chestDesc(game.player) + ".  ", false);
        // [if occurrence ==0]
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) outputText("As you sit up and begin to piece the puzzle together, you're interrupted by a familiar voice, \"<i>You have time to fuck everyone in Mareth silly, but can't be bothered to spend an instant of it with these magnificent mounds?</i>\" You feel your " + chestDesc(game.player) + " jiggle as Exgartuan speaks, only to have them yank you forward, planting your face back in the ground.  \"<i>I'll just have to make sure you'll never forget again.</i>\"", false);
        // [if occurrence ≥1]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4) {
            outputText("It's Exgartuan again; you haven't fondled her in a while.  \"<i>Rarin' for another round, eh, champion?</i>\" your " + chestDesc(game.player) + " ask you, jiggling furiously for emphasis, \"<i>I had hoped the previous lesson", false);
            // [if occurrence ≥2]
        ...
        // if occurrence ≥4
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8) outputText("</i>\"ARE YOU DENSE, CHAMPION?</i>\" Exgartuan shouts, your mammoth melons bouncing furiously on her every word, \"<i>I will knock you SENSELESS until I clear some space in that vapid cesspool between your ears!</i>\" You want to try and calm her down, but your " + chestDesc(game.player) + " promptly launch your face square into the dirt.  \"<i>Don't go on thinking for another SECOND that you can ignore ME!</i>\"", false);
        // [if occurrence ≥8]
        else outputText("Before another thought can cross your mind, your " + chestDesc(game.player) + " fly up and smack you in the gob! \"<i>" + player.short + ", it's that time again,</i>\" the eager demoness teases you.  You think she's grown to enjoy the torture she puts you through.  \"<i>If you insist on going day in and day out without spending quality time with these tits, then I'll just insist on instructing you otherwise.</i>\" Your beautiful bosom launches forward, throwing your mug right back in the dirt.", false);
        ...
        outputText("  You finally bear down and grasp onto... nothing?  <b>Your nipples are nowhere to be found!</b>  The passion is beginning to flatline as you confusedly grope around your " + chestDesc(game.player) + ".  \"<i>What's wrong, champion?</i>\" Exgartuan asks knowingly, \"<i>Is this too hard for you?</i>\" The tips of your fingers comb around your areolas until you discover an inward bend in your " + skin(player) + " where your nipples should be.  Apparently, Exgartuan isn't through having fun with you; the blasted seductress managed to suck your teats inward!  Before you can fathom just how she pulled it off without your knowledge, your humble howitzers start to tingle.  You feel an anxious quiver work its way up your spine before a familiar need begins to course through your being: the need to be milked!", false);
        // [if corruption <50]
        ...
        // [if not lactating]
        if (player.biggestLactation() < 1 || player.lactationQ() == 0) outputText("  <b>Your " + chestDesc(game.player) + " have started to lactate profusely.</b>", false);
        ...
        outputText("Your hands go to work on your nips, a tug here, a stroke there, your fingers exploring the ins and outs of your titantic teats.  You punch in just a scant number of moments before your faucets reach their crescendo, your hands holding on for all their worth as milk sprays out everywhere, your " + chestDesc(game.player) + " writhing with each squirt.  It's hard to make out just how much or how far your cream has gone in the dark, but judging by what seemed like an eon of excitement, you're confident that you've made your mark.  You know that Exgartuan has fallen into her slumber when your otherwise perky pompoms succumb to the laws of gravity and return to their original state, soreness seeping in after a night of tossing, tugging and teasing.", false);
        // [if corruption <50]
    ...
    public exgartuanNagaStoleMyMasturbation(): void {
        ...
        outputText(" load working its way up your " + cockDescript(game.player, 0) + "... and stop.  You sit up in an involuntary attempt to release the pressure, only to be met by your coiled-up shaft bending to greet your face, its urethra spread wide open...\n\n", false);
