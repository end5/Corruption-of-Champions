...
export class Exgartuan extends NPCAwareContent implements TimeAwareInterface {
    ...
    */
                    ...
                    if (player.statusAffectv1(StatusAffects.Exgartuan) == 2 && player.biggestTitSize() >= 12) { // Chick stuff
                        if (game.time.hours % 9 == 0) { // Only once every 9 hours or so.
                            if (rand(3) == 0) { // lactation messing with!
                                ...
                                outputText("\n<b>");
                                if (rand(2) == 0)
                                    outputText("You feel warm and tingly, good all over.  Wait a second, your hands are playing with your " + game.player.breastDescript(0) + ".  You yank your hands away, but it only makes Exgartuan laugh with demonic pleasure!");
                                else {
                                    outputText("Your hands knead and caress your " + game.player.breastDescript(0) + ", eagerly touching every inch of soft flesh.  You gasp when you realize what you're doing and pull them away");
    ...
    public timeChangeLarge(): boolean {
        if (checkedExgartuan++ == 0 && player.findStatusAffect(StatusAffects.Exgartuan) >= 0 && player.statusAffectv2(StatusAffects.Exgartuan) == 0 && game.time.hours == 4) {
    ...
    private drinkFountainEndowment(): void {
        ...
        if (rand(3) == 0 && player.totalCocks() > 0) {
            outputText("\n\nYour " + game.player.multiCockDescriptLight() + " feels tighter inside your " + player.armorName + ", even when flaccid.  You shudder and realize you've probably gained more than a few inches in total length, and who knows how your thickness has changed.", false);
    ...
    private exgartuanInfestDick(): void {
        ...
        // (+Demon dick possession – not demondicked)
            ...
            outputText("\n\nYour " + game.player.cockDescript(0) + " puffs up, growing even larger as it absorbs the fountain's essence.  It dribbles pre-cum and twitches about as if sniffing the air, feeling very warm and sensitive.", false);
            outputText("\n\nA voice suddenly splits the air, demanding, \"<i>Satiate me mortal, or I'll make you find someone who will!</i>\"", false);
            outputText("\n\nWhat the hell was that?  You look around, but cannot find the source of the voice.  It speaks again, \"<i>Down here.  What are you, deaf!?</i>\"", false);
            outputText("\n\nYou look down, and find your demonic cock pointing directly at you, and shaking with... indignation?  The ground hits your " + buttDescript() + " hard as you fall backwards, too surprised to maintain your footing.  Is your dick talking to you?", false);
            outputText("\n\n\"<i>Yes I am.  You should consider yourself lucky – you're now the host of the great demon Exgartuan, and you'd best please me every few hours, or I'll make sure your body finds someone to relieve my building pressure.  But I think you'll do fine.  Come now, I can see a wonderful camp in your mind that we can paint white,</i>\" it suggests.", false);
    ...
    public exgartuanMasturbation(): void {
        ...
        if (player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            if (player.cor >= 30 && player.cor < 60) outputText("You happily remove your " + player.armorName + ", eager to pleasure yourself.  Your possessed " + game.player.cockDescript(0) + " throbbs happily.\n\n", false);
            ...
            if (player.cor < 33) {
                ...
                outputText("You sigh, squeezing out thick globs of pre-cum as you fondle the nodule-ringed crown of your " + game.player.cockDescript(0) + ", twitching happily against your hands.  Oh gods it feels too good to be true.  Happy coos of pleasure escape your mouth as you try to endure your lewd actions.  You struggle against your possessed loins as they guide your fingertips over the most sensitive places, temporarily stealing away control of your limbs.", false);
            ...
            // Medium corruption characters
                ...
                outputText("Your orgasm spreads through the demon like a wave.  You briefly wonder if it's the demon causing this to feel so good, or your own corrupt desires.  The thoughts are scattered by the feeling of a fat gob of spooge splattering over your " + face(player) + ".  You blink your eyes clear in time to see the fat, pulsating tip of your " + game.player.cockDescript(0) + " hovering in front of your face.  Your urethra spreads wide, launching another spurt and splattering it into your " + hairDescript() + ".\n\n", false);
            ...
            // high corruption characters
                ...
                outputText("He's so right too.  You could keep making him bigger until it's hard to move and he drags on the ground, but you're sure his demon-magics would entice plenty of corrupted sluts, and haze the minds of any uncorrupted person enough to bring them under the spell of your " + game.player.cockDescript(0) + ".  Gosh it makes you hot!  Just thinking about having a harem of goblin girls massaging your mighty member while another grinds her eager gash against your tip... you NEED to make this happen.  Perhaps you could breed an army of the little sluts, to bear you around on a litter and squeeze out cum anytime you have the barest hint of lust.\n\n", false);
                outputText("Your " + game.player.cockDescript(0) + " seems quite taken with the idea, spurting hot globules of pre-cum until it's glazed itself in a coating of slick wetness.  Both of your hands rub along the surface, soaking themselves in the copious demon-goo, working it entirely of their own volition.  You manage to control your hips at least, and put them to work thrusting up, increasing the stimulation further, and spurring your " + game.player.cockDescript(0) + " to drizzle even more of its corrupt fluid.  It feels too good to try to resist, and there really isn't any reason to, is there?\n\n", false);
                ...
                if (player.biggestTitSize() >= 5) outputText("your hands smashing your " + allBreastsDescript() + " around the " + game.player.cockDescript(0) + " and vigorously titfucking it.", false);
                else outputText("your hands repositioning your " + game.player.cockDescript(0) + " so it lays against your chest.", false);
        ...
        // TITURBATION
            ...
            outputText("Both hands rise unbidden and begin to caress your " + game.player.breastDescript(0) + ".  They slide over every sensitive inch of ", false);
    ...
    public exgartuanBored(): void {
        ...
        if (player.statusAffectv1(StatusAffects.Exgartuan) == 1 && player.cockArea(0) >= 100) {
            ...
            if (select == 0) {
            ...
            else if (select == 4) outputText("You feel your " + game.player.cockDescript(0) + " slowly expand and contract, air escaping its urethra and tickling your nether regions.  Did... did your dick just sigh?  Your demon is growing impatient.", false);
                ...
                outputText("Your " + game.player.cockDescript(0) + " has started rubbing against your thighs as a familiar voice chimes in, \"<i>I've got a hot, steaming batch of cum ", false);
            ...
            switch (select) {
                case 0:
                    outputText("You feel an ominous jiggling in your " + game.player.breastDescript(0) + " as the demon inside you stirs back to wakefulness.  The sound of a yawn being muffled by your " + player.armorName + " confirms it.", false);
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    outputText("Suddenly your " + game.player.chestDesc() + " feel as if they trying to force their way off your chest.  The strange motions are accompanied by some loud moaning, as if they are stretching awake.  Looks like the delightful peace and quiet has ended.", false);
                    break;
                case 4:
                    outputText("Your arms suddenly hug against your " + game.player.chestDesc() + " of their own accord, the squeeze filling you with a hint of warmth.  The demoness is awake and filling you with longing to be touched and teased.", false);
                    break;
                case 5:
                    outputText("Your " + game.player.chestDesc() + " fidget ominously, a muffled female voice piping up, \"<i>No cloth, metal, latex, or gel can protect you from me, champion.  Give in and caress these cans!</i>\"", false);
                    break;
                case 6:
            ...
            // (+Lust in combat) for girls
                ...
                switch (select) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        outputText("You really want to end this fight and bend " + monster.a + monster.short + " over... Why is this taking so long, your " + game.player.cockDescript(0) + " does NOT want to wait!", false);
                        if (player.cor < 50) outputText("  You snap back to reality and curse yourself for falling to the demon's desires.", false);
                        break;
                    case 4:
                        outputText("This fight has gone on long enough; all you really want is to shove your " + game.player.cockDescript(0) + " into the " + monster.a + monster.short + "'s... Wait, what? Your possessed pecker is getting the better of you.", false);
                        break;
                    case 5:
                        outputText("For a moment, you find it hard to concentrate, visions of impaling the " + monster.a + monster.short + " with your " + game.player.cockDescript(0) + " etching their way into your mind.  Curse this horny demon!", false);
                        break;
                    case 6:
                        ...
                        break;
                    case 7:
                        outputText("Maybe it would be best to just lay down your arms and strip off your " + player.armorName + ". Just give yourself up to the " + monster.a + monster.short + " and let fate decide. Surely, " + monster.pronoun1 + " would return the gesture by embracing your " + game.player.cockDescript(0) + " and... Augh!  The demon is again toying with your judgment.", false);
                        break;
                    case 8:
                        outputText("Tight loving assholes and gaping vaginas, slick long red tongues and breasts like fine china.  Succubi and the hot sexings they bring, these are a few of your favorite things!  ...Wait, what?  Was that musing your own?  And why are you absently stroking your " + game.player.cockDescript(0) + "?", false);
                        break;
                    case 9:
            ...
            // (Taunts Male Foes -enemy lust)
                ...
                switch (select) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        outputText("Your " + game.player.cockDescript(0) + " squirms around, pushing your " + player.armorName + " out of the way.  Exgartuan barks, \"<i>Why are you bothering my host, fool?  Can't you see my magnificence?  You're nothing compared to me.  Go wank in shame and get out of our way.  We have cunts to fill.</i>\"", false);
                        break;
                    case 3:
                        outputText("The waist of your " + player.armorName + " expands as your " + game.player.cockDescript(0) + " flies skyward fully erect, \"<i>Tremble in fear, peon! My " + num2Text(player.cocks[0].cockLength) + " inches of might shame that feeble nub between your legs.  We've no time for your slack-jawed awe; go home and be a family man.</i>\"", false);
                        break;
                    case 4:
                        outputText("Disobeying your will, your hands promptly undo your " + player.armorName + ", your " + game.player.cockDescript(0) + " springing forth and flaring its urethra menacingly at the " + monster.a + monster.short + ", \"<i>You have a dick not even a mother could love.  Has that thing ever graced another living being's flesh?  Run back to your lonely hovel full of unattainable fantasies, and leave the real action to the pros.</i>\"", false);
                        break;
                    case 5:
                        ...
                        break;
                    case 6:
                        outputText("Your " + player.armorName + " unexpectedly opens itself of its own accord, prompting your " + game.player.cockDescript(0) + " to extend into the open air, \"<i>All the chemicals, potions, and morsels in existence can't help that infinitesimal tool you possess.  The orifices of this world deserve better!  All you are accomplishing this day is their disappointment in delaying the inevitable.</i>\"", false);
                        break;
                    case 7:
                        outputText("All of a sudden, your " + player.armorName + " splays open, your " + game.player.cockDescript(0) + " quickly slithering up and around your back, stopping uncomfortably close to your face while pointing at your opponent, \"<i>Look at this pitiful cretin, " + player.short + ".  We could be out spreading hot dickings to the wanting cunts of the land.  But, no!  This " + monster.a + monster.short + " desires eradication.  Well, champion...oblige him.</i>\"", false);
                        break;
                }
            ...
            if (monster.totalCocks() > 0) {
                ...
                switch (select) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        outputText("Your " + game.player.chestDesc() + " begin to playfully bounce up and down, making it difficult for you to focus on your fight.  You aren't too worried, however, as the " + monster.a + monster.short + " seems to be hypnotized by the movement.", false);
                        break;
                    case 4:
                        outputText("A sultry woman's voice teases the " + monster.a + monster.short + ", \"<i>There's no need for hostilities, is there?  Merely lay down your arms and come help fondle these marvels of creation.</i>\"  Your " + game.player.chestDesc() + " shimmy for emphasis.", false);
                        break;
                    case 5:
                ...
                switch (select) {
                    case 0:
                        outputText("A brief fantasy of " + monster.a + monster.short + " brutally squeezing and caressing your chest fills your mind.  You break free of the twisted daydream and pull your hands away from your " + game.player.breastDescript(0) + ".  Damnit you're in combat!  There's no time for such foolishness!", false);
                        break;
                    case 1:
    ...
    public exgartuanArmorShift(): void {
        ...
        if (player.armor == armors.BEEARMR) {
            ...
            outputText("The green gel-plate protecting your groin thins and presses tightly against you, molding around your " + game.player.cockDescript(0) + " in an incredibly lewd way.", false);
            player.modArmorName = "crotch-hugging glistening gel-armor plates";
            changed = true;
        }
        else if (player.armor == armors.LEATHRA) {
            outputText("Your leather armor shifts, pressing tightly against your upper " + player.legs() + " and molding itself around your " + game.player.cockDescript(0) + " to prominently display it.", false);
            player.modArmorName = "crotch-hugging leather armor segments";
            changed = true;
        }
        else if (player.armor == armors.INDECST) {
            outputText("The chainmail bikini of your indecent steel armor rearranges and bends its interlocking rings to best shape itself around your " + game.player.cockDescript(0) + ", leaving very little else to the imagination.", false);
            player.modArmorName = "crotch-hugging practically indecent steel armor";
            changed = true;
        }
        else if (player.armor == armors.R_BDYST) {
            outputText("The thin, transparent material of your red bodysuit begins to firmly press against your groin, perfectly shaping to your " + game.player.cockDescript(0) + " and every last one of its nubs and nodules.", false);
            player.modArmorName = "crotch-hugging red, high-society bodysuit";
            changed = true;
        }
        else if (player.armor == armors.SSARMOR) {
            outputText("The fine silk that makes up your armor suddenly undoes itself around your crotch, exposing your " + game.player.cockDescript(0) + " to the open air. The thin strands in the air begin to re-weave themselves around your enormous member, forming a prominent new addition to your protection.", false);
            player.modArmorName = "crotch-hugging spider-silk armor";
            changed = true;
        }
        else if (player.armor == armors.S_SWMWR) {
            outputText("The miniscule piece of swimwear that doubles as a tent to your " + game.player.cockDescript(0) + " begins to grow and encapsulate it, molding itself perfectly to your manhood.", false);
            player.modArmorName = "crotch-hugging slutty swimwear";
            changed = true;
        }
        else if (player.armor == armors.FULLCHN) {
            outputText("You\'re taken by surprise as the binds of your chainmail begin to flatten and rearrange themselves, doing their best to match the curves of your " + game.player.cockDescript(0) + " and make its presence known.", false);
            player.modArmorName = "crotch-hugging full-body chainmail";
            changed = true;
        }
        else if (player.armor == armors.CHBIKNI) {
            outputText("Your chainmail bikini rearranges and bends its interlocking rings to best shape itself around your " + game.player.cockDescript(0) + ", leaving very little else to the imagination.", false);
            player.modArmorName = "crotch-hugging revealing chainmail bikini";
            changed = true;
        }
        else if (player.armor == armors.FULLPLT) {
            outputText("You begin to clench your fists as your steel platemail heats up around your " + player.legs() + " and crotch. Slowly it begins to press itself against your " + game.player.cockDescript(0) + " and match its every feature.", false);
            player.modArmorName = "crotch-hugging full platemail";
            changed = true;
        }
        else if (player.armor == armors.SCALEML) {
            outputText("The steel scales that make up your armor begin to flap wildly around your crotch. They bend and shift as they attempt to match the profile of your " + game.player.cockDescript(0) + ".", false);
            player.modArmorName = "crotch-hugging scale-mail armor";
            changed = true;
        }
        else if (player.armor == armors.LTHRROB) {
            outputText("Your leather armor shifts, pressing tightly against your upper " + player.legs() + " and molding itself around your " + game.player.cockDescript(0) + " to prominently display it through your robes.", false);
            player.modArmorName = "crotch-hugging black leather armor surrounded by voluminous robes";
            changed = true;
        }
        else if (player.armor == armors.RBBRCLT) {
            outputText("You begin to feel your rubber outfit compressing itself against your upper " + player.legs() + " and " + game.player.cockDescript(0) + ", eliminating any pockets of air or wrinkles that may have existed before.", false);
            player.modArmorName = "crotch-hugging rubber fetish clothes";
            changed = true;
        }
        else if (player.armor == armors.ADVCLTH) {
            outputText("The layer beneath your tunic begins to compress against your " + game.player.cockDescript(0) + ", highlighting every curve and nodule while lifting your package to be clearly visible beneath your outer layers.", false);
            player.modArmorName = "crotch-hugging green adventurer's clothes";
            changed = true;
        }
        else if (player.armor == armors.OVERALL) {
            outputText("The denim of your overalls begins to press tightly against your " + game.player.cockDescript(0) + ", molding itself around your member and its every facet.", false);
            player.modArmorName = "crotch-hugging white shirt and overalls";
            changed = true;
        }
        else if (player.armor == armors.C_CLOTH) {
            outputText("Your clothing shifts, tightening up about your crotch until every curve and nodule of your " + game.player.cockDescript(0) + " is visible through the fabric.", false);
    ...
    public exgartuanBeeRape(): void {
        ...
        outputText("\"<i>You sure know your knots!   Speaking of knots, I got an idea...</i>\" exclaims the demon inside your " + game.player.cockDescript(0) + ".  You wonder at what the demon could have in mind this time as you finish spreading the bee-bitch's legs in preparation.  The scent wafting out from her genitals is unreal, making you simultaneously hungry and incredibly horny.  You pull up the ginormous flanged tip with both hands and rub it over her honey-slicked crotch, mixing your demonic pre-seed with her honey as you smear it all over her downy inner thighs.\n\n", false);
        ...
        outputText("You pull out with a satisfied grunt, enjoying the wet 'schlick' sound your " + game.player.cockDescript(0) + " makes as it pulls free of the bee-girl's once-tight hole.  Where once there was a honey-coated slit now resides a gaping monster, drooling a gooey mixture of slime and your tainted demonic seed.  Well, maybe her queen will have an easier time packing her full of eggs.\n\n", false);
        ...
        if (player.cor <= 20 && player.findPerk(PerkLib.BulgeArmor) >= 0) {
            ...
            if (player.cor < 33) {
                ...
                if (flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] < 5) {
                    ...
                    if (player.biggestTitSize() >= 2) outputText("you squeeze your tits around your " + game.player.cockDescript(0) + " with your biceps", false);
                    else outputText("you squeeze and caress your " + game.player.cockDescript(0), false);
                ...
                // (MED+COR, DONE A LOT:
                    ...
                    if (player.biggestTitSize() >= 2) {
                        outputText("  Your biceps squeeze around your " + allBreastsDescript() + ", mashing them into your " + game.player.cockDescript(0) + " and adding to the pleasure.", false);
            ...
            if (player.gender == 3) {
                ...
                if (player.balls == 0) {
                    ...
                    outputText(" surrounding your sex, teasing you with the barest hint of sensation while your ignorant hands maul your " + game.player.cockDescript(0) + " at Exgartuan's behest.  If only you had taken care of yourself earlier, you might have had the control to slip a digit into your " + vaginaDescript(0), false);
            ...
            if (temp > 500) {
                ...
                if (temp > 2500) outputText("  Back-pressure blasts your " + game.player.cockDescript(0) + " free from your imprisoning oral cavity along with a fountain of seed while you weakly try to cough out enough spooge to breathe.", false);
            }
            outputText("\n\n", false);
    ...
    private exgartuanBulgeTortureII(): void {
        ...
        outputText("  A little more pushing, pulling, knocking, groping, and stroking confirms what you feared: your " + game.player.cockDescript(0) + " has been cordoned off from you", false);
        ...
        if (player.biggestTitSize() >= 2 && player.bRows() == 1) outputText("  Your quest begins squarely on your pair of " + game.player.chestDesc() + ", your mitts feverishly groping and tugging away in the hope of finding any sanctuary from your encroaching lust.  Unable to extract any meaningful solace from your magnificent mounds, your sights set on your " + nippleDescript(0) + "s.", false);
        ...
        outputText("  Too preoccupied with whatever's going on down below, you can't seem to focus enough to get the job done right.  Your peer down your body at your " + game.player.cockDescript(0) + ", still flaccid and on lockdown.  The most you can respond is with another deep sigh, retreating your attention to the canvas up above you.  You figure the best course of action from here is to just try and make it until morning when you can find some help.  Confessing shame to some third party seems a much better alternative to going any more rounds with this nonsense.  Your fists clench and you take some deep breaths, prepared to ride out the remainder of the night with your sanity intact.\n\n", false);
    ...
    private exgartuanBulgeTortureIII(): void {
        ...
        outputText("  Through the blurry, trembling mess that is your vision, you can make out the mighty titan, its figure silhouetted against the blood-red moon behind it.  After what feels like forever, your majestic manhood slowly descends from its great heights towards you, pulsating in time with your frenzied heartbeat.  As if it were a god descending from heaven to bless a mortal, the " + game.player.cockDescript(0) + " stops right above your gaze, its urethra slowly widening, continuing to spill pre-cum all over your plagued form.\n\n", false);
    ...
    private exgartuanBulgeTortureIV(): void {
        ...
        outputText("  You pay one more glance to Exgartuan, the " + game.player.cockDescript(0) + " comfortably resting away in your outfit.\n\n", false);
    ...
    private boobGartuanSURPRISE(): void {
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            outputText("Your warning turns to moaning as the imp's hands quickly latch onto your " + game.player.chestDesc() + ", discarding the walking stick and golden idol to the hard floor.  \"<i>I don't need any of your words of wisdom, " + player.short + ",</i>\" Nemus teases, his eyes meeting yours while he continues to caress your breasts, \"<i>You are little more than my trophy now.  Hardly a position befitting of giving advice, wouldn't you agree?</i>\" You start to tilt your head back as his grubby mitts continue to grope your massive mammaries.  The fiend slowly moves in on you, his unkempt nails teasing your sensitive " + skin(player) + ".  You begin to feel the rough fabric of his overalls brushing up against you, brought on by his stiffening member.  Nemus continues to draw closer to you.\n\n", false);
    ...
    private boobgartuanSurprise2(): void {
        ...
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            // [if corruption <30]
            if (player.cor < 33) outputText("Your " + game.player.chestDesc() + " brush against the imp's enormous scrotum, causing him to eventually tumble over from the sensation, blocking the impeding entourage of imps behind you.", false);
            // [if corruption ≥30 & <70]
    ...
    private boobgartuanSurprise3(): void {
        ...
        outputText("Thankfully you were more prepared this time, your reflexes heightened enough to keep you from slamming your noggin yet again.  You also felt just where the shove originated from: your " + game.player.chestDesc() + ".  ", false);
        // [if occurrence ==0]
        if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) outputText("As you sit up and begin to piece the puzzle together, you're interrupted by a familiar voice, \"<i>You have time to fuck everyone in Mareth silly, but can't be bothered to spend an instant of it with these magnificent mounds?</i>\" You feel your " + game.player.chestDesc() + " jiggle as Exgartuan speaks, only to have them yank you forward, planting your face back in the ground.  \"<i>I'll just have to make sure you'll never forget again.</i>\"", false);
        // [if occurrence ≥1]
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4) {
            outputText("It's Exgartuan again; you haven't fondled her in a while.  \"<i>Rarin' for another round, eh, champion?</i>\" your " + game.player.chestDesc() + " ask you, jiggling furiously for emphasis, \"<i>I had hoped the previous lesson", false);
            // [if occurrence ≥2]
        ...
        // if occurrence ≥4
        else if (flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8) outputText("</i>\"ARE YOU DENSE, CHAMPION?</i>\" Exgartuan shouts, your mammoth melons bouncing furiously on her every word, \"<i>I will knock you SENSELESS until I clear some space in that vapid cesspool between your ears!</i>\" You want to try and calm her down, but your " + game.player.chestDesc() + " promptly launch your face square into the dirt.  \"<i>Don't go on thinking for another SECOND that you can ignore ME!</i>\"", false);
        // [if occurrence ≥8]
        else outputText("Before another thought can cross your mind, your " + game.player.chestDesc() + " fly up and smack you in the gob! \"<i>" + player.short + ", it's that time again,</i>\" the eager demoness teases you.  You think she's grown to enjoy the torture she puts you through.  \"<i>If you insist on going day in and day out without spending quality time with these tits, then I'll just insist on instructing you otherwise.</i>\" Your beautiful bosom launches forward, throwing your mug right back in the dirt.", false);
        ...
        outputText("  You make out a slight warmth radiating through your chest, followed by your " + game.player.chestDesc() + " pulling you up into the air!  Your weak bonds to the earth either slip free or unroot, leaving you at the mercy of your possessed pillows.  Not long after you return to your feet does your chest remount its attack, flinging you with ease from side to side while Exgartuan laughs at you.  By the third time you tumble towards the terrain, you finally decide to lock your arms around your mutinous milk cans, your fingers clamping down as hard as they can into your " + skin(player) + ".  Your powerful puppies flow over your death grip, the pressure becoming pleasure, your struggle dissolving into confusion.  The demoness pushes and shakes against your hold as your footing keeps up to compensate.  It seems as though her desire to be fondled is stronger than her desire to fight, your turbulent tatas' harsh movements slowly becoming much more smooth and relaxed.\n\n", false);
        ...
        outputText("  You finally bear down and grasp onto... nothing?  <b>Your nipples are nowhere to be found!</b>  The passion is beginning to flatline as you confusedly grope around your " + game.player.chestDesc() + ".  \"<i>What's wrong, champion?</i>\" Exgartuan asks knowingly, \"<i>Is this too hard for you?</i>\" The tips of your fingers comb around your areolas until you discover an inward bend in your " + skin(player) + " where your nipples should be.  Apparently, Exgartuan isn't through having fun with you; the blasted seductress managed to suck your teats inward!  Before you can fathom just how she pulled it off without your knowledge, your humble howitzers start to tingle.  You feel an anxious quiver work its way up your spine before a familiar need begins to course through your being: the need to be milked!", false);
        // [if corruption <50]
        ...
        // [if not lactating]
        if (player.biggestLactation() < 1 || player.lactationQ() == 0) outputText("  <b>Your " + game.player.chestDesc() + " have started to lactate profusely.</b>", false);
        ...
        outputText("Your " + game.player.chestDesc() + " begin to rumble and quake, filling you with a mix of anxiety, dread, and passion.  One moment later, an enormous force bursts forth against your hands; your nipples have popped back out, soaking and ready to - wait a second...", false);
        ...
        outputText("Your hands go to work on your nips, a tug here, a stroke there, your fingers exploring the ins and outs of your titantic teats.  You punch in just a scant number of moments before your faucets reach their crescendo, your hands holding on for all their worth as milk sprays out everywhere, your " + game.player.chestDesc() + " writhing with each squirt.  It's hard to make out just how much or how far your cream has gone in the dark, but judging by what seemed like an eon of excitement, you're confident that you've made your mark.  You know that Exgartuan has fallen into her slumber when your otherwise perky pompoms succumb to the laws of gravity and return to their original state, soreness seeping in after a night of tossing, tugging and teasing.", false);
        // [if corruption <50]
    ...
    public exgartuanNagaStoleMyMasturbation(): void {
        ...
        // [else]
            ...
            outputText("  Your " + game.player.cockDescript(0) + " makes good on its end of the bargain by pumping out its own never-ending supply of lubricant, making your master massage all the more slick and smooth along its surface.  You lay off for a moment to admire your work, your demonic dong throbbing happily now that its full of blood and as tall and thick as a tree.  The corrupt warmth and comfort flowing through your body pleases you to no end.\n\n", false);
        ...
        outputText(" load working its way up your " + game.player.cockDescript(0) + "... and stop.  You sit up in an involuntary attempt to release the pressure, only to be met by your coiled-up shaft bending to greet your face, its urethra spread wide open...\n\n", false);
