...
export class Vapula extends NPCAwareContent implements TimeAwareInterface {
    ...
    private jojoButtFuckTrain(): void {
        ...
        if (player.cockArea(x) > 100) outputText("  You can actually feel his internal organs being bumped against your meat as your " + cockDescript(game.player, x) + " stretches his colon beyond its normal size and thrusts in and out like a charging mammoth.");
