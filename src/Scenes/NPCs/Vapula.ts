...
export class Vapula extends NPCAwareContent implements TimeAwareInterface {
    ...
    private vapulaCeraphThreesomePleaseBoth(): void {
        ...
        outputText(".");
        outputText("\n\nYou feel your ");
        if (player.balls > 0) outputText(ballsDescriptLight() + " twitch and your " + cockDescript(game.player, x) + " pulsate as they unload their");
