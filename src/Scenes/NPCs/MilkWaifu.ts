...
export class MilkWaifu extends NPCAwareContent {
    ...
    private milkBathTime(): void {
        ...
        else if (player.gender == 3) outputText(game.player.multiCockDescriptLight() + " and [vagina]");
