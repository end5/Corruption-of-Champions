...
export class Raphael extends NPCAwareContent implements TimeAwareInterface {
    ...
    private RaphaelPicnicSkill(): void {
        ...
        // {Fencing practice variables: Speed 30-39 Must play out at least once}
            ...
            outputText("You gasp.  For the first time, Raphael forbids you something with harsh tone.  It's quite the departure.  You hang limply from his grasp, your " + game.player.breastDescript(0) + " squashed against his chest like dough.\n\n", false);
        ...
        // {Fencing practice variables: Speed 40-49, Must play out at least once}
            ...
            outputText("<i>\"I think you have found the proper posture now.\"</i> he comments austerely, holding you by the " + game.player.breastDescript(0) + " once more to make sure the angle of your back is correct. You push your rear a bit deeper into the fox's loins without needing to be guided in, enjoying the heat pulsing off the seat upon his manhood and how shamelessly you're grinding into him.  You actually begin to wonder if he himself doesn't notice and you struggle to contain the urge to wiggle around and bring attention to it.\n\n", false);
