...
private  fuckFollowerSophie():void {
	...
	//Both
	outputText("  You strip out of your [armor] without a second thought and present your " + cockDescript(x) + " to Sophie.");
	...
	outputText("\n\nSophie gives your " + cockDescript(x) + " an appreciative swat before pirouetting around, bent over with her hands on her knees and her butt up in the air.  She wiggles back and forth, her lasciviously luscious backside jiggling, the cheeks clapping audibly at the apex of each sway.  Her voice purrs, \"<i>Come and get it, if you think you're " + player.mf("man","woman") + " enough!</i>\"");
	
	outputText("\n\nYou prowl forward, but Sophie backs up, wings flapping, her rump pushing right into you.  Her bubble-butt drives you back against one of the many standing stones, pinned between a cunt and a hard place.  Squishing noisily, your " + cockDescript(x) + " slides right into Sophie's ");
	...
	outputText(", her words still affect you.  Her pussy just feels... so... exquisite.  It's so hot and wet that you almost feel like you could cum right now.  Your [legs] wobble, but Sophie just pushes back even harder, holding you up by your " + cockDescript(x) + " and the friction of your [butt] on the boulder.  The harpy watches your expression as her hips continue their slow roll, feeling your fingers twitch and knead her immense backside when the pleasure begins to mount.  You try to stay composed, but it's just so gods-damned good!  Her silken slit is so warm, wet, and just plain... erotic.  Slowly, the point where you would normally orgasm approaches, but instead of the spasming clenches that signal release, your jizz stays bottled up inside you tighter than sperm in a goblin's womb.");
	...
	if(y >= 0) outputText("You shift to bring your " + cockDescript(y) + " up in place, just in time for Sophie's wiggling rectum to spread around it.  It slides on in without so much as a whimper.");
...
private  sophieBlowsSixtyNine():void {
	...
	if(player.cockTotal() > 1) outputText("s, searching for her target of the day.  At last, she settles on your " + cockDescript(x) + ", giving it an affectionate squeeze");
	...
	if(player.cumQ() >= 500) outputText("  She quickly gives up on trying to swallow it after she starts showing some cum-pudge, but her hand pumps you energetically as she milks your " + cockDescript(x) + ", squeezing the voluminous ropes of cum all over your [chest].");
...
private  forceSophieBlowjob():void {
	...
	outputText("\n\nImpatient, you slide your fingers through her feathery locks and edge her closer.  Her shining, amber mouth bumps into your " + player.cockHead(x) + ", followed by a surprised chirp from the unresisting harpy.  At that first touch, the electric tingle of her glossy gold lipstick hits you, causing your heart to beat faster and your " + cockDescript(x) + " to thicken slightly with arousal in her hand.  You involuntarily push harder without meaning to, spreading Sophie's plump cock-kissers around the thickening meat, her spit slicking the slow, steady journey into her mouth.  Like magic, she begins to push forward on her own, almost pulling out of your grip in her eagerness.  Her mouth smoothly slides down ");
...
private  sophieSpecial():void {
	...
	outputText("\n\nYou hear Sophie's shlicking vagina swallow your entire " + cockDescript(x) + " and release it repeatedly, her hips and soft, plump ass bouncing off of your [legs] as she continues to fuck herself on your " + cockDescript(x) + " harder and harder.  The way her inner folds lap and massage at your drug-infused cock is exquisite, and it takes every ounce of willpower to indeed stop yourself from cumming inside her repeatedly like you were broken down there.  Finally, Sophie slaps her hips into your hardness, moaning out loud as her cunt squeezes and tugs at your member violently, temporarily stopping the flow of cum out of your " + cockDescript(x) + ", but only for a split second.  It churns and boils in your [balls], raising through your " + cockDescript(x) + " to be fired into Sophie's wet, ravenous cunt and baby-wanting womb.  Sophie's own orgasm and yours blend into one and prolong one another as you release ");
	...
	outputText("\n\nShe says that, but every lift and fall of her hips is a torture on your thoroughly milked, overly sensitive " + cockDescript(x) + ".  Her pussy is trying to draw out every drop of fluid you have in your body, and soon, it will succeed at doing just that it seems...");
