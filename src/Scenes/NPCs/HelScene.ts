...
export class HelScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public loseToSalamander(): void {
        ...
        if (player.hasCock() && (player.gender == 1 || rand(4) < 3) && player.cockThatFits(85) >= 0) {
            ...
            outputText("If only to get her working on your cock, you start sucking on her tail like it was her own prick, licking the underside and nibbling on the soft, yielding scales.  Satisfied, she starts to rise on your " + game.player.cockDescript(x) + ", letting it taste the mercifully cool air of the plains – before thrusting back down upon you, engulfing you in her searing heat.  The two of you continue like this for some time, you busily working her tits and sucking her tail as she fucks your " + game.player.cockDescript(x) + ", thrilling your mind with the intense disparity between cool air and burning depths.\n\n", false);
            ...
            outputText(".  She gasps at the sensation and grabs your hips as another shot goes off inside her.  Panting, she gives you one massive, final thrust and cums herself, squeezing your " + game.player.cockDescript(x) + " hard inside her and screaming as brutal a scream as any warcry to the heavens.", false);
        ...
        // Player Loss – Rape – Female
            ...
            if (player.gender == 3) outputText("\"<i>Though not exactly a woman, are we?</i>\" she laughs, giving your " + game.player.cockDescript(x) + " a quick stroke.  ", false);
            ...
            outputText("Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your " + game.player.chestDesc() + ".  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her cum-soaked tail from your " + vaginaDescript(0) + " and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.", false);
        }
        // Player Loss – Rape – Genderless & Male >85 cockarea
            ...
            outputText("Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your " + game.player.chestDesc() + ".  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her tail from your " + assholeDescript() + " and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.", false);
        }
        player.orgasm();
        dynStats("sen", 1);
    ...
    public beatUpHelAndStealHerWalletFromHerVagina(): void {
        ...
        if (player.hasVagina()) outputText(" while releasing her breasts to finger your " + vaginaDescript(0), false);
    ...
    public getLickedByHel(): void {
        spriteSelect(68);
        outputText("", true);
        outputText("You agree to her proposition, and instruct her to get on her knees as you slip out of your " + player.armorName + ", revealing your " + vaginaDescript(0) + ".  She grins and kneels before you, quickly discarding her scaled bikini as you grasp her shoulders, pressing your womanhood to her lips.  Her long, forked tongue darts forward, teasing your lips.\n\n", false);
        ...
        if (player.hasCock()) {
            outputText(" while " + game.player.sMultiCockDesc() + " shoots its load into her red hair", false);
    ...
    public helTailPegging(): void {
        ...
        outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, sensing this from the fashion you're wringing her tail, gives your " + buttDescript() + " a hard slap and slams in as far as it can go.  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt", false);
        if (player.gender > 0) {
        ...
        outputText(", writhing in pleasure as her tail slowly withdraws from your " + assholeDescript() + ".\n\n", false);
    ...
    private nagaCoilsUpHel(): void {
        ...
        outputText("You're not quite done yet, though.  As soon as her orgasm subsides, you draw her off your shaft and turn her upside down in your tail's grasp.  You lower her head until it's even with your " + game.player.cockDescript(x) + ", and her bare cunt is vulnerable before you.  Without encouragement, she takes your shaft into her mouth, using her tits to pump it into her welcoming maw as you set to work on her twat, tongue fucking her while you slip one, two, three fingers into her ass, eliciting a deep moan of pleasure from her with the dual stimulation.\n\n", false);
        ...
        outputText("massive orgasm, you collapse onto your back and release your salamander lover from your grasp.  She crawls up to you and nuzzles into your " + game.player.chestDesc() + ", wrapping her own tail around you in return.  Soon, you drift off into a calm, peaceful sleep.", false);
        // (reduce lust, increment Helgate flag by 1)
        player.orgasm();
        flags[kFLAGS.HEL_FUCK_COUNTER]++;
        flags[kFLAGS.HEL_AFFECTION]++;
    ...
    private nagaCoilsUpAnalNaga(): void {
        ...
        outputText("When you come to your senses, you're lying on your back, panting and gasping for breath.  Slowly, you salamander lover drags herself to her feet, only to collapse on top of you a second later.  Seemingly content, she nuzzles into your " + game.player.chestDesc() + " and strokes your cheek.  No less than exhausted yourself, you soon drift off into a peaceful sleep.", false);
        // (reduce lust, increment Helgate flag by 1)
        player.orgasm();
        flags[kFLAGS.HEL_FUCK_COUNTER]++;
        flags[kFLAGS.HEL_AFFECTION]++;
    ...
    private mountHel(): void {
        ...
        outputText("You're a little nervous about outright breaking her, but she asked for it.  You trot up and swing your front hooves over her shoulders, resting part of your weight on her as your " + game.player.cockDescript(x) + " presses urgently against her firm ass cheeks.  She gasps and groans under your weight and at the prodding of your cock, so desperately seeking a hole to fill.  Finally, you slip between her legs and enter her cunt, ramming your full " + num2Text(int(player.cocks[x].cockLength)) + " inches into her sweltering depths.  You gasp and shudder at the intense heat of her inner walls, but your lover can only cry with exaltation as your cock fills her to the hilt.\n\n", false);
        ...
        outputText("You fuck and rut and thrust until the salamander lets out a sharp cry, and her steaming inner muscles clamp down like a vice.  You grunt and impale her one last time before your " + game.player.cockDescript(x) + " explodes within, filling her to the brim with your centaur spunk", false);
        if (player.cumQ() >= 500) outputText(" until it begins to pour out around your cock, pooling between her spread legs", false);
        outputText(".\n\n", false);

        outputText("You stay like that for a good few minutes, your " + game.player.cockDescript(x) + " rammed to the hilt inside of her as she grips the tree, huffing and puffing and reeling from her orgasm.  Finally, she lowers her rear, letting you dismount her.  You take only a few paces before you collapse on your side, exhausted.  A moment later and you feel the warm body of your salamander lover curl up against your belly, arms wrapped tightly around your flanks.\n\n", false);
    ...
    private helVaginaTaur69(): void {
        ...
        outputText("You start trotting, letting the hands on your withers guide you this way and that across the wide open plains.  All the while, she whispers gentle encouragements into your ear, occasionally stopping to rub her tits tantalizingly into your back, letting her dangling tail flicker across your " + vaginaDescript(0) + " and " + buttDescript() + ".  Eventually, though, she sets her sights on a patch of particularly tall, green grass, almost up to your ears.  As soon as you arrive, she slips gracefully from your back and laughs aloud.  \"<i>Oh, that was so much fun.  Thank you, friend.  I've never ridden a horse – a centaur – before you, but I think I could get used to it.  Oh!  Imagine, you and I, valiant adventurer and her trusty warhorse, wading into battle like – hey, I see that look on your face.  Don't laugh, dammit!</i>\"\n\n", false);
        ...
        if (player.hasCock()) {
            outputText("Now that you're calmer, the salamander takes the opportunity to grasp " + game.player.oMultiCockDesc() + " with her free hand and guide it into her mouth.  Her forked, reptilian tongue flicks out, running across your girth as more and more of you slips past her thin lips and down her throat", false);
        ...
        outputText(".  Getting a good grip on her hot, red tail, you start to fuck her hard, fast, and perhaps vengefully as she continues to assault your " + vaginaDescript(0), false);
        if (player.hasCock()) outputText(" and swelling member", false);
        outputText(".\n\n", false);

        outputText("It cannot go on forever.  You soon feel the tell-tale pressure of impending orgasm building behind your " + vaginaDescript(0), false);
    ...
    private helPossessionShitPoopCock(): void {
        ...
        if (player.hasFuckableNipples()) {
            outputText("Well, you can't let her have ALL the fun!  Still leaving the lower half of your body within the bunny-girl, you slip a pair of fingers into one of your hungry nipplecunts.  Grinning, you stretch your nipple-fuckhole out and bend forward, letting your chest-lips kiss the tip of your possessed bunny-cock.  You shudder as you press yourself down upon the bunny rod, taking the first few inches into your " + game.player.chestDesc() + " even as the salamander continues to titfuck the length of your column.  You settle into a rhythm with the salamander, rising and falling in unison as you coax the eggs out of the bunny and toward your nipplecunts.\n\n", false);

            outputText("Your eyes roll back in your head, your long tongue rolling out of your mouth as you give in utterly to the pleasure.  The first egg crests out of your distended bunny-cock, making you scream with orgasmic pleasure as it launches into your hard-cumming nipplecunt.  The top of your " + game.player.chestDesc() + " lurches upward with the impact, then again as eggs slam out of you and into your waiting tit-mouth.  Laughing, the reptilian woman yanks the cock out of your tit and squishes it between her own mounds, finishing your orgasm off as she hungrily licks the bunny-spooge out of your chest-holes, letting it pour onto herself as eggs crack against her chest.\n\n", false);
        }
    ...
    private rapingHelsAssMeansYourCorruptCauseAnalIsEvil(): void {
        ...
        outputText("She's too exhausted, and you're too skilled, for the attack to land.  Instead, you grab her wide hips and lunge forward, ramming your " + game.player.cockDescript(x) + " into her ass", false);
        if (y >= 0) outputText(", and your " + game.player.cockDescript(y) + " into her waiting vag, doubling the assault on the helpless berserker", false);
    ...
    private receiveCorruptRimjobsFromHel(): void {
        spriteSelect(68);
        outputText("", true);
        outputText("The sight of the salamander berserker on her knees stirs the fire in your loins, and in moments you've stripped out of your " + player.armorName + " and advanced upon her.  She looks up at you, gritting her teeth as if preparing to strike – you preempt her with a hard kick in the chest, knocking her on her back, then kneel down and straddle her, pinning her arms down underneath your knees as you bring your " + assholeDescript() + " to hover over her face.\n\n", false);
        ...
        if (player.hasVagina()) outputText("  Her tongue begins to zero in on your " + vaginaDescript(0) + ", but you give her a quick penalty swat on the tits.  You've got other plans!", false);
        outputText("\n\n", false);

        outputText("After a few moments of this, her long tongue traces its way along your " + buttDescript() + ", causing small shudders of pleasure to rock through you, but she's only just getting to the main event.  You force yourself to relax your sphincter as her tongue flicks once, twice, thrice across your " + assholeDescript() + ".  In a heartbeat, she's in!  You gasp as her long, slender tongue flicks and writhes within you, teasing and pleasuring the sensitive muscles of your ass as she works more and more of it in.\n\n", false);

        outputText("Firmly within your depths, she plants her smooth, scaled hands on your " + buttDescript() + " and starts to flick her tongue as fast as she can, withdrawing and ramming it back into your ass.  You gasp and moan like a whore", false);
        ...
        outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, possibly sensing this by the way you wring her tongue, gives your " + buttDescript() + " a hard slap and rams in as far as she can go!  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt, writhing in pleasure as her tongue slowly withdraws from your " + assholeDescript() + ".\n\n", false);
    ...
    private helMinoThreeSomeLickItsDick(): void {
        ...
        if (player.hasCock()) outputText(" while " + game.player.sMultiCockDesc() + " ejects its load into the mess on the 'taur's chest", false);
        outputText(".\n\n", false);
    ...
    private stuffIzzyAndSalamanderWithDicks(): void {
        ...
        outputText("You stand up and start stripping out of your " + player.armorName + ".  " + game.player.SMultiCockDesc() + " pops free as soon as your crotch is clear, already at full hardness thanks to the sight of Hel crawling atop Isabella, pressing her E-cups into the cow's milky teats and giving her a full kiss on the lips.  You stay back for a moment, watching the kiss, able to catch just a glimpse of Isabella's massive flat tongue entwining with Hel's long, slender one.\n\n", false);
        ...
        outputText("That's all the invitation you need.  You drop to your knees behind the two redheads and thrust your " + game.player.cockDescript(x) + " into Hel's snatch, eliciting a sharp moan from the salamander.  ", false);
        // (IF MULTICOCK and second cock is under 9 inches:
        if (y >= 0) outputText("Meanwhile, your " + game.player.cockDescript(y) + " slides easily into Isabella's pussy, making the cow-girl gasp at the sudden and unexpected penetration.  ", false);
        outputText("You grab Hel's hips and push in, reveling in the incredible heat and tightness of her pussy as your " + game.player.cockDescript(x) + " slides into her until you've bottomed out", false);
        if (y >= 0) outputText(" with your " + game.player.cockDescript(y) + " similarly coming to a rest inside Isabella's depths; you're able to feel the cow's rapid heartbeat hammering through her, causing her already tight cunt to contract rhythmically around your girth", false);
        outputText(".\n\n", false);
        ...
        if (y == -1) {
            ...
            outputText("Still grasping Hel's hips, you slide into Isabella.  She's tighter than you expected, and you have to fight to push your " + game.player.cockDescript(x) + " into her despite how wet she is.  When you're half-way buried inside her, you begin to pull out, making her moan as Hel adds a good tit-sucking to the experience.  You slam home again, this time ramming your cock up to the hilt inside her.  Isabella lets out a near-orgasmic MOOOOOO as you start to fuck her in earnest, using Hel's hips for leverage as you pound the cow-girl's box with your " + game.player.cockDescript(x) + ".\n\n", false);

            outputText("You keep this up for perhaps two minutes before pulling out of the cow-girl and slamming yourself back into the salamander's hot cunny.  Without warning of the coming blow, Hel gasps, spurting a bit of milk all across Isabella's already sweat-soaked chest.  Now freed from the sucking and fucking combination, Isabella squirms underneath Hel, somehow managing to put the pair of them in a 69 position while you continue to fuck the salamander.  Now in the more equitable position, you see Hel's head bob down between Isabella's luscious thighs, and watch the cow-girl's tongue reach out and give Hel a long, wet lick before making its way up the underside of your " + game.player.cockDescript(x) + ". You shudder at the alien sensation of Isabella's tongue running along your dick, causing you to skip a stroke in fucking Hel.  Giving the cow-girl an encouraging nod, however, you resume in earnest, pounding her as fast and hard as you can.\n\n", false);
        ...
        // (Player has 2-3 cocks)
            ...
            outputText("Now fucking both girls at once with your super-human twin endowments, you settle into a good solid rut.  The girls squeal and moan under your intense fucking, only stopping in their sweetly feminine vocalizations to kiss or suckle each other.  Just as you've hit your rhythm, though, you're suddenly pushed to the ground as both Isabella and Hel give you a playful kick with their hoofed-or-scaled feet.  They switch positions so that Isabella is fore-most and facing you atop your " + game.player.cockDescript(x) + " while Hel sits behind her, impaled on your " + game.player.cockDescript(y), false);
            if (z > -1) outputText(" with your " + game.player.cockDescript(z) + " even now spearing her tight ass", false);
            outputText(".\n\n", false);
            ...
            outputText(" of your cocks in use.  Surprisingly, though, they're the ones who cum first – Isabella lets out a sharp MOOOOO as she contracts down hard upon your " + game.player.cockDescript(x) + ", overwhelmed by the double sensation, and Hel soon follows suit, increasing her tempo wildly as she brings herself to orgasm.\n\n", false);
        ...
        // (Player has 4 cocks or more)
            ...
            outputText("You ram all four cocks into them, sinking your " + game.player.cockDescript(x) + " into Hel's ass, your " + game.player.cockDescript(y) + " into her vag, your " + game.player.cockDescript(z) + " into Isabella's, and your " + cockDescript(zz) + " into her tight asshole.\n\n", false);
    ...
    private izzySallyThreeSomeFollowup(): void {
        spriteSelect(68);
        outputText("", true);
        outputText("Now a sweat-and-cum soaked mess, the girls collapse onto their backs around you.  Sighing contentedly, Isabella rolls over and nuzzles her head on your chest; a moment later sees Hel doing the same, wrapping her warm tail around your " + game.player.cockDescript(0) + " lovingly.\n\n", false);
    ...
    private izzySallyThreeSomeVagoozlaz(): void {
        ...
        // (IF HERM)
        if (player.hasCock()) outputText("As you continue to lick Hel out, you feel a sudden crawling sensation across your belly. Looking down with alarm, you see her armored tail snaking its way across you.  It wraps around " + game.player.oMultiCockDesc() + ", coiling tightly, though it refuses to move.  Groaning, you try to buck your hips into her coiled tail, but Isabella's grasp on your " + hipDescript() + " prevents you from moving more than an inch.  Frustrated, you try to pleasure your tightly-bound cock somehow, but cannot even get your hands around it.  Giving up, you return to licking Hel's cunny, and are immediately rewarded by a hard jerk of your cock.  Now you get it!  You start licking the salamander out with redoubled effort, with a stroke for every lick.\n\n", false);
        ...
        // (IF HERM:
        if (player.hasCock()) outputText(" and Hel jerking your " + game.player.cockDescript(0) + " off", false);
        ...
        if (player.hasCock()) outputText(", wrapping her warm tail around your " + game.player.cockDescript(0) + " lovingly", false);
        outputText(".\n\n", false);
    ...
    public foxyFluffsFoursomeAsMale(): void {
        ...
        let x: number = player.cockThatFits(85);
        if (x < 0) x = player.smallestCockIndex();
        outputText("You strip out of your " + player.armorName + " and grab your " + game.player.cockDescript(x) + ".  Giggling drunkenly, Miko flops onto her back on the bed and begins to stroke her knotty cock as Helia and Mai get on their knees, Hel burying herself between Miko's spread legs as her sister wraps her soft hands around your " + game.player.cockDescript(x) + " and guides it into her mouth.  You run your hands through Mai's silver hair as she sucks you off, jerking off the base of your cock and flicking her wet tongue across the head and shaft, her full lips wrapped around your girth in a cute little \"<i>O.</i>\" She carries on for another minute, letting you guide the speed and force of her blowjob with your hands planted on her head.\n\n", false);
    ...
    public foxyFluffGirlsFuckSex(): void {
        ...
        // [IF NippleCunts:]
        if (player.hasFuckableNipples()) {
            outputText("Now that the girls are nice and wet, you pull them as close together as you can and bring your glistening, moist nipplecunts to bear.  You slip a pair of fingers into each of your " + game.player.chestDesc() + "'s waiting holes, beckoning the girls to penetrate you.  Though somewhat startled by your alien anatomy, a few encouraging words are enough to get the sisters off their feet and grabbing your shoulders for support.\n\n", false);

            outputText("They thrust in easily, sliding their twin doggy cocks into your tits until their knots press against your lips.  You shudder at the penetration, feeling the inhuman sensation of the two shafts sliding into your " + game.player.chestDesc() + ".  As they start to fuck your tits, you feel Hel kneel down behind you, wrapping her scaled arms around your waist and slipping her tail between your legs.  You only have a second to brace for the coming attack before her tail slithers into your " + vaginaDescript() + ", forcing its way into your love tunnel until you can feel her sharp tip writhing and prodding against your womb.\n\n", false);
