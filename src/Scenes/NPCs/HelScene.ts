...
private  helFuckMenu(isAmbush:boolean = false):void {
	...
	var leave:() => void = declineHelSexings;
	...
	var getLicked:() => void = null;
	if(player.hasVagina()) {
		getLicked = getLickedByHel;
	}
	var fuckVag:() => void = null;
	var fuckAss:() => void = null;
	var tailWank:() => void = null;
	var dp:() => void = null;
	var getBlown:() => void = null;
	if(player.hasCock()) {
	...
	var tailFuck:() => void = helTailPegging;
	//ALTERNATE BODY BUTTONS
	var bodyText:string = "";
	var bodyButt:() => void = null;
	var bodyText2:string = "";
	var bodyButt2:() => void = null;
