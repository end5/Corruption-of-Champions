...
export class HelScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public loseToSalamander(): void {
        ...
        // Player Loss – Rape – Genderless & Male >85 cockarea
            ...
            outputText("Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your " + chestDesc(game.player) + ".  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her tail from your " + assholeDescript() + " and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.", false);
        }
        player.orgasm();
        dynStats("sen", 1);
    ...
    public helTailWanksYourDickBecauseSheLovesYouDesuDesuHoraHora(): void {
        ...
        outputText("The salamander reclines back, letting her tail slip between her legs and snake its way toward you.  The surface of her tail, once glowing bright-hot, is now little more than red scales; you have momentary second thoughts, but the first touch of its tip against your leg is enough to calm you – she's hot, but not enough to burn you.  Your " + cockDescript(game.player, x) + " begins to throb with anticipation as the dawdling tailtip makes a slow, sensual trek from the ground to your crotch, lingering and playing along the sensitive skin of your inner thighs and " + assDescript() + " before eventually slithering onto your " + cockDescript(game.player, x) + ".\n\n", false);
    ...
    private stuffIzzyAndSalamanderWithDicks(): void {
        ...
        // (Player has 4 cocks or more)
            ...
            outputText("You ram all four cocks into them, sinking your " + cockDescript(game.player, x) + " into Hel's ass, your " + cockDescript(game.player, y) + " into her vag, your " + cockDescript(game.player, z) + " into Isabella's, and your " + cockDescript(zz) + " into her tight asshole.\n\n", false);
