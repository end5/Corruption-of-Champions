...
export class HelScene implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        trace("\nHelia time change: Time is " + game.time.hours + ", incubation: " + pregnancy.incubation + ", event: " + pregnancy.event, false);
...
export function loseToSalamander(): void {
    ...
    if (player.cocks.length > 0 && (player.gender == 1 || rand(4) < 3) && player.cocks.cockThatFits(85) >= 0) {
        ...
        outputText("If only to get her working on your cock, you start sucking on her tail like it was her own prick, licking the underside and nibbling on the soft, yielding scales.  Satisfied, she starts to rise on your " + cockDescript(game.player, x) + ", letting it taste the mercifully cool air of the plains – before thrusting back down upon you, engulfing you in her searing heat.  The two of you continue like this for some time, you busily working her tits and sucking her tail as she fucks your " + cockDescript(game.player, x) + ", thrilling your mind with the intense disparity between cool air and burning depths.\n\n", false);
        ...
        outputText(".  She gasps at the sensation and grabs your hips as another shot goes off inside her.  Panting, she gives you one massive, final thrust and cums herself, squeezing your " + cockDescript(game.player, x) + " hard inside her and screaming as brutal a scream as any warcry to the heavens.", false);
    ...
    // Player Loss – Rape – Female
        ...
        if (player.cocks.length > 0) outputText(", your cock shooting a massive rope of spunk onto her face as your vag cums from the tailfucking", false);
        outputText(".\n\n", false);

        outputText("Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your " + chestDesc(game.player) + ".  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her cum-soaked tail from your " + vaginaDescript(player, 0) + " and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.", false);
    }
    // Player Loss – Rape – Genderless & Male >85 cockarea
        ...
        outputText("You gasp as you feel a sudden pressure against the rim of your " + assholeDescript(player) + ".  Your eyes widen, but your fiery lover only smiles and increases the pressure against your asshole until you force yourself to relax, admitting the tip of her tail into your ass.  Every few licks, you're forced to stop and gasp or shudder as her tail works its way into your " + assholeDescript(player) + ", fucking you like a cock and a skilled finger at once, not pistoning in and out, but writhing within your depths like a tentacle.");
        ...
        outputText("Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your " + chestDesc(game.player) + ".  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her tail from your " + assholeDescript(player) + " and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.", false);
    }
    player.orgasm();
    dynStats("sen", 1);
...
function helFuckMenu(isAmbush: boolean = false): void {
    ...
    let fuckAss: () => void = null;
    let tailWank: () => void = null;
    let dp: () => void = null;
    let getBlown: () => void = null;
    if (player.cocks.length > 0) {
        ...
        if (player.cocks.length > 1 && player.cocks.cockThatFits(85) >= 0 && player.cocks.cockThatFits2(85) >= 0)
            dp = dpHel;
        getBlown = helBlowsYou;
    }
    const tailFuck: () => void = helTailPegging;
    // ALTERNATE BODY BUTTONS
    let bodyText: string = "";
    let bodyButt: () => void = null;
    let bodyText2: string = "";
    let bodyButt2: () => void = null;
    ...
    // [Possession]
    if (player.isNaga()) {
        if (player.cocks.length > 0 && player.cocks.cockThatFits(85) >= 0) {
...
function declineHelSexings(): void {
    ...
    if (game.inCombat) outputText("\"<i>Aw, hell.  You're no fun,</i>\" she pouts, picking up her sword and sheathing it.  \"<i>Well, at least take this,</i>\" she adds, tossing a few gems your way.  You thank her for the gems as she starts walking over the hill towards wherever it is she's going.  ", false);
...
export function getLickedByHel(): void {
    ...
    if (player.cocks.length > 0) {
        outputText(" while " + sMultiCockDesc(game.player) + " shoots its load into her red hair", false);
...
export function helTailPegging(): void {
    ...
    outputText("You do as she asks, getting on all fours and giving her a good views of your vulnerable " + buttDescription(player) + ".  Looking over your shoulder, you can see her smile wolfishly as she brings her tail to bear, now doused of its previous flames, and gives its tip a little suckle, moistening it up as she straddles your hips to fuck you doggy style.  Her tail slips down from her mouth and winds between her legs like a cock as she lines herself up with your " + assholeDescript(player) + ".\n\n", false);
    ...
    outputText("Firmly within your depths, she plants her smooth, scaled hands on your " + buttDescription(player) + " and starts to hammer your ass, quickly thrusting her tail in and out.  You gasp and moan like a whore, barely able to support your own weight as she fucks your ass hard and fast, threatening to tear your tender insides up with her rough fucking.\n\n", false);

    outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, sensing this from the fashion you're wringing her tail, gives your " + buttDescription(player) + " a hard slap and slams in as far as it can go.  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt", false);
    if (player.gender > 0) {
...
function nagaCoilsUpHel(): void {
    ...
    outputText("You get the idea in a hurry, and discard your " + player.armorName + " as she disrobes, giving you a good view of her smooth snatch and her big, soft breasts.  The sight of her nude form causes your " + cockDescript(game.player, x) + " to quickly slip out of its hidey-hole in your reptilian half; she grabs it and starts to stroke it, bringing it to full hardness as you coil your tail around her feet.  She gasps from the sudden tightness around her belly as you make a full loop around her, binding her arms to her side and pulling her up off the ground with your strong tail.\n\n", false);

    outputText("With your lover now completely at your mercy, you lean back and draw her close, lining her crotch up with your " + cockDescript(game.player, x), false);
    if (y >= 0) outputText(" and her ass up with your " + cockDescript(game.player, y), false);
    ...
    outputText("You're not quite done yet, though.  As soon as her orgasm subsides, you draw her off your shaft and turn her upside down in your tail's grasp.  You lower her head until it's even with your " + cockDescript(game.player, x) + ", and her bare cunt is vulnerable before you.  Without encouragement, she takes your shaft into her mouth, using her tits to pump it into her welcoming maw as you set to work on her twat, tongue fucking her while you slip one, two, three fingers into her ass, eliciting a deep moan of pleasure from her with the dual stimulation.\n\n", false);
    ...
    outputText("massive orgasm, you collapse onto your back and release your salamander lover from your grasp.  She crawls up to you and nuzzles into your " + chestDesc(game.player) + ", wrapping her own tail around you in return.  Soon, you drift off into a calm, peaceful sleep.", false);
    // (reduce lust, increment Helgate flag by 1)
    player.orgasm();
    flags[kFLAGS.HEL_FUCK_COUNTER]++;
    flags[kFLAGS.HEL_AFFECTION]++;
...
function nagaCoilsUpAnalNaga(): void {
    ...
    outputText("Once both your tails are sufficiently lubricated, the salamander crawls behind you, and presses her back tightly to yours.  In an odd show of kindness, she even takes your hands in hers as her tail slithers between the cheeks of your " + buttDescription(player) + ".  You return the favor, soon pressing the tip of your tail to her tight but relaxed asshole as hers begins to slip into your " + assholeDescript(player) + ".  You gasp with the sensation of the hot, writhing tail-cock pushing inside you, fighting every inch to wring sensation out of it even as you push yours deep inside her, hard enough to make her take a sharp breath and knock her knees.", false);
    buttChange(player, 40, true, true, false);
    outputText("\n\n", false);

    outputText("She continues to force her way into you, wriggling her thickening tail further into your " + assholeDescript(player) + ", stretching it wide as her tail gains in thickness.  Finally, though, she can get no more of herself into you, nor you into her.  \"<i>Ready for a wild ride, lover?</i>\" she asks, twisting her head so that she can plant a tender kiss on your shoulder.  You nod eagerly, and start to bounce.\n\n", false);
    ...
    outputText("When you come to your senses, you're lying on your back, panting and gasping for breath.  Slowly, you salamander lover drags herself to her feet, only to collapse on top of you a second later.  Seemingly content, she nuzzles into your " + chestDesc(game.player) + " and strokes your cheek.  No less than exhausted yourself, you soon drift off into a peaceful sleep.", false);
    // (reduce lust, increment Helgate flag by 1)
    player.orgasm();
    flags[kFLAGS.HEL_FUCK_COUNTER]++;
    flags[kFLAGS.HEL_AFFECTION]++;
...
function mountHel(): void {
    ...
    outputText("You're a little nervous about outright breaking her, but she asked for it.  You trot up and swing your front hooves over her shoulders, resting part of your weight on her as your " + cockDescript(game.player, x) + " presses urgently against her firm ass cheeks.  She gasps and groans under your weight and at the prodding of your cock, so desperately seeking a hole to fill.  Finally, you slip between her legs and enter her cunt, ramming your full " + num2Text(int(player.cocks[x].cockLength)) + " inches into her sweltering depths.  You gasp and shudder at the intense heat of her inner walls, but your lover can only cry with exaltation as your cock fills her to the hilt.\n\n", false);
    ...
    outputText("You fuck and rut and thrust until the salamander lets out a sharp cry, and her steaming inner muscles clamp down like a vice.  You grunt and impale her one last time before your " + cockDescript(game.player, x) + " explodes within, filling her to the brim with your centaur spunk", false);
    if (player.cumQ() >= 500) outputText(" until it begins to pour out around your cock, pooling between her spread legs", false);
    outputText(".\n\n", false);

    outputText("You stay like that for a good few minutes, your " + cockDescript(game.player, x) + " rammed to the hilt inside of her as she grips the tree, huffing and puffing and reeling from her orgasm.  Finally, she lowers her rear, letting you dismount her.  You take only a few paces before you collapse on your side, exhausted.  A moment later and you feel the warm body of your salamander lover curl up against your belly, arms wrapped tightly around your flanks.\n\n", false);
...
function helVaginaTaur69(): void {
    ...
    outputText("You start trotting, letting the hands on your withers guide you this way and that across the wide open plains.  All the while, she whispers gentle encouragements into your ear, occasionally stopping to rub her tits tantalizingly into your back, letting her dangling tail flicker across your " + vaginaDescript(player, 0) + " and " + buttDescription(player) + ".  Eventually, though, she sets her sights on a patch of particularly tall, green grass, almost up to your ears.  As soon as you arrive, she slips gracefully from your back and laughs aloud.  \"<i>Oh, that was so much fun.  Thank you, friend.  I've never ridden a horse – a centaur – before you, but I think I could get used to it.  Oh!  Imagine, you and I, valiant adventurer and her trusty warhorse, wading into battle like – hey, I see that look on your face.  Don't laugh, dammit!</i>\"\n\n", false);
    ...
    if (player.cocks.length > 0) {
        outputText("Now that you're calmer, the salamander takes the opportunity to grasp " + oMultiCockDesc(game.player) + " with her free hand and guide it into her mouth.  Her forked, reptilian tongue flicks out, running across your girth as more and more of you slips past her thin lips and down her throat", false);
        if (player.cocks.shortestCockLength() <= 24) outputText(" , until you're buried to the hilt", false);
    ...
    if (player.cocks.length > 0) outputText(" from around your encapsulated cock", false);
    outputText(".  Getting a good grip on her hot, red tail, you start to fuck her hard, fast, and perhaps vengefully as she continues to assault your " + vaginaDescript(player, 0), false);
    if (player.cocks.length > 0) outputText(" and swelling member", false);
    outputText(".\n\n", false);

    outputText("It cannot go on forever.  You soon feel the tell-tale pressure of impending orgasm building behind your " + vaginaDescript(player, 0), false);
    if (player.cocks.length > 0) outputText(" and shaft", false);
    ...
    if (player.cocks.length > 0) outputText(" and filling her throat with jism", false);
    outputText(".\n\n", false);
...
function helPossessionShitPoopCock(): void {
    ...
    if (player.breastRows.hasFuckableNipples()) {
        outputText("Well, you can't let her have ALL the fun!  Still leaving the lower half of your body within the bunny-girl, you slip a pair of fingers into one of your hungry nipplecunts.  Grinning, you stretch your nipple-fuckhole out and bend forward, letting your chest-lips kiss the tip of your possessed bunny-cock.  You shudder as you press yourself down upon the bunny rod, taking the first few inches into your " + chestDesc(game.player) + " even as the salamander continues to titfuck the length of your column.  You settle into a rhythm with the salamander, rising and falling in unison as you coax the eggs out of the bunny and toward your nipplecunts.\n\n", false);

        outputText("Your eyes roll back in your head, your long tongue rolling out of your mouth as you give in utterly to the pleasure.  The first egg crests out of your distended bunny-cock, making you scream with orgasmic pleasure as it launches into your hard-cumming nipplecunt.  The top of your " + chestDesc(game.player) + " lurches upward with the impact, then again as eggs slam out of you and into your waiting tit-mouth.  Laughing, the reptilian woman yanks the cock out of your tit and squishes it between her own mounds, finishing your orgasm off as she hungrily licks the bunny-spooge out of your chest-holes, letting it pour onto herself as eggs crack against her chest.\n\n", false);
    }
...
function rapingHelsAssMeansYourCorruptCauseAnalIsEvil(): void {
    ...
    outputText("She's too exhausted, and you're too skilled, for the attack to land.  Instead, you grab her wide hips and lunge forward, ramming your " + cockDescript(game.player, x) + " into her ass", false);
    if (y >= 0) outputText(", and your " + cockDescript(game.player, y) + " into her waiting vag, doubling the assault on the helpless berserker", false);
...
function receiveCorruptRimjobsFromHel(): void {
    ...
    outputText("Firmly within your depths, she plants her smooth, scaled hands on your " + buttDescription(player) + " and starts to flick her tongue as fast as she can, withdrawing and ramming it back into your ass.  You gasp and moan like a whore", false);
    if (player.breastRows.biggestTitSize() >= 1) outputText(", groping your tits,", false);
    ...
    outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, possibly sensing this by the way you wring her tongue, gives your " + buttDescription(player) + " a hard slap and rams in as far as she can go!  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt, writhing in pleasure as her tongue slowly withdraws from your " + assholeDescript(player) + ".\n\n", false);
...
function helMinotaurThreesome(): void {
    ...
    if (player.cocks.length > 0) outputText("I've got another hole needs filling!</i>\"", false);
...
function helMinoThreeSomeLickItsDick(): void {
    ...
    outputText("With a mighty bellow, the 'taur slams his hips into hers and comes on demand, pumping her so full of bull-cum that jets of it begin shooting back at him, coating his furry chest with his own jism.  The sight of it's enough to drive you over the edge, and you thrust down on the bull's snout and cry aloud as your own orgasm comes, your " + assholeOrPussy(player) + " clenching down on his tongue, trapping it inside you as your orgasm rocks your body", false);
    if (player.cocks.length > 0) outputText(" while " + sMultiCockDesc(game.player) + " ejects its load into the mess on the 'taur's chest", false);
    outputText(".\n\n", false);
...
function nomOnIzzyTitWithSallyMancer(): void {
    ...
    if (player.cocks.length > 0) outputText(", and your " + player.armorName + " is tenting visibly, displaying your excitement as you take her soft, delightfully warm and full breast in hand", false);
...
function stuffIzzyAndSalamanderWithDicks(): void {
    ...
    while (temp > 0) {
        temp--;
        if (player.cocks.cockArea(temp) <= 85) {
            if (x == -1) x = temp;
            else if (y == -1) y = temp;
            else if (z == -1) z = temp;
            else if (zz == -1) {
    ...
    outputText("You stand up and start stripping out of your " + player.armorName + ".  " + SMultiCockDesc(game.player) + " pops free as soon as your crotch is clear, already at full hardness thanks to the sight of Hel crawling atop Isabella, pressing her E-cups into the cow's milky teats and giving her a full kiss on the lips.  You stay back for a moment, watching the kiss, able to catch just a glimpse of Isabella's massive flat tongue entwining with Hel's long, slender one.\n\n", false);
    ...
    outputText("That's all the invitation you need.  You drop to your knees behind the two redheads and thrust your " + cockDescript(game.player, x) + " into Hel's snatch, eliciting a sharp moan from the salamander.  ", false);
    // (IF MULTICOCK and second cock is under 9 inches:
    if (y >= 0) outputText("Meanwhile, your " + cockDescript(game.player, y) + " slides easily into Isabella's pussy, making the cow-girl gasp at the sudden and unexpected penetration.  ", false);
    outputText("You grab Hel's hips and push in, reveling in the incredible heat and tightness of her pussy as your " + cockDescript(game.player, x) + " slides into her until you've bottomed out", false);
    if (y >= 0) outputText(" with your " + cockDescript(game.player, y) + " similarly coming to a rest inside Isabella's depths; you're able to feel the cow's rapid heartbeat hammering through her, causing her already tight cunt to contract rhythmically around your girth", false);
    outputText(".\n\n", false);
    ...
    // (Player has 2-3 cocks)
        ...
        outputText("Now fucking both girls at once with your super-human twin endowments, you settle into a good solid rut.  The girls squeal and moan under your intense fucking, only stopping in their sweetly feminine vocalizations to kiss or suckle each other.  Just as you've hit your rhythm, though, you're suddenly pushed to the ground as both Isabella and Hel give you a playful kick with their hoofed-or-scaled feet.  They switch positions so that Isabella is fore-most and facing you atop your " + cockDescript(game.player, x) + " while Hel sits behind her, impaled on your " + cockDescript(game.player, y), false);
        if (z > -1) outputText(" with your " + cockDescript(game.player, z) + " even now spearing her tight ass", false);
        outputText(".\n\n", false);
        ...
        outputText(" of your cocks in use.  Surprisingly, though, they're the ones who cum first – Isabella lets out a sharp MOOOOO as she contracts down hard upon your " + cockDescript(game.player, x) + ", overwhelmed by the double sensation, and Hel soon follows suit, increasing her tempo wildly as she brings herself to orgasm.\n\n", false);
    ...
    // (Player has 4 cocks or more)
        ...
        outputText("You ram all four cocks into them, sinking your " + cockDescript(game.player, x) + " into Hel's ass, your " + cockDescript(game.player, y) + " into her vag, your " + cockDescript(game.player, z) + " into Isabella's, and your " + cockDescript(player, zz) + " into her tight asshole.\n\n", false);
...
function izzySallyThreeSomeVagoozlaz(): void {
    ...
    outputText("It works like a charm: with a sharp cry, Hel clamps down on your invading fingers and tongue, her vaginal muscles spasming and contracting as the beginnings of orgasm hit her.  You can hear Isabella begin to moo ecstatically behind you, sending immensely-pleasurable vibrations up through your " + vaginaDescript(player) + ".  You let yourself go, sinking into orgasmic bliss as the cow", false);
    if (player.cocks.length > 0) outputText(" and salamander double-team", false);
    outputText(" works to send you over the edge.  You scream into Hel's cunt as you cum, setting off the peak of her own orgasm, and Isabella shrieks in ecstasy as Hel fists her cow-cunt until she, too, cums hard.  You recoil as Hel's femcum squirts onto your face, covering you with her juices, and you're treated to the sight of much the same happening to her and to Isabella as your " + vaginaDescript(player) + " releases its pent-up femspunk, splattering the cow-girl.\n\n", false);
    ...
    if (player.cocks.length > 0) outputText(", wrapping her warm tail around your " + cockDescript(game.player, 0) + " lovingly", false);
    outputText(".\n\n", false);
...
export function foxyFluffsFoursomeAsMale(): void {
    ...
    let x: number = player.cocks.cockThatFits(85);
    if (x < 0) x = player.cocks.smallestCockIndex();
    outputText("You strip out of your " + player.armorName + " and grab your " + cockDescript(game.player, x) + ".  Giggling drunkenly, Miko flops onto her back on the bed and begins to stroke her knotty cock as Helia and Mai get on their knees, Hel burying herself between Miko's spread legs as her sister wraps her soft hands around your " + cockDescript(game.player, x) + " and guides it into her mouth.  You run your hands through Mai's silver hair as she sucks you off, jerking off the base of your cock and flicking her wet tongue across the head and shaft, her full lips wrapped around your girth in a cute little \"<i>O.</i>\" She carries on for another minute, letting you guide the speed and force of her blowjob with your hands planted on her head.\n\n", false);
...
export function foxyFluffGirlsFuckSex(): void {
    ...
    // [IF NippleCunts:]
    if (player.breastRows.hasFuckableNipples()) {
        outputText("Now that the girls are nice and wet, you pull them as close together as you can and bring your glistening, moist nipplecunts to bear.  You slip a pair of fingers into each of your " + chestDesc(game.player) + "'s waiting holes, beckoning the girls to penetrate you.  Though somewhat startled by your alien anatomy, a few encouraging words are enough to get the sisters off their feet and grabbing your shoulders for support.\n\n", false);

        outputText("They thrust in easily, sliding their twin doggy cocks into your tits until their knots press against your lips.  You shudder at the penetration, feeling the inhuman sensation of the two shafts sliding into your " + chestDesc(game.player) + ".  As they start to fuck your tits, you feel Hel kneel down behind you, wrapping her scaled arms around your waist and slipping her tail between your legs.  You only have a second to brace for the coming attack before her tail slithers into your " + vaginaDescript(player) + ", forcing its way into your love tunnel until you can feel her sharp tip writhing and prodding against your womb.\n\n", false);
...
function telHelToGetOffTheMInoCock(): void {
    ...
    if (player.effects.findByType(StatusAffects.CampMarble) >= 0) outputText(", just like how Cowgirls have addictive breastmilk");
    outputText(".");
...
function satisfyHelSoSheStopsMinoFucking(): void {
    ...
    // {PC has low libido}
        ...
        if (player.cocks.length > 0) outputText("another dick's ");
        outputText("cum.  You nod, agreeing to pleasure her whenever she needs it.");

        outputText("\n\nShe smiles at you, clawed hands clutching tightly to your " + skinFurScales(player) + ". \"<i>Don't worry about a thing, lover mine.  I'll be careful not to hurt you... too much.</i>\"");
    }
    if (player.lust < 33) {
        dynStats("lus", 0.1);
        player.lust = 33;
...
export function helSexualAmbush(): void {
    ...
    // Got rid of this, now handled by passing true:	buttonEvents[9] = pussyOutOfHelSexAmbush;
    helFuckMenu(true);
}
