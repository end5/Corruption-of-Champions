...
export class SheilaScene implements TimeAwareInterface {
    ...
    private sheilaForcedOralGeneric(): void {
        ...
        if (player.cor >= 90 || player.cor > sheilaCorruption()) {
            ...
            // [(demon/dragon tongue)
            if (player.tongueType > TONUGE_HUMAN) outputText("  As tired as you are, you simply go along with it, allowing her rippling walls to slowly draw your tip deeper inside until it bumps against her cervix; she shivers and kisses the top of your head as you groggily run your tongue over the entrance to her womb.");
    ...
    private sheilaGoesDemon(): void {
        ...
        if (player.tongueType > TONUGE_HUMAN) outputText("extending your oral muscle until it's all the way to the back of her pussy.  ");
