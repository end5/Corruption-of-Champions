...
private  bargeInOnArian():void {
	...
	//(else) //if PC is a herm
		...
		outputText("\n\nArian hides his face once more inside his covers and says in a whisper, \"<i>Yes....</i>\"");
		outputText("\n\nYou pull the covers off his face and say, \"<i>Well... we'll have to fix that then.</i>\"  You slip off his bed and begin stripping off your [armor].  Arian shyly does the same, stripping off his robes until he is laying in his bed, completely naked.");
		outputText("\n\nOnce you toss your [armor] on the floor, however, Arian's eyes widen as he realizes you're not entirely female; he eyes your " + game.player.multiCockDescriptLight() + " and the moistening pussy between your legs with equal parts wonder and arousal.");
...
private  giveArianAnal():void {
	...
	//Loose, sensitive enough to make Arian scream in pleasure. (It's like a tight vagina, feels like one too, minor pain)
		...
		outputText("\n\nArian's ass tightens around your " + game.player.cockDescript(x) + " as [Arian eir] ");
		if(flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
		...
		outputText(".  Arian is only capable of moaning and shuddering as [Arian eir] powerful orgasm rocks the poor lizan to [Arian eir] core.  The extra tightness of [Arian eir] contracting butthole increases the friction on your " + game.player.cockDescript(x) + ", pushing you ever closer to the climax.");
	...
	//Very Loose, sensitive enough to make Arian cum just from insertion. (Feels better than anything else. Yep, Arian really becomes a buttslut at this point)
		...
		outputText("\n\nYou almost blink in surprise; you were just throwing the term buttslut around as a joke, you didn't think Arian was really like that.  Still, there are far more important matters - like digging your way into the depths of Arian's greedy little ass with your " + game.player.cockDescript(x) + "!  You squeeze the lizan's scaly butt and begin to rut [Arian em] like an animal, thrusting your way in and out of [Arian eir] back passage with all the eagerness you can muster.");
...
private  doublePenetrateArian():void {
	...
	var x:number = player.cockThatFits(flags[kFLAGS.ARIAN_CAPACITY]);
	var y:number = player.cockThatFits2(flags[kFLAGS.ARIAN_CAPACITY]);
	outputText("You look over your feminine lizard lover, and feel your " + game.player.multiCockDescriptLight() + " starting to stir in your [armor].  Since you have enough tools for the job, and Arian has enough holes, you ask if Arian would be willing to let you fuck her in both her ass and pussy at the same time?");
	...
	outputText("\n\n\"<i>What do you think I'm trying to do!?  Now get in here and paint my womb white!</i>\" Arian snaps, bracing herself on her bed and allowing her ass and pussy both to suck you in with surprising force.  As soon as you're hilted within both holes, her ass clamps shut on your " + game.player.cockDescript(y) + ", while her pussy's contractions begin truly milking you for all you're worth.  Stuck as you are, you have no option but to sit back and enjoy her contractions as you feel yourself nearing the edge of an inevitable orgasm.");
	...
	//(Low Cum Amount)
	if(player.cumQ() <= 250) {
		outputText("\n\nYour " + game.player.multiCockDescriptLight() + " explode inside Arian's eager holes, giving them the liquid warmth they so crave.  The massage that your two cocks are receiving only enhance the intense feeling, and you find yourself cumming more than usual.  They don't stop massaging you for more, even as you stop unloading.");
		
		outputText("\n\n\"<i>More, I need more for my eggs!</i>\" Arian demands, yet you are truly spent...");
	}
	//(Medium Cum Amount)
	else if(player.cumQ() <= 1000) {
		outputText("\n\nLiquid lust floods Arian's insides, as your " + game.player.multiCockDescriptLight() + " do their best to relieve ");
		if(player.balls == 0) outputText("themselves");
		else outputText("your [balls]");
		outputText(" of their load; a load Arian is not only pleased to accept, but also eager to relieve you of every single stray drop off.  The tightness of her ass, pressing down on your " + game.player.cockDescript(y) + ", her pussy milking on your " + game.player.cockDescript(x) + ".  How could anyone refuse such an invitation?  You let yourself go, stuffing the eager lizan with more cum than you thought yourself capable of producing.");
		
		outputText("\n\n\"<i>M-more,</i>\" Arian pleads, even as her belly starts to distend.");
	}
	//(High Cum Amount)
	else {
		outputText("\n\nYou cum with such force, that if Arian's ass wasn't clamping down on your " + game.player.cockDescript(y) + " so tightly, you'd be sure she was going to get pushed off.  \"<i>So much cum!  Yesssss!</i>\" Arian moans, as you quickly give her usually lithe belly a very blatant bump.  Even though your prodigious amount of cum is enough to completely fill the eager lizan-girl, her ass and pussy work overtime to ensure you're completely spent; and you have no desire to resist.");
		
		outputText("\n\nBy the time you're finished, Arian's belly is positively bulging.  \"<i>Ahhh... eggs... cum... yes...</i>\" she states in a stupor.");
	}
	outputText("\n\nArian's ass goes slack around your " + game.player.cockDescript(y) + ", and Arian slowly slides off your shaft to plop on her bed; eyes closed in bliss, as she takes a short nap.");
...
public  wakeUpAfterArianSleep():void {
	...
	if (player.hasCock()) {
		...
		if(flags[kFLAGS.ARIAN_ANAL_XP] < 33) {
			...
			outputText("\n\nArian promptly nuzzles your " + game.player.multiCockDescriptLight() + ", rubbing [Arian eir] face all over ");
