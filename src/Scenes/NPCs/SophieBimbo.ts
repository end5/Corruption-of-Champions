...
export class SophieBimbo extends NPCAwareContent {
    ...
    */
    ...
    public bimboSophieLustStickSurprise(): void {
        ...
        if (select == 0) {
            ...
            if (!player.hasCock()) {
                ...
                outputText("You shiver, " + game.player.sMultiCockDesc() + " growing hard and ready to submit to the feathery blond's love.  Perhaps you'll take care of that soon...", false);
                dynStats("lus", 15);
            }
            ...
            sophieSprite();
            outputText("During an idle moment, you feel heavy breasts squeezing against your back.  Sophie caresses your " + game.player.chestDesc() + " and nibbles at your ear.  She asks, \"<i>Can we like, fuck soon, babe?  I've been so wet here all by myself, just stroking my pussy and dreaming of you.</i>\"  You can't help but turn and smile at her, but as soon as you do, she plants a kiss full on your lips.  ", false);
            if (!player.hasCock()) {
                outputText("Pushing her back, you give her ass a slap and mouth, 'Soon'.", false);
                dynStats("lus", 1);
            }
            else {
                outputText("Pushing her back, you try not to make contact against her with " + game.player.oMultiCockDesc() + ".  Your lips tingle dangerously, and you know you'll be lusting after harpies for at least a few hours.", false);
                dynStats("lus", 15);
            }
            sophieScene.luststickApplication(5);
        }
            ...
            sophieSprite();
            if (player.hasCock()) {
                outputText("While standing there, drinking a sip of water, strong hands pull down your " + player.armorName + ".  Plump lips wrap around " + game.player.oMultiCockDesc() + " and smother it in plush, warm slipperiness.  You look down at your bimbo harpy and sigh while " + game.player.oMultiCockDesc() + " grows harder in her lips.  She pops off and asks, \"<i>Like, wanna fuck?</i>\"  You sigh and try to resist the images of yourself mounting the harpy that flood your mind.  It might be time to fuck her soon...", false);
                dynStats("lus", 15);
            }
            else {
                dynStats("lus", 10);
            ...
            if (player.hasCock()) {
                dynStats("lus", 15);
                outputText(game.player.SMultiCockDesc() + " seems to wiggle inside your " + player.armorName + ".  Damn, she feels really good on you!  Maybe you should screw the slutty bimbo soon?  ", false);
            }
    ...
    private bimboSophieLicksRugs(): void {
        ...
        else outputText("You groan as your groin burns with desire, filling your " + game.player.multiCockDescriptLight() + " with blood.  Images of yourself relentlessly fucking your bimbo bride pregnant over and over again fill your mind.  You shudder and blush, trying to resist the artificial needs pounding through your body, but you realize your body is ready.", false);
        outputText("\n\n", false);
    ...
    private bimboSophieSixtyNineAfterCunnilingus(): void {
        ...
        if (!player.hasCock() || player.cockThatFits(sophieCapacity()) == -1) {
            ...
            outputText("Sophie drops down onto her elbows, her ass-length blond plumage tickling at your " + player.legs() + " as she examines your groin.  The slutty harpy leans over your gold-smeared crotch and gives your " + clitDescript() + " a kiss, her plush lips smothering the ", false);
        ...
        // SixtyNine Continuation - DUDES
            ...
            outputText("Sophie leans down to kiss you on the lips, smearing more of her lust-enhancing lipstick over your mouth.  " + game.player.SMultiCockDesc() + " stays hard as a rock, but the need to service her pussy with your tongue slowly fades.  You feel oddly sated in spite of your erection, yet you know that a peek at your vapid harpy mistress will likely throw you into a rutting frenzy all over again thanks to the properties of her lipstick.", false);
            player.orgasm();
    ...
    private buttFuckBimboSophie(): void {
        ...
        outputText(" delic... de... yummy!</i>\"  You slap her ass, grab her tail feathers, and pull the harpy's winking asshole down onto your " + game.player.cockDescript(x) + ". Her voices rises, not in anger, but in delight, and your " + player.cockHead(x) + " pulses pleasantly in the first few inches of the harpy's rectum.  The bimbo relaxes and sinks down, giggling and asking, \"<i>Is-ooh-is my butt, like, good for you?  It's soooo tight, and it's making my cunny all wet and stuff!</i>\"\n\n", false);

        outputText("You squeeze her shuddering rump hard enough to feel her flesh bulging out around your fingers, the soft cheeks nearly subsuming your hands, and then you pull her hard, dragging your " + game.player.cockDescript(x) + " the rest of the way inside her, all the way to the ", false);
    ...
    private fuckBimboSophiesTits(): void {
        ...
        outputText("She wobbles forward and her massive mounds easily slide to either side of " + game.player.oMultiCockDesc() + ", completely engulfing it.  Still holding on to her nipples, you pull them together and ", false);
        ...
        outputText(" in warm, smooth skin.  The smell of your " + game.player.cockDescript(x) + " mere inches from her nose seems to startle Sophie from her trance, and she breaks into a smile so big you'll worry it'll break her face.\n\n", false);
        ...
        outputText("One of the dumb blonde's hands circles under her bouncing, jiggling chest to stroke your " + game.player.cockDescript(x) + ", jacking you off with the spit, sweat, and drugged gloss as lubricants.  She jerks you hard and fast, smearing it ", false);
        ...
        outputText("  " + game.player.SMultiCockDesc() + " thickens and bloats, a rush of warmth rushing up the base as your internal muscles clench tight, squeezing out a globby rope of jism.  It explodes from your cum-slit, taking Sophie full on the face.\n\n", false);

        outputText("You're just getting started.  Sophie smirks and opens her mouth, letting her tongue slide out to taste your jizm as you launch the next rope, so long it trails from her hair to her chin and so thick it rolls in drops from the side of her face.  She hums in delight and squeezes her breasts tight around your " + game.player.cockDescript(x) + ", the next blast backing up inside you from the pressure.  A moment of buildup later, and your seed germinates and blooms over the harpy's tits, soaking them with spunk.  Droplets of the stuff splatter onto the ground around the both of you, but you just keep coming.  In your mind you have visions of yourself knocking up harpy after harpy, the slutty bird-girls mounting your fountaining fuck-stick long enough for their bellies to bloat with seed before moving on.  Like this, you could inseminate a whole tribe...\n\n", false);
        ...
        outputText("and her eyes are closed, held shut by a thick layer of your sperm.  She's been well and truly bukkaked, drenched in ejaculate, and judging by how furiously she's schlicking away at her pussy, she couldn't be happier.  As for you, " + game.player.sMultiCockDesc() + " is still erect, even though you feel like you don't have a drop left in you.  Of course, the drugs soaking into your gold-tinted cock will probably keep you hard and ready to breed for hours.\n\n", false);
        sophieScene.luststickApplication(5);
        player.orgasm();
        dynStats("sen", -1);
        doNext(camp.returnToCampUseOneHour);
    ...
    private rideDatSophieVag(nice: boolean = false): void {
        ...
        if (nice) {
            ...
            outputText("\n\n\"<i>So then,</i>\" you coo, reaching down and grabbing your " + game.player.cockDescript(x) + ".  You give it a few strokes, enjoying the feeling of your cock between your fingers, and then angle it so the tip is rubbing directly against Sophie's gushing cunt, the bird herself begging you with her eyes.  You let go of her other breast to rub a downy-feathered thigh, and she bites her lip as you chuckle.");

            outputText("\n\n\"<i>Ready?</i>\" you ask her, prodding your tip against her entrance.  She opens her mouth to answer - and you shove in all at once, enjoying the way her voice hikes up a couple of octaves as she moans in sheer pleasure.  Her soppy cunt squeezes down on your " + game.player.cockDescript(x) + ", the internal muscles desperately trying to work you, but you give them little room to do so; you instead pull right back out, watching as Sophie's arms - freed from your grip - reach out to try and tug you back in.");
            ...
            outputText("\n\nYour hips turn into a staccato of smacks and slaps as you help Sophie thrust against your constant pounding, her walls trying their very damnedest to milk your " + game.player.cockDescript(x) + " of its seed, and her feathery arms run across your back as she lets out another squawky moan - and then her body seizes up.");
    ...
    private sophieImpregnationSex(): void {
        ...
        outputText("\n\nYou're up in a second, and a moment later, you've got the bimbo pushed over on all fours, your " + game.player.cockDescript(x) + " already pressing against her mound");
        ...
        outputText("\n\nYour hands find their way to just above the flare of the bird-brained girl's waist and begin to pull her down with each piston forward you make, forcing her to meet you halfway.  You pound Sophie's twat like a jackhammer, fluids squirting out with each booty-shaking cunt-stuffing thrust you dish out.  Your " + game.player.cockDescript(x) + " feels so sensitive, so hard that her slit feels like a molten pleasure-sleeve");
        if (player.cockTotal() > 1) {
        ...
        outputText("\n\nEvery ounce of strength in your body diverts to stuffing your " + game.player.cockDescript(x) + " as far into Sophie's sodden, drug-inducing pussy as possible, ramming so hard into her that she gives a chirp of half-pleasure, half-pain.  Your dick");
        ...
        else outputText("running down your " + game.player.cockDescript(y) + " in miniature rivers");
        ...
        outputText("\n\nLicking her lips, Sophie chants, \"<i>Just one more, in my pussy, please?  Please, cum in my pussy again!</i>\"  She goes on like this, asking, begging, and even pleading as she pivots to place her plump, cum-soaked mound back on your " + game.player.cockDescript(x) + ".  The silken vice fits you as snugly as a tailor-made glove.  She immediately begins to bounce it up and down, looking over her shoulder to watch your face as the waves of sensation overpower your resistance, breaking down your conscious thoughts.  You cum promptly, squirting a long rope of pleasure in on top of all the sperm you've already deposited.  She bounces, forcing more of that ecstasy through your " + game.player.cockDescript(x) + ", laboring messily atop you in a display lascivious enough to make a whore blush.  Every upstroke of her velvet walls along your shaft earns her all the cum your accelerated reproductive system can offer up since the last downstroke, weak spurts of little bearing, but still an extra dose of cream for her twat.");

        outputText("\n\nYou fall back, eyes rolling wildly, moaning uncontrollably.  Consciousness for you becomes little more than the feelings tingling through your " + game.player.cockDescript(x) + " and the ensuing orgasms.  At some point, you lose track of time and pass out.");
        sophiePregChance();
        player.orgasm();
        dynStats("lib", 1);
    ...
    public sophieFenCraftedSex(morning: boolean = false): void {
        ...
        // {Morning Sex}
        if (morning) {
            outputText("\nOoooh, that feels good.  There's a slippery, warm snugness wrapping around your " + game.player.cockDescript(x) + ", accompanied by a quick, 'schluck-schluck-schluck' in steady beat.  Your heart beats faster as your ardor rises, matched lock step with your rising erection");
            if (player.cockTotal() > 1) outputText("s");
    ...
    public fuckYoPregnantHarpyWaifu(morning: boolean = false): void {
        ...
        // REGULAR FUCK
            ...
            clearOutput();
            sophieSprite();
            outputText("You go ahead and take off your [armor], letting Sophie take in the view of [eachCock].  She immediately flounces over and drops to her knees in front of you.  Her hands wraps around " + game.player.cockDescript(x) + ", ");
        ...
        outputText(" proving the veracity of her statements many times over.  You can't SEE the wetness, but your " + game.player.cockDescript(x) + " certainly feels it, twitching inside Sophie's silky slit when the waves of wetness roll over it.");
    ...
    private sophiePreggoTitJobs(): void {
        ...
        outputText(" with her lips, already pursed into a plump, cock-sucking doughnut hole of pleasure.  The noise she makes when your " + game.player.cockDescript(x) + " ");
    ...
    private goHogWildOnSophieBewbs(): void {
        ...
        sophieSprite();
        const x: number = player.biggestCockIndex();
        outputText("You don't care about her promises- there's a pair of soft tits right there just waiting for a dick to fuck them, and nothing is going to stop you from spooging all over them however you want!  Sophie barely has a chance to react before you're tossing her on her back and mounting her chest.  Your [butt] rubs on the top of her pregnant belly as you settle your " + game.player.cockDescript(x) + " into the perfect position.");
        if (player.cockTotal() > 1) {
        ...
        else outputText(" immense rod smacks across her face, too long to try to jam down her throat.  It completely covers her face, smothering her features with rigid, veiny dickflesh.  She immediately begins to lavish the underside with licks and long wet kisses, aided by her plus-sized bimbo lips.  When her eyes peek out from under your " + game.player.cockDescript(x) + ", they seem placid and happy.  It seems the slut wants nothing more than to lie there and service your cock.");
        outputText("\n\nGrabbing hold of Sophie's plump nipples, you immediately use them for leverage, tugging them together above your dick.  The tiny, pebbly joysticks are almost rock-hard already!  With your yanks merging her tits together around your " + game.player.cockDescript(x) + " and shooting explosions of sensation through her brain, Sophie struggles to stay coherent enough to keep orally attending to your maleness.  Her tongue's licks quickly begin to devolve into spastic, instinctive strokes, lashing around your underside with lusty fury.  They still feel good, so you don't really mind.  The space under Sophie's ass sloshes around muddily, proof of just how much the harpy is enjoying this tryst, even if you've turned the tables on her.");

        outputText("\n\nSophie's tits bounce off your crotch, hard.  Your [hips] have begun their march back and forth, bouncing off your pregnant tart's immense belly and back into her voluptuous tits.  The jiggling udders feel so good pressed around your " + game.player.cockDescript(x) + " that you can't even comprehend why anyone would want to wait for such pleasure.  You fuck her tits hard, so violently that Sophie begins to give up short gasps of pain, stopping her fellatio as the pain and pleasure mix confusingly in her head.  She grabs her jugs from the side, pressing them into you to take some of the tension from her abused nipples.");

        outputText("\n\nThe effects of her honeyed lipgloss are becoming more and more apparent to you, visible to the extreme in the thick, exceedingly quick pulsations that are running through your " + game.player.cockDescript(x) + ".  It's twitching happily, bouncing in the harpy's fat tits.  Her soft breasts have the perfect amount of give, and the golden fluid that slicks them makes them easily as slippery as a wet pussy, perhaps even more so.  Pre-cum is dribbling from your tip");
        ...
        outputText(".  Your [butt] is squished up against her belly, both of you sweating and slipping all over each other.  Bulging in her breasty embrace, your " + game.player.cockDescript(x) + " flexes, and your " + player.cockHead(x) + " thickens.");
    ...
    private letSophieMilkYoDick(): void {
        ...
        outputText("\n\nSophie rolls her eyes exaggeratedly and pops her mouth back off your dick.  \"<i>Why didn't you just, like, say that, sexy?</i>\"  She giggles cutely and returns to polishing your gold-gilt rod.  Her eyes flick back up at you, the corners of her mouth curling up as she begins to hum on your " + game.player.cockDescript(x) + ".  Sophie suddenly switches tempo, bouncing her left tit down while she takes her right titty up.  With the creamy tits on either side to moving to different tempos, sliding their slick druggy payload across you with delicious, alternating friction your " + game.player.cockDescript(x) + " immediately begins to twitch and pulse fitfully.  It's like you have your cock fucking two different pussies at once, all while getting a blowjob from a pair of puffy, bee-stung bimbo-lips.");
        ...
        // On top of her.
            ...
            else if (player.cumQ() < 800) outputText(" moans when your heavy deposits splatter into her hair, dripping through the downy blond feathers in a messy web.  Throughout it all, she sucks and licks at you, polishing your " + game.player.cockDescript(x) + " until she's sure every single drop of jizz has been expelled onto her curvy frame.");
            else {
