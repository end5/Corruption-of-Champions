...
public  approachSoberUrtaHeatRutProc():void {
	...
	//Player in rut:
		...
		if(player.hasVagina()) outputText("  Your " + game.player.multiCockDescriptLight() + " and [vagina] are filling your clothes with mixed juices");
...
private  notInterestedInUburDrunkUrtaRuts():void {
	...
	//Rut: 
	if(player.inRut && player.hasCock()) outputText("Your " + game.player.multiCockDescriptLight() + " hardens in your pants as you still force yourself to leave.");
	//[Medium lust increase]
...
private  drunkUrtaIntroPartDuex(chosenSex:number = 1, newl:boolean = true):void {
	...
	if(chosenSex == 1) outputText(game.player.multiCockDescriptLight());
	else outputText("[vagina]");
...
private  keepTeasingDatHornyFawkes():void {
	...
	outputText("slowly beginning to stroke and caress your " + game.player.multiCockDescriptLight() + " for the benefit of those who bear vaginas.");
...
private  soberUrtaSatingPCHeat():void {
	...
	//[If herm]:
	if(player.hasCock()) {
		outputText(" by shoving your " + game.player.multiCockDescriptLight());
...
private  sateRutWithSoberUrtaButHuegDicked():void {
	...
	outputText("Urta observes your approaching " + game.player.cockDescript(x) + " with a hungry, eager expression. Without taking her eyes off of it, she flips up her ");
	...
	outputText("\n\nYou stare at your " + game.player.cockDescript(x) + " in an uncomprehending fashion.  How are you going to find relief now?  You look up as Urta saunters over towards you in a seductive manner, erect cock jutting before her and a mischievous grin on her face.  \"<i>While I'll have to go and attend to this myself later, I can still give you a hand...</i>\" she purrs throatily.  She kneels before you, and you have to watch yourself to avoid having her twenty inches of cock slap your [leg].  Confidently, she reaches out to take hold of your " + game.player.cockDescript(x) + ", first with one hand, and then the other.");
	...
	//Lover Urta Path/
		...
		outputText("\n\nShe pulls her head free and gasps for breath, looking at you in admiration. \"<i>By Marae... how do you manage to do this for me, lover?</i>\" she asks, stunned.  But then, gamely, she returns her attention to your " + game.player.cockDescript(x) + ", licking, suckling and mouthing at the head.  As she does this, she continues her restless assault with her hands upon the rest of your lengthy shaft with her skilled hands.  She shuffles closer, allowing you to rest yourself between her DD-cups.  \"<i>Can you feel how fast my heart is beating through your cock?  You turn me on so very much,</i>\" she purrs.");
...
private  sateRutWithSoberUrta():void {
	...
	outputText("\n\nWell, you don't intend to keep the lady waiting any longer then you have to, and you slide it home, allowing her testicles to drop once you are safely inside.  The globular organs bounce atop your " + game.player.cockDescript(x) + " and rock back and forth against your belly, jiggling with every movement the two of you make, Urta's cock sandwiched firmly between your bodies and held between her breasts.");
...
private  drunkenUrtaFucksPCInHeat():void {
	...
	if(player.hasCock()) 
	{
		outputText(", impatiently nudging aside your " + game.player.multiCockDescriptLight());
	...
	if(player.hasCock()) outputText("nor even your " + game.player.multiCockDescriptLight());
...
private  drunkUrtaRidesARutPCsCock():void {
	...
	outputText("\n\nUrta lifts her balls and presses your already hard cock against her black pussy lips, justifying your decision.  Slowly, you feel your tip sink into her, then the rest of your member, as she releases a soft moan.  She keeps pressing down, forcing your " + game.player.cockDescript(x) + " inside her wet gash until you feel her butt pressed against your ");
	if(player.balls > 0) outputText("[balls]");
	else outputText("[hips]");
	outputText(", and her own balls resting comfortably on your abdomen.  She grits her teeth as you feel her pussy slowly tighten around and massage your " + game.player.cockDescript(x) + ", and you groan in response.  Urta starts to bounce up and down on your member, smacking her thighs and ass into your body, not minding her own giant equine member flopping around and occasionally smacking you over your chest.  She lets her tongue flick out into the air for a moment and moans in delight, before picking up the pace and starting to pump your cock in and out of her hungry passage furiously.");
	...
	else outputText("recognize the tingling sensation from your " + game.player.cockDescript(x) + " to your spine");
	...
	if(player.cumQ() >= 500 && player.cumQ() <= 1500) outputText("\n\nUrta seems positively full and stretched now, and your rut almost subsides for a moment, her stretched tummy imitating a pregnancy quite well.");
		...
		outputText("\n\nUrta is stretched and completely full, so, holding your " + game.player.cockDescript(x) + " in her hand for a moment, she lifts herself off your cock, presses on her abdomen and allows some of your spunk to drip out of her, coating the table, your thighs and your ");
		if(player.balls > 0) outputText("[balls]");
	...
	outputText("\n\nYour " + game.player.cockDescript(x) + " feels sensitive and tender after the two past orgasms, but the horny nympho just forces it deep into her snatch, the sensitive head and shaft all the way down to your base again squeezed tighter as she starts to bounce up and down, trying to breathe life into your erection.  She kisses you furiously and passionately, exploring your mouth with her tongue as she keeps the stimulation on your groin, cooing, groaning and panting as if trying to breathe her own lust into you.");

	outputText("\n\n\"<i>Come on, come on, whatever it takes!  Squeeze those boobies, smack that ass, just get fucking hard!</i>\"");

	outputText("\n\nFollowing her plea, you give her breasts a rather rough squeeze, and you feel your " + game.player.cockDescript(x) + " miraculously harden inside her once again.");
	...
	outputText("\n\nYour tired and lust-hazed mind sees no reason not to, and you grab her, so Urta's massive mare member starts to be pleasured by her own hand as well as yours.  Squealing in delight, the horny vixen returns to what seems to occupy her mind completely: bouncing fervently on top of you, with your " + game.player.cockDescript(x) + " trapped in her wet snatch.");
	...
	outputText(".  You seem to slowly lose the sensations in most of your body.  The awareness of your surroundings slips away, as all your thoughts and feelings focus in your groin, struggling to keep up with the mad pace of breeding that Urta has kept so far.  It's hard to keep conscious as you feel another surge of ecstasy pass all over your body and focus on your " + game.player.cockDescript(x) + ", shooting off yet again inside her coaxing hole.  You hear the sound of your name being called and the milking, squeezing sensations that you barely manage to associate with her ravenous, insatiable pussy.");
	...
	//[Both end here]
	outputText("\n\nSatisfied even if your body hurts all over and your " + game.player.cockDescript(x) + " seems empty, dry, burning, and almost ruptured.  You leave the house with a small smile on your face, and a strong stench of sexual fluids following you back to the camp.");
