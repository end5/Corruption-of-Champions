...
private  rathazulWorkOffer():boolean {
	...
	var purify:() => void = null;
	var debimbo:number = 0;
	var reductos:() => void = null;
	var lethiciteDefense:() => void = null;
	var dyes:() => void = null;
...
public  rathazulArmorMenu():void {
	spriteSelect(49);
	clearOutput();
	var beeArmor:() => void = (player.hasItem(useables.B_CHITN, 5) ? craftCarapace : null);
	var gelArmor:() => void = (player.hasItem(useables.GREENGL, 5) ? craftOozeArmor : null);
	var silk:() => void = null;
