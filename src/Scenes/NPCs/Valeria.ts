...
export class Valeria extends NPCAwareContent implements TimeAwareInterface {
    ...
    private valeriaGetFucked(): void {
        ...
        // [if PC has cock: \"<i>
        if (player.hasCock()) outputText("her gooey ass devouring your " + game.player.cockDescript(0) + " as she slides down your belly");
        ...
        // (If Male/Herm)
            ...
            outputText("\n\nResigned, you let the goo-girl have her way.  You try your best to relax as her goo-cock slithers between your ass-cheeks, her prick remaining just hard enough for her to hotdog herself between your cheeks.  But rather than penetrate, she instead seems content for the moment to rock her hips in your lap, riding your " + game.player.cockDescript(0) + " and fucking your butt-cheeks with her own rod.  As she rides you, Valeria slips a little more foot into your mouth, pouring her leg into you until you get the hint and start to suckle her dainty toes, easily slipping your tongue into her soft body to taste her insides.");
            outputText("\n\nJust as you're getting into the rhythm of things, you feel a sudden pressure against your [asshole].  Oh, shit.  You squirm and try to relax yourself, but surprisingly, you don't feel the hard pinch of a cock's insertion.  Instead, Valeria pours a tiny trickle of herself into your anus, slowly but surely stretching you out as her cock inflates half-way inside you.  You groan in pleasure as she stretches you out and redoubles her pace on your " + game.player.cockDescript(0));
            // (if Herm: [
            if (player.hasVagina()) {
            ...
            outputText(" and fucking your " + game.player.cockDescript(0) + " with one fluid, passionate motion.  You're both moaning openly now, nearly overwhelmed by a multitude of pleasures.  You can feel your impending orgasm rising, and by the heightening pitch of Valeria's moans, she seems to be just as close to the edge.");
    ...
    private penetrateValeria(): void {
        spriteSelect(79);
        clearOutput();
        outputText("\"<i>Mmm, that's a tasty-looking cock,</i>\" Valeria says as you disrobe, letting your " + game.player.cockDescript(0) + " flop free.  \"<i>I just might have to get a sample,</i>\" she chuckles, squatting down before you and taking your shaft in hand.  Rather than giving you a simple handy, however, the goo-girl places her palm against the head of your cock and presses forward.");
        outputText("\n\nYou gasp as her gooey skin parts, letting your " + game.player.cockDescript(0) + " slip inside her.  Her palm and forearms act like a snug, wet cocksleeve, shifting and molding to perfectly fit around your prick as you slide into her up to the hilt.  She grins up at you as she gives you a handy the likes of which only a goo-girl could manage, using her penetrable palm like a cunt.  You groan as she moves her arm, slowly stroking your cock inside of her, occasionally varying her motions, making wide circles around you or moving side to side.");
        outputText("\n\nBefore you can get too comfortable, however, Valeria sidles forward and moves your " + game.player.cockDescript(0) + " from her arm to her breast with a wet POP.  She squeezes her palmable C-cups together and leans in, letting your cock slip in between them and into her gooey flesh.  You moan as the pleasurable wetness and warmth of her interior returns when the goo-girl begins to titty-fuck you, slipping her wet breasts along the length of your shaft as the head bobs in and out of her cunt-like interior.");
        outputText("\n\nYou sink your fingers into the goo's shoulders and start to guide her speed, moving her back and forth along your cock at your own pace like a particularly lush onahole.  The normally-dominant Valeria makes a surprised, happy squeal as you seize control.  She redoubles her efforts of tit-fucking your " + game.player.cockDescript(0) + " as you use her as your own personal sex-toy, roughly ramming her back and forth on your shaft until you feel an orgasm bubbling up inside you.");
    ...
    private valeriaSexDominated(): void {
        ...
        // (PC has Dick)
            ...
            outputText("\n\nValeria begins to use her goo to peel back your clothes, soon revealing your defenseless, half-erect  package.  She makes a show of licking her lips as tendrils of goo wrap tightly around [eachCock] like a warm, wet onahole. You submit to your gooey bonds, and seeing your lack of resistance, Valeria smiles down at you and squeezes your " + game.player.multiCockDescriptLight() + " tighter.");
            outputText("\n\nYou gasp with pleasure as she starts to stroke [eachCock], jerking you off as she looms over you, grinning wickedly.  \"<i>Oh, you like that do you?</i>\" the armor-goo asks.  \"<i>Well then, I might just let you get off, too... If you're a good " + player.mf("boy", "girl") + "</i>\"  She starts to increase her tempo, making you squirm and writhe as she wanks your " + game.player.multiCockDescriptLight() + ", licking her lips as little bubbles of pre start to form.");
    ...
    private valeriaGooRapeII(): void {
        ...
        if (player.hasCock()) {
            ...
            if (player.totalCocks() > 1) outputText("s");
            outputText(". You inadvertantly clench your muscles in a way that makes your " + game.player.multiCockDescriptLight() + " so very swollen, in turn making it that much easier for the gelatinous fiend to have her way with your cumslit");
            if (player.totalCocks() > 1) outputText("s");
            outputText(". You feel that warm, wet fluid slowly peel it open and push inside. It doesn't hurt at all, but it is a little weird having your " + game.player.multiCockDescriptLight() + " slowly stuffed in such a way. The warmth travels the whole way down your dick");
            if (player.totalCocks() > 1) outputText("s");
