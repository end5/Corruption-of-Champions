...
export class Ember extends Monster {
    ...
    private dragonFarce(): void {
        ...
        this.effects.create(StatusAffects.StunCooldown, 4, 0, 0, 0);
    ...
    protected performCombatAction(): void {
        ...
        if (this.effects.findByType(StatusAffects.StunCooldown) >= 0) {
            this.effects.addValue(StatusAffects.StunCooldown, 1, -1);
            if (this.effects.getValue1Of(StatusAffects.StunCooldown) <= 0) this.effects.remove(StatusAffects.StunCooldown);
        }
        else if (rand(3) == 0) {
            dragonFarce();
            return;
    ...
    public constructor() {
        ...
        // this.plural = false;
        const gender: number = game.flags[kFLAGS.EMBER_GENDER];
        if (gender == 0) {
            this.pronoun1 = "she";
            this.pronoun2 = "her";
            this.pronoun3 = "her";
        ...
        if (gender >= 2) {
            ...
            this.breastRows.createBreastRow(breastCupInverse("flat"));
        }
