...
export class Urta implements TimeAwareInterface {
    ...
    */
    ...
    public urtaAvailableForSex(): boolean { return urtaFuckbuddy() && Scylla.scyllaAction != Scylla.SCYLLA_ACTION_FUCKING_URTA && flags[kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] == 0; }
    ...
    public urtaJustFriends(): boolean { return flags[kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] == 0 && flags[kFLAGS.URTA_PC_LOVE_COUNTER] == -1; }

    public urtaAtBar(): boolean { // Is Urta physically at the Wet Bitch?
    ...
    public knockUpUrtaChance(): void { // Moved here from UrtaPregs since it needs to be accessed from outside Urta
        // GTFO IF PREGGO
