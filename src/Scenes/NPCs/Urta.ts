...
public  urtaCapacity():number {
	var bonus:number = flags[kFLAGS.TIMES_RUT_FUCKED_URTAS_CUNT] * 5;
...
public  goBackToUrtasForLuvinzII():void {
	...
	var vaginal:() => void = null;
	var femaleRides:() => void = null;
...
private  urtaDiscussesEdryn():void {
	...
	var discussRomance:() => void = (urtaJustFriends() ? null : urtaDiscussesEdrynRomance);
...
private  urtaDiscussessKatherine():void {
	clearOutput();
	var affection:number = flags[kFLAGS.KATHERINE_URTA_AFFECTION];
...
private  urtasRuinedOrgasmsFromGooPartII():void {
	...
	var edrynAvailable:boolean = !telAdre.edryn.pregnancy.isPregnant;
