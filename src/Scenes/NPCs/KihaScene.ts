...
export class KihaScene extends NPCAwareContent {
    ...
    public kihaVictoryIntroduction(): void {
        ...
        // [OPTIONS]
        // All
        const forceMasturbate: () => void = tsundereMasturbationChristmasCarol;
    ...
    private kihaMilkTitHumiliation(): void {
        ...
        outputText("Kiha recoils at the drops of white beading atop your " + nippleDescript(0) + " and asks, \"<i>Do you really think that's hot?  It's disgusting.  A perversion of the body only a sick... MAMMAL would enjoy.</i>\"\n\n", false);

        outputText("The scaly woman leans down to tug on your " + nippleDescript(0) + "s in turn, laughing every time a spurt of milk erupts from one of your tits.  Each rough squeeze sends shivers of erotic sensation through your body, and you quickly grow aroused from the rough treatment.  Kiha keeps going, ", false);
    ...
    private kihaRapesMen(): void {
        ...
        if (x < 0) x = 0;
        outputText("You try to rise, but the dragon girl whips around, her long, thick tail delivering a subduing crack against the side of your head, dropping you back onto your " + buttDescript() + ".  Triumphantly standing over you, the scaled woman eyes you with a panting breathlessness that betrays the coldness in her gaze.  She squints, arcing an imperious eyebrow as she looks you up and down, drawing her hands back to shoulder level and barely brushing against her breasts.  Her tail lashes back and forth between her legs, wrapping around her calves as she lifts a clawed foot and rests it lightly upon your stiffening groin.  Apparently, your fight left her wanting more than just your gems.  Her flexible toes squeeze your " + game.player.multiCockDescriptLight() + " through your " + player.armorName + ", and she snorts in derision.  \"<i>This is it, huh?  Pathetic.  I'm going to have to do all the work if I have any hope of you satisfying me.</i>\"\n\n", false);

        outputText("With a swift kick to your collarbone, Kiha knocks you on your back and stands over you, her vulva swollen with excitement despite her frosty insults.  She opens your " + player.armorName + " with her long, clenching talons just enough to expose " + game.player.sMultiCockDesc() + ".  The dragoness curls her tail between her legs, the warm, scaled surface of the dexterous limb rubbing your tender flesh impatiently, tip flicking " + game.player.oMultiCockDesc() + " before coiling around the crest of your cockhead.  The narrow point of her backside pokes at your urethra, parting the narrow slit and tickling the sensitive, silken interior to draw a weak gasp from you.  \"<i>Yeah, I bet you'd love to get penetrated,</i>\" she scoffs, wrapping her hands around the thick girth of tail poking between her thighs like a massive, scale-textured cock.  She strokes the fat plates and thumbs the ridge-like nobs lining its underside with a hip-swaying motion that sends her chest wobbling.  \"<i>But,</i>\" she continues, her tail lifting off of your " + game.player.multiCockDescriptLight() + " and curling upwards, \"<i>this isn't about what you want.</i>\"\n\n", false);
        ...
        outputText("Before long, her cunny practically drools, but you're not sure what she's getting off on more, the tail teasing her clit or your dick stiffening uncontrollably at her feet.  She grins, more to show her teeth than in pleasure, and begins to feed her tail into her snatch, the girl's folds parting eagerly to the rough limb, her honeypot polishing her scales to a liquid gleam almost immediately.  As she pumps long, slow thrusts inside herself, Kiha shifts to one leg, bringing her adept foot to your " + game.player.cockDescript(x) + " once more", false);
        ...
        outputText("The dragon girl's little show has already brought you to full mast and the pad-like scales of her foot rubbing up and down your length has you rock hard, helplessly twitching under her heel.  She hooks her long toes around your pulsing tip and pulls your " + game.player.cockDescript(x) + " into the air, straining shaft rising in obedience to her demands.  Reluctantly withdrawing the tail from her slavering slit, Kiha crouches down until your flesh spear is parallel with her belly. She inches forward, your crown just a hair's breadth from her pussy and she makes a \"<i>tut</i>\" sound in the back of her throat.  \"<i>Considering the shitty battle you gave me, you certainly don't deserve this hole, nor any chance at fathering children.</i>\"  Despite her contempt, her lower lips splatter your " + game.player.cockDescript(x) + " with the warm, liquid bounty of the dragon girl's vigorous masturbation.  You shudder at the heat showering your groin, unsure how much more teasing you can take.  Sliding forward a bit more, the victorious woman guides her narrow pucker over your throbbing meat.  \"<i>This should be more your speed, little fairy,</i>\" she taunts, before plunging herself onto your manhood.\n\n", false);

        outputText("The gushing honey pooled and slathered along her tail and asscheeks while she was frigging herself gives you more than enough lubrication to part the dragon's silken passage, muscled sphincter clenching rhythmically, more to pull you deeper inside than in response to the sudden intrusion.  You cry out at the intense tightness sucking at your " + game.player.cockDescript(x) + " and reach up to grab the girl's breasts, but she smacks your hands away with a sharp blow.  \"<i>If you dirty my scales with your filthy mitts, I'll crush you between my thighs!</i>\" she gasps, running her own hands through her hair as her head rolls back in delight.  She rides you hard, bouncing off of your lap without regard for the bruising her athletic ass is giving your " + hipDescript() + ", but you can hardly feel anything beyond the vice-like tightness of her rectum.  You open your mouth to beg her to ease up, but she uses the opportunity to thrust her tail between your parted lips, the warm appendage still dripping with girl-cum.  You nearly gag at the insertion, but the shock is quickly subordinated to arousal as your mouth is flooded with the second-hand taste of her sweaty nectar. You reflexively begin sucking on the scaled tip, wrapping your tongue around the scaly invader and even rolling your jaw as you lap Kiha's cream from her posterior.\n\n", false);

        outputText("With a rumbling growl, the dragoness impales herself on your " + game.player.cockDescript(x) + " hard enough to knock the wind from your lungs. She clamps down and begins rolling her ass back and forth over your groin, stroking you off with only the rippling contractions from the toned walls of her rectum.  Your orgasm moments away, you helplessly clench your fingers in the earth", false);
        // [Lizard/naga tail:
        ...
        if (player.balls > 0) outputText(", your " + ballsDescriptLight() + " practically leaping in over-burdened joy as their heavy load rushes through your flesh", false);
        outputText(".  A geyser of hot spunk sprays from your " + game.player.cockDescript(x) + ", flooding her innards with the excruciatingly hefty torrent of seed all her teasing and abuse built within you.", false);
    ...
    private kihaRapesHerms(): void {
        ...
        outputText(", Kiha repositions herself so that her ashen-hued vulva presses moistly against your " + vaginaDescript(0) + ", the plush lips of her nethers lapping at yours in a torrid embrace.  Rocking against you in an angular motion, the dragon's sweltering sex grinds against your own sensitive flesh, small shocks of overstimulation arcing through your hips as her stiff, pink pearl brushes against your " + clitDescript() + ".  You mirror her motions, rubbing into the girl with increasing urgency as your flesh engorges, nearly forgetting the throbbing imperative of your " + game.player.multiCockDescriptLight() + ".\n\n", false);

        outputText("You're so lost in the motion of your sinuous bodies gyrating against one another that when a stiffness slides between your cunnies, rather than thinking to look down, you merely writhe against it with unquestioning ardor.  When nubby ridges begin to caress your clenching womanhood, however, you draw a sharp intake of breath and blink back the lusty haze from your eyes.  Kiha's wriggling tail has slid between the breach of her ass and has slipped up, between the two of you, textured hardness rubbing both snatches with drool-oiled scales.  Gradually pumping her tail between the engulfing cunts, the dragoness throws her head back in eye-clenching pleasure.  \"<i>Oh, I'm so much better at this than you are!</i>\" she moans, taking care to flick the ridges of her plates against her sweet, hooded nub, massaging your " + clitDescript() + " almost as an afterthought.  \"<i>You're fucking lucky I took pity on a loser like you,</i>\" she exhales, her voice stifled by the rapid approach of her orgasm.\n\n", false);
    ...
    private tsundereMasturbationChristmasCarol(): void {
        ...
        if (player.hasCock()) {
            outputText(game.player.multiCockDescriptLight() + " against her soft flesh, ", false);
        ...
        else outputText(nippleDescript(0) + "s against the hard ridges of her back, your tongue softly licking her smooth skin.", false);
    ...
    private kihaVictoryPomfTail(): void {
        ...
        outputText("  Now nude, you sway your " + hipDescript() + " back and forth sensually, forcing Kiha to watch your body before you use her.  ", false);
        ...
        outputText("Satisfied that it is sufficiently lubricated, you squeeze the now-slippery tail and point its nubby tip at your entrance.  It bumps your " + clitDescript() + " as you wrangle with the struggling hind-limb, only turning you on all the more.  Feeling the tip circling your tunnel's opening, you push it up and seat the tentacle-like tail deep inside yourself.  ", false);
        ...
        outputText(" girl-cum, your " + vaginaDescript() + " cums hard.  It squeezes down with clenching, rippling action that finally stop the tail's frantic struggles, immobilizing it in your womanhood.\n\n", false);
    ...
    private victoryDickKiha(): void {
        ...
        if (player.lust > 60) outputText("only makes " + game.player.sMultiCockDesc() + " harder.", false);
        else outputText("quickly makes " + game.player.sMultiCockDesc() + " hard", false);
        outputText(".  Her rear-most extremity yanks out of your grip to cover her femininity once more and you let it, for now.\n\n", false);

        outputText("Pausing for a moment, you set to removing your " + player.armorName + " and unleashing " + game.player.sMultiCockDesc() + " ", false);
        if (player.hasVagina()) outputText("and " + vaginaDescript() + " ", false);
        ...
        if (y != -1 && player.cockTotal() > 1) {
            ...
            outputText("Dully, you realize " + game.player.sMultiCockDesc() + " are twitching, her powerful clenching holes combining with your frenzied strokes too much for you to endure.  Heat boils out from your " + ballsDescriptLight() + " as your orgasm approaches, threatening to burst from your loins even as blackness eats at the edges of your vision.  Screw it - if she's choking you out, you're at least going to get to cum first.  You grab both her nipples as you hilt yourself and twist, HARD.  Jizm spurts from your cocks, glazing Kiha's hot, juicy puss,", false);
        ...
        // (SINGLE DICKING VARIANT)
            ...
            outputText("That perfect, dripping entrance beckons for your " + game.player.cockDescript(x) + ", and without hesitation, you slide inside.  Kiha growls, \"<i>That's it?  How artless.</i>\"  In spite of her disappointed tone, her slippery passage squeezes down on your member with miraculous tightness, embracing your " + game.player.cockDescript(x) + " in its firm, velvet grip.  You sigh happily and enjoy the dragon-pussy's pressure for a few moments, tuning out Kiha's griping to focus on the heavenly feelings her body is giving you.\n\n", false);

            outputText("Eventually, you become accustomed to the feel of the reptilian tunnel's simmering juices, and eager for more stimulation, you begin to saw your " + game.player.cockDescript(x) + " in and out of sodden box.  The draconic woman beneath you lets out whimpers and moans of pleasure mixed with discontent, unable to resist you and unable to allow herself to enjoy it.  She squirms and wriggles beneath your forced affections, growing ", false);
    ...
    private kihaRapesLittleGirlsISawItOnTheNews(): void {
        ...
        outputText("\"<i>Here's how this is going to go,</i>\" she murmurs when you've finally stopped gasping for breath.  \"<i>You will lick me until I tell you to stop, and every time you displease me I'm going to take it out on your sensitive little fuck hole.</i>\"  She swings around and sits on your face, smashing her wet cunt on your " + face(player) + ".  \"<i>Be grateful that I'm letting you do this,</i>\" she gurgles, pinching your clit again for emphasis.  Doing as you're told, you lick deeply into the warm velvet of the dragon's folds.", false);
    ...
    */
    ...
    private analRapuzulaKiha(): void {
        ...
        if (player.cockArea(x) <= 20) outputText("You quickly shed your " + player.armorName + ", letting your " + game.player.multiCockDescriptLight() + " out to breathe in the warm, swampy air.  Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  \"<i>Oh? What do you think you're gonna do with THAT, huh?  Just ravish me like some kind of sex-crazed demon? Is that your genius plan?</i>\"\n\n", false);
        else outputText("You quickly shed your " + player.armorName + ", letting your " + game.player.multiCockDescriptLight() + " out to breathe in the warm, swampy air. Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  \"<i>Hah, look at that pathetic thing.  You might have gotten me a little hot, but I really doubt you could please anyone with that puny piece of equipment.</i>\"\n\n", false);
        ...
        outputText("As soon as your fingers touch her skin, her tail whips around your " + game.player.multiCockDescriptLight() + ", wrapping up your groin", false);
        if (player.balls > 0) outputText(" and threatening to crush your " + ballsDescriptLight(), false);
        ...
        if (y >= 0) {
            ...
            else if (player.hasVagina()) outputText("; your " + vaginaDescript() + " pulses with pleasure, soaking your thighs with girl-cum as your cocks unload", false);
            outputText(".\n\n", false);
            ...
            outputText("Her moans become louder as you continue the butt-fuck, her hole becoming as wet as her pussy as your intruding member slides in and out of her dilated sphincter.  Her involuntary signs of enjoyment spur you on and pre flows freely from your member, allowing you to ignore her crushing tightness and enjoy the hot pleasure that envelops your " + game.player.cockDescript(x) + ".  You doubt that even her pussy's depths would give you this kind of feeling.\n\n", false);
            ...
            if (player.hasVagina()) outputText("Your " + vaginaDescript() + " pulses with pleasure, but it's an empty orgasm, leaving you wishing you had something to fill that aching void.  Still, you cannot help but marvel at the superior feeling of cumming with a multitude of sexual organs.  ", false);
