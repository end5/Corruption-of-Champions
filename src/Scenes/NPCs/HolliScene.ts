...
export class HolliScene extends NPCAwareContent {
    ...
    public treeMenu(output: boolean = true): void {
        ...
        if (flags[kFLAGS.FOUGHT_HOLLI] > 0) {
            ...
            if (player.perks.findByType(PerkLib.Dragonfire) >= 0 || player.perks.findByType(PerkLib.FireLord) >= 0 || player.perks.findByType(PerkLib.Hellfire) >= 0 || player.findStatusAffect(StatusAffects.KnowsWhitefire) >= 0) {
