...
export class HolliScene extends NPCAwareContent {
    ...
    private fuckFuckingFuckFlowerP2(): void {
        ...
        outputText("\n\nThe internal suction spikes as your dick bloats larger, and with a roar of bestial pleasure, you arch your back, hands pushing your " + game.player.cockDescript(x) + " as deep into the plant's gullet as possible.  ");
    ...
    private fuckTheFlower(): void {
        ...
        outputText("\n\nDuring a particularly shameless moan, you realize that you're dipping a little deeper with each pendulous stream.  Luckily, the corrupt tree's arboreal lust must be rising like your own, and after a few slow swings, your " + game.player.cockDescript(x) + " is slipping three quarters of the way in");
        ...
        outputText("\n\nYou've been kept on edge for so long that even this brief taste of liquid-soft snugness has your body clenching and warm bliss mounting inside of you.  You wrap as much of your [legs] around the trunk below as possible and give into your pleasure, thrusting your " + game.player.cockDescript(x) + " against the petalled muff each time the vines draw you away.  You rut like a demon's pet, half-mad with pleasure and desire so powerful it obviates rational thought.  The ecstasy rises like an all consuming tide, tinting your vision pink as your eyes roll back and [eachCock] thickens.");

        outputText("\n\nJizz blasts out of your " + game.player.multiCockDescriptLight() + " with uncommon force, painting the flower's interior with white");
    ...
    private fuckHolliInZeFlowerPuss(): void {
        ...
        outputText("  You grab hold of the edges of her tits and squeeze, smushing them tight around yourself and sliding them up and down.  The plant-woman's twinkling golden eyes meet your own while she pleasures your " + game.player.cockDescript(x) + ", and her hands come to rest over top of your own, assisting you with the quick tit-fuck.");
    ...
    private holliGetsDickDommed(): void {
        clearOutput();
        outputText("Tossing your [armor] aside, you expose your " + game.player.multiCockDescriptLight() + ".  Holli's eyes fixate on [oneCock], her attention rapturously contained by a single phallus.  You grip your maleness in hand and bounce it up and down into your other palm.  The solid slaps of genital impacts echo off the surrounding rocks, each sending a pleasant tingle of pleasure through the root of your manhood.  Before long, you're completely erect and throbbingly hard, bouncing unbidden with each and every thrum of your heart.");
        ...
        outputText("\n\nThe abruptness of your orgasm startles you.  One moment there's the sanguine ecstasy of the surrounding fuck-flesh, and the next, there's an explosive volcano of lust boiling out of your " + game.player.multiCockDescriptLight() + ", geysering fountains of fluid.");
        if (player.cockTotal() > 1) {
    ...
    // >Lose
    public enjoyYourBadEndBIYAAAATCH(): void {
        clearOutput();
    ...
    private holliPlaysWithPenisesBadEnd(): void {
        ...
        outputText(game.player.multiCockDescript() + ", standing erect and hard as iron; the brown-haired girl blushes and looks away.");
    ...
    private girlsGetANiceManToBadEnd(): void {
        ...
        if (player.balls > 0 && player.ballSize > 10 && player.gender == 3) outputText(game.player.multiCockDescriptLight() + " with [balls] swinging below.");
        // (if H and ballsize < 10)
        else if (player.balls > 0 && player.ballSize <= 10 && player.gender == 3) outputText(game.player.multiCockDescriptLight() + " and [balls] that hang slightly over a [vagina].");
        // (if H and noballs)
        else if (player.gender == 3) outputText(game.player.multiCockDescriptLight() + " and a [vagina].");
