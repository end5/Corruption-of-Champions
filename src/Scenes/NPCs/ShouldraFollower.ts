...
private  shouldraTalkMenu():void {
	...
	var blowShitUp:() => void = null;
	var shrinkShit:() => void = null;
...
private  shouldraGroPlus():void {
	...
	var balls:() => void = null;
	var breast:() => void = shouldraGrowsYoTits;
	var clit:() => void = null;
	var cock:() => void = null;
	var butt:() => void = shouldrasButtBigginator;
	var nipples:() => void = shouldraGivesYaSomeFukkinTeats;
