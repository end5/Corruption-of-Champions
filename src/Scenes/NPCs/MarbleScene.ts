    ...
    */
    ...
    private marbleMilkSex(newpage: boolean = true): void {
        ...
        // (player is female)
            ...
            if (player.totalBreasts() > 2) outputText(" with each of your " + allBreastsDescript(player), false);
            ...
            if (player.biggestLactation() <= 1 && !player.hasFuckableNipples()) outputText("Of course, since you aren't lactating, nothing but your " + nippleDescription(player, 0) + " reaches her lips.  Marble doesn't seem to be put off by this and still gives you a thoroughly enjoyable experience.", false);
            outputText("\n\n", false);
    ...
    */
    private marbleCampSexNew(): void {
        ...
        if (!player.isNaga()) {
            ...
            // ORAL
                ...
                if (player.hasVagina() && !player.cocks.length > 0) outputText("probing her tongue in your " + vaginaDescript(player, 0) + ", licking you in the most appropriate places");
                ...
                if (player.hasVagina() && !player.cocks.length > 0) outputText("poking your cunt");
    ...
    public marbleBadEndFollowup(): void {
        ...
        if (player.gender == 1 || player.gender == 3) {
            ...
            // mysterious baby?
            if (player.gender == 3 && player.biggestTitSize() >= 2 && player.cocks.biggestCockArea() < 15) {
    ...
    private marbleNightSexDudes(): void {
        ...
        // nope the PC is the one
            ...
            if (player.biggestTitSize() >= 2) outputText("You pull your hands back up and begin to run them over your " + biggestBreastSizeDescript(player) + ", toying and teasing your nipples as your " + cockDescript(game.player, x) + " continues to pound away at Marble's confines.  Marble soon has her hands on the breasts you vacated, clearly enjoying teasing herself just as much as you are.  The two of you cry out in pleasure from the stimulation; you can feel your orgasm fast approaching.\n\n", false);
