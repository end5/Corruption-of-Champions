...
function sharkbustersVictory(): void {
    ...
    if (player.breasts.biggestTitSize() >= 1) outputText(", " + allBreastsDescript(player) + " squishing and squashing against her own barely-clad bosom", false);
...
function sharkyEctoginas(): void {
    ...
    // [if breasts present]
    if (player.breasts.biggestTitSize() >= 1) outputText("and caking your cleavage with the excess lubrication", false);
...
function slimeGinaFlation(): void {
    ...
    if (player.breasts.biggestTitSize() < 1) outputText("Your frame is jostled about as the slime under you shrinks.", false);
    ...
    if (player.breasts.biggestTitSize() < 1) outputText("see your " + nippleDescription(player, 0) + " wiggling sporadically.", false);
...
function slimeyPenorsAhoy(): void {
    ...
    // ([if boobs present]
    if (player.breasts.biggestTitSize() < 1) outputText(" while squishing her small boobs into your own " + allBreastsDescript(player), false);
...
function genderlessGhostBuster(): void {
    ...
    if (player.breasts.biggestTitSize() < 1) outputText("two new additions bud on your chest.", false);
    else if (player.breasts.biggestTitSize() <= 8) outputText("your " + allBreastsDescript(player) + " begin to bounce all around.", false);
    ...
    // [if flat to E-cup]
    if (player.breasts.biggestTitSize() <= 8) outputText("your new EE-cup breasts settle", false);
    ...
    if (!player.breasts.hasFuckableNipples()) outputText("new ", false);
    ...
    if (player.breasts.biggestTitSize() < 1) outputText("your tits, along with the elongated nipples, receding back into a flat chest.", false);
    else if (player.breasts.biggestTitSize() <= 8) outputText("your boobflesh shrinking back down into its normal size, nipples included.", false);
...
function slimeGhostGalForHerms(clearOut: boolean = false): void {
    ...
    if (player.breasts.biggestTitSize() > 0) outputText("both you and the spooky slime press your tits together, your swaying thrusts only enhancing the mammary meltdown.");
