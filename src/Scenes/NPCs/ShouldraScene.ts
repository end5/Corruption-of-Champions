...
export class ShouldraScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    private ghostIzmaPenis(): void {
        spriteSelect(67);
        outputText("", true);
        outputText("You swiftly disrobe and lay your " + player.armorName + " to the side, revealing your stiffening " + game.player.multiCockDescriptLight() + " in all of its glory. The ghost-girl's eyes brighten at the sight, and she even allows herself a little swoon (which looks absolutely silly, given her current tough shark-like vessel) as she regards your manhood.  ", false);
    ...
    private ghostGooGurlzDuckfaces(): void {
        ...
        // ([if penis present]
        if (player.hasCock() && !player.hasVagina()) outputText(" presenting your " + game.player.multiCockDescriptLight() + " to the spectral slime.", false);
    ...
    private penisLossThatIsntALoss(): void {
        ...
        if (player.inte < 50) outputText("It's not very hard for her to break down your fortifications, and you soon feel yourself being pushed aside by her vast mental capacity.", false);
            ...
            outputText("She moves to leave in a huff, but you stop her with a single telepathic demand. She's yours, you remind her, and since she's gone through the trouble of trying to get you off, she might as well finish the job. Even as her lips purse in a stubborn pout, a dominating wave of influence sweeps over her, and regardless of herself, she begins unsteadily moving towards you. Resolving to meet halfway, you stride over to her and push her to your knees. As she watches, you shed your " + player.armorName + " and hoist your " + game.player.cockDescript(x) + " up to her lips, leaving a fairly clear implication of your expectations. The ghost girl's eyes widen at the sight of your manhood, and she cringes as a new wave of arousal sweeps through her. She gives a little whimper at her inability to quell her overwhelming libido, but you simply laugh mockingly and gesture at your maleness.  \"<i>Ghost blowjob,</i>\" you mutter snidely.\n\n", false);

            outputText("You don't even give her the chance to act of her own volition, simply reaching out, taking ahold of her head, and slamming her onto your " + game.player.cockDescript(x) + ".  She takes it surprisingly well, unsurprisingly easily, taking most of the shaft in the first thrust alone.  With not as much as even a sputter, she impatiently double-handedly grabs your " + buttDescript() + " and thrusts her head forward.  Before you know it, your entire " + game.player.cockDescript(x) + " is wrapped in a fleshy tunnel of love.", false);
            if (player.cockTotal() > 1) {
                outputText("  Mindful of ", false);
                if (player.cockTotal() == 2) outputText("your other dick", false);
                else outputText("the rest of " + game.player.multiCockDescriptLight(), false);
    ...
    private letShouldraIn(): void {
        spriteSelect(67);
        outputText("", true);
        outputText("The ghost girl squeals in excitement as you allow her partial control- only enough for her to feel your penis as if it were her own.  With an ecstatic, victorious scream, she impales herself upon your dick, taking the entire thing down her throat like it's nothing.  Your jet-stream of cum rockets into her gob, blasting her head straight off your dick to slam into your " + game.player.chestDesc() + " with an \"<i>Oof.</i>\"\n\n", false);
    ...
    private ghostBJFinisher(inside: boolean): void {
        ...
        outputText("Like a backed up geyser, your gigantic testicles push hot, thick strands of seed out of your belaboured " + game.player.cockDescript(x) + " straight up in the air.  The cum splatters on both you and the ", false);
    ...
    private hermaphroditeGhostsCumEctoplasm(): void {
        ...
        outputText("Taking complete control of your body as if it was never actually yours, she removes your " + player.armorName + " and throws them carelessly to the ground. Grabbing up your " + game.player.cockDescript(x) + " in both hands and fondling it awkwardly, she strikes you as obviously inexperienced with the male anatomy, despite her levels of intelligence. She continues to grope your lengthening member, admitting, \"<i>Even with the rare male bodies I have possessed, I rarely got to play with their...</i>\"\n\n", false);
        ...
        outputText("She chuckles malevolently, and you groan, mind cycling through the possible outcomes of the girl's impulses. Your lips curl unbidden in an evil smile, then begin mouthing an archaic incantation. You wince inwardly, bracing for the worst. She finishes and goes back to the vigorous stroking, and you are left to wonder what the spell was meant to do- that is, until you feel a tingling beginning at the base of your " + game.player.cockDescript(x) + ", slowly climbing up the shaft until your entire length is covered in the sensation.\n\n", false);
    ...
    private ourDadTaughtUsNotToBeAshamedOfOurDicks(): void {
        ...
        outputText("and you feel your hands moving unbidden towards your crotch. You snap the sneaky extremities back to your sides, knowing exactly what she wants to do. The ghost girl soon proves herself the stronger in the contest of wills, however, and eventually, your will breaks and she takes complete control once again. She forces your body to stand, removing your " + player.armorName + " and throwing them carelessly to the ground. She takes your " + game.player.cockDescript(x) + " in both hands and fondles it awkwardly, obviously inexperienced with the male anatomy.  \"<i>Most of my hosts have been women,</i>\" she explains as she continues to grope your lengthening member.  \"<i>And even then, I rarely got to play with their...</i>\"\n\n", false);
    ...
    private loseToShouldraWithWorms(): void {
        ...
        outputText("and you feel your hands moving unbidden towards your crotch. The ghost girl soon proves herself the stronger in the contest of wills, however, and eventually, your will breaks and she takes control. She heaves your body off the ground, removing your " + player.armorName + " and throwing them carelessly to the ground. She takes your " + game.player.cockDescript(0) + " in both hands and fondles it awkwardly, obviously inexperienced with the male anatomy. \"<i>Most of my hosts have been- WHAT THE FUCK!?</i>\"\n\n", false);
    ...
    private loseToShouldraAsHerm(): void {
        ...
        outputText("and you feel your hands moving unbidden towards your crotch. You snap the sneaky extremities back to your sides, knowing exactly what she wants to do. The ghost girl soon proves herself the stronger in the contest of wills, however, and eventually, your will breaks and she takes complete control once again. She forces your body to stand, removing your " + player.armorName + " and throwing them carelessly to the ground. She takes your " + game.player.cockDescript(0) + " in both hands and fondles it awkwardly, obviously inexperienced with the male anatomy.  \"<i>Most of my hosts have been women,</i>\" she explains as she continues to grope your lengthening member.  \"<i>And even then, I rarely got to play with their...</i>\"\n\n", false);
        ...
        if (player.balls > 0) outputText("Stopping her double-handed stroke technique, she slips your hand under your obtrusive " + ballsDescriptLight() + " and gently pushes them aside to get a better look at your previously unnoticed female sex.  ", false);
        outputText("She chuckles evilly, and you groan, mind cycling through the possible outcomes of the girl's impulses. Your lips curl unbidden in an evil smile, then begin mouthing an archaic incantation, and you wince inwardly, bracing for the worst. She finishes and goes back to the vigorous stroking, and you are left to wonder what the spell was meant to do—that is, until you feel a tingling beginning at the base of your " + game.player.cockDescript(0) + ", slowly climbing up the shaft until your entire length is covered in the sensation.\n\n", false);
