...
export class ShouldraScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    private sharkbustersVictory(): void {
        ...
        if (player.biggestTitSize() >= 1) outputText(", " + allBreastsDescript(player) + " squishing and squashing against her own barely-clad bosom", false);
    ...
    private slimeGinaFlation(): void {
        ...
        if (player.biggestTitSize() < 1) outputText("see your " + nippleDescription(player, 0) + " wiggling sporadically.", false);
    ...
    private slimeyPenorsAhoy(): void {
        ...
        // ([if boobs present]
        if (player.biggestTitSize() < 1) outputText(" while squishing her small boobs into your own " + allBreastsDescript(player), false);
    ...
    private genderlessGhostBuster(): void {
        ...
        else if (player.biggestTitSize() <= 8) outputText("your " + allBreastsDescript(player) + " begin to bounce all around.", false);
