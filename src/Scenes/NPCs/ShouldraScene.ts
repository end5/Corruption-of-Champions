...
export class ShouldraScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    private sharkbustersVictory(): void {
        ...
        if (player.biggestTitSize() >= 1) outputText(", " + allBreastsDescript() + " squishing and squashing against her own barely-clad bosom", false);
    ...
    private sharkyEctoginas(): void {
        ...
        outputText(". After the cloud of arousal disperses from the ghost-girl's normally intelligent mind, she can't help but notice how uncomfortable you must be, squirming about with her gigantic pinky shoved up your " + vaginaDescript(0) + ".\n\n", false);
    ...
    private ghostIzmaPenis(): void {
        ...
        if (player.balls > 0) outputText(" and cradling your " + ballsDescriptLight() + " with almost reverent gentleness, running her coarse shark-skinned fingers across your sack as gently as she can manage", false);
        outputText(".\n\n", false);
    ...
    private ghostGooGurlzDuckfaces(): void {
        ...
        else if (player.hasVagina()) outputText(" slipping a hand down to your " + clitDescript() + " eagerly.", false);
        // [if herm]
    ...
    private slimeGinaFlation(): void {
        ...
        else outputText("Your frame is jostled about as the slime under you shrinks, your goo-filled gut pushing your " + allBreastsDescript() + " up into your overburdened jaw.", false);
        outputText("\n\n", false);
        ...
        if (player.biggestTitSize() < 1) outputText("see your " + nippleDescript(0) + " wiggling sporadically.", false);
        else outputText("see your " + allBreastsDescript() + " trembling, " + nippleDescript(0) + " twitching eagerly.", false);
    ...
    private genderlessGhostBuster(): void {
        ...
        else if (player.biggestTitSize() <= 8) outputText("your " + allBreastsDescript() + " begin to bounce all around.", false);
        else outputText("your " + allBreastsDescript() + " swell slightly to make room for a sudden increase in milk production.", false);
    ...
    private penisLossThatIsntALoss(): void {
        ...
        if (player.inte < 50) outputText("It's not very hard for her to break down your fortifications, and you soon feel yourself being pushed aside by her vast mental capacity.", false);
            ...
            outputText("You don't even give her the chance to act of her own volition, simply reaching out, taking ahold of her head, and slamming her onto your " + cockDescript(game.player, x) + ".  She takes it surprisingly well, unsurprisingly easily, taking most of the shaft in the first thrust alone.  With not as much as even a sputter, she impatiently double-handedly grabs your " + buttDescript() + " and thrusts her head forward.  Before you know it, your entire " + cockDescript(game.player, x) + " is wrapped in a fleshy tunnel of love.", false);
    ...
    private penisGartuanGhostSmexVictory(): void {
        ...
        outputText("After a moment's more of hesitation, the ghost girl sinks down to your waist, pushing her head out of your " + hipDescript() + ".  \"<i>I apologize, sir, but our- er, sorry, your host did not mention he was already... occupied,</i>\" she admits in her soft, feminine voice.\n\n", false);
    ...
    private hermaphroditeGhostsCumEctoplasm(): void {
        ...
        if (player.balls > 0) outputText("Stopping her double-handed stroke technique, she slips your hand under your obtrusive " + ballsDescriptLight() + " and gently pushes them aside to get a better look at your previously unnoticed female sex.  ", false);
    ...
    private genderlessShouldrasLossRapes(): void {
        ...
        else outputText("your " + allBreastsDescript() + " swells slightly to make room for a sudden increase in milk production.", false);
        outputText("  As the ghost continues darting around the room, ", false);
        if (player.biggestTitSize() <= 8) outputText("your new EE-cup breasts settle", false);
