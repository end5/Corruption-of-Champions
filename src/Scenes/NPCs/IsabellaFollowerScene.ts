...
Optional Morning Oral for small-membered males*/
    ...
    public isabellaMorningWakeupCall(): void {
        ...
        if (player.balls > 0) outputText(ballsDescriptLight() + " against her chin, the cum-bloated orbs bouncing and shuddering with your " + cockDescript(game.player, x) + " as release nears.", false);
        else {
