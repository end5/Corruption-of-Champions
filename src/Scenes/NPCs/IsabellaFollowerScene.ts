...
export function isabellaMoovesInGreeting(): void {
    ...
    if (flags[kFLAGS.ISABELLA_TIMES_OFFERED_FOLLOWER] == 0) {
        ...
        else outputText("squeeze against your " + chestDesc(game.player) + ", the four hard nipples capping each milk-flooded breast pressing on your own.", false);
...
function isabellasAccentCoaching(): void {
    ...
    const result: number = player.inte / 5 + rand(9);
...
export function isabellaMorningWakeupCall(): void {
    ...
    outputText("  Her massive, malleable tongue moulds around your " + cockDescript(game.player, x) + " as she works to enhance your pleasure.  A trickle of warm, creamy milk escapes the heavy jugs resting on your " + legs(player) + ", showing you just how much she enjoys dispensing oral pleasure.  The tangled, crimson mass of hair slowly begins to bob up and down upon your loins, and Isabella's big brown eyes look up at you with radiant happiness, the corners of her mouth curling into a cock-filled smile.\n\n", false);

    outputText("You groan out loud at the sight of the sexy cow-girl's mischievous gaze.  She's face-fucking your " + cockDescript(game.player, x) + " without any difficulty and laying languid, lascivious licks over every part of your maleness simultaneously.  Your cock is utterly, helpless bound up by her thick oral organ.  It twitches inside her mouth-muscle's embrace, helplessly releasing rivulets of pre-cum that disappear into Isabella's throat as fast as you can produce them.  You can see her cheeks hollowing as she begins to pull the tongue-wrapped dick deep into her maw, the suction making your " + cockDescript(game.player, x) + " grow dangerously sensitive to the cow-girl's whims.\n\n", false);

    outputText("\"<i>Oh fuck!</i>\" you groan without meaning to, lifting your " + hipDescription(player) + " to press your ", false);
    ...
    outputText("  Isabella brushes her hair back to watch your reaction; her shining eyes never leave your face as she kicks her efforts into overdrive, pumping and stroking your " + cockDescript(game.player, x) + " with nothing more than her tongue's moist heat.\n\n", false);
    ...
    outputText("milk-puddle around your " + legs(player) + ".  She sighs and says, \"<i>", false);
    if (flags[kFLAGS.ISABELLA_MORNING_FELLATIO_COUNT] == 1) {
        ...
        if (isabellaAccent()) outputText("Yum!  You cum so hard for momma Izabella, don't you?</i>\"  The sated cow-girl gives your " + cockDescript(game.player, x) + " an affectionate squeeze before murmuring, \"<i>So yummy...", false);
        else outputText("Yum!  You cum so hard for momma Isabella, don't you?</i>\"  The sated cow-girl gives your " + cockDescript(game.player, x) + " an affectionate squeeze before murmuring, \"<i>So yummy...", false);
    }
    else {
...
function repeatGermanBratwurstInCamp(): void {
    ...
    if (flags[kFLAGS.ISABELLA_TIME_SINCE_LAST_HOTDOGGING] < 5 && flags[kFLAGS.ISABELLA_TIME_SINCE_LAST_HOTDOGGING] > 0) {
        ...
        if (isabellaAccent()) outputText("gleefully muses, \"<i>Oooh, I see.  Of course I vill help you, " + player.short + "!</i>\"  She traces a finger around " + oMultiCockDesc(game.player) + "' outline and continues, \"<i>It vould be mein pleasure to squeeze it all out into mein caboose.  Zat is what you vant, nein?", false);
        else outputText("gleefully muses, \"<i>Oooh, I see.  Of course I'll help you, " + player.short + "!</i>\"  She traces a finger around " + oMultiCockDesc(game.player) + "' outline and continues, \"<i>It would be my pleasure to squeeze it all out into my caboose.  That is what you want, no?", false);
    }
    outputText("</i>\"\n\n", false);
    ...
    outputText("You nod, catching a whiff of her musky pussy's aroma without meaning to.  It's not like you could avoid it, with her body mere inches in front of your " + face(player) + ", shaking so perfectly and so closely that an occasional droplet catches on your nose.  Your hands clamp around the chair with an iron grip as you fight not to rise and rape her tender, teasing asshole on the spot.  " + SMultiCockDesc(game.player) + " is trickling and dribbling, bouncing with your heartbeats as your " + legs(player) + " shiver and shake with denied lusts.  You NEED to do something... to fuck, thrust, or just fap... anything - your " + multiCockDescriptLight(game.player) + " can't take it anymore!\n\n", false);

    outputText("Drawn up by your dick, you let go of your grip on the cow-crafted chair and start to rise into Isabella.  She expertly drops her bouncy butt into your " + chestDesc(game.player) + ".  It knocks you back down into place while she scolds, ", false);
    ...
    if (isabellaAccent()) outputText("\"<i>Good " + mf(player, "boy", "girl") + ".  Relax, Momma Isabella vill take care of you.</i>\"\n\n", false);
    ...
    if (player.cocks.cockArea(x) <= 38) {
        ...
        outputText("You grab hold of the chair again with both hands, struggling not to cum while Isabella's ass slides over your member.  It's so hot, wet, and sensual that you're trembling from the effort of holding still, but you manage, knowing the longer you hold back, the better the finish will be.  She slowly pumps your " + cockDescript(game.player, x) + " in her anal valley while you whine and moan, your face taking on a more lurid, sexual expression with every passing moment.  When at last you feel you can hold back no longer, you groan, \"<i>G-gonna... gonna-cum-soon!</i>\"\n\n", false);
        ...
        if (player.cumQ() >= 1000) {
            ...
            outputText(".  She whimpers slightly and murmurs, \"<i>Such a fertile " + mf(player, "boy", "girl") + "... Momma Izzy can take it.</i>\"  ", false);
        }
        outputText("Your " + cockDescript(game.player, x) + " writhes in bliss for what seems like forever, but before you know it, you're coming back down to Earth.  Isabella whispers, \"<i>Good " + mf(player, "boy", "girl") + ",</i>\" to you and stands up, ignoring the cum that drips from her dark pucker to stain " + sMultiCockDesc(game.player) + ".  She helps you up, and her hand tussles your hair affectionately.  Then she turns towards her side of camp, walking a little bow-legged as she leaves.", false);
    }
    // (Big dicks)
    else {
        if (isabellaAccent()) outputText("\"<i>Oh my, does mein ass feel zat good on ze huge, pervy thing you call a dick?</i>\" teases Isabella as she flexes one side then the other, forcing your " + cockDescript(game.player, x) + " to bend in response to the two dueling masses of her booty cheeks.  She keeps talking, \"<i>You have such a naughty look on your face, drooling all over yourself like a dog.  Is that what having a big dick does to you?  Does it make you so horny and weak-willed that you'll waste your cum all over my ass?</i>\"  Isabella stops her back-and-forth flexing in order to begin bouncing up and down.  Her soft, flexing buns caress your " + cockDescript(game.player, x) + " from base ", false);
        else outputText("\"<i>Oh my, does my ass-job feel that good on that huge, pervy thing you call a dick?</i>\" teases Isabella as she flexes one side then the other, forcing your " + cockDescript(game.player, x) + " to bend in response to the two dueling masses of her booty cheeks.  She keeps talking, \"<i>You have such a naughty look on your face, drooling all over yourself like a dog.  Is that what having a big dick does to you?  Does it make you so horny and weak-willed that you'll waste your cum all over my ass?</i>\"  Isabella stops her back-and-forth flexing in order to begin bouncing up and down.  Her soft, flexing buns caress your " + cockDescript(game.player, x) + " from base ", false);
        if (player.cocks[x].cockLength > 48) outputText("to as high as she can reach on the towering shaft's length", false);
        else outputText("to " + cockHead(player, x), false);
        ...
        outputText("You shudder, trying to hold still and prolong the pleasure, but " + sMultiCockDesc(game.player) + " is jerking up and down, defiantly grinding itself through the hot, slippery valley of Isabella's ass.  The " + cockHead(player, x) + " bounces above like a flag-pole in a hurricane, and then you can bear it no longer.  You're cumming... cumming so very hard.  Your whole body locks tight, back arching slightly from the strain.  Isabella slides down to the bottom of your convulsing pole and resumes rolling your " + cockDescript(game.player, x) + " between her bronzed ass-cheeks, causing your eruptions of seed to form lazy 'S' shapes in the air before splattering down on her heaving bottom.", false);
...
function tentacleBoneFollowerIzzy(): void {
    ...
    if (isabellaAccent()) outputText("Without a word, you adroitly guide your squirming bunch of tentacle peckers toward her body, slowly encircling her. In no time your " + cockDescript(player, t1) + " is already wrapping her supple waist, quickly followed by your " + cockDescript(player, t2) + "; using the combined strength of your inhumanly powerful pair of dick muscles, you lift her off the ground.  \"<i>Oh... you're a kinky boy, aren't you? Well, if that's what you want...</i>\"", false);
    else outputText("Without a word, you adroitly guide your squirming bunch of tentacle peckers toward her body, slowly encircling her. In no time your " + cockDescript(player, t1) + " is already wrapping her supple waist, quickly followed by your " + cockDescript(player, t2) + "; using the combined strength of your inhumanly powerful pair of dick muscles, you lift her off the ground.  \"<i>Oh... you are a kinky boy, ja?  Vell, if zat is vhat you vant...</i>\"", false);
    outputText("  Struggling at first, she eventually succumbs to the manipulating and caressing tips of " + oMultiCockDesc(game.player) + "; already quite aroused by the contact of her wriggling body, your peckers start dribbling pre-cum. You copiously smear her body with your own juices, painting her belly and her breast with translucent goo. The rubbery friction of your penile floras running all over her naked skin is teasing her, and you can feel her shiver and tremble as you ruthlessly grope her with your flexible genitalia.\n\n", false);
    ...
    outputText("After toying with her for a while, you decide to bring your other tentacle dicks into the game; with expert precision, you move your " + cockDescript(player, t3) + " to her face.  Moaning under your gentle ministrations, she doesn't even notice the protruding mammoth about to lodge inside her drooling mouth. With a ferocious thrust you slam it all the way between her pulpy lips. Her sighs of pleasure are abruptly muffled as you block her windpipe with vegetal dickflesh. You start ramming your meat up and down her throat, its raw musk making her dizzy.  She tries to accommodate the monster stretching her mouth by moving her tongue around your erect " + cockDescript(player, t3) + ", squeezing it there and there, fondling your veins and milking your urethra of your pre-cum. You groan from the tongue-teasing and start filling her stomach with oozing fluid; the intimate contact makes her squirm a little more under the almost unbearable arousal. She's doing an expert job with her mouth, and her throat feels so good, so tender...  You try to stuff more of your " + cockDescript(player, t3) + " inside her, always wanting more pleasure; the additional pressure almost sends her over the edge as she eagerly gobbles your vegetal rod.\n\n", false);

    // [if demon tongue]
    if (player.tongueType == TongueType.DEMONIC || player.tongueType == TongueType.SNAKE || player.tongueType == TongueType.DRACONIC) {
    ...
    if (t9 >= 0) {
        ...
        if (t10 >= 0) outputText("s are left with nothing to stuff, writhing in frustration.  You think it would be fair to put them to use: you wrap one around her wrists, binding her hands and immobilizing her to ease the penetration of the others, then run the tip across the unused parts of her body, and simply enjoy the caress of her delicate skin against your " + cockDescript(player, t9) + ", feeling her shiver under your fluid tentacle motion.  Your remaining " + cockDescript(player, t10) + " wraps around her face, squeezing her cheeks and pointing its tip toward her eyes, in order to make sure her every sense is saturated with cock.", false);
        else outputText(" is left with nothing to stuff, writhing in frustration.  You think it would be fair to put it to use: you wrap it around her wrists, binding her hands and immobilizing her to ease the penetration of the others, then run the tip across the unused parts of her body, and simply enjoy the caress of her delicate skin against your " + cockDescript(player, t9) + ", feeling her shiver under your fluid tentacle motion.", false);
        outputText("\n\n", false);
    }
    ...
    outputText(multiCockDescriptLight(game.player) + " did all the work; your groin feels sore from the sheer effort deployed in order to engage in a maximally effective penetration.  As you keep pumping, grinding and teasing her with your wriggling rods, you feel a pressure growing in your crotch and all the way up your urethras; you accelerate the thrusting pace even as ", false);
    if (player.canFly() && player.str >= 90) outputText("you descend, setting your " + feet(player) + " on the soil again but still holding Isabella herself in the air; ", false);
    outputText("you feel your climax coming closer and closer.  Isabella's body is literally swooning in pleasure and her face displays all signs of an intense incoming climax.  The sight of your lover's bliss is enough to launch you over the edge; with an amazingly inhuman might, you cum. The spunk boils furiously as it spurts out of " + sMultiCockDesc(game.player) + ". You give in to your powerful orgasm as you coat her with white goo, filling her throat", false);
    if (t4 >= 0) {
        outputText(", ", false);
...
function sparring(type: number = 1): void {
    ...
    monster.effects.create(StatusAffects.Sparring, type, 0, 0, 0);
    // No gems.
    monster.gems = 0;
...
function getIzzyBurped(): void {
    ...
    if (flags[kFLAGS.ISABELLA_PROBOVA_BURP_COUNT] == 1) {
        ...
        outputText("hat-</i>\" she sputters, the last syllable mysteriously cut off. Curious about the interruption, you look up from your massaging to her face. Isabella's cheeks are seriously inflated, as if she was attempting to hold back... oh.  Ooooooh.  Almost theatrical in its timing, her first echoing belch strikes you the same time as realization dawns upon you, the surprisingly sweet-smelling gust blasting your " + hairDescription(player) + " behind you.\n\n", false);
        ...
        if (player.lowerBody != LowerBodyType.HOOFED || player.horns <= 0 || player.hornType != HornType.COW_MINOTAUR) {
        ...
        if (player.lowerBody != LowerBodyType.HOOFED) {
            ...
            else outputText("  Confused, you quickly inspect yourself before your gaze settles on your " + feet(player) + " – or should you say, former " + feet(player) + ".  Triggered by what you surmise are the Pro Bova's fumes, your " + feet(player) + " have quickly and painlessly refashioned themselves into cloven hooves – not unlike those Isabella is currently sporting.", false);
            changed = true;
        }
        // [if no cow horns present]
        if (player.horns <= 0 || player.hornType != HornType.COW_MINOTAUR) {
            if (player.horns > 0 && player.hornType > HornType.NONE) outputText("  Your existing horns quiver, then reform into those of a " + mf(player, "bull", "cow"), false);
        ...
        // [if no cow tail]
        if (player.tailType != TailType.COW) {
            if (player.tailType > TailType.NONE) outputText("  The tip of your tail reshapes into a burst of fur, the entire length changing to match.", false);
        ...
        if (changed) player.effects.create(StatusAffects.BurpChanged, 0, 0, 0, 0);
    }
    else {
        ...
        if (player.lowerBody != LowerBodyType.HOOFED || player.horns <= 0 || player.hornType != HornType.COW_MINOTAUR || player.earType != EarType.COW || player.tailType != TailType.COW || (player.cocks.length > 0 && player.cocks.longestCockLength() < 18)) {
...
function acceptCowpology(): void {
    ...
    // REPEAT
        ...
        // female
            ...
            outputText("You lower the cow-girl to the ground and follow, both of you still enthusiastically suckling.  With her free hand she roams your form, sliding down the contours of your waist, giving your " + buttDescription(player) + " a playful squeeze.  Giving a muffled little groan of satisfaction, you follow suit, slipping a hand down her belly.  Your fingers part her thick, soaking lips and slip inside.  It takes a mere few seconds of tickling her little clitty until it swells into your hand.  Isabella's knees knock together, but her suckling efforts only redouble.\n\n", false);
...
function fuckIsabellaInTheBarn(): void {
    ...
    outputText("\n\nStripping out of your [armor], you sidle up behind the distracted bovine and grab your " + cockDescript(game.player, x) + ", giving it a few quiet strokes until it's nice and hard.  Then, with a grin, you let it pop free of your grasp so that it flops down between Isabella's gropable cheeks, quickly buried beneath her yielding flesh.");
    ...
    outputText("\n\nWith each of your movements, Isabella's cheeks clench, tormenting the " + cockDescript(game.player, x) + " trapped between your belly and her backside.  Your hips move slowly against her, gently pushing into her soft, forgiving flesh before leaning back until just the " + cockHead(player, x) + " remains caught in her tender embrace.  Between kisses and caresses, you hear your love begging for more, for you to slide your thick shaft into her eager hole, but not yet...  not yet...");
