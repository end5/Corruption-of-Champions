...
export class CeraphFollowerScene extends NPCAwareContent {
    ...
    private CeraphHandsOutNewFetishesLikePervCandy(): void {
        ...
        // *Fetish level = 2
            ...
            if (player.totalCocks() > 0) {
                ...
                outputText("your " + game.player.multiCockDescriptLight() + ".", false);
            }
            ...
            // [dicks]
            if (player.totalCocks() > 0) {
                outputText("grabs your " + game.player.cockDescript(0), false);
    ...
    private fuckFollowerCeraphsVagoo(): void {
        ...
        outputText("  Dragging the demon back, you bring her slutty, sodden puss up to your " + game.player.cockDescript(x), false);
        ...
        outputText("  Yanking back, you bury all " + num2Text(Math.round(player.cocks[x].cockLength)) + " inches of your " + game.player.cockDescript(x) + " into Ceraph's unholy, warm snatch, ", false);
        ...
        outputText("Somehow, she feels as tight around your " + game.player.cockDescript(x) + " as any virgin and three times as wet.  The gentle claps of genital against genital send ripples through Ceraph, smearing her cheek in the growing mud-puddle while her tits wobble dangerously inside the sheer latex bra.\n\n", false);
        ...
        // (DOUBLE PENN!)
        if (y >= 0) {
            outputText("A wicked idea crosses your mind, and you reach down to grab your " + game.player.cockDescript(y) + ", aiming it at the flexing asshole just above the slave's squelching snatch.  Your next thrust plows it deep into Ceraph's anus, thankfully lubricated by the demon's constant squirting.  Growling at the mounting, doubling pleasure, you resume your tempo and slam both your cocks hilt-deep in Ceraph.  ", false);
        ...
        outputText("With a shuddering explosion of warmth, you cum.  Ceraph groans loud and low, her pussy happily caressing your " + game.player.cockDescript(x) + " as it spews its potent load into her demonic womb.  ", false);
        if (y >= 0) outputText("Her asshole likewise gleefully devours the seed from your " + game.player.cockDescript(y) + ", flexing wildly from the fluid injection.  ", false);
        ...
        outputText(".  It trails off, though her pussy continues teasing your " + game.player.cockDescript(x) + ", wringing the last of your seed from your " + ballsDescriptLight() + ".\n\n", false);
    ...
    private ceraphTentacleGrape(): void {
        ...
        outputText("A warm, sucking orifice aligns itself with your " + game.player.multiCockDescriptLight() + ", making obscene squelching noises as it dilates to take ", false);
        ...
        outputText(".  Even better, there are what feels like thousands of wriggling cilia squirming in the syrupy tunnel, each of them caressing and licking at " + game.player.sMultiCockDesc() + " repeatedly.  Like thousands of hungry tongues, they seem to set off every nerve in your " + game.player.multiCockDescriptLight() + ", nearly making you forget the rhythmic, pulsating suction of the tendril as it fellates you.\n\n", false);
    ...
    private fuckCeraphsCatgirls(): void {
        ...
        if (player.cockTotal() == 1) outputText("sliding her hand between the furry tits, down the base of your " + game.player.cockDescript(x) + ".", false);
        ...
        outputText("Thanks to all the stimulation from before, their expert tongues almost immediately bring your body to a shuddering orgasm, and " + game.player.sMultiCockDesc() + " ", false);
    ...
    private ceraphLackeyCorruption(): void {
        ...
        if (player.cockArea(player.biggestCockIndex()) < 48 && player.hasCock()) {
            outputText("Your " + game.player.cockDescript(x) + " throbs, veins bulging as it grows larger, ballooning to a generous 20-inch long, 3-inch thick size.  ", false);
        }
    ...
    private sweetieNOOOO(): void {
        ...
        outputText("  She reaches up and takes a tentative grasp of her curved, demonic horns, straightening and molding them into more bovine models.  The spade-tip of her tail shrinks, then puffs out with hair, and the whole appendage droops as it becomes remarkably more cow-like.  Almost as an afterthought, she paces up to you and slowly strips you of your " + player.armorName + ".  She teases " + game.player.oMultiCockDesc() + " a bit before gliding back to her previous position.\n\n", false);
    ...
    private cerminika(): void {
        ...
        if (player.hasCock()) {
            ...
            if (player.biggestTitSize() >= 0) outputText("She casually and playfully gives the gentlest squeeze to your " + game.player.chestDesc() + ".  ", false);
            ...
            outputText(".  Her tongue roams hungrily over her inky lips, and an almost predatory grin sets across her features as she pulls up your " + game.player.cockDescript(0) + ".  Her fingernails cup under your head delicately and carefully tease you, rubbing her palm into the underside of your shaft.\n\n", false);

            outputText("\"<i>How long,</i>\" she purrs, \"<i>Have you wanted to really be inside me?</i>\"\n\n", false);

            outputText("Dominika slides her body back, rubbing the softness of her folds against your " + game.player.cockDescript(0) + ".  ", false);
            ...
            outputText("  You simply smirk at her, starting to bounce her into your lap and shoving your " + game.player.cockDescript(0) + " deeper inside. Once more she bites her lip, fingers digging into your stomach. No matter how classy she wants to appear, you can quite easily feel how wet she is", false);
            ...
            outputText("You give her a carefully crafted retort that demonstrates your intellectual superiority, but she just gives you a fake smile and pats your cheek.  Eyes half-closed she slowly slides herself along you, enjoying the sensation of each inch of your " + game.player.cockDescript(0) + " as it brushes along her walls.  \"<i>Mmmm,</i>\" she lets herself purr out, \"<i>Worth... the wait.</i>\"  Her toes curl slightly, one of her legs shifting back slightly to alter the angle you enter her at.  It seems to work how she wants it to, as a deep, satisfied breath accompanies the next downward slide of her hips.", false);
            ...
            else outputText("  She shudders as your " + game.player.cockDescript(0) + " fills her guts with warmth, hips seizing as she rides out her assgasm.", false);
            ...
            outputText("  The demoness laps at your " + game.player.cockDescript(0) + ", cleaning it of spunk, sweat, and all the various filth it accumulates, sucking and dragging her fat, midnight lips across them.  Dominika purrs her happiness, her joy at being forced into such a whorish form.\n\n", false);
    ...
    private fuckZetsukosTonguepussy(): void {
        ...
        outputText("\"<i>Ooo-oohh! " + player.mf("Master's", "Mistress's") + " cock tastes so good in Zetsuko's pussy!</i>\" she moans, rolling her eyes back as you feel her begin to \"<i>suck</i>\" on your " + game.player.cockDescript(x) + " deeply, rocking her hips back and forth.  The suction inside her drooling cunt feels like one of the most intense deepthroats you've ever felt, and you forget for a moment that it's coming from her vagina until Zetsuko's loudest moan yet snaps you back to reality.\n\n", false);
        ...
        outputText("With the way her pussy and tongue are squeezing you now, it would be nearly impossible not to indulge her request.  Your " + game.player.cockDescript(x) + " twitches inside her, releasing a creamy deluge that causes Zetsuko to begin drooling from both ends.  \"<i>Oooh...  so good, so thick, so creamy...  Fill Zetsuko up, yes!</i>\"", false);
    ...
    private getTonguedByZetsuko(): void {
        ...
        if (x >= 0) outputText("wrapping itself around your " + game.player.cockDescript(x) + " and squeezing momentarily before ", false);
        ...
        if (x >= 0) {
            outputText("In a somewhat impressive feat of contortion, Zetsuko brings her feet in toward her groin to stimulate your " + game.player.multiCockDescriptLight() + ", lifting ", false);
            ...
            if (player.cockTotal() > 1) outputText("s", false);
            outputText(" with the soles of her feet.  Her toes are surprisingly dextrous, able to curl around and grip your " + game.player.cockDescript(x) + " lightly, gently pinching and tugging at the skin just under the head and manipulating your throbbing member", false);
            if (player.cockTotal() > 1) outputText("s", false);
        ...
        if (x >= 0) {
            outputText("  " + game.player.SMultiCockDesc() + " twitches powerfully between her feet, ", false);
    ...
    private ceraphFollowerCockTaking(smallest: boolean = false): void {
        ...
        outputText("\n\nCeraph's fingers feel unexpectedly hot as they brush your " + game.player.cockDescript(x) + ", as if she had just come out of a heated tub.  You don't have long to ponder that little detail as they pinch into a tight ring", false);
        if (player.cocks[x].cockThickness >= 4) outputText(", compressing your massive girth into the rigid shaft", false);
        outputText(", slowly closing.  It should hurt but it doesn't, it just feels warmer and warmer, and then with a sudden 'PYOING!', Ceraph is holding your " + game.player.cockDescript(x), false);
