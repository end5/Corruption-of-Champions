...
export class CeraphFollowerScene extends NPCAwareContent {
    ...
    private fuckFollowerCeraphsVagoo(): void {
        ...
        outputText(".  It trails off, though her pussy continues teasing your " + cockDescript(game.player, x) + ", wringing the last of your seed from your " + ballsDescriptLight() + ".\n\n", false);
    ...
    private followerCeraphTongueFucking(): void {
        ...
        outputText("Desirous of being pleasured by your demonic slave, you spread out your " + legs(player) + " to allow easy access to your " + vaginaDescript(), false);
    ...
    private postUdderChoice(newl: boolean = false): void {
        ...
        if (player.balls > 0) outputText("your " + ballsDescriptLight() + " tightening", false);
    ...
    private getTonguedByZetsuko(): void {
        ...
        outputText("Your " + vaginaDescript(0) + " cinches tight around Zetsuko's tongue, and it continues to wriggle inside you while you ride out your orgasm.", false);
        if (x >= 0) {
    ...
    private ceraphFollowerTitTaking(rowNum: number = 0): void {
        ...
        if (x < player.breastRows.length - 1 && player.breastRows.length > 1) {
            // If only 1 row below
            if (x >= player.breastRows.length - 2) outputText("your torso has shifted and your " + breastDescript(x + 1) + " have moved up to fill the void.", false);
            // Multiple below
