...
"KeltOff" - Turns off Kelt */
    ...
    private keltEagerlyGetNaked(): void {
        ...
        if (player.totalCocks() == 0) outputText("\"<i>Well, aren't you a pretty little thing, all together.  You and I will get along real nice, that's for sure!</i>\"\r\r", false);
            ...
            // (Any Cock:
            outputText("and almost inevitably, his eyes drop down to your " + game.player.cockDescript(0) + ".  He snorts, ", false);
            // (Human Cock:
    ...
    private keltReluctantlyGetNaked(): void {
        ...
        outputText("You remove your top first, slowly revealing your " + allBreastsDescript() + ".  Kelt is pacing around you, eyes locked on your chest hungrily.  As you let your top fall to the ground, he laughs mockingly, ", false);
        if (player.gender == 1 && player.biggestTitSize() < 1) outputText("\"<i>What are you, a girl?  Get on with it so I can see what I'm dealing with.</i>\"\r\r", false);
        else {
            if (player.biggestTitSize() == 0) outputText("\"<i>Oops!  Could have sworn I'd find a pair of tits on you.  That's okay... I'm sure you'll hit puberty some day!</i>\"\r\r", false);
            // (Too small, A to DD:
    ...
    private keltMainEncounter3(): void {
        ...
        // NAKERS
            ...
            if (temporary == 3) {
                ...
                outputText("To your surprise, he suddenly leans forward, fist moving towards your head.  You raise your arms to deflect the blow, but he changes tactics suddenly and grabs one of your " + game.player.breastDescript(0) + " instead.  You stiffen, but before you can react further, he squeezes them brutally, mauling your breasts roughly with his hands.\r\r", false);
                // (Small Size, A-DD:
                ...
                outputText("Despite his cruel words, you can't help but groan a little bit as he brutalizes your sensitive chest.  Kelt seems to take a good deal of pleasure in how helpless you are, pinching and flicking your " + nippleDescript(0) + "s.\r\r", false);
                // (Milk)
    ...
    private keltMainEncounterPostBlowjob(): void {
        ...
        if (player.findStatusAffect(StatusAffects.BlowjobOn) >= 0) {
            ...
            if (player.lust >= 75 || player.statusAffectv2(StatusAffects.Kelt) >= 90 && rand(2) == 0) {
                ...
                // (Penis:
                if (player.totalCocks() > 0) outputText("  Your " + game.player.cockDescript(0) + " is rock hard, but he ignores it almost contemptuously.  You almost feel ashamed of it, compared to the slowly-growing manhood between his legs.", false);
                // (Vagina:
                ...
                // (Penis:
                if (player.totalCocks() > 0) outputText("  Beneath you, pressed firmly into the harsh wood of the mounting board, your " + game.player.cockDescript(0) + " erupts, splattering your stomach with your own cum.  As the thick semen slides down towards your face, you begin slipping on your own warm seed, rocking back and forth with each harsh pounding Kelt delivers to your backside.", false);
                // (Vagina:
    ...
    private fuckKeltsShitUp(): void {
        ...
        if (player.faceType == FACE_SNAKE_FANGS && player.tongueType == TONUGE_SNAKE && player.lowerBody == LOWER_BODY_TYPE_NAGA) {
            ...
            if (player.hasCock()) {
                ...
                if (player.cocks[0].cockLength <= 10) {
                    ...
                    outputText("You feel a mighty groan around your " + game.player.cockDescript(0) + " and Kelt's cock begin to pulse against your tail urgently.  Quickly and expertly, you wrap the end around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your prick.\r\r", false);
                    ...
                    outputText("You punctuate these last words with three final thrusts and then, spent, slowly withdraw your " + game.player.cockDescript(0) + " from his mouth, spit and cum trailing on your captive's lips.  Smirking, you loosen your bonds just a little by withdrawing your tail from his ass.  Kelt doesn't even orgasm; he raggedly moans as cum simply drools out of his abused dick by the bucket load.\r\r", false);

                }
                // If >10 inches:
                else {
                    outputText("Slowly but surely you feed more of your formidable member into his mouth until you feel the back of his throat, with most of your " + game.player.cockDescript(0) + " still outside his lips.  The centaur is now entirely engaged with your length, moving his head back and forth as his tongue slathers it with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, moving his head in rhythm with your own movements.\r\r", false);

                    outputText("You feel a mighty groan around your " + game.player.cockDescript(0) + " and your snake tip feels Kelt's cock begin to pulse urgently.  Quickly and expertly, you wrap the end of your tail around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cock.\r\r", false);

                    outputText("\"<i>Ah, ah, ah,</i>\" you hiss.  \"<i>Sluts don't get off before their masters.</i>\"  A wicked idea strikes you.  Whilst still holding onto the centaur's cock with your coils, you begin to wind the tip of your tail towards Kelt's ass.  It isn't easy; you have invested the entirety of your frame into holding onto the centaur, so it is by measures that you constrict him tighter as your tail inches towards his anus.  He is bone-crushingly gripped in your coils by the time you find his sphincter, which you softly but surely sink your tip into.  Kelt struggles with the last of his strength against this final humiliation, but there is nothing he can do; with your venom plaguing his limbs, your coils wrapped hard around his frame, and your cock buried in his face, you have robbed him of everything.  Slowly you begin to feed even more of your " + game.player.cockDescript(0) + " into his mouth, until you see his throat bulge with your manhood.  The tightness of it is sensational and you groan.  You let him get used to the sensation of deepthroating you before you begin to pick up the pace, ramming the majority of your dick into his mouth until your " + ballsDescriptLight() + " begin to slap against his chin.  At your other end you feel your snake tip touch something which pulses, and you gently probe it as you continue to roughly fuck his mouth, beginning to reach your peak.  Kelt only manages a few muffled screams as you milk his prostate while continuing to deny his cock release, before you silence him with a torrent of cum, pouring it directly into his stomach.\r\r", false);
        ...
        // Standard anti-kelt scene
            ...
            if (player.gender == 0) {
                ...
                outputText("You spread your " + player.legs() + " and expose your " + vaginaDescript(0) + ".  \"<i>Lick it, bitch,</i>\" you command.  When he doesn't, you give the rope a pull, and his hooves paw at the dirt in pain.  \"<i>I said LICK!</i>\" you scream, and this time he does.  His tongue slips between your puffy folds ", false);
