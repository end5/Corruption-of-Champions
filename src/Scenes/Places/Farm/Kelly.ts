...
private  breakKeltGo():void {
	...
	outputText(" small droplets of pre-cum begin dripping out of your " + game.player.multiCockDescriptLight() + " before being swallowed by the potent, feminine mixture down below.  The white spots are drowning in that milky goo, but you're confident that Kelt will be able to recognize the taste.");
...
public  defeatKellyNDBREAKHIM():void {
	...
	outputText(" your erect " + game.player.multiCockDescriptLight() + ".");
...
outputText("\n\nKelly remains quiet for a couple of seconds before slowly muttering, \"<i>Please [Master], give me your cock.  I want nothing more in the world.  I'll squeeze you until you're milked dry.  Please, let me suck your dick!</i>\"");
	...
	outputText(" Kelly at last: you can hear her moan and sigh, and her hands move erratically on your " + game.player.multiCockDescriptLight() + ", sometimes violently yanking it as she loses control.  This brings all kinds of painful yet pleasurable tingles to your body, and only entices you to feel her up even more.");
...
private  finalKeltBreaking():void {
	...
	outputText("\n\nYou laugh triumphantly as you whip your " + game.player.multiCockDescriptLight() + " out of your [armor]; the slut is more than ready!");
	...
	outputText("\n\nThe cum-flow eventually starts to ebb; less and less goo pours from your " + game.player.multiCockDescriptLight() + " and your orgasm gradually fades out.  When your euphoric pleasure wears off, you finally get a good look at the creature standing before you.");
...
private  fuckKellysCunt():void {
	...
	outputText("Holding your " + game.player.cockDescript(x) + " in one hand, you press your " + player.cockHead(x) + " against her entrance.   The steamy cunt pulses wetly around your girth, slowly spreading its thick lips to accept your rigid endowment.");
	...
	outputText("  You slowly slide inside the tight tunnel, feeling Kelly's powerful muscles squeeze delightfully around you, massaging your " + game.player.cockDescript(x) + " with slow undulations.");
...
private  tentaFuckKelly():void {
	clearOutput();
	outputText("With a mischievous grin, you remove your [armor], fully revealing your " + game.player.multiCockDescriptLight() + ".  The plant-like appendages wriggle around the horny centauress, inspecting her body from every angle.  You feel your own lust rising as the tentacle peckers grow harder, their green heads turning pink in arousal.  Kelly stammers, confused: \"<i>W-what are you-</i>\"");
...
private  getARimjobFromKelly():void {
	...
	//[Centaur:]
	else if(player.isTaur()) outputText("\n\nYou gesture at the ground.  \"<i>Lie down,</i>\" you command.  Kelly carefully folds her body up to do so, until her horse half is prostrate and only her human half is propped up.  You lead yourself back until your rear end is near to her face; grinning to yourself, you slowly brush your semi-erect " + game.player.cockDescript(x) + " against her soft face, teasing her with the idea that you've changed your mind; you cannot see her but from the small bitten off grunts and moans you know she's struggling with the urge to wrap her lips around it.  Finally, you carefully lean downwards, so that instead of your dick she's faced with your [butt].");
	
	//[Biped/Other:
	else outputText("\n\nYou gesture at the ground.  \"<i>Lie down,</i>\" you command.  Carefully Kelly folds her body up to do so, until her horse half is prostrate and only her human half is propped up.  You step forwards and for a few moments slowly brush your semi-erect " + game.player.cockDescript(x) + " against her soft face, teasing her with the idea that you've changed your mind; she struggles with the urge to wrap her lips around it, emitting small bitten off grunts and moans to your ministrations.  Finally, with a grin you pull away and turn around, so that her mouth is now facing your [butt].");
	...
	outputText("\n\nHer tongue probes deeper and deeper into you, her plump lips pressing into your [asshole] until she touches something sensitive.  Your " + game.player.cockDescript(x) + " immediately reacts, twitching upwards restlessly.");
	...
	outputText(".  Grunting, you reach your peak.  Your " + game.player.cockDescript(x) + " opens wide and you ejaculate streams of cum, splattering into the dust in front of you, your whole body clenching and seizing around the warm, wet muscle wedged in your [butt].");
	//[Pussy:]
	...
	//[Repeat: 
		...
		outputText("\n\n\"<i>Th-thank you for the lesson, [Master],</i>\" she says.  She knows the drill by now; she quickly gets to her feet and then trots over to the off-white slimy mess you have created.  What a good girl.  Before she can get started you present your " + game.player.cockDescript(x) + "; she murmurs thanks for the gift and licks your oozing head spotless first before getting on with the main meal.  You rub her behind the ear as she licks away at the spent seed at your feet and then leave her to it.");
		if(player.cumQ() >= 1000) outputText("  She is, after all, going to be here for a while.");
	}
	player.orgasm();
...
private  rideKellyForPunishment():void {
	...
	if(flags[kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] == 1) 
	{
		...
		else 
		{
			...
			if(!player.isTaur()) 
			{
				...
				outputText("\n\nNeither of you are in any condition to keep this up for long, and after five minutes of fevered fucking, you groan as you clutch Kelly's ass firmly and pour yourself into her, your " + game.player.cockDescript(x) + " surging line after line of cum into her.  She moans breathily and happily to the heavenly sensation of being filled with your seed, her vagina milking you for every drop it can get.  You don't even know how many times she orgasmed; her pussy dribbled and gushed the entire time you were inside her.");
			}
			//Centaur: 
			else 
			{
				outputText("\n\nEventually you arrive back at camp, and not a moment too soon.  Your nostrils are full of the smell of Kelly, the sight of her hot, moist skin and you are practically champing at the bit yourself; even her rippling horse body speaks directly to your own, urging you irresistibly to mount her.  You bring her to a shuddering halt, rip off your [armor], and then without any further ado rear onto her back and sink your straining " + game.player.cockDescript(x) + " straight into her cunt.  It is absolutely soaked with arousal and you encounter virtually no resistance as you thrust your hips into her soft butt and immediately begin to fuck her as hard as you can.  In your sex daze you realize you are still clutching the reigns; you pull at them intermittently as you push as much of yourself in the centauress hot, grasping warmth as you can, making her rear, squealing and then screaming around her gag to the dual sensation of her [master]'s dick burying itself in her and the harness pulling tight upon her head and bit, thrusting back into you as best she can.");
				outputText("\n\nYou wish you could live forever in these luscious moments; it is so indefinably right to be reared over your eager submissive, encompassing her with your own flesh as you penetrate her deep wetness, both your human and horse parts cry out for it; mounting her, breeding her, imprinting yourself upon her and making her yours.  Neither of you are in any condition to keep it up for long though, and after five minutes of this fevered fucking you groan as you clutch Kelly's breasts hard and pour yourself into her, your " + game.player.cockDescript(x) + " surging line after line of cum into her.  She moans breathily and happily to the heavenly sensation of being filled with your seed, her vagina milking you for every drop it can get.  You don't even know how many times she orgasmed; her pussy dribbled and gushed the entire time you were inside her.");
			}
		}
		kellyPreggers();
		//All go to: 
	...
	//First repeat: 
		...
		//[Not centaur: 
		if(!player.isTaur()) outputText("   You sigh and enjoy the sight of her pretty head bobbing over your groin, your " + game.player.cockDescript(x) + " encapsulated in soft shifting blankets of wet mouth flesh, your ears filled with her slurps and muffled sighs.  You are quickly pushed towards a new high by the worshipful treatment; you give her what she wants and cum in her mouth, letting her savor your texture and flavor; she closes her eyes and swallows, orgasm shuddering through her as it hits her stomach.  You smile and hold her face as she basks in an afterglow earned from pure debasement.");
		else outputText("  You sigh and enjoy your " + game.player.cockDescript(x) + " encapsulated in soft shifting blankets of wet mouth flesh, your ears filled with her slurps and muffled sighs.  You are quickly pushed towards a new high by the worshipful treatment; you give her what she wants and cum in her mouth, letting her savor your texture and flavor; she closes her eyes and swallows, orgasm shuddering through her as it hits her stomach.  You smile, turn and hold her face as she basks in an afterglow earned from pure debasement.");
	...
	//Second+ repeat: 
		...
		if(player.tallness < 78 && !player.isTaur())
		{
			...
			outputText("\n\nYou lead her down a side alley - giving a hard look to the onlookers which makes most of them remember they have business elsewhere- and then, braced against her formidable weight, slowly dip your " + game.player.cockDescript(x) + " into her cunt until it is completely slathered in girl slime.  She sighs to the agonisingly gentle treatment and then gives out a muffled cry out of shock as you withdraw completely and, using the lubrication she provided, push into her tight asshole.");
...
private  takeKellysVirginity():void {
	...
	if(!player.isTaur()) outputText("get down behind her and line your " + game.player.cockDescript(x) + " with her dribbling lips.");
	else outputText("lie down behind her, sliding your hindlegs behind hers in order to properly align your " + game.player.cockDescript(x) + " with her dribbling lips.");
...
private  kellyPreggers():void {
	...
	var x:number = Math.round(player.cumQ() / 20);
	if (x > 80) x = 80;
...
private  kellyPregSex():void {
	...
	outputText("\n\nYou remove your [armor] and watch your " + game.player.multiCockDescriptLight() + " grow into a rock-hard erect state under the aphrodisiac scent; you're ready to stuff the breeding mare before you.  Driven mad with lust, you jump the centaur's behind and slap her angrily, making her moan and snort in submissive pleasure.  You can't take it anymore and with feverish excitement, you grab hold of [oneCock] and plunge it deep into Kelly's dark recesses.");
...
private  giveKellyAppleSauce():void {
	...
	//[merge]
	var x:number = player.cockThatFits(300);
	var y:number = player.cockThatFits2(300);
	//Not Centaur: 
	if(!player.isTaur()) {
		...
		//1 < cock:
		if(y >= 0) {
			outputText("\n\nYour eyes fasten upon her tight, puckered asshole as lust grips you closer, a tiny puddle of human pink buried in her heaving brown horse flesh.  Your breath coming heavily now you withdraw your " + game.player.cockDescript(x) + " from her wet softness, dripping with her lubrication.  Quickly you push it against her puckered anus whilst lining up your " + game.player.cockDescript(y) + " with her gaping vagina.");
			outputText("\n\nYou wait for Kelly's head to descend towards the bowl again and then thrust forward, penetrating both her holes at the same time.  She cries out from the intense sensation and then bucks back into you, helping you sink your " + game.player.cockDescript(x) + " deeper and deeper into her ass, spreading her deliciously tight anal passage whilst your " + game.player.cockDescript(y) + " slides effortlessly into the fleshy folds of her cunt.  You slap her ass exultantly, making her squeak again, as you find your limit before resuming the same rhythm, fucking both her sopping vagina and tight, hot ass now with deep, slow strokes.");
		}
		...
		outputText("as you push towards your reward.  Panting, Kelly thrusts back into you as best she can, resisting your frenetic tugs to her hair so that the big, final slather of apple sauce can slide out of the bowl and into her mouth.  She screams around the wet, gooey mouthful and her vagina quivers and seizes your bulging " + game.player.cockDescript(x) + " in milking ripples");
		if(y >= 0) outputText(" as her anus clenches around your " + game.player.cockDescript(x));
	...
	//Centaur: 
		...
		outputText("\n\nYou tut mockingly and pull it away until she lowers her hands, then bring it in close to her face.  Her hands fall on her erect nipples as she dips her head into the bowl, scoops up a long lap of the green mash with her tongue and guides it into her wet mouth.  Her throat works and she closes her eyes.  The intermittent dripping of her femcum on the straw behind you turns into a steady trickle and your own arousal urgent now, you push your " + game.player.cockDescript(x) + " against her sopping pussy gently.  She is radiating heat and her wet depths suck at your " + player.cockHead(x) + " deliciously.");
		...
		outputText("\n\n\"<i>Oh [Master]...</i>\" Kelly groans, arching her head back from her feed so it spoons into your neck.  A series of clenches grip your " + game.player.cockDescript(x) + " and a sudden gush of fluid warms your ");
		if(player.balls > 0) outputText("[balls]");
		else outputText("thighs");
		...
		//1 < cock:
		if(y >= 0) {
			outputText("\n\nYou think about her tight, puckered asshole beneath you as lust grips you closer, a tiny puddle of human pink buried in her heaving brown horse flesh.  Your breath coming heavily now you withdraw your " + game.player.cockDescript(x) + " from her wet softness, dripping with her lubrication.  Quickly you push it against her puckered anus whilst lining up your " + game.player.cockDescript(y) + " with her gaping vagina.  You wait for Kelly's head to descend towards the bowl again and then thrust forward, penetrating both her holes at the same time.  She cries out from the intense sensation and then bucks back into you, helping you sink your " + game.player.cockDescript(x) + " deeper and deeper into her ass, spreading her deliciously tight anal passage whilst your " + game.player.cockDescript(y) + " slides effortlessly into the fleshy folds of her cunt.  You grab one of her soft tits and squeeze exultantly, making her squeak again, as you find your limit before resuming the same rhythm, fucking both her sopping vagina and tight, hot ass now with deep, slow strokes.");
		}
		...
		outputText("\n\nPanting, Kelly thrusts back into you as best she can, resisting your frenetic tugs to her hair so that the big, final slather of apple sauce can slide out of the bowl and into her mouth.  She screams around the wet, gooey mouthful and her vagina quivers and seizes your bulging " + game.player.cockDescript(x) + " in milking ripples");
		if(y >= 0) outputText(" as her anus clenches around your " + game.player.cockDescript(y));
