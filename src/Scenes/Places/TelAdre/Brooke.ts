...
export class Brooke extends TelAdreAbstractContent {
    ...
    public penetrateBrooke(): void {
        ...
        // [if (cocks >= 2)]
        if (y >= 2) outputText(".  Your " + game.player.cockDescript(y) + " rubs up and down the crack of her ass lamely, though the way she clenches against you with every inward thrust makes every sensation worth the effort");
        // [if (isHerm = true)
        ...
        outputText(".  She moans appreciatively with you some more, loving the feel of your " + game.player.cockDescript(x) + " in her.");
        ...
        if (y >= 0) outputText("  Your " + game.player.cockDescript(y) + " shoots its own load up and onto her lower back and the base of her tail, snug between the cheeks of her ass");
        // [if (cocks >= 3)
    ...
    public brookeAnal(): void {
        ...
        if (player.cockArea(x) >= 61) {
            outputText("Bluntly, you ask Brooke what her opinion is on anal.  <i>\"What, with you?\"</i> she asks, leaning her ass back and trapping your " + game.player.cockDescript(x) + " between her asscheeks expertly.  You moan with pleasure, but before you get the wrong idea, she hums disapprovingly.  She was actually using her ass to measure your " + game.player.cockDescript(x) + "!  <i>\"Sorry, sweet thing, but maybe not this time.  I just got in from the gym, and working a beast like that into my ass would be a workout in of itself.  I'm up for anything else, though.\"</i>");
        ...
        outputText(", leaning her ass back and trapping your " + game.player.cockDescript(x) + " between her asscheeks expertly.  You moan with pleasure while she glides her globes up and down, feeling your manhood rise and swell with each bob.  Your hands are already on her butt, clenching the skin hard together while you thrust in the space between her buttocks.  <i>\"Well... all right.  But only because I like you so much.\"</i>");

        outputText("\n\nYou grip onto her hips, dragging your " + game.player.cockDescript(x) + " through the crack of her ass, working yourself up further before you jump right in.  Thanks to the shower, you're both lubed up well enough - just what you were both waiting on.  Brooke leans into the wall of the shower stall, bracing herself while trying to keep herself relaxed, waiting for you to make your move although it's difficult; the thought of taking you up her ass is making her a little short of breath.");
        // [if {first time}]
        ...
        outputText("\n\nThe " + player.cockHead(x) + " of your " + game.player.cockDescript(x) + " rubs against her rosebud in anticipation");
        ...
        outputText("\n\nYou plan to take it easy on her.  You realign yourself, pointing your " + player.cockHead(x) + " right at her hole, and slowly begin to push yourself in.  On reflex, she inhales sharply, pressing her upper body into the wall some more.  You reassure her and push in a little deeper, sliding a quarter of your " + game.player.cockDescript(x) + " into her anus.  She gasps, but doesn't object.  Another push, sliding in to halfway.  A grunt, and she shuffles her feet slightly, getting more stability.  Another push, nearly to the base.  She gives out a whorish moan, and you wonder if she's at her comfort limit.  You push forward anyway, to your [sheath], and gasp in pleasure and sigh with relief when she doesn't object.");

        outputText("\n\nYou stay still for a moment, basking in the heat of her ass as she completely takes your " + game.player.cockDescript(x) + ".  The ring of her sphincter pulls and tightens around you, dragging the skin of your cock with each movement, and her inner muscles clench and massage every fiber of your hard meat.  You shuffle a bit, when Brooke interrupts you.  <i>\"Just a sec,\"</i> she says, rocking her hips some more, this way and that, trying to get a good feel for your dick in her ass.  You let her take her time – it's her ass you're fucking.  She eventually shuffles into a comfortable standing position, and with a nod, gives you the go ahead.");
        ...
        outputText("\n\n<i>\"Little harder,\"</i> she asks, when you're already going about as hard as you can.  You sacrifice a bit of speed for power as you plunge harder into her, spearing her anus apart with your " + game.player.cockDescript(x) + ", driving yourself harder into her.  She relents more space, practically crawling herself up the wall, and you continue to go up to your ");
        ...
        if (player.cockTotal() > 1) outputText("  Your second dick flails and erupts with your " + game.player.cockDescript(x) + ", spraying onto the wall in front of Brooke and across the lips of her sex.");
        // [if (cocks >= 3)]
        if (player.cockTotal() > 2) outputText("  [EachCock] blasts in time with your " + game.player.cockDescript(x) + ", each of your dicks pointing in a different direction.  Your cum gets on everything: Brooke, yourself, the stall – some even reaches as high as the shower nozzle.");
        ...
        outputText("\n\nWith some reluctance, she eventually lets go of your spent, flaccid cock, conceding momentary defeat.  The water's long-since turned cold, and you spend the remainder of your time together washing and drying each other off.  She does all she can to entice you some more – she fondles your " + game.player.cockDescript(x) + " and kisses your neck sensually, eager for some more anal-play, but you're just too worn from her earlier energy.  She pouts, but gives in, finally allowing you to slip on your [armor] and leave the gym in peace.");
    ...
    public getLaidByBrooke(): void {
        ...
        if (player.hasCock()) outputText("spearing your " + game.player.cockDescript(x) + " between her cheeks wickedly, feeling it rise effortlessly against her soft fur and the smooth, strong muscles of her glutes");
        // [if (hasCock = false)]
        ...
        if (player.hasCock()) outputText("your " + game.player.cockDescript(x) + " continues to thrust and spear between her luscious ass, demanding attention be paid to it.  Brooke notices, and rocks her hips against you, squeezing your meat teasingly with each downstroke her ass makes on your " + game.player.cockDescript(x));
        ...
        if (player.hasCock()) {
            ...
            outputText("\n\nBrooke opens her mouth and breaths hotly on your " + game.player.cockDescript(x) + ", hesitating just a moment to feel you jump in her hands, before taking you in.  She only wraps her lips around the crown, suckling gently on you, lapping at any precum that flows out.  Her tongue, though, runs out of her mouth unabated, lathering the underside of your " + game.player.cockDescript(x) + " with her saliva, preparing it for the journey it's about to take.");
            ...
            outputText("\n\nShe moans and pushes herself deeper, swallowing more of your " + game.player.cockDescript(x) + " into her tight, slurping maw: her head bobs and her tongue tastes, sucking more of your meat into her, eager to please.  You pump your hips with her sucking, your fingers twirling and playing with her hair affectionately, ");
            ...
            if (player.gender != 3) outputText("\n\n");
                ...
                outputText("and gets her tongue to work on your [vagina].  You gasp, unintentionally squatting just a bit to get more of her.  Ever the multi-tasker, she keeps her left hand busy, stroking your " + game.player.cockDescript(x) + ", making sure no part of you is ever left alone for long.\n\nShe pushes her nose up, rubbing the bridge of her long dog-nose against your [clit], knowing how much that'd get to you.  From her position, she can't reach very deep into your tunnel with her tongue, but she certainly does what she can: she licks and digs at your vulva, tasting every drop of juice you drip, and allows you to fuck against the fine fur on her face as she services you.  With the work she does in your [vagina] and with the way her expert hand continues to masturbate your " + game.player.cockDescript(x) + ", your body is horribly confused in which way to thrust against, but the sensations lighting up your mind nonetheless make it worthwhile.\n\nEventually, Brooke pulls back, releasing your cock from her hand and stepping out from between your legs.  She rolls her head on her neck a bit – staying in such a way for so long must have been a strain – and gets right back to work, sucking your " + game.player.cockDescript(x) + " back into her mouth, deeper and faster this time.  ");
            }
            outputText("Brooke moans out loud, pressing herself farther in, loving the feel of your dick in her mouth as much as you do.  Your " + game.player.cockDescript(x) + " pulses and bounces with each of your heartbeats, and she can feel the jump in her mouth and across her tongue.  She does everything she can to enhance your pleasure, from pressing your " + game.player.cockDescript(x) + " against the roof of her mouth, to using the base of her tongue on your " + player.cockHead(x) + " while she toys with your shaft with the tip, to leaning in and taking all of you in her mouth at once and staying there for a moment.  You let her know that her efforts are paying off with a wordless grunt and jerking your hips: you're close, and she can tell.");
    ...
    public doubleDicked(): void {
        ...
        outputText("\n\nYou don't bother saying much and choose to just rub yourself against the wet, matted fur of her ass for a bit.  [EachCock] begins to rise and stiffen, thawed by the heat of her body and the friction between you two: your " + game.player.cockDescript(x) + " drives itself sensually between her thighs and across her sex, while your " + game.player.cockDescript(y) + " enjoys the warmth and coziness of her ass, rubbing across her taint and teasing her anal ring.  You don't make any attempts at either hole – that comes later.");

        outputText("\n\nBrooke giggles to herself, letting you jerk yourself off with her lower body.  The " + game.player.cockDescript(x) + " between her legs caresses and tickles against her pussy while another, " + game.player.cockDescript(y) + " crawls devilishly up her butt and between her cheeks.  She squeezes down on both, forcing you to rub a bit harder, which was just the reaction she was aiming for.");
        ...
        outputText("\"</i>  She rocks her hips a little higher, brushing the ring of her anus across your " + game.player.cockDescript(y) + " while driving your " + game.player.cockDescript(x) + " further across her labia.");
        ...
        outputText("\n\nShe teases your dual penises, rubbing her wet holes against your " + game.player.cockDescript(x) + " and your " + game.player.cockDescript(y) + ", intent on bringing you to full mast before taking any sort of plunge.  Your hands travel down to her toned, trim hips, and you grasp onto them sharply, helping her rock against you.  She 'mmm's at the feel of your rough hands on her muscles, and the way you continue to drive [eachCock] against her.");
        ...
        outputText("\n\nYour tongues work together, arousing you both, preparing [eachCock] for the plunge and preparing herself, sexually and mentally, for the strain she's volunteering to take for your pleasure.  You were both well along before you had started, though: you're not going to get much harder and she's not going to get much wetter (all things considered).  She disengages from you so she can turn herself around, straddling you once more, face-to-face.  Her hips rise along with your " + game.player.cockDescript(x) + " and your " + game.player.cockDescript(y) + ", until one head is pushing against her impatient cunt while the other rests against her butthole.");
        ...
        outputText("\n\nThe " + game.player.cockDescript(x) + " in her quim slides in tightly, but easily.  The " + game.player.cockDescript(y) + " pressing against her rim, though, takes a bit more convincing.  She grits her teeth and closes her eyes in concentration, grinding her hips just slightly, back and forth, working the meat into her butt.  Once the " + game.player.cockDescript(y) + " pops in, she lets out a gasp, opening her eyes a bit, before focusing once again to work more of it into her.  Her muscles relax and tense sporadically – ");
        // [if {first time anal}
        ...
        outputText("\n\nYou accede; it's the least you can do in return.  After all the effort she went through to right herself on you, you pull out from her, ruining all her hard work, and then thrust back in, slowly.  Her breath catches in her throat, but she doesn't object – you repeat yourself, pulling out just as far, and she shucks in some air once you thrust in.  Her pussy squelches and squeezes, but not anything like her anal ring: it's like she's both trying to keep you in and trying to keep you from entering her body, all at once.  Her muscles move and form around your " + game.player.cockDescript(x) + " and your " + game.player.cockDescript(y) + " with each movement you make, doing their best to shape themselves around both of your intruders.");
        ...
        // [if (cumQuantity <= 349)]
        if (player.cumQ() <= 349) outputText("Your jizz blasts into her, filling into her womb nice and comfortably and shooting deep into her bowels.  Your both shake: her from the feeling of getting two doses of your cum at once and you from having your " + game.player.cockDescript(x) + " and your " + game.player.cockDescript(y) + " pleased so uniquely.  Your orgasm goes for two, three, and four blasts, before tapering off to nothing inside of her.");
        // [if (cumQuantity <= 999)
        ...
        else outputText("Once your orgasm finally, powerfully overtakes you, a glimmer of a thought questions that maybe finishing inside her wasn't the best idea.  Your cum rockets into both her pockets and then some: the " + game.player.cockDescript(x) + " in her vagina fills it to the brim in just a few spurts, and the " + game.player.cockDescript(y) + " in her ass shoots and shoots into the rest of her, distending even her tight stomach and ruining her form.  She grunts hard, gripping onto you while you fill her out, but the tightness from both your cocks makes keeping herself composed a harder task than she anticipated.  Your orgasm goes for what seems like minutes, and when you're finally done, she looks primed to pop like a balloon.");
    ...
    public brookeSpecialMediumSceneContinued(): void {
        ...
        if (x >= 0 && !player.hasVagina()) {
            ...
            outputText("  Your heart races, and your " + game.player.cockDescript(x) + " pulls and tightens in her pussy.  With some more encouraging, demanding words, and with a little more activity on her part, you finally cum, giving Brooke everything she asked for.");
        ...
        // {Herms only}
            ...
            outputText("\n\nYou tremble and whimper, approaching your edge with the things Brooke is doing to you.  She's very skilled, and she uses everything she knows to bring you to your climax – seemingly, anyway.  She recognizes the telltale signs of your approaching orgasm, and she angrily stands up, bringing herself to your eye level.  <i>\"Don't be rude,\"</i> she chastises, reaching around behind you and gripping onto the stall wall you're leaning on.  She lifts one leg and wraps it around your [hips], lining her hot, tight twat with your " + game.player.cockDescript(x) + " but refusing to make the first move.  <i>\"I know you weren't thinking of finishing without me.\"</i>  You assure her that you wouldn't dream of it.  <i>\"Good.  Get to work.  You have some ground to make up.  Show me what your hot bod can do.\"</i>");

            outputText("\n\nYou grin and take the invitation gladly.  You grip onto her own hips tightly, admiring the feel of her body under your palms, as you thrust into her.  She gasps and stutters, mouth dropping agape once your wet " + game.player.cockDescript(x) + " is thrust imperiously into her, through no small effort on your part.  Her bravado wavers and her arms buckle as her weak grip tries to keep her steady.  You, though, just stand there for a moment, enjoying the feel of her velvet cunt accepting you as it had.  She's tight, amazingly so – for someone with so much experience pleasuring a herm like yourself, she seems almost virginally tight.");
            ...
            if (player.cockTotal() == 2) outputText("  Your second penis swings, cold and alone, between your body and Brooke's as you continue to saw into her with your " + game.player.cockDescript(x) + ".  The tip points up to the cleft of her swinging, pounding breasts, ready to erupt and coat the underside of her tits with your offering.  She knows of it, and she does what she can to pleasure it, but even her well-defined six-pack can only do so much.");
            ...
            outputText("\n\nShe howls to the ceiling as her body convulses, unable to contain herself anymore.  She orgasms hard, squeezing your " + game.player.cockDescript(x) + " hard, making your last few thrusts all the sweeter before you cum yourself.");
            ...
            // [if (cumMedium = true)]
            if (player.cumQ() <= 500) outputText("  Your fluid pumps into her hungry cooch with abandon: each of your heartbeats begets a pulse through your " + game.player.cockDescript(x) + " and into her womb.  She continues to shout with each of her convulsions, her voice slowly and steadily descending as her own orgasm subsides.  It takes you a moment to calm down, yourself.");
            // [if (cumHigh = true)]
            ...
            outputText("\n\nFinally turning the frigidly cold water off, you each make a show of drying yourselves off.  Despite how bow-legged Brooke is moving and despite the wear your " + game.player.cockDescript(x) + " is feeling after such a workout... well, to put it one way, you can't wait until you meet her again after this.  Miraculously, you both manage to keep your hands to yourselves, and the rest of your drying ends without incident.  She blows you a kiss before she leaves the locker room, and, after a vigorous dry, you put your [armor] back on and leave the gym.");
            // Lust reduced to 0, sensitivity decreased by 2, fatigue increased by 10
            player.orgasm();
            dynStats("sen", -2);
            fatigue(10);
    ...
    public submitHeckelXBrookeThreesome(): void {
        ...
        if (player.hasCock()) outputText("engulfing your " + game.player.cockDescript(0) + " into her warm, busy mouth");
    ...
    public brookeVHeckelBrookeWins2(): void {
        ...
        if (x >= 0) {
            ...
            outputText("\n\nYour arms and your back begin to strain a bit from having to balance both of the horny bitches as they bounce on you and on each other, but the rising pleasure in your " + game.player.cockDescript(x) + " overrides them both: you're not too far off, and from the rising grunts from Brooke, neither is she.  She finally lets go of Heckel's face, smiling playfully down on the hyena, not caring to wipe the sweat from her brow as she continues her ride.");
            ...
            outputText("\n\nHeckel cries out shortly after Brooke and begins flooding the eager Shepherd girl's cunt with her cum, blasting her womb with her potent spunk again and again, her whole body shaking and shivering uselessly, a collective slave to her cock taking all the energy out of her.  Her pussy spasms and clamps down on your " + game.player.cockDescript(x) + " simultaneously, milking you for every drop you have, and with a few barbaric thrusts and a wordless cry, you oblige, shooting your own load into her hungry vagina.");
            if (player.hasKnot(x)) outputText("  Likewise with Brooke, you pound your knot against Heckel's quim again and again, refusing to be denied entry, and with your orgasm, her pussy relents, taking in every inch of your " + game.player.cockDescript(x) + " with you.");
            ...
            // [if (isHerm = true)]
            if (player.gender == 3) outputText(".  Your [vagina] pulses in time with your " + game.player.cockDescript(x) + ", spraying your feminine juices down the inside of your tired legs uselessly, lonely and longing for a cock of its own to take");
