...
function showOffForIfris(): void {
    ...
    if (player.gender == 0 || (player.femininity < 40 && player.cor > 75 && player.faceType == FaceType.COW_MINOTAUR)) {
    ...
    if (player.cocks.length > 0) {
        ...
        if (flags[kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] == 0) {
            ...
            outputText("Spurred on by your ego, you lift the huge weight with seeming effortlessness.  The devil-girl seems to move closer as your muscles burn and strain. Suddenly you feel one of her slender hands sliding up your " + leg(player) + ", the smooth palm stroking your thigh, and then cupping your crotch. A surge of arousal ripples through your cock, making the length twitch and immediately begin to swell as she squeezes, making you pause in your efforts.\n\n", false);
        ...
        // 5a-Repeat oral scene, male/herm-
            ...
            if (player.balls > 0) outputText(", her hand cupping your " + ballsDescriptLight(player), false);
    ...
    // 4b4-PC succeeds! Is female!-
        ...
        // 5b-Repeat oral scene, female-
            ...
            if (player.breastRows.biggestTitSize() >= 1) outputText("breasts", false);
            ...
            outputText("With the first push, that long devil-tongue slides up along your " + vaginaDescript(player) + ", not teasing, but firmly lapping between the lips, spreading them slightly as she tastes you. With a pretty little moan, Ifris laves her tongue up your pussy over and over again as you pump your iron, enjoying your flavor, but knowing you'll need more to really get you going. Two fingers spread your " + vaginaDescript(player) + " open as her lips seal over your " + clitDescription(player) + ", suckling it gingerly, tongue swirling over it. Her fingers pump into you nice and quickly, your pleasureful reward for... well, you don't quite understand why this gets her excited, nor do you care.\n\n", false);
...
function ifrisDP(): void {
    ...
    outputText("Spurred on by the crimson cutie's urgings, you set the machine a bit higher and set your mind to lifting, trusting her to follow through on her teases.  You flex and strain, hefting the heavier weight higher and higher, until you've completely raised it.  As soon as you reach that glorious apex, your coverings fall away to expose your " + multiCockDescriptLight(game.player) + " to the musky gym air.  They pulsate, slowly filling with blood while you hold the bulky weights aloft.  You gradually bring the machine back down, exhaling a moan of relief once Ifris takes two of your half-swollen shafts in her hands, feeling the flesh filling out between her hot, oiled fingers.\n\n", false);

    outputText("\"<i>Mmmm... don't stop darling.  You're... more than a handful.  Just keep lifting, and I'll take care of everything down here,</i>\" promises the sultry voice of your companion.  Nodding in understanding, you return to the task you've been given - putting on a show in exchange for sexual pleasure.  " + SMultiCockDesc(game.player) + " fill, to the muscle-focused demon's delight, getting coos of pleased surprise as they fully engorge.  She strokes them slowly, letting the tightening dick-flesh slide through her oily grip a few times to make sure you're absolutely ready, always stopping the moment you start to hesitate in your assigned workout.\n\n", false);
    ...
    outputText("Ifris leans down and twines her arms around your shoulders, resting her head in the nape of your neck, her dark tongue licking the salt from you " + skin(player) + ".  Your whole body is shaking, trapped between the desire to cave in to the crimson beauty's body and the need to support the machine's tremendous load.  Hot and trembling, your arms feel like they're melting into weak, burning rubber.  Ifris senses this, and she says, \"<i>Set it down and release... release for me, darling.</i>\"\n\n", false);
