...
function useTheSexMachine(): void {
    ...
    if (player.gender == 1) {
        if (flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_MALE] == 0) {
            ...
            outputText("It takes little time for " + sMultiCockDesc(game.player) + " to grow hard, your lust betraying you as another phallic shaped metallic length is presented in front of your face. A small shock is delivered to your " + assholeDescript(player) + ", causing you to gasp, and allowing the phallic length to slip deep into your mouth, giving you little choice but to suck on the device. The tube-like length on your " + cockDescript(game.player, 0) + " continues its assault, humming and stroking your firm cock, starting to suck softly to pleasure your mighty rod; so much that you nearly don't notice as a small tube slips into the tip of your penis, beginning to slowly devour your leaking pre-cum.\n\n", false);
            ...
            if (player.balls > 0) outputText("your " + ballsDescriptLight(player) + " pulling up tightly ", false);
    ...
    // [If you decide to mess with the machine, female:]
        ...
        if (flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_FEMALE] == 0) {
            outputText("You gently sit on the padded bench, curious as to what this machine might actually accomplish, noting the various odds and ends that seem more devious in nature than exercise inclined. The screen before you quickly flickers to life, welcoming you and asking you to kindly place your " + feet(player) + " in the appropriate safety straps and place your arms in the secure cuffs. You wonder briefly if this is a good idea, but work your way into the tight fitting straps anyways.\n\n", false);
            ...
            if (player.breastRows.biggestTitSize() >= 2) outputText("  It slips a fourth cock between your " + chestDesc(game.player) + ", using two arms to press them together and fuck your tits as well, splashing a burst of mysterious cum on your face with every thrust.", false);
            outputText("\n\n", false);
            ...
            if (player.breastRows.biggestTitSize() >= 2) outputText("your breasts covered in cum and ", false);
        ...
        // [Female repeat scene]
            ...
            outputText("The cool air makes your nipples stand out, and you notice a pleasant surprise: the cocks slipping between your ass-cheeks and thighs are made of a soft, but firm, latex.  They warm as they leak cum on your " + assholeDescript(player) + " and labia. You blush, willingly opening your mouth for the cock in front of you.  Sucking it in to taste the heady seed, you close your eyes, enjoying the ride as your labia softly part, wet and ready for the intruding member.\n\n", false);

            outputText("You moan lustfully as the members slip into your " + vaginaDescript(player) + " and " + assholeDescript(player) + ", filling you deeply.", false);
            cuntChange(player, 30, true, true, false);
            buttChange(player, 30, true, true, false);
            outputText("  They begin to stroke slowly", false);
            if (player.breastRows.biggestTitSize() >= 2) outputText(", and it doesn't take long for the machine to slip a cock between your breasts as well, starting to tit fuck you as it rotates you in your restraints to optimize your position", false);
    ...
    // [Sexless]
        ...
        if (flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_EUNUCH] == 0) {
            ...
            buttChange(player, 30, true, false, true);
        ...
        // [Sexless Repeat]
            ...
            outputText("You shrug it off, slipping, as directed, into the various straps and buckles to secure yourself to the machine, and once more it lifts you into the air. You feel a firm pressure against your " + assholeDescript(player) + " once again, teasing you with a surprise: you feel a flexible latex head probing your asscheeks, leaking cum all over them!\n\n", false);
    ...
    // [Hermaphrodite]
        ...
        if (flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_HERM] == 0) {
            ...
            if (player.breastRows.biggestTitSize() >= 2) outputText("  Well, not every part of you, but that is rapidly fixed as a final cock rubs against your " + chestDesc(game.player) + ", starting to stimulate your chest as well.", false);
            outputText("\n\n", false);
            ...
            if (player.breastRows.biggestTitSize() >= 2) outputText("  The cock on your chest pumps cum onto your " + chestDesc(game.player) + ", as y", false);
