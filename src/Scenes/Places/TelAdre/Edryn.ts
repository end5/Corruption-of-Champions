...
export class Edryn extends TelAdreAbstractContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        trace("\nEdryn time change: Time is " + game.time.hours + ", incubation: " + pregnancy.incubation + ", event: " + pregnancy.event);
    ...
    public edrynBarTalk(): void {
        ...
        // Post kids talk
            ...
            if (player.cockArea(x) < 300 && player.cockArea(x) > 24) {
                ...
                outputText("You look down at your " + game.player.multiCockDescriptLight() + " and curse, irritated at how easily she can affect you.  There's no way you'll be turning her down this time.  You get up and follow her back to her room, intent on taking care of the need between your legs.\n\n", false);
                // Sex
                doNext(pregdrynOffer);
                return;
            }
        ...
        if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR && player.totalCocks() > 0) {
            outputText("and the potent female scent works its way into your blood, making you dizzy as your " + game.player.cockDescript(0) + " ", false);
            ...
            outputText(", now rock-hard.  You breathe deeply, your mind subsumed in a sea of equine instincts.  The hard floor squeezes your " + game.player.cockDescript(0) + " painfully underneath you, forcing you to rise up onto your hooves.  You can feel more than a few curious gazes sliding along your now fully exposed maleness, and it twitches as if it were happy for the attention.\n\n", false);
            outputText("Swaying back and forth, alternatively snorting and breathing deeply of the female's scent, your gaze immediately locks onto the returning mare.  Your " + game.player.cockDescript(0) + " jumps and bounces underneath you, painfully hard and swollen.  A thick dollop of pre beads on your " + player.cockHead() + ", as if the bar needed your display to be any more overtly sexual.  Edryn looks you over, walking alongside you she talks, \"<i>My my, someone liked what they saw.  Or was it smelled?  I can never tell what it is that gets you " + player.mf("studs", "hotties") + " so worked up about me.</i>\"\n\n", false);
            outputText("A soft hand slides under your belly, hefting your " + game.player.cockDescript(0) + " and smearing the bead of pre over it with long slick strokes.  She coos, \"<i>", false);
            dynStats("lus", 70);
            edrynOffer();
            return;
        }
            ...
            // Non horsedick
                ...
                if (player.cor > 50 || player.statusAffectv1(StatusAffects.Edryn) > 0 || flags[kFLAGS.LOW_STANDARDS_FOR_ALL]) {
                    outputText("  Unbidden, your mind wonders what her juicy horse-snatch would feel like, and your " + game.player.cockDescript(0) + " responds immediately, thickening with readiness.  You squirm uncomfortably from how constricting your " + player.armorName + " feels.\n\n", false);
                    ...
                    if (player.cocks[0].cockType == CockTypesEnum.TENTACLE) outputText("  She smiles coyly when your " + game.player.cockDescript(0) + " wriggles, wrapping around her arm.", false);
                    outputText("\n\n", false);
                    dynStats("lus", 40);
                    edrynOffer();
                    return;
    ...
    private edrynOffer(): void {
        ...
        if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR && player.totalCocks() > 0) {
            ...
            outputText("</i>\"\n\n", false);
            outputText("She releases your " + game.player.cockDescript(x) + " and looks expectantly at you.  Your body is ready to do anything for a chance to breed her.  What will you do?\n\n", false);
            ...
            if (player.horseCocks() > 0) {
                ...
                if (player.cockArea(x) >= 24) {
                    ...
                    outputText(game.player.cockDescript(x) + " twitch.  Will you accept her proposition and give her what she wants?\n\n", false);
                    if (cost > 0) outputText("(Do you pay " + num2Text(cost) + " gems to fuck her?)", false);
                    else outputText("(Do you fuck her?)", false);
                    doYesNo(edrynSexSelecter, telAdre.barTelAdre);
                }
            ...
            // Normal Wingdangdoodle
                ...
                if (player.cockArea(x) >= 24) {
                    ...
                    outputText("Edryn keeps talking, \"<i>I do ALL kinds of mercenary work, even the sloppy wet kind, and lucky for you, I'm more than wet enough to let you satisfy your " + game.player.cockDescript(0) + " in me.  ", false);
                    if (cost > 0) outputText(Num2Text(cost) + " gems ", false);
                    else outputText("An hour of your time ", false);
    ...
    private fuckEdrynNonTaur(): void {
        ...
        outputText(", pressing your " + face(player) + " into her slick folds and tasting her flavor.  Your nose easily slips into her gash as your tongue explores it, testing and tasting thick, liquid centaur lust.  It's tangy and sweet, surprisingly unlike the scent it gives off.  You easily find her large clit and suckle on it, listening to the wet squelches and whinnies of pleasure.\n\n", false);
        ...
        outputText(", you guide your " + game.player.cockDescript(x) + " towards the shining, black horse-cunt in front of you.  It parts easily, like a velvet curtain.  You slowly slide forward into Edryn's welcoming nethers, enjoying not having to fight to get your large " + Appearance.cockNoun(CockTypesEnum.HUMAN) + " in for a change.  She trembles as you pass the halfway point, ", false);
        ...
        outputText("She whinnies and pushes back against you, forcing your entire " + game.player.cockDescript(x) + " to slip up her well-lubed passage.  You slap her ass, watching the furred flanks jiggle slightly.  Edryn looks over her shoulder again to and gives you a sultry look.  Before you can puzzle out what she's trying to tell you, her entire cunt contracts tightly, like a silken vise.  It wrings your " + game.player.cockDescript(x) + " tightly, immobilizing you inside the powerful centauress and making your " + player.legs() + " feel wobbly and weak.\n\n", false);
    ...
    */
    ...
    private threesomeEdrynAndHel(): void {
        ...
        outputText("Hel gets to work without further prompting, grabbing Edryn's wide flanks and burying her face into the centauress's horse-cunt. You grab your " + game.player.cockDescript(x) + ", stroking yourself off to the show unfolding before you.  Edryn whinnies happily, wiggling her hips into Hel's face, crushing the salamander further and further into the wall.\n\n", false);
        ...
        outputText("Hel rolls over on her back, using her legs to steady on Edryn's back as you rub your " + game.player.cockDescript(x) + " against Edryn's gaping horsecunt, making the centauress shudder.  The shudder nearly throws Hel off her back, causing the salamander to dig her claws painfully into Edryn's sides.  She bucks back in surprise, impaling herself right on your " + game.player.cockDescript(0) + ".\n\n", false);
    ...
    private pregdrynOffer(cs: boolean = true): void {
        ...
        if (pregnancy.incubation < 250) {
            ...
            if (player.cockTotal() > 1) outputText("All of your " + game.player.multiCockDescriptLight() + " fill in seconds, growing rock hard and actually aching with their need.  ", false);
            else if (player.cockTotal() == 1) outputText("Your " + game.player.cockDescript(0) + " fills in seconds, growing rock hard and actually aching with need.  ", false);
            ...
            if (player.cor + player.lib < 100 || player.cockTotal() < 1) outputText("you struggle not to reach into your " + player.armorName + " to touch yourself.", false);
                ...
                outputText(game.player.cockDescript(0) + " and stroking it under the table.", false);
            }
            outputText("\n\n", false);
            ...
            else if (player.cockTotal() > 0) outputText(game.player.cockDescript(0), false);
        ...
        // (PC TOO BIG)
            ...
            outputText("Edryn brushes her hand over ALL of your " + game.player.cockDescript(0) + " then jerks it back, startled.  She sighs, \"<i>Dear, that thing is a BEAST.  I mean, there's no doubt I'd love to get it inside me, but I promise it won't fit me.</i>\"\n\n", false);
    ...
    public fuckPregEdryn(): void {
        ...
        if (player.lowerBody != LOWER_BODY_TYPE_CENTAUR) {
            ...
            outputText(game.player.cockDescript(x) + ".  It drips with anticipation, leaking drops of pre-cum with each inhalation of your mate's over-sexualized slit's scent.  Edryn looks over her shoulder to gauge the distance, but when she sees your state her face breaks into a happy smile.  She says, \"<i>Steady now, we wouldn't want you to miss your target, would we?</i>\" as her backside slowly descends, splattering hot sexual fluids over your length.\n\n", false);

            outputText("The centaur's gash devours your " + game.player.cockDescript(x) + " with a long, wet slurping noise.  Her body-heat is much warmer than your own, wrapping slippery heat around every sensitive inch of your fuck-pole.  The flesh around you squeezes and massages instinctively.  It feels so good that it seems as if your " + game.player.cockDescript(x) + " is going to melt under the onslaught of pleasure.  Edryn moans loudly and begins to pump her hips atop you, \"<i>Oooh yes, thats perfeeeect...</i>\"\n\n", false);
            ...
            if (player.cumQ() < 100) {
                outputText("Your " + game.player.cockDescript(x) + " dumps the last of its seed into her hungry cunt and softens slightly.  Her warm cunt's constant milking motions continue, still pleasurable, but they prevent you from going soft until the centaur's orgasm has concluded.", false);
            }
            else if (player.cumQ() < 500) {
                outputText("Your " + game.player.cockDescript(x) + " spurts thick flows of seed into her hungry cunt, flooding her snatch with an abnormally large load of semen.  Her warm cunt's constant milking motions continue, forcing more and more of your spunk inside her until her own orgasm has concluded.", false);
            }
            else {
                outputText("Your " + game.player.cockDescript(x) + " erupts, pouring a thick wave of seed into the centaur's hungry cunt.  The constant milking motions don't let up while Edryn's orgasm continues, helping you flood her with even more spooge.  Even after your pregnant lover's orgasm has concluded, your " + game.player.cockDescript(x) + " keeps dumping more cum into her until it's soaking and dripping from her huge, furry ass.", false);
            }
        ...
        // TAURZILLA
            ...
            outputText(".  The horse half of your body arches, pulling your " + game.player.cockDescript(x) + " partway out, then lurches back forward to bury it deep inside her.  The impact jiggles her flesh from her ass to her shoulders, and you feel it underneath you as an instinctual, barely thought sign of sexual dominance.\n\n", false);
            ...
            outputText(".  Her twat clutches you so tightly that you're immobilized for fear of hurting yourself, and the tight seal of her entrance acts as a cock-ring, actually bloating your " + game.player.cockDescript(x) + " inside her.\n\n", false);

            outputText("Your " + game.player.cockDescript(x) + " is milked from ", false);
    ...
    private jizzFromEatingPregdrynOut(): void {
        ...
        outputText("your " + game.player.multiCockDescriptLight() + " in a steady stream.  Your urethra bulges and flexes, forcing you to waste your seed all over Edryn's pillows.", false);
        if (player.cumQ() < 1000) {
    ...
    private edrynFucktroduction(): void {
        ...
        if (!player.isTaur()) {
            ...
            if (player.cocks[0].cockType == CockTypesEnum.HORSE) outputText("making your " + game.player.cockDescript(x) + " twitch and ache.  It floods your body with animalistic desires, overpowering any sense of propriety you might have once had.", false);
    ...
    public eatEdrynPussyLikeABawss(): void {
        ...
        outputText("Edryn starts to say something, but you strip out of your [armor] before she gets more than a half-dozen words out, your " + game.player.multiCockDescriptLight() + " jutting proud and erect, leaking clear streams of pre-cum down ");
        ...
        outputText("\n\nArching your back, you allow the palpable relief to wash through you, bubbling lust pumping out from your [balls] to flood the poor centaur's slippery, equine slit.  You ejaculate with forceful lurches of your [hips], matching each rope of creamy jism by burying your " + game.player.cockDescript(x));
        if (y >= 0) outputText(" and " + game.player.cockDescript(y));
        outputText(" to the");
