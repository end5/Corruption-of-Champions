...
export function loppeFirstMeeting(): void {
    clearOutput();
...
export function loppeGenericMeetings(): void {
    clearOutput();
...
function getAssFuckedByLoppeAsACentaur(): void {
    ...
    if (player.skinType != SkinType.SCALES) outputText(" have goosebumps all over your body");
...
function boobjobLoppe(): void {
    ...
    outputText("\n\nEmboldened, you clasp your breasts firmer together and start to rise and fall, slowly scraping your " + skin(player) + " up and down the half-breed's prick.  It feels so hot and firm against your chest, growing increasingly damp as Loppe oozes gouts as voluminous as the cumshots of ordinary men, making your breasts and her prick alike equally slippery and enabling you to stroke her faster and faster. \"<i>K-keep that up and I'm gonna shoot anytime,</i>\" Loppe groans, trying to hump into your cleavage.");
    ...
    if (player.tongueType >= TongueType.DEMONIC) outputText("retract your tongue into your mouth and ");
    ...
    if ((player.str < 50 && !player.isTaur()) || (player.str < 30 && player.isTaur())) {
        ...
        if (player.tongueType > TongueType.HUMAN) outputText("looping your inhuman tongue around it and stroking for extra stimulus even while ");
...
function teaseLoppeNSuck(): void {
    ...
    if (player.tongueType > TongueType.HUMAN) outputText(", inhumanly long tongue looping out to coil wetly around the length");
