...
private  timesFellatrixSucked():number {
...
public  fellatrixBarApproach():void {
	spriteSelect(10);
	outputText("", true);
...
private  fellatrixSexWarmup():void {
	...
	//(If breasts)
	if(player.biggestTitSize() >= 1) outputText("They briefly run down to the top of your " + game.player.breastDescript(0) + " before returning to your collar.  ", false);
	//First time
...
private  acceptFellatrixOral():void {
	...
	if(player.hasVagina() && (player.gender == 2 || rand(2) == 0)) {
		if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00153] == 0) {
			...
			outputText("Her lower lip brushes against your " + clitDescript() + ", and another groan leaves your throat. You hadn't expected a touch there so soon, but it sends pleasure all through your body and your breath immediately starts to come quicker. That lip slips down as she opens her mouth, and her topmost pillow remains pressed to your " + clitDescript() + ", continuing to offer more stimulation. She grinds her plump puckers slowly along the outer folds of your " + vaginaDescript(0) + ", letting you feel the obsidian flesh press to and stimulate you, filling you with the sensation of a succulent sex organ on your own.\n\n", false);
			outputText("Nails dig into your thighs abruptly as she tightens her grip. Hungrily she opens her mouth wider and pushes her tongue into your " + vaginaDescript(0) + ", wriggling it about. She pushes against your walls curiously and experimentally, aggressively seeking out your pleasure. With a strangled gasp you cannot help but rock your hips forward, pressing closer to her warm and seductive mouth.  A familiar lustful heat rises through your body as her tongue brings out the same reaction in you as the thickest phalluses. You gasp out praise for her oral ministrations, whimpering while she swallows down your nectar. Once more you reach down to stroke through Dominika's hair, but once more she pushes your hands away.\n\n", false);
			outputText("She rises from your " + vaginaDescript(0) + ", irritation on her face. \"<i>Lay. Down.</i>\" Her words come out firmly, the ebony lips enunciating each word. You find it impossible not to look at them as she speaks now, staring at their slow movement to form each sound. \"<i>Let me feed.</i>\" Echoing in your mind, you groan happily. The way those dark lips curve as she speaks, the way they curl and press together... You want them on you. You want them pressing over every inch of your sensitive flesh, pulling at the skin on your neck, rubbing along your own lips. Their dark beauty is intoxicating. Your fingers rub along the bed, gripping the covers tightly as you moan and press your hips forward, offering up your " + vaginaDescript(0) + ".\n\n", false);
			outputText("Her mouth and those lips descend on you again, pulling lightly at your labia and scandalizing your flesh with their contact. She opens wide and practically swallows your " + vaginaDescript(0) + ", covering all of it with her maw and breathing hotly into it. Her tongue pushes in and rapidly returns to its ministrations, grinding spit and your juices in a circle. Practically lapping at you like a cat drinking from a bowl she can be heard slurping on you and your pussy. Indeed, she seems to purr into you, vibrating her tongue within. Those lips quiver slightly against you in the motion.\n\n", false);
	...
	//MULTICAWWWWK
		...
		if(flags[kFLAGS.DOMINIKA_TIMES_MULTICOCK_SLOBBERED] == 0) {
			...
			outputText("\"<i>My my my, you must have been looking forward to this, you brought me a bouquet,</i>\" she teases.  Curling her palm around your " + game.player.cockDescript(0) + ", Dominika tosses you a smug smile.  \"<i>Although I hope I'm not disappointing you if I call it more of a buffet.</i>\"  While continuing to tease your " + game.player.cockDescript(0) + " with gentle friction, her other hand roams along your crotch.  The gentle fingers tease between your " + game.player.multiCockDescriptLight() + ", taking the time to familiarize themselves with the texture of your flesh.  The grin spread across her deep lips does not lessen as her skin tastes yours.  \"<i>I'm always curious about the circumstances that lead to this point,</i>\" Dominika admits as her fingertips play about your head.  \"<i>Was it an addiction to Incubus Draft? A spell gone wrong? You certainly didn't come here equipped like this. But then...</i>\"  She leans in, flicking her tongue across the tip of your " + game.player.cockDescript(0) + ". \"<i>It's not particularly important, is it?</i>\"\n\n", false);

			outputText("She leans in close to continue, her breasts rubbing across your " + game.player.multiCockDescriptLight() + " as a result.  \"<i>We're not after life stories, or deep introspection here,</i>\" she whispers slowly, her breath flowing heatedly over your " + game.player.cockDescript(0) + ".  \"<i>You want me to do things to your body. It's that simple. And I...</i>\" Her black lower lip drags itself over your head, its full curve teasing your cumslit as it passes by.  \"<i>I want this.</i>\"  Fingernails trail over your skin as she runs the verbal foreplay across your " + game.player.cockDescript(0) + ", carried in her breath.  Her tongue flicks across your slit, taunting it while her hands roam freely over you.  In the relaxation her pleasure provides, you reach forward to rest your hand on her head, only to be abruptly reprimanded by a slap to your wrist.  \"<i>No,</i>\" she hisses smugly, letting her lips drag against the side of your " + game.player.cockDescript(0) + " as she speaks.  Their softness quickens your breath, and you focus on the words she speaks to keep your head.  \"<i>I'm not interested in letting you set the pace, dear.  This is mine to play with.</i>\"\n\n", false);

			outputText("She shifts in deeper, slurping lightly on the side of your base.  Her chin rubs against your " + game.player.cockDescript(1) + " as she teases your primary wang, letting her skin taunt everything in your lap from your thighs to your pricks with her proximity.  The plumpness of her breasts makes for a suitable cockrest as her ebony puckers glide over the straining flesh of your " + game.player.cockDescript(0) + ".  They shift and move with her, pressing into your thigh as she swaps sides and sucks on the meat of your shaft.  Her dark lips feel better than you had imagined.  Their fullness belied a delicate touch that now, in the moment of finally experiencing them, borders on ecstasy.  You let your hands fall to the side to support yourself as Dominika works over your lap, accepting her terms if it means she labors over you like this.  The continued teasing over the side of your " + game.player.cockDescript(0) + " makes you eager to actually enter her mouth, but the casual way she claims dominion over your lap so that she can blow you is too enjoyable to interrupt.\n\n", false);

			outputText("Fortunately, you don't have to wait long. As her midnight cocksuckers drag up your " + game.player.cockDescript(0) + " once more, they curl around your head.  Finally your dick finds the warmth and clinging flesh of a hole. A groan forces itself past your lips and you can feel Dominika's dark puckers smirk.  They twist from side to side around your shaft, her breasts shifting and knocking against your " + game.player.multiCockDescriptLight() + " and catching some of the sweat from your crotch on them. Her fingers play wantonly where they please, at times squeezing and rubbing into your thighs, at others caressing randomly across your flesh.  Your " + game.player.cockDescript(1) + " soon comes to know their touch quite intimately.  Despite all this – despite much of your " + game.player.multiCockDescriptLight() + " simply sitting out in the air, pressing against the tattooed woman for warmth – your mind is drawn to the sensations of her mouth, and the sensations of those  deep, dark lips.  You only lust for them more as they drag along you.  Every little twist, every gulp that pushes them in another direction sends a tensing shiver down your " + game.player.cockDescript(0) + ".  Your breath catches in your throat, gasping when you feel the inside of her cheek grind against your prick.\n\n", false);

			outputText("The tensing, slurping pleasure forces you to pull your gaze away eventually, closing your eyes as everything unfocuses in favor of experiencing raw sensation.  The thought of those dark suckers is more than enough to fixate on.  Their succulent fullness is perfectly imagined in your mind, and thinking about them only gets you hotter and harder.  This in turn only spreads the black, flawless cocksuckers around your " + game.player.cockDescript(0) + " wider, the thought of which is nearly too much just by itself.  Imagining Dominika's pitch dark lips forced into a wide O by your prick feels so natural, and so right.  You spread your legs further apart to thrust your " + game.player.multiCockDescriptLight() + " out even more, prostrating yourself before those delicious and devilish dickslurpers.  The eagerness with which they grip, twist, and spread the thick saliva that clings to every inch that her mouth has descended upon provides you some of the strongest pleasure you've felt since... really, with your mind so absorbed in the lewd and loud cocksucking, you can't remember feeling better.\n\n", false);

			outputText("Dominika only goes further on you, letting your " + game.player.cockDescript(1) + " push over her shoulder and past her hair.  It sits out in the air but the obscene warmth wrapping around your " + game.player.cockDescript(0) + " keeps you from caring.  Even having just one of your dicks in her dripping maw, attended to by her covetous tongue, is enough.  You think just having her work your head would satisfy you – though you hardly object to those dark lips pulling you further in!  Half your prick sits inside her hungry mouth, your cockhead grinding at the back of her throat.  The dominance she claims over your lap ensures you need not ask her to keep going – her gulping throat keeps pulling, taking all of your " + game.player.cockDescript(0) + " into it.  Deep swallowing slurps drag along the length of your " + game.player.cockDescript(0) + " as though it was being milked for those black puckers.  Perhaps it was.\n\n", false);

			outputText("The cabalist seems ill content to simply rest in your lap, and resumes her ravenous and whorish bobbing.  She does not shy from taking great big gulps of your prick, sliding so far up your shaft that her depraved 'O' lips stop right beneath your head, and then diving back down to impale her face and clutch you within her throat once more.  Again and again she performs this lewd facefucking upon you, coating your " + game.player.cockDescript(0) + " and her chin in spit yet remaining fully in control.  The urge to cum continues to rise in you, eager to feed and please those perfect fat cocksuckers and show them that your prick is worth it.  As she continues to repeat the dominant suction it becomes harder to resist this urge, and as the pleasure continues to rise, your cock straining and bursting to release, you ask yourself why you are resisting it at all.  The first blast of cum splatters into Dominika's throat, and nearly whimpering in pleasure you thrust forward.  Nothing is important but cumming, dumping the thick loads that have yearned to escape out into whatever is before your " + game.player.multiCockDescriptLight() + ".  You feel the cabalist gather them up to press against her warm body, not out into space.  Some of your jizz runs down your " + game.player.cockDescript(1) + ", dripping off her chin. It's hard to focus.  You just want to ride this wave of pleasure further, continue to jerk and spasm as your lap releases its load.  More and more you cum as those dark lips squeeze you, those fat flawless cocksuckers that so desperately need your cum.  You give everything, and you just keep thrusting.\n\n", false);

			outputText("Softly her lips press against yours, and you start to relax.  Glancing down your " + game.player.multiCockDescriptLight() + " has long since finished, and Dominika stands before you smirking.  She collects some of the spunk splattered across her chest on a finger and sucks it clean between those deep lips.  It's hard to recall all of what you just went through, but you feel incredible.  Just the sensation of the air on your sensitive prick makes you whimper a little.  \"<i>Healthy, hearty,</i>\" she teases, \"<i>You pass expectations, I'd say. A shame I could not get to every inch of you before you blew, but... well, I'm used to it.</i>\"  You voice your appreciation, but can't help but ask why she wanted to blow you.  \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat.  Still though, even if I wanted to...</i>\"\n\n", false);
		...
		//[Follow up Multi]
			...
			outputText("You barely have time to nod your assent before Dominika drags you into the other room with a grin, nearly throwing you to the bed and licking her lips.  \"<i>C'mon then you cumfactory,</i>\" she smirks, tossing aside the bottom of your " + player.armorName + " carelessly.  Her fingers trail at your thighs as she looks down at your " + game.player.multiCockDescriptLight() + " with an unsubtle hunger.  \"<i>Show me just how much you like what I do.</i>\"  Her hand curls around your " + game.player.cockDescript(1) + ", jerking it recklessly and lewdly.  You're hardly about to not get erect at her half-naked form and the administrations to your crotch – much less the sight of those deep, delicious lips – so the command feels a little silly.  You really stop caring about how silly it is as soon as her mouth slides over your " + game.player.cockDescript(1) + ".  She sucks casually on the prick, roaming over the base with one hand while the other taunts the head of your " + game.player.cockDescript(0) + ".  Though you try to relax, a small amount of tension still sits in you, brought about by the knowledge of just how recklessly Dominika can assault your prick with her succulent full puckers.\n\n", false);

			outputText("It's clear that it won't take long for her to reach that point.  Though she soon squeezes your cocks together and lashes her tongue across them, you can see her eyes settling on your " + game.player.cockDescript(0) + ", hungry for the fattest one.  Those dark cocksuckers kiss every cumslit wetly in turn, but wrap around the foremost of your pricks soon after.  They slide and shift messily around, the cabalist unafraid to spit and drool over your " + game.player.cockDescript(0) + " as she works it over.  Every movement the soft flesh makes excites you.  Your prick presses into the roof of her mouth, into her cheeks, pressing down her tongue.  It roams about the wet maw not freely, but where she demands it go.  The wet warmth pulling at your prick ensures you don't mind at all.  Her tongue nearly flays your prick in her ravenous domination, grinding so intimately into you they might have been joined as one.  Saliva drips down your prick from her squeezing ebony kiss, only allowing her to move slicker and quicker about you.  The plump 'O'-shaped puckers dominate your thoughts as easily as they dominate your lap, nearly sealing around your " + game.player.cockDescript(0) + " and ensuring that you will not leave her mouth until she is ready for you to.  The control she exhibits is wildly arousing and you happily drool pre-cum into her gulping mouth.  She swallows it up at the same time as she pulls you into her throat, claiming your prick even more.\n\n", false);

			outputText("All the while the rest of your " + game.player.multiCockDescriptLight() + " find themselves in the grip of her delicate hands. Their softness speaks to the life of a magic-user. It seems as though the hardest she may have worked in her life was the rough pumping she gave your " + game.player.cockDescript(1) + ".  She is unrelenting in her treatment, ensuring you stay constantly stimulated even at the risk of overdoing it.  Dominika doesn't seem to care how much you groan, or gasp, or whimper at the pleasure and wet friction she gives you.  She cares only about making you cum.  Without those full black lips to focus on it feels as though she might make you pass out, but you can cling to the thought of them as tightly as they cling to you.  They engulf you, swallowing and sucking messily eternally.\n\n", false);

			outputText("She drags you recklessly to the edge.  You know you will fall over it, and when you do you will pump load after load of sticky spunk out of your " + game.player.multiCockDescriptLight() + " drenching whatever has a grip on you or sits in front of you.  Dominika dominates this position, and her dripping maw's constant assault on your lap demands so much of your attention it becomes easy to forget that anything else exists.  You twitch and clench, pushing up and forwards until her face is hilted on you.  In that moment of slutty unity you can no longer resist her throat's demands.  Bulging out her swallowing hole, even your sense of self becomes momentarily replaced by nothing more than the need to cum and dump your jizm.  Maybe the two of you are a single entity, devouring and producing cum eternally.  You don't know. You just cum.  You don't stop cumming.  You pump and you thrust and you moan in unbroken pleasure.  The sensation seems eternal until a kiss on your cheek breaks the reverie, leaving you to fall backwards gasping.\n\n", false);
	...
	//[If \"<i>Yes</i>\" and penis small enough to suck]
		...
		//Horsecock suck
			...
			if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00174] == 0) {
				outputText("The smile that spreads across her face might have looked sinister on someone else. She takes your hand and guides you to the other room, licking her lips. Within rests an extraordinarily comfortable-looking bed, featuring a level of finery you had nearly forgotten existed. The cabalist leads you to it, and helps you sit down. \"<i>Yeah,</i>\" she smirks, \"<i>I figured you might say yes.</i>\" She reaches down to remove the bottom of your " + player.armorName + ", before chuckling lightly at the sight of your " + game.player.cockDescript(x) + ". \"<i>Oh yeah?</i>\" she says, \"<i>Do they call you the Icathian Stallion?</i>\"\n\n", false);

				outputText("You blink in confusion at her. \"<i>...You know, like... it's a nickname from... you know what, never mind.</i>\" She waves her hand dismissively and smiles. \"<i>I'm sure no matter how uninformed you are, you still blow a load.</i>\" Her hands reach down to slowly rub against the stiffening " + game.player.cockDescript(x) + ", eager to have its fun with the topless arcanist standing before it. There's a comfortable softness to her thumb as it plays over your flared tip. She settles down to kneel before you, continuing to stroke your " + game.player.cockDescript(x) + " and entice it into a much fuller form. Even just this close you can begin to feel her breath emanating from between those luscious, deeply-coloured lips. The warmth of the sensation is seductive, carrying promises of what is yet to come. Your " + game.player.cockDescript(x) + " practically leans towards her in anticipation.\n\n", false);

				outputText("A single finger traces along the rim of the excited " + game.player.cockDescript(x) + ". Pulsing and hungry you grunt a little as a portion of pre-cum begins to form, slipping down from the cumslit. Your tattooed companion leans forward, catching it with her tongue before it slides down your shaft, and snapping it back into her mouth. A light smile tugs at the edge of her dark lips in turn. \"<i>Glad to see you're of some use,</i>\" she muses. Her fingers slip away from your head and stroke along the length of your prick instead, not wanting to get in the way of her intent. Once more her tongue touches the flat head of your " + game.player.cockDescript(x) + ", dragging up from the bottom and across your cumhole before flicking calmly off the top.  Then her lips touch you.\n\n", false);

				outputText("You nearly melt. You've had blowjobs before. You've kissed lips, put your fingers on them, had them brush across your cheek. You know what lips feel like. The ones resting on the top of your " + game.player.cockDescript(x) + " have a softness, a plumpness, and a fullness to them you can barely process. Immediately you take a breath and then let out a groan. You feel rather than hear her chuckle against your dick, each motion of those dark pillows rubbing across you as they pull in a slight smile. Stammering out some degree of praise (though with how distracted you have abruptly grown you're not sure that you even formed a coherent sentence) you grind your " + game.player.cockDescript(x) + " forward in hopes of pushing past the simple kiss that graces your top. Those pursed lips remain steadfast in their act and press lightly to your cumslit, before widening slightly and flicking her tongue against it.\n\n", false);

				outputText("Moaning once again, your hands come forward to stroke through her hair and encourage her, but you are abruptly surprised by the slapping of your wrists. \"<i>Down,</i>\" Dominika says to you, her fingers returning to stroking your base once your hands return to the bed. \"<i>This is mine to play with, not yours.</i>\" You respond the most well-spoken way you can at the moment, namely by panting slightly. Still, the thought of letting those dark lips act upon you is appealing. You can't come up with any compelling reasons to disobey her desires. Apparently satisfied with your passive inaction, Dominika returns her attentions to your " + game.player.cockDescript(x) + ", dragging those lush, gorgeous lips over your head and letting all of the sensitive flesh feel and grow enamored with them.\n\n", false);

				outputText("To your regret, they soon slip away. To your delight, they move to the side of your " + game.player.cockDescript(x) + ", dragging her mouth up and down the side of your prick while her palm curls around your flattened crown. She opens up her warm maw enough that her tongue can press against your engorged shaft but not so much that it covers the fat bottom lip that slides deliciously along you. You think of all the times you've had to jerk yourself off at camp and wish that you had at least had just this much more to aid you. Even without entering her, the glossy slide of her inky, pillowy cocksuckers elicits uncontrollable and desperate throbbing from your " + game.player.cockDescript(x) + ", alive with a need it only just developed. More pre-cum rises out of your prick, practically bubbling in its eagerness to be devoured.\n\n", false);

				outputText("Dominika fulfills its desire. Her flawless lips slide back up along the shaft, dragging themselves with a tauntingly slow speed up to the perverse summit of the " + game.player.cockDescript(x) + " she climbs. Her lower lip stops at the bottom of your flared head but the top presses onwards. She takes the leaked pre-cum into her awaiting mouth and more, her lip rising until she engulfs the tip of your prick. You enter her mouth  with a wet, messy noise. Spit drips down your shaft. Those lush, flawless midnight lips that you had so adored grinding against your side close around you, and it is better than you hoped. The wet warmth, the pinching suction, and the overwhelming softness make you shudder, and all the while her tongue lashes dominantly across your " + game.player.cockDescript(x) + ".\n\n", false);

				outputText("You find yourself obsessing over those lips, picturing them in your mind when you are forced to lean back and blur your vision in your pleasure. You stare at nothing in particular – at the walls, the ceilings, the shifting blonde bun – and as you do you imagine them, pulling at your dick and sucking it into her mouth, their ebony flawless fatness curved in an obscene O. You can imagine them engulfing and pulling on your " + game.player.cockDescript(x) + " so vividly, and their image is so perfectly formed and dominant in your mind that it is hard to think about anything else. It is as though those gorgeous dark lips are sucking directly on your mind – but then, given how much the needs of your " + game.player.cockDescript(x) + " dominate your every action, perhaps they are.\n\n", false);

				outputText("She bobs deeper, moving her head rougher. You enter her throat a few times before it becomes a far more frequent and rapid occurrence. It's difficult to remember that you're simply sitting down on the cabalist's bed, as the aggressive facefuck greatly resembles an uncontrolled rut. The act is all hers, assertively controlling your crotch with her mouth and using you for her own needs, recklessly slurping and coating your " + game.player.cockDescript(x) + " in her spit. She less fellates your prick than mounts it, treating her mouth as a slut's hungry cunt and aggressively claiming your crotch as a dildo for her needs. In the back of your mind you remember, though. It's not the sex she wants from you. It's your cum.\n\n", false);

				outputText("This thought proves catalyst enough for the last vestiges of control over your " + game.player.cockDescript(x) + " to vanish. Your mouth gapes in a deep and struggling moan, your body shaking as you lean back and let loose. The heat of your cum surges up the length of your " + game.player.cockDescript(x) + " and into Dominika's sucking, swallowing maw. Your prick becomes a delivery device for your thick spooge squeezed into submission by her fat, gorgeous, black, full, plush... you can barely process them. They're formed in your mind with such impossible perfection and desire. You long for them, ache for them, your entire body bucking and twisting with a desire to please the lips that curl around your base, engulfing your " + game.player.cockDescript(x) + " and using you, feasting on you. More, you have to cum more, you have to keep giving her everything you have. You're not even certain if you are cumming anymore, your mind locked in the brain-wiping haze of orgasm...\n\n", false);

				outputText("Softly her lips press against yours, and you start to relax. Glancing down, your " + game.player.cockDescript(x) + " has long since finished, and Dominika sits beside you smirking. She gently massages your sensitive shaft as you recover from the fellatio, groaning slightly. It's hard to remember those last few moments, though you feel incredible. Just the sensation of the air on your sensitive prick makes you whimper a little. \"<i>That's a good stallion,</i>\" she teases, \"<i>It's always good to remind a dick that a good mouth can do oh so much to it.</i>\" You voice your appreciation, but can't help but ask why she wanted to blow you. \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat. Still though, even if I wanted to...</i>\"\n\n", false);
		...
		//Human/fallback wang
			...
			if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00151] == 0) {
				...
				outputText("She removes the bottom of your " + player.armorName + " and kneels in front of you. Taking your " + game.player.cockDescript(x) + " into her hands, her fingers begin a slow and steady massage along the length. She leans down and brings her lips to a soft kiss right on the tip of your " + game.player.cockDescript(x) + ". The glistening moisture you saw on them before feels almost unnatural, as though her lips are oiled up – but given what you've experienced in this land, such an idea does not startle you in the slightest. Her equally slick tongue slips out to press against the underside of your head and then flicks up, leaving saliva behind. The gentle touch of her palm presses against the spit and begins to spread it around. She swirls it slowly around your sensitive tip, enticing your erection further.  The ball of her thumb in particular works into the curve of your head, sliding against where it meets your shaft.\n\n", false);
				//(if player has balls)
				if(player.balls > 0) outputText("Meanwhile her mouth slips down your dick, planting a few kisses along the way before reaching your " + sackDescript(player) + ". Her dark lips press against each of your " + ballsDescriptLight() + " in turn, granting each her moist smooch. She exhales warmly over them, teasing the cumfactories with a grin. Her mouth slips partially over one, her tongue slipping around the soft flesh. She is gentle and delicate in her administrations, and you feel comfortable about your " + sackDescript(player) + " sitting in her warm mouth – though you would prefer she wrap those plump lips around something else. Your head continues to be stimulated by her soft palm, and now adds pre-cum to the saliva she slowly spreads. A grunt makes her smirk, lifting from your " + sackDescript(player) + " and sliding her lips slowly up your dick.\n\n", false);
				outputText("\"<i>You like this, mm?</i>\" she asks, emphasizing her question with a gentle squeeze of her hand. \"<i>To think of the path I've walked,</i>\" she muses, \"<i>Once a capable cabalist, and now I'm a better fellatrix.  Still – as long as you enjoy your work.</i>\" She leans forward and quickly slurps up a drop of pre, gulping it down visibly. The trail of spit on your shaft hides any evidence that it was ever there, leaving only her smug grin as a tribute to its existence. Still holding your prick in her hand she ducks lower, using her tongue to take long deep slurps of your " + game.player.cockDescript(x) + ". Teasing swirls flick across your base and her jaw rubs into the space between your thighs.  Dripping dragged paths of saliva are tracked along either side of your length, before she returns to your head.\n\n", false);
				outputText("The rush of pleasure could have staggered you if you were standing. One moment your " + game.player.cockDescript(x) + " was pressing into those soft black lips and moments later they had slipped around your head. She squeezes firmly with them and her tongue twists and contorts around your bulb, prostrating itself like an adherent before a god. Entering her mouth had been almost effortless. Her lips slipped apart like they were made to, while clinging to your girth like life support. A wet gulping noise accompanied a tight squeeze, her head beginning to shift around your " + game.player.cockDescript(x) + " in a careful and deliberate polishing.\n\n", false);
				outputText("Her hands travel along your length and roam along your thighs, squeezing them and slipping over your flesh. She seems to revel in the sensations of sucking on you, her eyes closed and her head bobbing rhythmically. The warm heat of her mouth slips along your " + game.player.cockDescript(x) + ", her slick lips managing to generate more than enough friction, and more than you expected. Her flesh hugs to your " + game.player.cockDescript(x) + " as tight as any cunt you've encountered so far, and as she begins to move her head more and more excitedly it becomes easy to forget. Only the wriggling tongue constantly rubbing and slipping along your meat and the palpable pucker of her perfect lips inform you of the fuckhole she's using to get you off.  It's difficult for your mind to not fixate on the black curves working you over. They seem as though they could truly be more comfortable, more soft and slick and smooth to slide into than anything else you've ever entered.\n\n", false);
				outputText("Her hands press to your thighs and push them apart slightly, and the reason why becomes quickly clear. She knocks your " + game.player.cockDescript(x) + " against the back of her  throat a few times before jamming you in, beginning to throatfuck herself on you. You gasp eagerly and move your hands up to her hair, but almost brutally she comes up and grabs your wrists, forcing you to place them on either side as she brutalizes her face on you. Spit practically flies off her chin and your shaft, dripping onto the bed and the floor. She fucks her mouth on you recklessly, acting like she was jamming a dildo into her cunt in a desperate frenzy to get off, but instead you feel her nose slamming into your crotch.  Those ebony slick suckers taunt you with how frictionless they seem to move, but they simultaneously push tightly against your skin with every inch they pass. You adore them.\n\n", false);
				outputText("The friction, the mess, and the obscenity of it all prove too much for you. Giving a strangled noise your " + game.player.cockDescript(x) + " throbs and starts to fire its load. She shoves herself into your lap, her lips wrapping tight around your base and her cheeks hollowing in as she sucks your load out. Her hunger for your spunk feels ravenous, and it's almost as though she's tugging it directly out of you. If she had sucked this hard to begin with, perhaps she would have! Still, you can't object to her need, and you moan helplessly as your " + game.player.cockDescript(x) + " blasts its creamy load directly down her throat and into her belly, aching to just keep cumming. Your hips press forward, trying to insert more of your dick into those perfect black lips, almost flawlessly imagined in your mind. You want to cum, you want to keep splattering your thick spunk between those fat puckers, those immaculate dark cockpillows.  Their image dominates your mind, the thought of them curving into that wet O ripping more cum from you. Your orgasm is only enhanced by the knowledge that you can spread them into that obscene shape, helping to demonstrate every nuance of their gorgeous form.\n\n", false);
				outputText("A wet pop signals her lips slipping over your tip. \"<i>Mmm...</i>\" she purrs softly. Your hips thrust forward slightly still, your " + game.player.cockDescript(x) + " tense and barely even relaxing, but your orgasm still rides out, pleasure overwhelming you. Gasping and weakly thrusting to the air, you shudder with tormented delight. Did the blowjob stop? It's hard to say. Your mind still fixates on those flawless lips, imagining their plush grip on your base. It was so good. It is so good, did it stop? You have to give them more cum, their plushness, their fullness needs to be helped.  She glides her hands up your body and rises. A soft kiss to your lips and you find your body willing to stop at last, falling back against her bed and gasping. \"<i>I appreciate it, love,</i>\" she smiles, climbing up and leaning against you, running a hand along your " + hairDescript() + ". \"<i>You were delicious.</i>\"\n\n", false);
				outputText("She gently massages your head as you recover from the fellatio, groaning slightly. You look back down at your " + game.player.cockDescript(x) + ", watching it drip with saliva. \"<i>I think I gave him a bit of a workout,</i>\" she teases, \"<i>It's always good to remind a dick that a good mouth can do oh so much to it.</i>\" You voice your appreciation, but can't help but ask why she wanted to blow you. \"<i>Oh I told you, dear,</i>\" she laughs slightly, licking her lips, \"<i>I need to eat. Still though, even if I wanted to...</i>\"\n\n", false);
			...
			//[Follow-up Sex, player has penis]
				...
				outputText("Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck your " + game.player.cockDescript(x) + ". She removes the bottom of your " + player.armorName + " and kneels in front of you. Taking your " + game.player.cockDescript(x) + " into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. \"<i>Mmm, give me all your cum,</i>\" she purrs, giving the top of your " + game.player.cockDescript(x) + " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " + game.player.cockDescript(x) + " before engulfing the sweaty meat.\n\n", false);
	...
	//[If \"<i>Yes</i>\" and penis too big to suck]
		...
		if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00152] == 0) {
			...
			outputText("She shifts slightly, arcing her back a bit more to bring her breasts into greater visibility. Pressing forward she begins to rub the soft flesh over your shaft. Occasionally her nipple brushes across your veiny girth, sending a brief but agreeable little blush of pleasure. Your prick's sweat serves as suitable lubrication for the slow glide of her breasts, slipping against but not around your meat. Her back rocks repeatedly to grind her tits along you, in turn letting your " + game.player.cockDescript(x) + " rub against her collarbone. The delicate fingers of her hand coil around your rod to rub her palm over your head, and after giving you another wet lick Dominika looks up at you.\n\n", false);
			...
			outputText("Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck on your " + game.player.cockDescript(x) + ". She removes the bottom of your " + player.armorName + " and kneels in front of you. Taking your " + game.player.cockDescript(x) + " into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. \"<i>Mmm, give me all your cum,</i>\" she purrs, giving the top of your " + game.player.cockDescript(x) + " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " + game.player.cockDescript(x) + " before messily pressing to the top in a wide O.\n\n", false);
			outputText("She pushes your legs open and forces your " + game.player.cockDescript(x) + " to stand prominent, as though offering it up to her. Any attempt to hold on to her or guide her is quickly rebuffed, slapped away with her own hands. There is nothing submissive about her position. Her lips twist from side to side around your head, messily spilling warm drool down your prick. Your cumslit rubs against the roof of her mouth, against the inside of her cheek, tantalized and tormented by the wet flesh within. She gulps and sucks on your " + game.player.cockDescript(x) + " even with your limited entry, pulling on the flesh in a ravenous, sensual hunger. She fucks her mouth the best she can on your tremendous girth, only causing an increasingly wet mess.\n\n", false);
			outputText("Soon her hands and her tits comes to bear against your flesh, grinding up and around your veiny and oversized " + game.player.cockDescript(x) + ". They make use of the dripping spit along your shaft to slip and rub faster against your phallus, relying on soft aggressive friction to get you gasping. It succeeds, your mouth hanging open as you moan in pleasure, rocking your hips forward as though you could descend further into those darkly vibrant and beautifully plump cocksuckers, but even through your bliss you can feel them stretched to their limit. You can imagine them perfectly in your mind, in an ebony immaculate O, and the imagery is too much for you.\n\n", false);
			outputText("Your bucking hips seize and tremble as the first sticky load flings itself into her waiting maw. Her hands grip you with a possessive tightness, stroking along your " + game.player.cockDescript(x) + " as though coaxing every last drop out – and indeed, you give her every last drop you can, cumming until you can't anymore. Even then the orgasmic pleasure lingers in your mind, and you can't stop rocking your hips forward in a desire to let it continue. She slips away from your prick, finally rising up to kiss you on the lips. The touch of those dark puckers relaxes you, and you come down from the pleasure with a low, happy groan.\n\n", false);
			outputText("\"<i>As always, delicious,</i>\" she smiles, cuddling with you in the afterglow of her meal. She caresses you until you regain your strength, and then politely helps you re-dress and sends you on your way, giving you a kiss to remember her. Those black lips linger in your mind as you walk the streets of Tel'Adre on your way back to camp.", false);
		}
...
private  agreeWithDominika():void {
	...
	if(flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0) {
		...
		if(player.hasCock()) outputText(game.player.multiCockDescriptLight(), false);
...
private  dominikaBlowjobs():void {
	...
	if(player.hasCock()) {
		if(player.cockArea(x) <= 36) {
			...
			outputText("A loud deep gulp of your " + game.player.cockDescript(x) + " drowns out the thought.  She dives down the length of your shaft every time, her throat so warm and tight that the air touching your spit-covered skin is almost agonizing in the chill it gives you.  Your " + game.player.cockDescript(0) + " spits pre-cum into her gut.  An incredible, strong suck of your prick soon accompanies it, as though she was hoping to pull the rest of your cum out right then and there.  She descends down into your lap, her plump fat lips squeezing around you, and then she sucks again.\n\n", false);
			...
			outputText("Blood surges into your " + game.player.cockDescript(x) + ".  Though still riding off the high of your last delicious orgasm an incredible desire engulfs and consumes you.  You want to fuck again.  No, you want to get sucked off by Dominika again.  You want to drown in her mouth, enslaved and consumed.  Your " + game.player.cockDescript(x) + " is so fucking sore, desperately aching for warmth and comfort.  Dominika touches her lips to your tip and in a single wet motion provides it.  The noise that slips between your lips is downright " + player.mf("emasculating","humiliating") + ", but what do you care?  The comfort that clenches back around you is worth any girlish whimpers that may have come from your throat.  Cumming in her throat will fully make up for it.  Fuck, you want to cum in her.  It would be so easy to just relax, and let your " + game.player.cockDescript(x) + " relax unabashedly...\n\n", false);

			outputText("You adore the feeling of the 'O' her lips make as your " + game.player.cockDescript(x) + " surges with cum again. Those lips are so fucking beautiful.  Immaculate.  Even as she grinds them over something as obscene and lewd as your " + game.player.cockDescript(x) + " they're almost impossibly beautiful.  Occasionally your thighs spasm into the hands holding them down, the raw sensation of that constant dripping wet presence around your prick overwhelming and dominating your mind, making you lose control of your muscles.  The cabalist pulls at your " + game.player.cockDescript(x) + " with every inch of her throat.  Her lips, tongue, throat, teeth, cheeks all take your prick with singleminded intensity, expressing no concerns other than facilitating the emptying of the cum flooding through it.\n\n", false);
			...
			outputText("Her fingers trace strange patterns over your " + game.player.cockDescript(x) + ", ones that seem both sensual and sinister.  The incredible stiffness you feel makes it difficult to focus on their actual shape, only their presence.  You are perceptive enough to realize that their increasing size is not before she drags them further across your prick, however.  It's getting smaller.  Dominika is taking the size of your " + game.player.cockDescript(x) + " from you.  \"<i>Just relax, little lamb,</i>\" she purrs softly, \"<i>I'll give it back.  I just need you to fit, tonight.  You want that, don't you?</i>\" she breathes hotly over your prick, dragging her fat, luscious lips over it.  \"<i>You want these around you?</i>\"\n\n", false);
			...
			outputText("The incredible and oppressive ache that had dominated the thick stiffness of your " + game.player.cockDescript(x) + " is relieved in the tight fleshy confines that restrain it.  You still burn with the need for the pleasure but it no longer seems like a darkness without end – or at least, an aid in the form of a different darkness is near.  The portal of her full lips squeezes tighter than anything you've felt in a long time, as though her mouth was locked as tightly around you as the belt around her waist.  Involuntarily, one of your thighs briefly spasms.  Being pinned in this position with a deep mouth pulling you in should be uncomfortable, but the sensation of flesh around your " + game.player.cockDescript(x) + " soaks up your focus.  Dominika's lips reach your base, her mouth doing a light twist on your prick.  Your hips jerk up in shocked reflex.  Wet and thick breathing comes from between your legs before she rises.  Fingernails press painfully into your skin as she uses your helpless body for her desires.\n\n", false);

			outputText("Dominika's lips come all the way to the top of your head, tucking briefly under the bulb of your knob before she takes another deep descent.  Her ebony puckers clutch to your pole like an addict's grip on their bottle, but you sense no dependency in Dominika.  If anything, right now you need her.  You are drowning in the darkness of the barely-illuminated room and only the deep throat that swallows you can save you.  Only the thick tar of her lips can pull you under.  But if you're drowning, don't you want to...\n\n", false);

			outputText("A loud deep gulp of your " + game.player.cockDescript(x) + " drowns out the thought.  She dives down the length of your shaft every time, her throat so warm and tight that the air touching your spit-covered skin is almost agonizing in the chill it gives you.  Your " + game.player.cockDescript(x) + " spits pre-cum into her gut.  An incredible, strong suck of your prick soon accompanies it, as though she was hoping to pull the rest of your cum out right then and there.  She descends down into your lap, her plump fat lips squeezing around you, and then she sucks again.\n\n", false);
