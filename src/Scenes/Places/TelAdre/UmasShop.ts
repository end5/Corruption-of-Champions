...
const MASSAGE_RELIEF_BONUS_TEXT: string = "<b>(10% Reduction to all Lust gains whilst active!)</b>";
...
const MASSAGE_LUST_BONUS_TEXT: string = "<b>(10% Increase to all Lust gains whilst active!)</b>";
...
const MASSAGE_MODELLING_BONUS_TEXT: string = "<b>(+10 Bonus Femininity whilst active!)</b>";
...
const MASSAGE_RELAXATION_BONUS_TEXT: string = "<b>(10% Reduction to all Damage taken whilst active!)</b>";
...
const MASSAGE_POWER_BONUS_TEXT: string = "<b>(10% Increase to all Damage inflicted whilst active!)</b>";
...
export function hasNeedleworkPerk(): boolean {
    const pType: PerkType = this.getNeedleworkPerk();
    if (pType != null) {
        return true;
    }
    else {
 ...
 * SEXY TIMES
 */
const UMA_CONSIDER_PC_FEM: number = 70; // Femininity value that Uma considers "girly"
const UMA_CONSIDER_PC_AND: number = 50; // Femininity value that Uma considers "androgynous"
...
function sexEroticMassage(): void {
    ...
    const hoursSinceCum: number = player.hoursSinceCum;
    dynStats("lust=", 0);
