...
export class Heckel extends TelAdreAbstractContent {
    ...
    */
    ...
    private heckelLovesAnal2(): void {
        ...
        // [<IF PC HAS PENIS AND VAGOO>
        if (player.hasCock() && player.hasVagina()) outputText("Although " + sMultiCockDesc(game.player) + " is trapped beneath you, Heckel's balls slap into your cunt with every one of her quickening thrusts.  Although neither your " + multiCockDescriptLight(game.player) + " or " + vaginaDescript(0) + " are getting much stimulation, your prostate is being milked better than it ever has. One thrust in particular makes you cry out, and Heckel laughs above you as she slams her furry thighs into yours again. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);

        // [<IF PC HAS PENIS AND BALLS>
        else if (player.hasCock() && player.balls > 0) outputText(SMultiCockDesc(game.player) + " pulses beneath you with every thrust, her duo of fist-sized balls slapping into your " + ballsDescriptLight() + ". You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, " + player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);
