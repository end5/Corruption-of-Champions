...
function encounterLottieCharge(): void { encounterLottie(true); }

export function encounterLottie(charge: boolean = false): void {
    spriteSelect(36);
    ...
    // [REPEAT ENCOUNTER]
        ...
        // [Normal Encounter, Encouragement 60 - 100]
            ...
            // [Figure 60 - 80]
            else if (flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 80) outputText("\"<i>Yo, " + mf(player, "big guy", "babe") + "! I've been waiting for you, so you better be pumped! Ready to get started?</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.", false);
            // [Figure 80 - 100]
            else outputText("\"<i>Hey, " + mf(player, "stud", "cutie") + "! You shouldn't keep me waiting, or I'll put you through the burn twice as hard! You ready?</i>\" Lottie winks at you and punches your arm playfully. She seems to be excited for what you've got in store today.", false);
        }
...
// [Sex]
function fourthMeetingChooseSexWithLottie(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Buddies]
function stayLottieBuds4Evah(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Decline]
function declineBeingLottiesGymHamsandwich(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Accept]
function acceptBeingLottiesHamSandwich(): void {
    spriteSelect(36);
    outputText("", true);
...
// If No]
function gotInShapeButTurnedDownLottie(): void {
    spriteSelect(36);
...
// [If God No]
export function gotInShapeComedyDeclineLottie(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Yes]
function gotInShapeAcceptTrainingOffer(): void {
    spriteSelect(36);
    flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00299] = 1;
    outputText("", true);
...
// [Water]
function drinkWaterWithYourHamhock(): void {
    spriteSelect(36);
    outputText("", true);
...
function drinkLustWithYourHamhock(): void {
    ...
    outputText("You take her by the hand and lead her into one of the empty saunas. \"<i>" + player.short + "...</i>\" You grab her by the hips and lean her against the wall, throwing off her towel and revealing her velvety skin underneath. Reaching down, you grab a handful of her luxurious ass, squeezing and slapping it lightly. Lottie moans into your shoulder and reaches towards your groin, removing your " + player.armorName + ". She begins stroking " + oMultiCockDesc(game.player) + " lightly, picking up the pace as you continue to work on her pert rump. You can't help but lust over her full figure, using one of your hands to firmly grope her pillowy jugs and reaching your other towards her glistening pussy. You move your hand over her cushiony rack, before burying your head into her bosom and eagerly sucking on one of her nipples, fondling the other between your thumb and forefinger. Your other hand is already fast at work, fingering her hot cunt. You can feel her legs about to buckle beneath their own weight. Lottie moans in between short, hot breaths, \"<i>Y-you're... really amazing, " + mf(player, "guy", "lady") + ".</i>\"  You give her chubby ass a hard slap in agreement.  Lottie squeals in glee, jerking your " + cockDescript(game.player, 0) + " as it pokes into her soft stomach. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n", false);
...
// [If Anal]
export function analLottieMilkshake(): void {
    spriteSelect(36);
    outputText("", true);
    ...
    outputText("\"<i>A-aa-ah, I-I... AHH!</i>\" Lottie oinks noisily, her eyes rolling to the back of her head and her large thighs slapping against your own, pulling your " + cockDescript(game.player, x) + " further in. She shudders in orgasm", false);
...
// [If Oral]
export function getSuckedOffByAHamSandwich(): void {
    spriteSelect(36);
    outputText("", true);
    ...
    outputText("She begins fellating your cock at an incredible rate, throatfucking herself on your " + cockDescript(game.player, x), false);
    if (player.balls > 0) outputText(", your sack slapping against her chin ", false);
    else if (player.breastRows.biggestTitSize() > 2) outputText(" while you play with your " + biggestBreastSizeDescript(player), false);
    ...
    // If Balls]
    if (player.balls > 0) outputText("knead your " + ballsDescriptLight(player), false);
    else outputText("reach around and squeeze your " + buttDescription(player), false);
    ...
    outputText("You slowly take your " + cockDescript(game.player, x) + " out of her hot mouth, a small *pop* breaking the silence as it escapes her plump, puckered lips. Grabbing one of her hefty tits in your hands, you rub your cockhead against her erect nipple, eliciting a small moan from the sweaty slut. You slap your " + cockDescript(game.player, x) + " against her sweaty chest a few times before burying it in between her cleavage, ", false);
    // [If the player has a cock equal to or over 13']
    ...
    outputText("cum you've painted on her flesh and gulping it all down. \"<i>Thanks for the load, " + mf(player, "big guy", "babe") + ",</i>\" she remarks, sucking gently on her fingers. \"<i>I'll... I'll see you again, hey!</i>\" You pat her on the head and begin to make your way out of the gym, making sure to grab a ", false);
    if (silly()) outputText("bacon ", false);
    outputText("shake on the way out.", false);
    // LOTTIE FIGURE -1, MUSCLE TONE +1, DRAINS PC'S LUST.
    lottieTone(-1);
...
// [Appearance]
function lotteryAppearance(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function firstOralReactionChooseEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function firstOralReactionChooseAbuse(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function firstAnalReactionChooseEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function firstAnalReactionChooseAbuse(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function lottieLowMoraleWeightGainEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function lottieLowMorealeWeightGainAbuse(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function lottieMediumMoraleWeightGainEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// If Abuse]
function lottieMediumMorealeWeightGainAbuse(): void {
    spriteSelect(36);
    outputText("", true);
    outputText("You tell Lottie your methods never fail, and if something happened that wasn't supposed to, it's her that's at fault. She looks up at you, shocked at your outburst. Lost for words, her eyes begin to well up. \"<i>I... god, I'm so stupid! Of course it was me! It's always me!</i>\" She cries softly to herself, pushing your hand off her shoulder and burying her head in her arms. \"<i>I wasted your time! I'm... I'm...</i>\" Before she finishes her sentence, you walk away from the cafe, content with what you've done. You don't stop hearing her whimpering voice until you leave the gym, returning back to camp – strangely satisfied.", false);
    lottieMorale(-10);
...
// [If Encourage]
function lottieHighMoraleWeightGainEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function lottieHighMoraleWeightGainAbuse(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function lottieHighMoraleWeightGainFATTYLOVESIT(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function lottieHighMoraleWeightGainFATTYLOVESABUSE(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function lottieLowMoraleWeightLossEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]f
function lottieLowMoraleWeightLossAbuse(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function lottieMediumMoraleWeightLossEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function lottieMediumMoraleWeightLossAbuse(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function lottieHighMoraleWeightLossEncourage(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function lottieHighMoraleWeightLossAbuse(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Encourage]
function lottieHighMoraleWeightLossFATTYLOVESIT(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Abuse]
function lottieHighMoraleWeightLossFATTYLOVESABUSE(): void {
    spriteSelect(36);
    outputText("", true);
...
// [To Fuck]
function lottieFatLoserCulminationFuckChoice(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
function lottieFatLoserCulminationHumiliationChoice(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// [Love Yourself]
function lottieHighMoraleFatLoveSelfOneTimeEvent(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
    ...
    outputText("  You both lay on the mat, panting in ecstasy while your " + cockDescript(game.player, x) + " continues to ejaculate inside her.\n\n", false);
...
// [You'll get there]
function lottieHighMoraleFatYoullGetThereOneTimeEvent(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// Threesome]
function lottieElleThreesomeFirstTime(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
function fuckElleInsteadOfThatFatSlutFirstTime(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// [Oh I Get It]
export function charlottesWebComedyBullshit(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// [If Not Fat]
function lottieSuccessOneShot(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// [Leave]
function leaveLottieInsteadOfYogaSex(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Boast]
function boastAtFitLottie(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Train]
function trainWithFitLottie(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Jogging]
function goJoggingWithLottie(): void {
    spriteSelect(36);
    outputText("", true);
    // [If Figure 0 – 70]
    if (lottieTone() <= 70) {
...
// [Sprint]
function sprintAndLeaveLottieBehind(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Sprint]
function sprintAndLeaveFitLottieBehind(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Jog]
function jogWithFitLottie(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Together]
function togetherLottieYoga(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Wait]
function waitAndShowLottieYourPoolBoner(): void {
    spriteSelect(36);
    outputText("", true);
...
export function giveLottieAnItem(): void {
    spriteSelect(36);
    clearOutput();
    let bova: () => void = null;
    let gro: () => void = null;
    let reducto: () => void = null;
    if (player.inv.hasItem(ConsumableLib.LABOVA_)) bova = feedLottieLaBova;
    if (player.inv.hasItem(ConsumableLib.GROPLUS) && player.effects.findByType(StatusAffects.DungeonShutDown) >= 0) gro = giveLottieGroPlus;
    if (player.inv.hasItem(ConsumableLib.REDUCTO)) reducto = giveLottieReducto;
...
// [If Cafe]
function feedLottieAWholeCafe(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If LaBova]
export function feedLottieLaBova(): void {
    spriteSelect(36);
    outputText("", true);
    ...
    player.inv.consumeItem(ConsumableLib.LABOVA_);
    lottieTone(-10);
    flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00322] = 40;
    doNext(Camp.returnToCampUseOneHour);
}
// [If Gro+]
export function giveLottieGroPlus(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Reducto]
export function giveLottieReducto(): void {
    spriteSelect(36);
    outputText("", true);
...
// [If Ham Sandwich]
export function hamSammitchTimeBIATCH(): void {
    spriteSelect(36);
    outputText("", true);
...
export function lottieFuck(): void {
    spriteSelect(36);
...
// [Doggystyle]
export function lottieRepeatDoggieStyle(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Walkies]
export function lottieRepeatWalkies(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Cowgirl]
export function lottieRepeatCowGirl(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Quickie]
export function lottieRepeatQuickie(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// [Threesome]
export function lottieRepeatThreesome(): void {
    spriteSelect(36);
    outputText("", true);
...
// [Netorare]
export function lottieRepeatSUPERNEATORARES(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// [Reverse Cowgirl]
export function lottieRepeatBackwardsAssCowgirl(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
...
// [FemDom]
export function lottieRepeatFEMDOMFEMFDOM(): void {
    spriteSelect(36);
    outputText("", true);
    let x: number = player.cocks.cockThatFits(40);
    if (x < 0) x = 0;
    ...
    // [If Cum Production High]
        ...
        outputText("Unfortunately for her, you have far too much built up to stop now. With another thrust, your " + cockDescript(game.player, x) + " pulses in delight, exploding in orgasm as ropes of spunk splatter upon Lottie's face and tits. The girl gasps, the sheer amount of your seed painting her white. \"<i>N-no, stop! Oh god!</i>\" she yelps, before her mouth is filled with your hot essence. She forces herself to swallow, coughing as you grin at the defeated slut. \"<i>O-okay, y-you win, " + player.short + ".</i>\" she looks up at you and smiles, before untying your binds and setting you free. \"<i>But you have to admit, this was pretty fun, right?</i>\" You give her a thumbs up before walking out the door, leaving her to clean your thick mess. On the way out, a milkshake vendor waves over to you – it's the guy from the cafe. You buy a ", false);
        if (silly()) outputText("bacon ", false);
        outputText("shake before deciding to head home.", false);
        if (silly()) outputText("  You fucking love bacon shakes.", false);
    }
...
// [Hug]
export function hugTheShitOutOfYourHam(): void {
    spriteSelect(36);
    outputText("", true);
...
// vaginal sex scene.
export function tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK(): void {
    outputText("", true);
    ...
    outputText("You grasp the base of your " + cockDescript(game.player, x) + " as it stretches forward, gently caressing Lottie's face before exploring the rest of her body, idly stroking the smooth curves of her hips or brushing against her hardening nipples.  The pig-girl moans quietly from the light petting while the feeling of her soft skin excites your hardening length, reminding you of your true intentions.  You walk behind her, obscuring yourself from Lottie's peripheral vision and crouching down to inspect the view of her perfectly rounded ass pointed conveniently into the air.  " + SMultiCockDesc(game.player) + " twitches in agitation, eager to plow the chubby slut trapped in front of you - and you aren't about to disappoint.\n\n", false);
    ...
    if (y >= 0) {
        ...
        if (z >= 0) {
            outputText("Her constant moaning and screaming reminds you that one of her holes at least isn't being put to use.  Her eyes widen in awe as she sees your " + cockDescript(game.player, z) + " inexorably moving to her waiting mouth, her lips forming a wide O as if to greet your tentacle pecker.  Without a word, you plunge your beast in her mouth, burying your prick until she's about to choke.  Fortunately she's used to blowjobs, and you have no trouble fitting a decent amount of inches down her throat.  You can see her neck bulge from the obscene intrusion, and the tip of your " + cockDescript(game.player, z) + " swells until her windpipe looks ready to explode.  She can't say anything, but the way her eyes are staring at you tell you more than anything about how she feels.", false);
            ...
            if (zz >= 0) {
                outputText("Surely her twat must have some room left for more cock?  Before you even think of it, your free tentacle prick is already squirming its way to the piggy's love-tunnel, trying to fit as its companion ruthlessly rams her fuckhole.  You feel her whole body clench as you press the tip of your " + cockDescript(player, zz) + " between her netherlips, stretching them beyond their normal capacity as you keep pushing forward.  If her mouth wasn't so full of dick, you'd be sure she would scream like a harpy in heat.  Once the tip manages to get through her tight vaginal entrance, the rest easily follows, and you effortlessly slide your dickflesh down her now-gaping cunt.  You synchronize your pricks penetrating her cuntwardly, literally ravaging her pussy as you pork her insides with your genitals.\n\n", false);
                // [if another extra cock]//to be added to standard text
                if (zzz >= 0) {
                    outputText("Since her dripping twat has been able to take some extra dick, why not try her backside?  Your " + cockDescript(player, zzz) + " wriggles joyfully as it wraps around Lottie's plump rump, ready to test her anal capacity.  Fortunately, its rubbery texture allows it to be compressed as it grinds against your " + cockDescript(game.player, y) + ", sliding toward the pig-girl's wet anus.  Your plant-like dong bounces back against her entrance numerous times, but you know she is being stretched wider at every attempt.  You don't know how many times you poke her pucker with the erect tip of your " + cockDescript(player, zzz) + ", and you can't imagine how the teasing stimulation feels for the poor prisoner of your tentacle embrace.  At last, with a brutal thrust, your flexible dong somehow manages to clear a path for additional butt-penetration.  Your twin erect pricks are incredibly squeezed against her tight anal walls and her body is about to be torn in half from all the rods impaling her from many directions at once.  That doesn't prevent you from thrusting back and forth very carefully through her colon, never completely pulling out.\n\n", false);
                    // [if another extra cock]//to be added to standard text
                    if (zzzz >= 0) {
                        outputText("No matter how hard you try, you can't fit any more cock in her toy-like body. Your " + cockDescript(player, zzzz) + " is quivering in frustration, until you notice her fleshy orbs bouncing up and down repeatedly on her chest as you ruthlessly pound her from every hole.  This might be the right occasion to get a good titfuck: your " + cockDescript(player, zzzz) + " slowly slithers along her sweaty body and slides between her sizable fuckpillows; although the sensation isn't as hot and amazingly rough as the sharp tingles of pleasure received from the dongs pounding her ass, your rod is being subtly tickled and teased by her supple flesh.  Already aroused from the thorough multi-penetration, you start dripping pre-cum all over her torso, smearing her whole body with your sap.  This makes her breasts all the more slick and slippery, and needless to say, the sensation isn't lost on your " + cockDescript(player, zzzz) + "; it seems to grow even bigger and becomes pinkish, the sudden color change betraying its arousal. You keep fucking her boobs until they are literally glistening from all the juices you've spilled on them.\n\n", false);

                        // [if another extra cock]//to be added to standard text
                        if (zzzzz >= 0) {
                            outputText("As you idly pump Lottie's body with all your junk, you mentally count all the extra ways her body could be used, since you have some tentacle dong left.  Mouth, cunt, ass, tits... wait!  Her hands are still free!  By the way they are twitching convulsively, you can clearly tell they are aching for some dick to handle.  You graciously comply to her cocky needs and shove your " + cockDescript(player, zzzzz) + " against her palm, coating it with your pre-cum.  She instinctively clings to your rod of flesh as if her life depended on it and starts jerking you off, ferociously rubbing your dickflesh and using a mix of her sweat and your pre-cum as lube.", false);
                            // [if another extra cock]
                            if (zzzzzz >= 0) outputText("  Seeing the effect your junk had on her, you move your " + cockDescript(player, zzzzzz) + " to her remaining hand and she grips it likewise.", false);
    ...
    // generic
    else outputText("You stand exhausted, trembling slightly from the after-effects of your climax while your tree-like junk slows its movements.  Retracting your " + cockDescript(game.player, x) + ", you slowly change back into your " + player.armorName + " while Lottie comes to.  She hazily opens her eyes, the smell of hot semen in the air while she lifts herself upwards, remembering the sequence of events leading to where she is now. \"<i>H-huh? " + player.short + "...</i>\" the girl mumbles, struggling to move out only to find she's still underneath the small weighted mattress.  \"<i>H-hey! I'm still stuck!</i>\"\n\n", false);
    // [if enc. 100]
    if (lottieMorale() >= 99) {
...
// [Weights]
export function ifrisAndLottieGetsNTRedLiftingWeights(): void {
    outputText("", true);
...
function lottieAndIfrisNTREpilogue(): void {
    outputText("", true);
...
export function lottiesThirtyMinutePigGasm(): void {
    outputText("", true);
    const x: number = player.cocks.biggestCockIndex();
