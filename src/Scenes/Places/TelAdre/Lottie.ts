...
export function getSuckedOffByAHamSandwich(): void {
    ...
    else if (player.breasts.biggestTitSize() > 2) outputText(" while you play with your " + biggestBreastSizeDescript(player), false);
...
function lottieSuccessOneShot(): void {
    ...
    // [Otherwise]
        ...
        if (player.breasts.biggestTitSize() >= 2) outputText("tits", false);
