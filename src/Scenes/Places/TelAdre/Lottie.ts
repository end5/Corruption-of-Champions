...
export class Lottie extends TelAdreAbstractContent {
    ...
    public encounterLottie(charge: boolean = false): void {
        spriteSelect(36);
        let comedy1: () => void = null;

        // Choice menu vars
        // [Appearance][Talk][Exercise][Give Item][Sex][Hug]
        const item: () => void = giveLottieAnItem;
        let sex: () => void = null;
        const hug: () => void = hugTheShitOutOfYourHam;
    ...
    public lottieFuck(): void {
        ...
        // [If Encouragement 60 – 100]
            ...
            const quickie: () => void = (flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00314] > 0 ? lottieRepeatQuickie : null);
            const cowgirl: () => void = (flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00313] > 0 ? lottieRepeatCowGirl : null);
            const rcowgirl: () => void = (flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00320] > 0 ? lottieRepeatBackwardsAssCowgirl : null);
            const femdom: () => void = (flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00319] > 0 ? lottieRepeatFEMDOMFEMFDOM : null);
            choices("Anal", analLottieMilkshake, "Oral", getSuckedOffByAHamSandwich, "Tentacle", tentacle, "", null, "", null,
