...
private  encounterLottieCharge():void { encounterLottie(true); }

public  encounterLottie(charge:boolean = false):void {
	spriteSelect(36);
	var comedy1:() => void = null;

	//Choice menu vars
	//[Appearance][Talk][Exercise][Give Item][Sex][Hug]
	var item:() => void = giveLottieAnItem;
	var sex:() => void = null;
	var hug:() => void = hugTheShitOutOfYourHam;
...
//[Buddies]
private  stayLottieBuds4Evah():void {
	spriteSelect(36);
	outputText("",true);
...
//[If Decline]
private  declineBeingLottiesGymHamsandwich():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Accept]
private  acceptBeingLottiesHamSandwich():void {
	spriteSelect(36);
	outputText("", true);
...
public  gotInShapeComedyDeclineLottie():void {
	spriteSelect(36);
	outputText("", true);
	outputText("Haha, of course you fucking aren't, why would you be? Lottie stares at you, tears welling in her eyes. Oh, whoops – you must've said that out loud. Proceeding to not give two shits about the bawling pig-slut in front of you, you take a good squeeze of her cushiony tits before whipping your " + cockDescript(player.biggestCockIndex()) + " out and slapping her in the face with it.  \"<i>W-w-why... why are you... *sniff* p-please...!</i>\" The pig girl chokes in between sobs. It almost gives you a hard on - almost. You take one final step backwards, before announcing quite loudly to the other cafe-goers that you're going for a home run. Lottie squeaks before you take your " + cockDescript(player.biggestCockIndex()) + " and swing at her face, hitting dead on and managing to leave a bit of pre-cum on her newly-christened cheek. You stand triumphantly at your latest work of art, though Lottie seems to have other ideas, running out the door in complete misery, pre-cum and all. You decide you'd better return home too, and head back towards the camp – but not before spending the next hour or so chasing after Lottie and taking grabs at her plush ass.", false);
	//[PC no longer encounters Lottie.]
	flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00278] = 1;
	doNext(camp.returnToCampUseOneHour);
}
...
//[If Yes]
private  gotInShapeAcceptTrainingOffer():void {
	spriteSelect(36);
	flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00299] = 1;
	outputText("", true);
...
//[Water]
private  drinkWaterWithYourHamhock():void {
	spriteSelect(36);
	outputText("", true);
...
private  drinkLustWithYourHamhock():void {
	...
	outputText("You take her by the hand and lead her into one of the empty saunas. \"<i>" + player.short + "...</i>\" You grab her by the hips and lean her against the wall, throwing off her towel and revealing her velvety skin underneath. Reaching down, you grab a handful of her luxurious ass, squeezing and slapping it lightly. Lottie moans into your shoulder and reaches towards your groin, removing your " + player.armorName + ". She begins stroking " + game.player.oMultiCockDesc() + " lightly, picking up the pace as you continue to work on her pert rump. You can't help but lust over her full figure, using one of your hands to firmly grope her pillowy jugs and reaching your other towards her glistening pussy. You move your hand over her cushiony rack, before burying your head into her bosom and eagerly sucking on one of her nipples, fondling the other between your thumb and forefinger. Your other hand is already fast at work, fingering her hot cunt. You can feel her legs about to buckle beneath their own weight. Lottie moans in between short, hot breaths, \"<i>Y-you're... really amazing, " + player.mf("guy","lady") + ".</i>\"  You give her chubby ass a hard slap in agreement.  Lottie squeals in glee, jerking your " + game.player.cockDescript(0) + " as it pokes into her soft stomach. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n", false);
...
//[If Anal]
public  analLottieMilkshake():void {
	spriteSelect(36);
	outputText("", true);
	outputText(images.showImage("lottie-fuck-her-in-teh-butzor"));
	var x:number = player.cockThatFits(40);
	if(x < 0) x = 0;
	outputText("You brush her grip off of " + game.player.oMultiCockDesc() + ", only to turn her around and fit your girth between her large cheeks", false);
	...
	outputText("\"<i>A-aa-ah, I-I... AHH!</i>\" Lottie oinks noisily, her eyes rolling to the back of her head and her large thighs slapping against your own, pulling your " + game.player.cockDescript(x) + " further in. She shudders in orgasm", false);
...
//[If Oral]
public  getSuckedOffByAHamSandwich():void {
	spriteSelect(36);
	outputText("", true);
	outputText(images.showImage("lottie-gives-you-a-blowjob"));
	var x:number = player.biggestCockIndex();

	outputText("You grab Lottie's shoulders and firmly move her down towards your crotch. She kneels down, face to face with your " + game.player.cockDescript(x) + ".  Feeling her hot breath against your " + player.skinFurScales() + ", you tell her to suck it.\n\n", false);

	//[If player cock is at or below 4']
	if(player.cocks[x].cockLength <= 4) {
		outputText("She stares at your " + game.player.cockDescript(x) + " and then up at you. \"<i>I... oh, well I guess this is okay.</i>\" She lazily slurps your member into her mouth, and moans at the taste of your " + game.player.cockDescript(x) + ". Her agile tongue moves over your entire length, licking gently over your sensitive head and along your shaft. Your " + game.player.cockDescript(x) + " sits comfortably inside her warm hole, covered in her saliva", false);
		if(player.cockTotal() > 1) {
	...
	//[If the player has a cock between 5' – 12']
		...
		outputText("She stares intently at your " + game.player.cockDescript(x) + " with hunger in her eyes. A small amount of drool escapes her luscious lips as she moves forward, kissing your ", false);
		if(player.cockTotal() > 1) outputText(" biggest head lightly", false);
		else outputText(" head lightly", false);
		outputText(".  Her saliva leaks onto your " + game.player.cockDescript(x) + ", though she is quick to lick it up while she works her tongue around the rest of your shaft", false);
		if(player.cockTotal() > 1) outputText(", jerking off your " + cockDescript(player.biggestCockIndex2()) + " with both hands", false);
	...
	//[If the player has a cock equal to or over 13']
		...
		outputText("She gasps as you lift your " + game.player.cockDescript(x) + " and slap her face. \"<i>It's... wow, " + player.short + "!</i>\" You grin before poking her pudgy cheek with the tip of your ", false);
		if(player.cockTotal() > 1) outputText("biggest erection", false);
		else outputText("erection", false);
		outputText(".  A small amount of drool escapes her luscious lips as she moves forward, kissing your head lightly. Her saliva leaks onto your " + game.player.cockDescript(x) + ", though she is quick to lick it up while she works her tongue around the rest of your lengthy shaft", false);
		if(player.cockTotal() > 1) outputText(" - using her hands to massage your leftover " + cockDescript(player.biggestCockIndex2()), false);
		outputText(". She places small licks on the tip of your head, and without warning stuffs as much of your thick girth as she can into her mouth, coughing around your " + game.player.cockDescript(x) + ".\n\n", false);
	}

	outputText("She begins fellating your cock at an incredible rate, throatfucking herself on your " + game.player.cockDescript(x), false);
	...
	outputText(". You remark on what a hungry little piggy she must be, and the chubby girl moans in response, the vibrations massaging your member. Relishing the feeling of your " + game.player.cockDescript(x) + " in between her hungry lips, you start to thrust into her warm mouth hole, grabbing onto her head as you pound her face against your groin.", false);
	if(player.cockTotal() > 1) {
	...
	//[if Multi]
	if(player.cockTotal() > 1) outputText(" stops rubbing your " + game.player.cockDescript(x) + " to ", false);
	//(Otherwise)
	...
	//If Balls]
	if(player.balls > 0) outputText("knead your " + ballsDescriptLight(), false);
	else outputText("reach around and squeeze your " + buttDescript(), false);
	...
	outputText("You slowly take your " + game.player.cockDescript(x) + " out of her hot mouth, a small *pop* breaking the silence as it escapes her plump, puckered lips. Grabbing one of her hefty tits in your hands, you rub your cockhead against her erect nipple, eliciting a small moan from the sweaty slut. You slap your " + game.player.cockDescript(x) + " against her sweaty chest a few times before burying it in between her cleavage, ", false);
	//[If the player has a cock equal to or over 13']
	...
	//[If the player has a cock equal to or over 13']
	if(player.cocks[x].cockLength > 12) outputText("Licking at your cockhead, Lottie squishes her breasts against the rest of your member, making sure to lap up the stray beads of pre-cum squirting from your tip. Relishing the taste of your " + game.player.cockDescript(x) + " in her mouth she begins to suck at your head, flicking her tongue around your urethra and pressing her full lips against it, creating a vacuum of pleasure around your manhood.\n\n", false);
	...
	if(player.cockTotal() > 1) {
		...
		outputText(" extra cock as you push it between her pouty lips, her face brushing against it while she tries to titfuck your main member. Looking up at you, Lottie descends on you and begins fellating your " + cockDescript(player.biggestCockIndex2()) + ", not forgetting to knead her fat tits into your " + game.player.cockDescript(x) + ".\n\n", false);
	}
...
//[If Encourage]
private  firstOralReactionChooseEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]
private  firstOralReactionChooseAbuse():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  firstAnalReactionChooseEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]
private  firstAnalReactionChooseAbuse():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieLowMoraleWeightGainEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]
private  lottieLowMorealeWeightGainAbuse():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieMediumMoraleWeightGainEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieHighMoraleWeightGainEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]
private  lottieHighMoraleWeightGainAbuse():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieHighMoraleWeightGainFATTYLOVESIT():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieLowMoraleWeightLossEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]f
private  lottieLowMoraleWeightLossAbuse():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieMediumMoraleWeightLossEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]
private  lottieMediumMoraleWeightLossAbuse():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieHighMoraleWeightLossEncourage():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]
private  lottieHighMoraleWeightLossAbuse():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Encourage]
private  lottieHighMoraleWeightLossFATTYLOVESIT():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Abuse]
private  lottieHighMoraleWeightLossFATTYLOVESABUSE():void {
	spriteSelect(36);
	outputText("", true);
...
private  lottieHighMoraleFatLoveSelfOneTimeEvent():void {
	...
	outputText("  You both lay on the mat, panting in ecstasy while your " + game.player.cockDescript(x) + " continues to ejaculate inside her.\n\n", false);
...
private  fuckElleInsteadOfThatFatSlutFirstTime():void {
	...
	if(player.cockTotal() == 1) {
		outputText("begins to caress your " + game.player.cockDescript(x) + " with two of her hands, while the other sets to work on ", false);
	...
	outputText("  Elle follows suit, groaning in pleasure as she reaches her own peak, her hole tightening around your length and trapping the rest of your spunk inside. The spinnerets upon her shoulder pulse in orgasm, spurting sticky globs of what appears to be thread up into the air and back down onto the pig, spunk pooling around her cleavage. You both relax, letting the spider-girl down off of you to collapse on the floor. You bend down, looking at Lottie before shoving your " + game.player.cockDescript(x) + " inside of her and letting one final spurt of your seed fill her up. \"<i>Satisfactory,</i>\" you mumble, redressing and heading out the door");
...
//[Leave]
private  leaveLottieInsteadOfYogaSex():void {
	spriteSelect(36);
	outputText("", true);
...
//[Train]
private  trainWithFitLottie():void {
	spriteSelect(36);
	outputText("", true);
...
//[Jogging]
private  goJoggingWithLottie():void {
	spriteSelect(36);
	outputText("", true);
	//[If Figure 0 – 70]
	if(lottieTone() <= 70) {
...
//[Sprint]
private  sprintAndLeaveLottieBehind():void {
	spriteSelect(36);
	outputText("", true);
...
//[Together]
private  togetherLottieYoga():void {
	spriteSelect(36);
	outputText("", true);
	...
	if(player.cockTotal() > 1) outputText("s", false);
	outputText(", while you secretly relish in the fact that you're at the back of the class. \"<i>Was... was that because of me?</i>\" Lottie whispers, tactlessly pointing directly at your " + game.player.multiCockDescriptLight() + ". You nod in response, Lottie giggling at your aroused reaction to her body. She playfully slaps your stiff length, and returns to her stretches. You groan and move towards an easier, less-exposed position.\n\n", false);
...
private  waitAndShowLottieYourPoolBoner():void {
	spriteSelect(36);
	outputText("", true);
	outputText("You figure it can't do much harm to let " + game.player.sMultiCockDesc() + " fly, so you decide to leave it be, even leaning back so as to accentuate the hardening length. It doesn't take long for Lottie to notice, letting out a little gasp as she observes your ", false);
...
//[If Cafe]
private  feedLottieAWholeCafe():void {
	spriteSelect(36);
	outputText("", true);
...
//[If Ham Sandwich]
public  hamSammitchTimeBIATCH():void {
	spriteSelect(36);
	outputText("", true);
...
public  lottieFuck():void {
	spriteSelect(36);
	var tentacle:() => void = null;
	var thirtyMinute:() => void = null;
	...
	//[If Encouragement 60 – 100]
		...
		if(player.cockTotal() > 1) outputText("s", false);
		outputText(" against her plump asscheeks. \"<i>W-woah! I... well, okay...</i>\" she moans, reaching back to stroke your " + game.player.cockDescript(x) + " through your clothing while you grab a handful of her rosy ass, slapping and squishing it against your palm. You continue to hump relentlessly against Lottie's tight shorts, occasionally reaching around to feel her hot mound, causing the odd squeal or moan to emanate from her pouting lips. Eventually deciding clothes are the only thing between Lottie's lewd figure and your own " + game.player.cockDescript(x) + ", you simultaneously remove your outfit while ripping off her sweaty top, causing her breasts to spill out into your eager, groping hand. Despite your sudden stripping, Lottie immediately gets back into position, placing your cock in between her pillow-like asscheeks and moaning while you flick and tease her swollen nipples, rocking back and forth against you.\n\n", false);

		outputText("Lottie whimpers in between short, hot breaths, \"<i>You're driving me crazy here, babe...</i>\" You give her chubby ass a hard slap in agreement. Lottie squeals in glee, jerking your " + game.player.cockDescript(x) + " as it pokes up through her ass. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n", false);
		...
		var quickie:() => void =	(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00314] > 0 ? lottieRepeatQuickie : null);
		var cowgirl:() => void =	(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00313] > 0 ? lottieRepeatCowGirl : null);
		var rcowgirl:() => void =	(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00320] > 0 ? lottieRepeatBackwardsAssCowgirl : null);
		var femdom:() => void =	(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00319] > 0 ? lottieRepeatFEMDOMFEMFDOM : null);
		choices("Anal", analLottieMilkshake, "Oral", getSuckedOffByAHamSandwich, "Tentacle", tentacle, "", null, "", null,
...
//[Doggystyle]
public  lottieRepeatDoggieStyle():void {
	spriteSelect(36);
	outputText("", true);
	outputText(images.showImage("lottie-fuck-her-doggie-style-repeat"));
	var x:number = player.cockThatFits(40);
	if(x < 0) x = 0;
	outputText("A few minutes later and you've taken your whore to the washrooms. Mirrors line the sides of the walls to allow members to observe how far they've gone and how far they still need to go. It's entirely empty for the night, though you make sure to lock the door just in case. You turn around to see Lottie cowering in the corner. She knows what you want – and you swear on Mareth's giant tree titties you'll get it. With her naked body on full display, Lottie quietly moves down to the ground, positioning herself on all fours with her butt facing towards you. She looks behind herself to see your erect " + game.player.cockDescript(x) + " on full display, quickly squealing and looking away. You grin as you stroke yourself into fullness, walking over and placing yourself behind Lottie's full derriere. \"<i>" + player.short + "?</i>\" she gently sobs, \"<i>P-please don't do this.</i>\" With that, you grab her ample thighs and thrust forward, driving your " + game.player.cockDescript(x) + " straight into her tense wetness.\n\n", false);
...
//[Walkies]
public  lottieRepeatWalkies():void {
	spriteSelect(36);
	outputText("", true);
...
//[Cowgirl]
public  lottieRepeatCowGirl():void {
	spriteSelect(36);
	outputText("", true);
...
public  lottieRepeatQuickie():void {
	...
	outputText("In moments flat you remove your clothes to jump the piggy, whipping out your " + game.player.cockDescript(x) + " and pushing it against Lottie's wet slit, the pig-girl lying on her back while her legs rest upon your shoulders. With a hearty thrust you drive yourself into her, eliciting a loud moan while you pork her insides with your meat. Her thick thighs slap against you as you bend over to take a lustful grab at her melons, sucking at her nipple and pinching the other, her sweet taste enveloping your mouth. Lottie buries you in her cleavage, yelping as you piledrive her tight pussy into submission – but you've got more in store. Flipping her over, Lottie lies face down with her soft butt jutting up in the air, your persistent fucking driving her wild. You continue gripping onto her tits as you pound her flesh, every thrust accompanied by her pleasured grunts. Back and forth you mount her until the familiar sensation in your loins signal your release. You increase your pace, pounding her pussy until you pull your head back and ejaculate inside her inner walls, slamming in harder every few seconds with each burst.", false);
	if(player.cockTotal() > 1) {
		outputText("  Your other cock", false);
		if(player.cockTotal() == 2) outputText(" twitches ", false);
		else outputText("s twitch ", false);
...
public  lottieRepeatSUPERNEATORARES():void {
	...
	if(player.cockTotal() == 1) {
		outputText("begins to caress your " + game.player.cockDescript(x) + " with two of her hands, while the other sets to work on massaging your ", false);
		if(player.balls > 0) outputText("balls", false);
		else if(player.hasVagina()) outputText("pussy", false);
		else outputText("ass", false);
	}
	else  outputText("uses all four of her hands to handle " + game.player.sMultiCockDesc() + ", jerking each one with ease", false);
	...
	outputText("  Elle follows suit, groaning in pleasure as she reaches her own peak, her hole tightening around your length and trapping the rest of your spunk inside. The spinnerets upon her shoulder pulse in orgasm, spurting sticky globs of what appears to be thread up into the air and back down onto the pig, spunk pooling around her cleavage. You both relax, letting the spider-girl down off of you to collapse on the floor. You bend down, looking at Lottie before shoving your " + game.player.cockDescript(x) + " inside of her and letting one final spurt of your seed fill her up. \"<i>Satisfactory.</i>\" You mumble, redressing and heading out the door, making sure to grab a ", false);
	if(silly()) outputText("bacon ", false);
	outputText("shake on the way out.", false);
	if(silly()) outputText("  You only need one of those to satisfy you.", false);
	player.orgasm();
...
public  lottieRepeatBackwardsAssCowgirl():void {
	...
	var x:number = player.cockThatFits(40);
	if(x < 0) x = 0;
	outputText("You both walk into the yoga area, met with the smell of sweat and flowers pervading the room. Lottie gently asks for you to lie down on your back, to which you comply quite easily. You're comfortable, folding your arms behind your head to give you leverage as you watch your lover walk slowly to you. Lottie turns around, her thick thighs straddling you as she sits down on your groin with her back facing your direction, giving you  a perfect view of her curvy body and plump ass. Your " + game.player.cockDescript(x) + " nestles gently between her rosy cheeks, pulsing with lustful intent as the girl grabs her hips and begins to pleasure you through her ass. The silence of the room breaks at your fevered pants and grunts as Lottie's skillful assjob sends you through fits of ecstasy, every curve of her bottom jiggling against the heat of your member. Her pace picks up while she bounces upon you, squeezing and squashing her perfect ass until one final lift in the air is met with her plunging your length up into her hot interior. The feeling of your molten cock inside her immediately sends Lottie into fits of orgasmic bliss, the intense heat filling the pig-girl with pleasure. Her attempts to continue are thwarted by your " + game.player.cockDescript(x) + " scraping against her inner walls, her thick thighs clenched together while she slowly moves up and down upon you. Deciding to take things into your own hands, you thrust upwards, almost pushing the girl off with your strength and causing Lottie to squeal as you begin pounding her irresistible hole. Her lush buttcheeks jiggle with every movement you make, the rising and falling of her body moving in accordance to your own will. You pump in and out, keeping a steady rhythm inside the hot and bothered woman.\n\n", false);
...
public  lottieRepeatFEMDOMFEMFDOM():void {
	...
	//[If Cum Production High]
		...
		outputText("Unfortunately for her, you have far too much built up to stop now. With another thrust, your " + game.player.cockDescript(x) + " pulses in delight, exploding in orgasm as ropes of spunk splatter upon Lottie's face and tits. The girl gasps, the sheer amount of your seed painting her white. \"<i>N-no, stop! Oh god!</i>\" she yelps, before her mouth is filled with your hot essence. She forces herself to swallow, coughing as you grin at the defeated slut. \"<i>O-okay, y-you win, " + player.short + ".</i>\" she looks up at you and smiles, before untying your binds and setting you free. \"<i>But you have to admit, this was pretty fun, right?</i>\" You give her a thumbs up before walking out the door, leaving her to clean your thick mess. On the way out, a milkshake vendor waves over to you – it's the guy from the cafe. You buy a ", false);
		if(silly()) outputText("bacon ", false);
		outputText("shake before deciding to head home.", false);
		if(silly()) outputText("  You fucking love bacon shakes.", false);
	}
...
public  tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK():void {
	...
	outputText("You grasp the base of your " + game.player.cockDescript(x) + " as it stretches forward, gently caressing Lottie's face before exploring the rest of her body, idly stroking the smooth curves of her hips or brushing against her hardening nipples.  The pig-girl moans quietly from the light petting while the feeling of her soft skin excites your hardening length, reminding you of your true intentions.  You walk behind her, obscuring yourself from Lottie's peripheral vision and crouching down to inspect the view of her perfectly rounded ass pointed conveniently into the air.  " + game.player.SMultiCockDesc() + " twitches in agitation, eager to plow the chubby slut trapped in front of you - and you aren't about to disappoint.\n\n", false);
	...
	if(y >= 0) {
		outputText("Seeing that you have extra junk left to be used, and she has some vacant holes, you quickly remedy this problematic situation; guiding your " + game.player.cockDescript(y) + " toward her moist butthole, you press the tip of your tree-like beast against her plush buttocks, literally stabbing her flesh with your penile flora.  The butt-slut doesn't seem to care: if anything, she squirms all the more, visibly aroused.  Her ass seems to stretch on its own as it braces itself for the imminent butt-devastation.  You welcome Lottie's efforts to comply to your anal needs and with a single thrust, you push ", false);
		if(player.cockArea(y) <= 80) outputText("the entirety of your " + game.player.cockDescript(y), false);
		else outputText("as many inches of your " + game.player.cockDescript(y), false);
		...
		if(z >= 0) {
			outputText("Her constant moaning and screaming reminds you that one of her holes at least isn't being put to use.  Her eyes widen in awe as she sees your " + game.player.cockDescript(z) + " inexorably moving to her waiting mouth, her lips forming a wide O as if to greet your tentacle pecker.  Without a word, you plunge your beast in her mouth, burying your prick until she's about to choke.  Fortunately she's used to blowjobs, and you have no trouble fitting a decent amount of inches down her throat.  You can see her neck bulge from the obscene intrusion, and the tip of your " + game.player.cockDescript(z) + " swells until her windpipe looks ready to explode.  She can't say anything, but the way her eyes are staring at you tell you more than anything about how she feels.", false);
			...
			if(zz >= 0) {
				outputText("Surely her twat must have some room left for more cock?  Before you even think of it, your free tentacle prick is already squirming its way to the piggy's love-tunnel, trying to fit as its companion ruthlessly rams her fuckhole.  You feel her whole body clench as you press the tip of your " + cockDescript(zz) + " between her netherlips, stretching them beyond their normal capacity as you keep pushing forward.  If her mouth wasn't so full of dick, you'd be sure she would scream like a harpy in heat.  Once the tip manages to get through her tight vaginal entrance, the rest easily follows, and you effortlessly slide your dickflesh down her now-gaping cunt.  You synchronize your pricks penetrating her cuntwardly, literally ravaging her pussy as you pork her insides with your genitals.\n\n", false);
				//[if another extra cock]//to be added to standard text
				if(zzz >= 0) {
					outputText("Since her dripping twat has been able to take some extra dick, why not try her backside?  Your " + cockDescript(zzz) + " wriggles joyfully as it wraps around Lottie's plump rump, ready to test her anal capacity.  Fortunately, its rubbery texture allows it to be compressed as it grinds against your " + game.player.cockDescript(y) + ", sliding toward the pig-girl's wet anus.  Your plant-like dong bounces back against her entrance numerous times, but you know she is being stretched wider at every attempt.  You don't know how many times you poke her pucker with the erect tip of your " + cockDescript(zzz) + ", and you can't imagine how the teasing stimulation feels for the poor prisoner of your tentacle embrace.  At last, with a brutal thrust, your flexible dong somehow manages to clear a path for additional butt-penetration.  Your twin erect pricks are incredibly squeezed against her tight anal walls and her body is about to be torn in half from all the rods impaling her from many directions at once.  That doesn't prevent you from thrusting back and forth very carefully through her colon, never completely pulling out.\n\n", false);
					//[if another extra cock]//to be added to standard text
					if(zzzz >= 0) {
						outputText("No matter how hard you try, you can't fit any more cock in her toy-like body. Your " + cockDescript(zzzz) + " is quivering in frustration, until you notice her fleshy orbs bouncing up and down repeatedly on her chest as you ruthlessly pound her from every hole.  This might be the right occasion to get a good titfuck: your " + cockDescript(zzzz) + " slowly slithers along her sweaty body and slides between her sizable fuckpillows; although the sensation isn't as hot and amazingly rough as the sharp tingles of pleasure received from the dongs pounding her ass, your rod is being subtly tickled and teased by her supple flesh.  Already aroused from the thorough multi-penetration, you start dripping pre-cum all over her torso, smearing her whole body with your sap.  This makes her breasts all the more slick and slippery, and needless to say, the sensation isn't lost on your " + cockDescript(zzzz) + "; it seems to grow even bigger and becomes pinkish, the sudden color change betraying its arousal. You keep fucking her boobs until they are literally glistening from all the juices you've spilled on them.\n\n", false);

						//[if another extra cock]//to be added to standard text
						if(zzzzz >= 0) {
							outputText("As you idly pump Lottie's body with all your junk, you mentally count all the extra ways her body could be used, since you have some tentacle dong left.  Mouth, cunt, ass, tits... wait!  Her hands are still free!  By the way they are twitching convulsively, you can clearly tell they are aching for some dick to handle.  You graciously comply to her cocky needs and shove your " + cockDescript(zzzzz) + " against her palm, coating it with your pre-cum.  She instinctively clings to your rod of flesh as if her life depended on it and starts jerking you off, ferociously rubbing your dickflesh and using a mix of her sweat and your pre-cum as lube.", false);
							//[if another extra cock]
							if(zzzzzz >= 0) outputText("  Seeing the effect your junk had on her, you move your " + cockDescript(zzzzzz) + " to her remaining hand and she grips it likewise.", false);
	...
	// generic
	else outputText("You stand exhausted, trembling slightly from the after-effects of your climax while your tree-like junk slows its movements.  Retracting your " + game.player.cockDescript(x) + ", you slowly change back into your " + player.armorName + " while Lottie comes to.  She hazily opens her eyes, the smell of hot semen in the air while she lifts herself upwards, remembering the sequence of events leading to where she is now. \"<i>H-huh? " + player.short + "...</i>\" the girl mumbles, struggling to move out only to find she's still underneath the small weighted mattress.  \"<i>H-hey! I'm still stuck!</i>\"\n\n", false);
	//[if enc. 100]
	if(lottieMorale() >= 99) {
...
//[Weights]
public  ifrisAndLottieGetsNTRedLiftingWeights():void {
	outputText("", true);
