...
export class Lottie extends TelAdreAbstractContent {
    ...
    public getSuckedOffByAHamSandwich(): void {
        ...
        if (player.cockTotal() > 1) {
            ...
            outputText(" extra cock as you push it between her pouty lips, her face brushing against it while she tries to titfuck your main member. Looking up at you, Lottie descends on you and begins fellating your " + cockDescript(player.biggestCockIndex2()) + ", not forgetting to knead her fat tits into your " + cockDescript(game.player, x) + ".\n\n", false);
        }
