...
export function circlejerk(): void { // Not available if Kath has no cock
    ...
    outputText("As soon as Urta’s top is off her, you move your hands to grope at her soft orbs, pinching and twisting her nipples, then pulling her head against your " + (player.breastRows.hasBreasts() ? breastDescript(player, 0) : "chest") + ", and finally giving her perky fox-ear a gentle bite");
    ...
    outputText("The two morphic herms moan and growl lustily, eagerly rubbing their stiff, mismatched dicks across your stomach, your " + (player.breastRows.hasBreasts() ? breastDescript(player, 0) : "chest") + ", your [hips]");
