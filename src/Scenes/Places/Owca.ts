...
function rapeZeVapula(): void {
    ...
    // Victory rape using vagina/anus [Take Dicks in All Holes](Z)
        ...
        if (player.breasts.biggestTitSize() >= 2) outputText(" and your " + breastDescript(game.player, 0) + " bounce gently");
        ...
        // [cunt nipples]
        if (player.breasts.hasFuckableNipples()) outputText("  Your freakish nipples moisten with excitement to the smell of man juice, and you feel your libido ratcheting up even higher.  Bending forward, you grab two other imps with smaller dicks, quickly guiding their lengths into your nipplecunts; they are small enough that you can mash their bodies against your soft flesh, doing all the work for them as your sensitive nubs are penetrated.");
        ...
        if (player.breasts.hasFuckableNipples()) outputText(", teats, ");
        else outputText(" ");
