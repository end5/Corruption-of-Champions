...
function joeysMassageWifNoExtraJizz(): void {
    ...
    if (!player.breasts.hasFuckableNipples()) outputText("tweaks and teases", false);
...
function joeysMassageWithEXTRASpooge(): void {
    ...
    if (!player.breasts.hasFuckableNipples()) outputText("squeezing and tugging on them", false);
