...
function MaraeIIStageII(): void {
    ...
    // [Hermz]  Marae grows vinecawks for DP under her flowercunt and sexes.
        ...
        if (player.breasts.hasFuckableNipples()) outputText(", slipping inside your cunt-like nipples with ease.  You moan into her ear at the unexpected penetration and shiver from the tingling shocks of pleasure in your " + breastDescript(game.player, 0) + ".", false);
