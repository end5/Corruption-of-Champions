...
export class Marae extends AbstractBoatContent implements TimeAwareInterface {
    ...
    private MaraeIIStageII(): void {
        ...
        // Marae uses a tree-tentacle to 'milk' male PC's.  Oral or Vajayjay? Not sure.
            ...
            outputText("The tentacle on her right arm convulses, then splits open along four joints.  The tip folds open to reveal a pink, wriggling interior that promises pleasures mortal minds weren't meant to comprehend.  Meanwhile, while you're distracted by the eager plant-hole, the other tentacle slips behind you and climbs up your " + leg(player) + ", leaving a trail of slime in its wake.   It slides between your cheeks and prods at your " + assholeDescript() + ".  You jerk forwards in surprise, but Marae pushes your " + hipDescript() + " back, allowing it to work its way inside.", false);
