...
export class Marae extends AbstractBoatContent implements TimeAwareInterface {
    ...
    private maraeStealLethicite(): void {
        ...
        // (FAIL)
            ...
            if (player.gender == 1 || (player.gender == 3 && rand(2) == 1)) {
                ...
                outputText("'s tip.  Immediately a powerful suction draws your " + game.player.cockDescript(0) + " inside the tentacle-maw, burying you up to the base in squirming pleasure.   Marae watches the plant go to work, squeezing teasingly until you orgasm.  It takes mere moments for the gifted tentacle to achieve its goal.  Your cum makes a tasty treat for the plant-beast, and it sucks and sucks until your body feels empty and drained.\n\n", false);
                ...
                outputText("You feel warm, enclosed in comfort and pleasure.  Is this heaven?  No, your head is throbbing and your eyes are closed... you open them and discover you're still lying at the base of the tree.  That greedy tentacle is still locked around your " + game.player.cockDescript(0) + " pinning it in the throes of orgasm.  You watch thick bulges of cum pump up the tentacle, evidence of a truly garguantuan fluid output.  It goes on and on, and you realize the pleasure ought to drive you mad.\n\n", false);
                outputText("Marae steps into your field of view, and pulls the tentacle free.  Your " + game.player.cockDescript(0) + " twitches pitifully, blasting a few massive loads onto your belly as your orgasm withers and dies from lack of stimulation.\n\n", false);
                outputText("\"<i>Sorry about the pain, I had to tweak your body to make you a true breeder.  You can go now stud.  I expect the monsters ought to worry about you now, or they'll all have dripping twats and swollen bellies,</i>\" apologizes Marae.  She turns away from you, returning to the embrace of her tree's tentacles, sinking into debauchery.  You stagger into your boat and row away, oblivious to the stream to pre-cum dripping from your " + game.player.multiCockDescript() + ".", false);
    ...
    private MaraeIIStageII(): void {
        ...
        if (player.gender == 2) {
            ...
            else outputText("your " + hairDescript(), false);
        ...
        // Marae uses a tree-tentacle to 'milk' male PC's.  Oral or Vajayjay? Not sure.
            ...
            outputText("  The open plant-hole dives for your groin while you're distracted, hits your " + game.player.cockDescript(0) + " and devours it with a greedy sluuuuurp.", false);
            if (player.cockTotal() == 2) outputText("  Another vine that may as well be the first's twin snakes from between the goddess' legs and jumps onto your " + game.player.cockDescript(1) + ".", false);
            ...
            outputText("It doesn't matter, you're giving her what she wants.  You cum until your " + player.legs() + " give out and you're sprawled on your back, " + game.player.sMultiCockDesc() + " being milked of its seed by the slurping, cunt-tentacles.  Every time you start to come down, the one in your backdoor rubs you just right and forces out another load.  Marae steps over your " + face(player) + " and drops down, allowing you to lick the nectar that drips from her sensitive, flower-like folds while you cum.  It's sweet, potent, and refreshing.  It makes it easy to keep cumming but hard to stay awake, and your eyes roll back as you pass out from an overload of pleasure.", false);
        }
        // [Hermz]  Marae grows vinecawks for DP under her flowercunt and sexes.
        else {
            outputText("Marae coos with pleasure and allows a nectar-slicked tentacle to slip free of her flower.   Her sweet, corrupted smell filters through the air, like pollen carried on a spring breeze.  You watch, breathlessly staring as she advances, trailing a single finger around the entrance of her plant-like pussy in a provocative manner.  Amber fluid leaks down her thighs, showing you just how ready for sex she is.   The stickiness of your crotch combined with the tightness of " + game.player.sMultiCockDesc() + " makes it difficult to focus.  Your body is reacting to Marae in a way that's making it hard to focus or think, and though you know she's incredibly dangerous since her fall from grace, you have a hard time caring.\n\n", false);

            outputText("The goddess closes with deliberately slow, hip-swaying steps that make your " + game.player.cockDescript(0) + " tremble and leave no doubt that she's the goddess of fertility.  Marae giggles and wraps her arms around you, planting a firm, wet kiss on your lips while she undoes your " + player.armorName + ".  Your gear hits the ground with a dull thump, and then her taut green nipples are pressed against your own", false);
            if (player.hasFuckableNipples()) outputText(", slipping inside your cunt-like nipples with ease.  You moan into her ear at the unexpected penetration and shiver from the tingling shocks of pleasure in your " + game.player.breastDescript(0) + ".", false);
            else outputText(".", false);
            outputText("  Hammering in your chest, your heart beats fast enough to flush your whole body when your " + game.player.cockDescript(0) + " manages to slip between Marae's legs.  It doesn't penetrate, merely trapping itself between her fluid-lubed thighs", false);
            ...
            outputText("She's easy to push down into the soft grasses of the island, and her legs part to allow you better access.  Your " + game.player.cockDescript(0) + " doesn't need to be told what to do, and it slips into her waiting wetness as if it was made for her.  ", false);
            ...
            else outputText("She feels perfect.  A velvet vice of hot, slippery wetness clutches tightly around your " + game.player.cockDescript(0) + ".  It almost feels like it's actually gripping you, cradling your cock in her ambrosia-slicked box.", false);
            if (player.cockTotal() > 1) {
            ...
            outputText("You happily thrust forwards, ramming your " + game.player.cockDescript(0) + " into her cunt with such force that a wet slap echoes over the lake and her fluids splatter your abdomen.  ", false);
            if (player.cockTotal() > 1) outputText("Her asshole is squelching and dripping from your " + game.player.cockDescript(1) + ", actually squirting more lubricant than her pussy from the violent fucking!  ", false);
            outputText("In spite of the obscene amount of pleasure " + game.player.sMultiCockDesc() + " is getting, you focus on obeying your goddess, and you work the muscles in your " + vaginaDescript(0) + " and " + assholeDescript() + " to pleasure her tentacles.  Muffled sloshes and spurts reach your ears, and you realize just how successful your efforts are.  Marae's pinching her nipples and arching her back, and a moment later a wave of pleasure hits you upside the head with the force of a hammer-blow.\n\n", false);
            ...
            if (player.cockTotal() > 1) outputText("The " + game.player.cockDescript(1) + " in her ass spasms and explodes with its brother, glazing her slippery colon with a coating of syrupy spunk.  ", false);
            if (player.cockTotal() > 2) {
                outputText("Neglected but orgasming, ", false);
                if (player.cockTotal() > 3) outputText("the remainder of ", false);
                outputText("your ", false);
                if (player.cockTotal() > 3) outputText(game.player.multiCockDescriptLight(), false);
    ...
    private MaraePt2RoundIIIPrizes(): void {
        ...
        // [HERMS]
            ...
            outputText("You awaken in the midst of a powerful orgasm.  Jism boils out of " + game.player.sMultiCockDesc() + ", pumping into the tight, sucking tentacle-hole.  Plant-spooge is pumping into your clenching birth-canal, and you can feel it worming its way into your over-packed womb.  Your eyes open wider, and your head clears while you rock your hips in bliss.  You're hanging upside down, suspended in the tentacle tree!  Marae isn't far from you, and she's busy deep-throating the fattest tentacle you've seen while another pair are working her openings.  She turns to you, aware of your wakefulness, and removes the oral intruder, though it manages to squirt a layer of spunk into her face in defiance.   The goddess smirks and slaps it, scolding it before she speaks, \"<i>", false);
