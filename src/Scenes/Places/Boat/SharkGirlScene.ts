...
*/
    ...
    private sharkgirlSixtyNine(): void {
        ...
        if (player.isNaga()) {
            ...
            // [if herm]
            if (player.gender == 3) outputText(". You remind her not to neglect your " + cockDescript(game.player, 0) + ", and the shark girl responds by thoroughly licking your hard erection and sucking at your " + ballsDescriptLight() + ".", false);
            outputText("\n\n", false);
