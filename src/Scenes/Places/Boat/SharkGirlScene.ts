...
*/
    ...
    private sharkgirlSixtyNine(): void {
        ...
        if (player.isNaga()) {
            ...
            // [if female]
            if (player.gender == 2) outputText(", pulling out every few minutes to lick your " + clitDescript() + ".", false);
            // [if herm]
            if (player.gender == 3) outputText(". You remind her not to neglect your " + game.player.cockDescript(0) + ", and the shark girl responds by thoroughly licking your hard erection and sucking at your " + ballsDescriptLight() + ".", false);
            outputText("\n\n", false);
            ...
            // [if herm]
            else outputText(" and stand up, gripping your " + game.player.cockDescript(0) + " and splattering thick jets of cum onto her face.", false);
    ...
    public sharkLossRape(): void {
        ...
        if (player.hasVagina() && (player.totalCocks() == 0 || rand(2) == 0)) {
            ...
            // [if herm]
            if (player.gender == 3) outputText("Seeing your " + game.player.cockDescript(0) + " puts a smile on the shark girl's face as she takes a firm grip on your erection. \"<i>Well, you're just full of surprises, aren't you? Maybe I'll give this bad boy a whirl sometime. For now though...</i>\"  ", false);
