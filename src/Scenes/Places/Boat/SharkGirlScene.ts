...
*/
    ...
    public sharkWinChoices(): void {
        ...
        // HP Win
        if (monster.HP < 1) {
            outputText("The shark-girl falls, clearly defeated.", true);
        }
        // Lust win
        else {
        ...
        if (player.lust >= 33 && player.gender > 0) {
            ...
            const dildo: () => void = (player.keyItems.has("Deluxe Dildo") >= 0 ? sharkGirlGetsDildoed : null);
            if (player.gender == 1)
    ...
    private sharkgirlSixtyNine(): void {
        ...
        if (player.isNaga()) {
            ...
            // [if female]
            if (player.gender == 2) outputText(", pulling out every few minutes to lick your " + clitDescription(player) + ".", false);
            // [if herm]
            if (player.gender == 3) outputText(". You remind her not to neglect your " + cockDescript(game.player, 0) + ", and the shark girl responds by thoroughly licking your hard erection and sucking at your " + ballsDescriptLight(player) + ".", false);
            outputText("\n\n", false);
            ...
            // [if herm]
            else outputText(" and stand up, gripping your " + cockDescript(game.player, 0) + " and splattering thick jets of cum onto her face.", false);
    ...
    public sharkLossRape(): void {
        ...
        if (player.hasVagina() && (player.totalCocks() == 0 || rand(2) == 0)) {
            ...
            outputText("The shark girl giggles and moves over to you, tugging at your " + player.armorName + "  impatiently. Her tail swishes around and smacks your " + buttDescription(player) + ". \"<i>You're gonna make me very happy, you hear? Otherwise...</i>\" she opens her mouth wide and you see her fangs glinting menacingly in the light. You gulp hard and nod, bringing a smile from the shark girl.\n\n", false);
            outputText("Wasting no time, she removes her skimpy swimwear and your own gear.  ", false);
            // [if herm]
            if (player.gender == 3) outputText("Seeing your " + cockDescript(game.player, 0) + " puts a smile on the shark girl's face as she takes a firm grip on your erection. \"<i>Well, you're just full of surprises, aren't you? Maybe I'll give this bad boy a whirl sometime. For now though...</i>\"  ", false);
            outputText("Her gaze drifts over to your " + vaginaDescript(player, 0) + " and she licks her lips in delight. \"<i>Now that's what I'm looking for! Tell you what dear, you get me wet and I might just give you some pleasure too.</i>\"\n\n", false);
