...
export class Lilium extends BazaarAbstractContent {
    ...
    private liliumDickRidah(): void {
        ...
        // (if player has breasts)
        if (player.biggestTitSize() >= 1) {
            outputText("You turn your attention to your own " + allBreastsDescript() + " and how they bounce from the force of your vigorous fucking, supporting the weight of your " + breastDescript(game.player, 0) + " with your hands as you continue to ride Lilium's cock.", false);
            // (if demonic tongue)
        ...
        outputText("  The tingle of pleasure across your body begins to strengthen and you grind your crotch into your demon lover's face that little bit harder, trying to get yourself over the edge; suddenly you feel a burst of electricity inside you.  Your muscles all contract, your arms pull tight to your body and you collapse inwards, on top of Lilium as the pulses of pleasure shoot out across your body.  The tingles in your " + nippleDescript(0) + ", your " + clitDescript() + ", your insides and out, through your arms and " + legs(player) + ", reach a fever pitch and you let out a short, strained squeak through gritted teeth to voice your pleasure.\n\n", false);
