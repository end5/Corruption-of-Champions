...
export class Lilium extends BazaarAbstractContent {
    ...
    public LiliumText(output: boolean = false): () => void {
        ...
        if (game.time.hours >= 17) return approachLilium;
        return null;
    }
    ...
    private buttFuckTongueJeorb(): void {
        ...
        outputText("Squatting before you, she traces a single gloved finger along the underside of your " + cockDescript(game.player, x) + ", teasing it until it grows to its full " + Math.round(player.cocks[x].cockLength) + "-inch length.  Once your maleness has sprung to life, she turns around and bends over to brace herself against the wall before looking back over her shoulder at you mischievously and giving her hips a little wiggle.  Taking position behind her, you slide your " + cockDescript(game.player, x) + " between her soft thighs.", false);
        // (If player cock length > 8 inches)
        if (player.cocks[x].cockLength > 8) outputText("  You can feel Lilium's smaller cock resting atop your " + cockDescript(game.player, x) + ".", false);
        ...
        outputText("One last time, you slowly draw your " + cockDescript(game.player, x) + " from between her thighs and let it flop against her lower back, your hands moving from Lilium's hips to her pearlescent ass cheeks.  Spreading her wide, you let your " + cockDescript(game.player, x) + " gradually inch down the cleft between them until the head rests against her back entrance.  With an agonizing slowness you begin to push.  The faintest gasps escape Lilium's lips as her ass finally envelops the head of your cock, followed by a squeak of surprise as you suddenly drive the remaining length in; the force of your " + hipDescription(player) + " meeting her ass pushes her entirely up against the wall.\n\n", false);
    ...
    private liliumDickRidah(): void {
        ...
        outputText("You draw yourself up and position yourself above Lilium's twitching cock.  Your fingers part the lips of your " + vaginaDescript(player, 0) + " which are slick with your own arousal.  ", false);
        // (If virgin/tight)
        ...
        else outputText("Without a second thought you plunge yourself down on Lilium's fuckrod, your " + buttDescription(player) + " jiggling from the sudden impact.  ", false);
        outputText("You pull yourself up until only the head of the demon girl's dick remains within you, before sliding back down to let her fill you again.  Up and down you bounce on top of her, your speed and force increasing with every stroke.  You let out a contented half moan, half grunt each time your " + hipDescription(player) + " collide with hers as her stiff cock stimulates your insides.  Lilium's own search for more pleasure brings her hands to her breasts and she begins to finger-fuck her nipples.  Before long she has two and then three fingers furiously plunging in and out of her gaping nipplecunts and you can see her eyes rolled back in her head as her mouth hangs open in testament to the excitement flowing through her body.", false);
        ...
        if (player.biggestTitSize() >= 1) {
            ...
            else if (player.biggestLactation() > 2) outputText("  A powerful stream of milk fires out of your " + nippleDescription(player, 0) + ", coating Lilium's flat stomach.", false);
            outputText("\n\n", false);
        }

        outputText("With several fingers still inside her nipples, Lilium bites her lip and forcefully pushes her breasts together as her hips begin bucking to meet your own " + hipDescription(player) + ".  Seeing that her orgasm is near, you begin flexing your internal muscles in addition to pumping up and down on her cock.  With a sudden burst of movement that surprises you, Lilium tears her hands from her breasts and roughly grabs your " + buttDescription(player) + ", her fingers digging into your buttcheeks as she attempts to hold you down tight upon her.  Her eyes bulge wide and she lets out a loud cry as you feel her pump load after load of demonic cum into you, flooding your " + vaginaDescript(player, 0) + ".  Lilium drops her arms to her sides with eyes half-lidded as she pants heavily.\n\n", false);

        outputText("Not finished with her yet, you draw yourself up off her wilting willy, clenching your lower muscles to keep as much of her cum inside you as possible as you flip yourself around and position your body above her face.  Lilium quickly catches on to what you're doing and you think you can see her gulp nervously as you lower your cum-stuffed pussy to her mouth.  Rolling your " + hipDescription(player) + " back and forth you begin grinding your " + vaginaDescript(player, 0) + " into the demon woman's face as her tongue worms and tickles inside you, beginning its task of cleaning out the remnants of her ecstasy from your love hole.  While Lilium's tongue gently strokes your insides with lips occasionally sucking gently on your labia, you turn your attention to your clit.  ", false);
        // (if little clit)
        if (player.clitLength < 2) outputText("With one finger you begin to knead your " + clitDescription(player) + ", which instantly increases the pleasure emanating from your lower body.", false);
        // (else if big clit)
        else outputText("Tenderly grasping it between your fingers you begin to rub your " + clitDescription(player) + " from base to tip, each stroke adding a wave of pleasure to that of the tongue treatment your " + vaginaDescript(player, 0) + " is receiving.", false);
        outputText("  The tingle of pleasure across your body begins to strengthen and you grind your crotch into your demon lover's face that little bit harder, trying to get yourself over the edge; suddenly you feel a burst of electricity inside you.  Your muscles all contract, your arms pull tight to your body and you collapse inwards, on top of Lilium as the pulses of pleasure shoot out across your body.  The tingles in your " + nippleDescription(player, 0) + ", your " + clitDescription(player) + ", your insides and out, through your arms and " + legs(player) + ", reach a fever pitch and you let out a short, strained squeak through gritted teeth to voice your pleasure.\n\n", false);
    ...
    private liliumNippleFuck(): void {
        ...
        // (else)
        else outputText("As her tongue reaches the end of its journey she gives the head of your " + cockDescript(game.player, x) + " a little flick with the tip of her tongue.  ", false);
        outputText("Taking one black tress in hand she draws it slowly across your glans, sending a shiver down your spine. Taking obvious delight in your reaction she starts brushing the lock of plush hair up and down your shaft.  You can see her bring her free hand up to her breast as she continues to tickle your " + cockDescript(game.player, x) + " with the soft strands of hair.  At first she cups and massages the pale flesh slightly, before slipping a finger inside her rosy nipplecunt.  She bites down on her lip as she begins working the finger in and out.\n\n", false);

        outputText("Not content with just the teasing Lilium continues to give your " + cockDescript(game.player, x) + ", you grab her shoulders and push her back against the wall, the shock of which causes her finger to come free of her nipple.  With one hand you line the head of your " + cockDescript(game.player, x) + " up with the now dripping entrance to her breast and drive forward.  There is a slight resistance at first, but then Lilium coos as you overcome it and her breast envelops you.  Her boobs are sadly not large enough to take you to the hilt, but pumping part of your shaft in and out of her chest is pleasurable all the same. The soft flesh mound distorts as you fuck it, stretching out as you draw back and squishing together as you thrust in.  Lilium's eyes unfocus and she begins to pant louder and louder as you fuck her breast.\n\n", false);
