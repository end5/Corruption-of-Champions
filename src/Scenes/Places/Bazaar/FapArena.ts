...
export class FapArena extends BazaarAbstractContent {
    ...
    private fapArenaPageII(): void {
        ...
        else if (player.cor > 33) outputText("You nervously grab hold of the rod on your right side.  In your stress, you can't help but give it a little squeeze.  You tremble as your left neighbor grabs " + oMultiCockDesc(game.player) + " with an expert hand.  Most people are as nervous as you, their whole naked body trembling in stress.\n\n", false);
        else {
    ...
    private fapResults(place: number = 3): void {
        ...
        if (place == 3) {
            ...
            // [if player lactates]
            if (player.biggestLactation() > 1.5) outputText("  Your " + allBreastsDescript(player) + " also release a milky flood of their own, the soft feeling of cream teasing your nipple only prolonging your orgasm.", false);
            outputText("\n\n", false);
        ...
        // [else, the player wins]
            ...
            if (player.biggestLactation() > 1.5) outputText("  Your " + allBreastsDescript(player) + " also release a milky flood of their own, the soft feeling of cream teasing your nipple only prolonging your orgasm.\n\n", false);
        }
        // Post fap
        ...
        // [else, corr >50]
        else outputText("Your body tenses and " + sMultiCockDesc(game.player) + " hardens at the perspective of a collective anal orgy.  You yell in lust like a minotaur in rut, \"<i>BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!</i>\" along with the others.  ", false);
        // end of global condition about PC's corr, display the following
        ...
        if (place <= 1) {
            ...
            if (rand(2) == 0) {
                temp = 3;
                outputText("You eagerly grab the luxurious, gelatinous butt cheeks in front of you.  You notice a pussy underneath that fine ass, freely spilling sexual juices.  If the compelling order wasn't resonating deep in your mind, you would easily lose yourself in the herm's glorious depths. Nevertheless, your " + cockDescript(game.player, x) + " remembers its job and starts pushing its way between these tender orbs, then into the herm's tight anus.\n\n", false);
            }
            else {
                outputText("You eagerly grab the firm, muscular ass cheeks in front of you, probably belonging to some vigorous male.  You grind your " + cockDescript(game.player, x) + " against his back and it automatically starts spilling pre-cum; as soon as the seminal liquid trickles down his shapely butt, you can feel his body tensing, as if his lust reached a new level.  Nevertheless, your " + cockDescript(game.player, x) + " remembers its job and starts pushing its way between these gorgeous buttocks, then into the man's tight anus.\n\n", false);
                temp = 1;
            }
            ...
            outputText("\n\nWincing in pain and pleasure mixed, your " + cockDescript(game.player, x) + " lets out one ultimate spurt of goo before resting, deeply buried into your partner's ass.  You fall over, making the whole chain fall to rest by domino effect.  After this torrid anal session, the butt-fuck train has exhausted its fuel.\n\n", false);
        }
        // [else if you didn't win]
        else if (place == 2) {
            outputText("You almost instantly feel firm arms groping your " + buttDescription(player) + " and the tip of an erect dick knocking at the door of your colon.  It slowly massages your rectum, and you can't help but giggle a bit as you feel a tingle of pleasure passing through your body.\n\n", false);

            // [1/2 chance of this]
            if (rand(2) == 0) outputText("You eagerly grab the luxurious, gelatinous butt cheeks in front of you.  You notice a pussy underneath that fine ass, freely spilling sexual juices.  If the compelling order weren't resonating deep in your mind, you would easily lose yourself in the herm's glorious depths.  Nevertheless, your " + cockDescript(game.player, x) + " remembers its job and starts pushing its way between these tender orbs, then into the herm's tight anus.\n\n", false);
            else outputText("You eagerly grab the firm, muscular ass cheeks in front of you, probably belonging to some vigorous male.  You grind your " + cockDescript(game.player, x) + " against his back and it automatically starts spilling pre-cum; as soon as the seminal liquid trickles down his shapely butt, you can feel his body tensing, as if his lust reached a new level.  Nevertheless, your " + cockDescript(game.player, x) + " remembers its job and starts pushing its way between these gorgeous buttocks, then into the man's tight anus.\n\n", false);

            outputText("You suddenly hear a muffled moan from behind.  Someone is probably being fucked at the back of the train.  You brace yourself for the imminent anal penetration... and here it comes.  The dong is projected at full force into your " + buttDescription(player) + " then all the way inside your colon; you're protected only by the copious glaze of pre-cum its bearer had been applying.", false);
            player.buttChange(5 + rand(15), true, true, false);
            outputText("  Instinctively, you reach for the butt awaiting your " + cockDescript(game.player, x) + " and push as if your life depended on it.  You notice how your sodomite partner does the same to the ass in front of him, and so on.  Eventually the last one is pushed face down onto the floor, but her butt bumps against the dong fucking her, making the cock's owner bump in response, and it all propagates back to your own pecker; you wince in pleasure as your asshole impales itself further on the turgescent member behind you.  You are pushed and pulled rhythmically, your throbbing member and the one fucking you serving both as vectors in this slow wave of anal pleasure.  Unable to keep control of your thrusts, you let go of your body, enjoying the feeling of being shoved in both directions, each motion bringing either a jolt of pleasure in your crotch or your " + buttDescription(player) + ".  You are being slowly overwhelmed by the delicious tightness of the butt you're fucking as well as the fat piece of meat pounding your own.  The raw feelings eventually prove too much for your horny body, and you jerk your head back and moan like a whore, waiting for the incoming orgasm.\n\n", false);
            tentacleFapSpecial(place);
            ...
            // end of conditions
            outputText("\n\nFinally the strength of all the ejaculations is starting to ebb, as well as your fading orgasm.  Wincing in pain and pleasure mixed, your " + cockDescript(game.player, x) + " lets out an ultimate spurt of goo before resting, deeply buried into your partner's ass.  You fall over, making everyone after fall too by domino effect.  As you slowly doze off, you have a special thought about the still semi-erect cock being lodged in your " + buttDescription(player) + ".  That wagon of butts and dicks... it felt so right, so powerful, so... connected.\n\n", false);
        }
        // [else, if you lost]
        else {
            outputText("You almost instantly feel firm arms groping your " + buttDescription(player) + " and the tip of an erect dick knocking at the door of your colon.  It slowly massages your rectum, and you can't help but giggle a bit as you feel a tingle of pleasure passing through your body.  You prepare yourself for the crazy butt-fuck train, with you being at the end of it.\n\n", false);

            outputText("You suddenly hear a muffled moan from behind. Someone is probably being penetrated at the back of the train.  You brace yourself for the imminent anal-fucking... and here it comes.  The dong is projected at full force into your " + buttDescription(player) + " then all the way inside your colon; you're protected only by the copious glaze of pre-cum its bearer had been applying.", false);
            player.buttChange(5 + rand(10), true, true, false);
            outputText("  You are pushed face down to the floor, bumping your ass against your anal partner's crotch, impaling it further on that fat erect meat.  Hands roughly dig their fingers into the soft flesh of your cheeks as their owner gives you another mad, uncontrolled thrust, an avatar of the train of lust behind him.  Probably the force of thirty people butt-fucking into him was too much for him to bear, so he passes it on to you.  But unlike him, you don't have an asshole to reach and bury your " + cockDescript(game.player, x) + " into, so you are smashed on the floor again, and again, and again.  It hurts, yet it feels so... powerful, so strong.  There is only one dong pounding your " + buttDescription(player) + ", yet it feels like you're being ass-fucked by thirty people at once.  Propelled by the might of thirty thrusts, the huge shaft is tearing its way inside your poor " + assholeDescript(player) + " and, needless to say, being the end of this line is probably the hardest butt-fuck you'll ever have.\n\n", false);
            tentacleFapSpecial(place);
    ...
    private tentacleFapSpecial(place: number): void {
        ...
        if (player.cocks[x].cockLength >= 40 && player.cocks[x].cockType == CockTypesEnum.TENTACLE) {
            ...
            if (place <= 2) {
                outputText("Needless to say, this interference creates a general disruption in the whole butt-fuck wave.  The whole train of peckers and puckers starts moving irregularly, grinding against your " + cockDescript(game.player, x) + " at the most unexpected moments, and the pleasure you're getting from your extra tentacle cock doesn't help.  Everyone's butt and dick is affected to some extent; everyone's pleasure is increased because of your audacious initiative, and loud, reluctant moans are heard.", false);
