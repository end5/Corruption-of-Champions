    ...
    public goblinRapesPlayer(): void {
        ...
        if (player.totalCocks() > 0 && (!player.hasVagina() || rand(2) == 0)) {
            ...
            if (player.cockArea(0) > monster.vaginalCapacity()) {
                ...
                else outputText("the base of your " + game.player.cockDescript(0), false);
