...
export class GoblinAssassinScene {
    ...
    public gobboAssassinBeatYaUp(): void {
        ...
        if (player.cockThatFits(monster.vaginalCapacity()) >= 0 && player.hasCock() && (!player.hasVagina() || rand(2) == 0)) {
            ...
            else if (player.hasVagina()) outputText(vaginaDescript() + ", the tips giving your soaked mound only the barest ghost of a touch.");
    ...
    private gobboButtSecks(): void {
        ...
        outputText("After quickly removing your " + player.armorName + ", you tear off what little clothing the green-skinned woman is wearing.  With ease, you lift her off the ground and position her over your " + game.player.cockDescript(x) + ". The little goblin whore is so enthralled with you that her body quivers from excitement.\n\n", false);
        outputText("With a sneer, you take the crown of your " + game.player.cockDescript(x) + " and press it not against her drenched pussy lips, but her asshole!\n\n", false);
        ...
        outputText("Without any reservations, you slam the goblin whore onto your " + game.player.cockDescript(x) + ", virtually impaling her! The immediate tightness of her asshole nearly drives you over the edge! The more she squirms, the tighter her ass muscles squeeze you. You stand frozen in ecstasy for a moment, your tongue drooping out of your mouth and eyes rolling into the back of your head.\n\n", false);
        outputText("Protesting, the goblin squirms more, even going as far as to beat her fists into your chest; she's so feeble at the moment that her strikes actually tickle. Her puny assault is enough to knock you out of your carnal daze. You grin manically as you grasp her tiny waist and hammer her! Your " + game.player.cockDescript(x) + " quickly adjusts to her stretching asshole as you thrust harder and deeper!\n\n", false);
        outputText("\"<i>This isn't what I wanted!</i>\" she cries, \"<i>This isn't what I wanted!</i>\" If your " + game.player.cockDescript(x) + " expanding her ass wasn't enough, she can feel your ", false);
    ...
    private rapeAGoblinCorruptTooBig(): void {
        ...
        outputText("You begin to remove your " + player.armorName + ", looking down on your helpless would-be-attacker and soon-to-be victim while licking your lips hungrily. Your " + game.player.multiCockDescriptLight(), false);
        ...
        if (player.cockTotal() > 1) outputText("one of your " + game.player.multiCockDescriptLight() + " comes to rest on top of her and the fact that it's ", false);
        else outputText("your " + game.player.cockDescript(x) + " comes to rest on top of her and the fact that it's ", false);
        ...
        outputText("You have a seat, legs wide, on the ground and hold the little goblin whore with her relatively tiny slit resting at the tip of your " + game.player.cockDescript(x) + ". Finally out of her stupor a look of extreme conflict crosses her face as her need for cock and cum goes to war with her survival instincts. On the brink of defeat, those instinct suddenly regroup and beat back her lust once she feels the pain of just the " + player.cockHead(x) + " of your " + game.player.cockDescript(x) + " starting to stretch out her " + monster.vaginaDescript() + ". She does all she can to resist, but with the way you're holding this is little more than flailing wildly and pushing against your " + game.player.cockDescript(x) + " with her feet, practically climbing it like the tree trunk it must look like from her perspective.\n\n", false);
        ...
        outputText("You ram home the rest of your " + game.player.cockDescript(x) + " left outside of your newly christened dick jockey. It's enough to orgasm the bitch, and you haven't even gotten started. You ", false);
        ...
        if (player.biggestTitSize() >= 1) {
            outputText(", her head resting between your " + game.player.breastDescript(0), false);
        ...
        if (player.hasVagina()) {
            ...
            if (player.cockTotal() > 1) outputText("and the rest of your " + game.player.multiCockDescriptLight() + " drench her, ", false);
        }
        ...
        outputText("er spasming " + monster.vaginaDescript() + " is clamping down so hard on your " + game.player.cockDescript(x) + " that it can't release.\n\n", false);
        ...
        outputText("Your " + game.player.cockDescript(x) + " is pressed so firmly against her skin that you can see the cum working its way up and out of your shaft and bloating your goblin toy with only the first shot. ", false);
        if (player.cockTotal() > 2) outputText("Your remaining " + game.player.multiCockDescriptLight() + " blast geysers into the air, coating you both in your spunk. ", false);
        ...
        outputText("Finally you blow your last wad into this latest piece of ass, shoving her off of your " + game.player.cockDescript(x) + " and letting her fall to the ground. The impact sends torrents of cum sluicing out of her.\n\n", false);
    ...
    private manRapesGoblinTooBig(): void {
        ...
        outputText(" of your " + game.player.cockDescript(x) + " visibly pulses in excitement as you brush it against her already-slick folds.  She squirms under you, clearly enjoying the feeling of you pushing against her opening.  With painful slowness, you begin pushing forward, feeling her body stretch around your ", false);
        if (player.cocks[0].cockType == CockTypesEnum.HORSE) outputText("flare", false);
        ...
        outputText("Disgruntled with the tease, you pull out and slide it onto her torso, pinning her underneath your " + game.player.cockDescript(x) + " and smearing her face and body with her juices.  Her tits squish down enough that her erect little purple nipples barely poke out on each side.  The little slut looks relieved and more than a little turned on.  She licks her lips and speaks happily, \"<i>Thanks hun, I think you would have torn me in half!  Don't worry, I'm more than happy to get soaked with your cum,</i>\" as she wraps her arms and legs around you", false);
    ...
    private gobboGetsRapedMaleFits(): void {
        ...
        if (player.cockArea(x) > monster.vaginalCapacity() * .8) {
            outputText("You pick up the defeated goblin, looking her over. She crosses her arms across her chest pitifully and asks, \"<i>What now?</i>\" with her eyes darting down when she thinks you won't notice. A grimace temporarily crossing her face at the size of your " + game.player.cockDescript(x) + ". You get the idea of giving her more cock than she can handle, and lower her down towards your " + game.player.cockDescript(x) + ". The tip slips between her moist and folds, stretching her and taking some of her weight off your arms. She winces slightly, wrapping her legs as far around your " + hipDescript() + " as possible.\n\n", false);
            ...
            outputText("It's all the encouragement you need, and you break into a run, feeling her lithe form bounce on your " + game.player.cockDescript(x) + ", drawing out a cacophony of cries ranging from happy wails and moans to slight yelps of pain. Her tiny fists dig into your ", false);
            ...
            outputText("The familiar tightness of a coming orgasm grows in your groin, tightening as you near release. You pick up the pace, full out sprinting, letting the girl bounce and jiggle as she clings to you, supported entirely by your " + game.player.cockDescript(x) + ". ", false);
            ...
            if (player.cumQ() >= 100) outputText("  Your enhanced body easily stuffs her full of cream, pudging her belly out slightly, your seed staying embedded in her womb with nowhere to escape, her cunt plugged tightly with your " + game.player.cockDescript(x) + ".", false);
            if (player.cumQ() >= 500) outputText("  The orgasm is so potent that by the time you wind down, she looks to be sporting a pregnancy the size of a medicine ball.  Your cum is trapped inside her, unable to find any gap between her walls and your " + game.player.cockDescript(x) + ".", false);
            else if (player.cumQ() >= 250) outputText("  The orgasm is so potent that by the time you wind down, she looks heavily pregnant.  Your cum is unable to find any gap between her walls and your " + game.player.cockDescript(x) + ".", false);
            outputText("\n\n", false);
        ...
        // (FITS – Get ridden)
            ...
            outputText("You pick up the defeated goblin, looking her over.  She crosses her arms across her chest pitifully and asks, \"<i>What now?</i>\" with her eyes darting down when she thinks you won't notice.  You muse to yourself 'great minds think alike' and lower her down towards your " + game.player.cockDescript(x) + ".  The tip slips between her moist and parted folds, brushing against her entrance and taking some of her weight for you.  She goes cross-eyed and smiles happily, wrapping her legs as far around your " + hipDescript() + " as possible.\n\n", false);
            ...
            outputText("It's all the encouragement you need, and you break into a run, feeling her lithe form bounce on your " + game.player.cockDescript(x) + ", drawing out a cacophony of happy wails and moans.  Her tiny fists dig into your ", false);
            if (player.biggestTitSize() >= 1) outputText("tits", false);
            else outputText("skin", false);
            ...
            outputText("The familiar tightness of a coming orgasm grows in your groin, tightening as you near release.  You pick the pace, full out sprinting, letting the girl bounce and jiggle as she clings to you, supported entirely by your " + game.player.cockDescript(x) + ".  ", false);
            if (player.balls > 0) outputText("Your " + ballsDescriptLight() + " tighten, releasing the seed of your orgasm.  ", false);
            outputText("The howl of a powerful orgasm fills your ears as your cumming sets off the little green cock-sleeve.  One of her hands lets go, and starts rubbing her belly while she kisses and licks your belly-button.", false);
            if (player.cumQ() >= 250) {
            ...
            if (player.cumQ() >= 500) outputText("  The orgasm is so potent that by the time you wind down, she looks heavily pregnant and your cum squirts out of any gap it can find between her walls and your " + game.player.cockDescript(x) + ".", false);
            outputText("\n\n", false);
            outputText("You pant and stop, pulling the stuffed goblin off you and setting her on the ground, smiling in satisfaction as your cum ", false);
            if (player.cumQ() >= 250) outputText("pours out in a river", false);
            else outputText("leaks", false);
    ...
    private gatsGoblinBoners(): void {
        ...
        outputText("Eventually you begin to feel yourself coming to a climax, your movements getting faster and faster as you build up to your release.  The goblin below you has already lost herself to the pleasure of your " + game.player.cockDescript(x) + ", her eyes rolled upwards and her tongue drooling out of her mouth while her slutty face rubs against the ground you're currently pounding her on.  With a final thrust, your hips lurch forward as you paint her insides with your thick spunk, relishing in the feeling of your ejaculate filling her up to the brim and plugging her entrance", false);
        ...
        outputText("You pick yourself back up, jerking yourself slowly as cum dribbles from your " + game.player.cockDescript(x) + " onto the collapsed body of the goblin.  It'll be awhile before she comes back to consciousness, but you're certain she'll have a better appreciation for sex when she does.", false);
        player.orgasm();
        cleanupAfterCombat();
    }
