...
export function gobboAssassinBeatYaUp(): void {
    ...
    if (player.cocks.cockThatFits(monster.vaginalCapacity()) >= 0 && player.cocks.length > 0 && (!player.vaginas.length > 0 || rand(2) == 0)) {
        ...
        outputText(mf(player, "strapping young man", "sexy breeder") + " will have enough jizz to pay for " + mf(player, "his", "her") + " trespass?</i>\"");
        ...
        else if (player.vaginas.length > 0) outputText(vaginaDescript(player) + ", the tips giving your soaked mound only the barest ghost of a touch.");
        ...
        outputText(" wild with need.  Thankfully, as soon as you submit to her puffy mound and give it a lick, a pair of soft, wrinkled feet wrap around your " + cockDescript(game.player, x) + ", drawing out a thick flood of your pre-cum.");
        outputText("\n\nToes smear your precum around your " + cockHead(player, x) + " before the warm soles drag them down the " + num2Text(Math.round(player.cocks[x].cockLength)) + " inches of your length, basting your " + cockDescript(game.player, x) + " in a mixture of goblin sweat and your personal juices.  You moan in delight, your sounds of rapture muted by the puffy, soaked lips that obscure your mouth, your cock spurting helpless trails of white submissively onto her feet.  Every brush of your lips is rewarded with caresses from the goblin’s tiny toes.  Every lick sends those squeezing, cum-lubed feet sliding up and down.  Every suck on her clit causes her pace to increase.  With encouragement like that, you cannot stop yourself from attending to the goblin’s syrupy box, worshipping her womanhood like a slave before an altar of a glorious god.");
        outputText("\n\nThe short, stacked woman moves her legs to lay your cock on her left foot while the entirety of her right foot presses down on your " + cockDescript(game.player, x) + "’s underside, squeezing a thick flow of your pent-up jism from the cum-slit at its tip.  Her sole rocks up and down your length, milking dollop after dollop of jizz onto the goblin’s toes.  After a while, she switches her legs to let her now-soaked foot do the rest of the squeezing.  You happily squirt and squirm, dripping like a sieve but not yet achieving true release.  The goblin, having no such problem, cums noisily atop you, numerous times.  Each successive squirt of girl-fluid soaks your face more than the one before, and by the time she’s done, your " + hairDescription(player) + " is sticky with it, half-buried in a puddle of goblin-lust.  You’re so close.  So very close.  Just a little bit more... a few more strokes.");
        outputText("\n\n\"<i>");
    ...
    // iii. Lust Loss - Female
        ...
        if (player.breastRows.hasFuckableNipples()) outputText("piston in and out of your [nipple], masturbating it just as hard as the real thing.");
