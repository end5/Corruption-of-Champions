...
export class SuccubusGardener extends Monster {
    ...
    public constructor() {
        ...
        this.breastRows.createBreastRow(Appearance.breastCupInverse("FF"));
    ...
    protected performCombatAction(): void {
        ...
        if (this.HPRatio() <= 0.6) {
            ...
            const opts: any[] = [sicem, corruptiveShower, lustAuraCast];
    ...
    private showerDotEffect(): void {
        ...
        if (player.lust < 50) outputText("The tentacles' sex-juices are still covering you - still slowly arousing you. You've got a good handle on it for now.\n\n");
            ...
            if (player.cocks.length > 0) {
                ...
                outputText(" soaked twat threatens to " + ((player.vaginas.wetness() == 4) ? "drown" : "further soak") + " your [legs].");
            }
            else outputText(".");
        }
        else {
