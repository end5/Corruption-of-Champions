...
export class DriderIncubusScenes {
    ...
    public fuckMitzi(): void {
        ...
        if (player.biggestCockArea() > 100) outputText(", her throat bulging with its unholy size");
    ...
    public titfuckMitziSlow(): void {
        ...
        if (player.biggestCockArea() <= 20) outputText(", tiny");
        outputText(" tower of meat");
        if (player.biggestCockArea() <= 20) outputText(", nearly obscuring the whole thing");
        else if (player.biggestCockArea() >= 100) outputText(", barely able to support it");
        outputText(".");
        if (player.cocks.length > 1) {
