...
// I don't think we'll need to save/load this, as we're not gonna allow saving in the dungeon, and it'll be overwritten by calling enterD3();

export let rooms: Record<string, any> = {};
let _currentRoom: string;
configureRooms();

function configureRooms(): void {
    let tRoom: room;
...
export function discoverD3(): boolean {
...
export function enterD3(): void {
    game.inRoomedDungeon = true;
    game.inRoomedDungeonResume = resumeFromFight;
    move("entrance");
}

export function exitD3(): void {
    game.inRoomedDungeon = false;
    game.inRoomedDungeonResume = null;
    Camp.returnToCampUseOneHour();
}

export function resumeFromFight(): void {
    move(_currentRoom);
}

function generateRoomMenu(tRoom: room): void {
...
export function move(roomName: string): void {
    ...
    const tRoom: room = rooms[roomName];
...
function entranceRoomFunc(): boolean {
...
function tunnel1RoomFunc(): boolean {
...
function antechamberRoomFunc(): boolean {
...
function roomofmirrorsRoomFunc(): boolean {
...
function magpiehallsRoomFunc(): boolean {
    if (flags[kFLAGS.D3_JEAN_CLAUDE_DEFEATED] == 0) {
        if (flags[kFLAGS.D3_ENTERED_MAGPIEHALL] == 0) {
            ...
            if (flags[kFLAGS.BENOIT_AFFECTION] == 100) outputText("  This can only be the hall that " + Benoit.benoitMF("Benoit", "Benoite") + " once worked in.");
...
const BLACK: number = 1 << 0;
const BLUE: number = 1 << 1;
const WHITE: number = 1 << 2;
const PINK: number = 1 << 3;
const BROWN: number = 1 << 4;
const PURPLE: number = 1 << 5;

function eggsAvailable(): number {
    const flagNum: number = flags[kFLAGS.D3_EGGS_AVAILABLE];
...
function takeEgg(eggMask: number): void {
...
function fallbackFromMagpieHallS(): void {
    clearOutput();
...
function magpiehallnRoomFunc(): boolean {
    if (flags[kFLAGS.D3_JEAN_CLAUDE_DEFEATED] == 0) {
...
function tunnel2RoomFunc(): boolean {
...
function edgeofkeepRoomFunc(): boolean {
...
function northentryRoomFunc(): boolean {
...
function southcourtyardRoomFunc(): boolean {
...
function southwestcourtyardRoomFunc(): boolean {
...
function southwestwalkRoomFunc(): boolean {
...
function westwalkRoomFunc(): boolean {
...
function northwestwalkRoomFunc(): boolean {
...
function northwestcourtyardRoomFunc(): boolean {
...
function northcourtyardRoomFunc(): boolean {
...
function northeastcourtyardRoomFunc(): boolean {
...
function northeastwalkRoomFunc(): boolean {
...
function eastwalkRoomFunc(): boolean {
...
function southeastwalkRoomFunc(): boolean {
...
function southeastcourtyardRoomFunc(): boolean {
...
// 9999 - Check this
function courtyardsquareRoomFunc(): boolean {
...
function greatliftRoomFunc(): boolean {
