...
export class Lethice extends Monster {
    public constructor() {
        ...
        this.breastRows.createBreastRow(8);
    ...
    private hornyPoke(): void {
        ...
        if (combatMiss()) {
            ...
            let damage: number = 70 - rand(player.tou);
            damage = player.takeDamage(damage);
    ...
    private fuckDemon(): void {
        ...
        if (player.breastRows.hasFuckableNipples()) outputText(" until you give her a wicked grin and guide the tip inside your [nipple]");
        ...
        if (!player.breastRows.hasFuckableNipples()) outputText(" that splatters all over your chest");
    ...
    private p2Heal(): void {
        ...
        let temp: number = int((player.inte / (2 + rand(3)) * game.spellMod()) * (player.maxHP() / 150));
    ...
    private sonicwhip(): void {
        ...
        let damage: number = 75 + weaponAttack + str;
        damage = player.takeDamage(damage);
        outputText(" (" + damage + ")");
    }
