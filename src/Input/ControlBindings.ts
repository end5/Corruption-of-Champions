...
inputManager.AddBindableControl(
    ...
    function(): void {
        if (mainView.menuButtonIsVisible(MainView.MENU_DATA)) {
            const saveFile: any = SharedObject.getLocal("CoC_1", "/");
...
inputManager.AddBindableControl(
    ...
    function(): void {
        if (mainView.menuButtonIsVisible(MainView.MENU_DATA)) {
            const saveFile: any = SharedObject.getLocal("CoC_2", "/");
            if (saveFile.data.exists) {
...
inputManager.AddBindableControl(
    ...
    function(): void {
        if (mainView.menuButtonIsVisible(MainView.MENU_DATA)) {
            const saveFile: any = SharedObject.getLocal("CoC_3", "/");
            if (saveFile.data.exists) {
...
inputManager.AddBindableControl(
    ...
    function(): void {
        if (mainView.menuButtonIsVisible(MainView.MENU_DATA)) {
            const saveFile: any = SharedObject.getLocal("CoC_4", "/");
            if (saveFile.data.exists) {
...
inputManager.AddBindableControl(
    ...
    function(): void {
        if (mainView.menuButtonIsVisible(MainView.MENU_DATA)) {
            const saveFile: any = SharedObject.getLocal("CoC_5", "/");
            if (saveFile.data.exists) {
