...
//*Ceraph goes full tentacle and double penetrates herms (+ standard dick BJ if ceraph dick toggle is on) (Zeddited)
		private  ceraphTentacleGrape():void
		{
			...
			outputText(".  Even better, there are what feels like thousands of wriggling cilia squirming in the syrupy tunnel, each of them caressing and licking at " + sMultiCockDesc() + " repeatedly.  Like thousands of hungry tongues, they seem to set off every nerve in your " + multiCockDescriptLight() + ", nearly making you forget the rhythmic, pulsating suction of the tendril as it fellates you.\n\n", false);
...
//After that is a scene tailored more specifically for the PC. Intention is to give nagas and centaurs and all that their own scene. Currently only scene is for PCs with a dick - should be naga-compatible.
		private  cerminika():void
		{
			...
			if (player.hasCock()) {
				...
				if (player.biggestTitSize() >= 0) outputText("She casually and playfully gives the gentlest squeeze to your " + chestDesc() + ".  ", false);
				...
				outputText(".  Her tongue roams hungrily over her inky lips, and an almost predatory grin sets across her features as she pulls up your " + cockDescript(0) + ".  Her fingernails cup under your head delicately and carefully tease you, rubbing her palm into the underside of your shaft.\n\n", false);

				outputText("\"<i>How long,</i>\" she purrs, \"<i>Have you wanted to really be inside me?</i>\"\n\n", false);

				outputText("Dominika slides her body back, rubbing the softness of her folds against your " + cockDescript(0) + ".  ", false);
				...
				outputText("  You simply smirk at her, starting to bounce her into your lap and shoving your " + cockDescript(0) + " deeper inside. Once more she bites her lip, fingers digging into your stomach. No matter how classy she wants to appear, you can quite easily feel how wet she is", false);
				...
				outputText("You give her a carefully crafted retort that demonstrates your intellectual superiority, but she just gives you a fake smile and pats your cheek.  Eyes half-closed she slowly slides herself along you, enjoying the sensation of each inch of your " + cockDescript(0) + " as it brushes along her walls.  \"<i>Mmmm,</i>\" she lets herself purr out, \"<i>Worth... the wait.</i>\"  Her toes curl slightly, one of her legs shifting back slightly to alter the angle you enter her at.  It seems to work how she wants it to, as a deep, satisfied breath accompanies the next downward slide of her hips.", false);
				...
				outputText("She wails in mixed frustration and pleasure, juices splattering against the ground as her hungry cunt grows hornier.  A darkness overtakes her eyes, and her nails grow long and sharp, and through it all your " + cockDescript(0) + " continues to degrade her ass.  As though a heartbeat pumping blood through her body, each thrust spreads the color over her skin a little more.  Her feet push and scrabble lightly against the ground in tormented frustration, but she is helpless beneath you.  You go without stopping, only slowing when wings unexpectedly burst from her shoulder blades, dark and starry.\n\n", false);
				...
				else outputText("  She shudders as your " + cockDescript(0) + " fills her guts with warmth, hips seizing as she rides out her assgasm.", false);
				...
				outputText("  The demoness laps at your " + cockDescript(0) + ", cleaning it of spunk, sweat, and all the various filth it accumulates, sucking and dragging her fat, midnight lips across them.  Dominika purrs her happiness, her joy at being forced into such a whorish form.\n\n", false);
...
//▶[GetTongued] requires vagina
		private  getTonguedByZetsuko():void
		{
			...
			if (x >= 0) outputText("wrapping itself around your " + cockDescript(x) + " and squeezing momentarily before ", false);
			...
			if (x >= 0) {
				outputText("In a somewhat impressive feat of contortion, Zetsuko brings her feet in toward her groin to stimulate your " + multiCockDescriptLight() + ", lifting ", false);
				...
				if (player.cockTotal() > 1) outputText("s", false);
				outputText(" with the soles of her feet.  Her toes are surprisingly dextrous, able to curl around and grip your " + cockDescript(x) + " lightly, gently pinching and tugging at the skin just under the head and manipulating your throbbing member", false);
				if (player.cockTotal() > 1) outputText("s", false);
			...
			if (x >= 0) {
				outputText("  " + SMultiCockDesc() + " twitches powerfully between her feet, ", false);
...
//▶[Banana?] silly mode
		...
		private  ceraphFollowerCockTaking(smallest:boolean = false):void
		{
			...
			outputText("\n\nCeraph's fingers feel unexpectedly hot as they brush your " + cockDescript(x) + ", as if she had just come out of a heated tub.  You don't have long to ponder that little detail as they pinch into a tight ring", false);
			if (player.cocks[x].cockThickness >= 4) outputText(", compressing your massive girth into the rigid shaft", false);
			outputText(", slowly closing.  It should hurt but it doesn't, it just feels warmer and warmer, and then with a sudden 'PYOING!', Ceraph is holding your " + cockDescript(x), false);
