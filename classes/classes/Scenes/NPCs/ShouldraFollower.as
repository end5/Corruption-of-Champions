...
private function shouldraTongueLicksPCs():void {
	...
	if(player.findPerk(PerkLib.Flexibility) >= 0) {
		...
		outputText("\"<i>Well then, let's get back to it!</i>\" Shouldra enthusiastically suggests.  She sits down and sets her dildos aside, preferring to get you warmed up first as usual.  She's gotten even better at mimicking the pose required to get your face close in to your sex, and has your body contorted that way in no time.");
		}
...
public function shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark():void {
	...
	switch(select) {
		...
		case 6:
			...
			else if(subSelect == 2) outputText("\"<i>So what other sorts of things can you concoct?</i>\" Exgartuan asks, shuffling around in your armor.  You're incredibly confused by the sudden question.\n\n\"<i>Honestly, that put me in the mood to make all of mother nature our bitch,</i>\" you respond... Shouldra responds.  The spirit is gabbing through your mouth to the your possessed pecker.  The two prattle on like this for some time.");
...
public function exgartuMonAndShouldraShowdown():void {
	...
	simpleChoices("Keep Exgartuon", keepExgartuanInsteadOfShouldra, "Keep Shouldra", keepShouldraAndKickOutExgartuan, "Keep Both", keepAllTheGhosts, "", null, "", null);
}
//Keep Exgartuan
