...
private  holliPlaysWithPenisesBadEnd():void {
	...
	outputText(multiCockDescript() + ", standing erect and hard as iron; the brown-haired girl blushes and looks away.");
