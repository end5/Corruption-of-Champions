...
private  ghostIzmaPenis():void {
	spriteSelect(67);
	outputText("", true);
	outputText("You swiftly disrobe and lay your " + player.armorName + " to the side, revealing your stiffening " + multiCockDescriptLight() + " in all of its glory. The ghost-girl's eyes brighten at the sight, and she even allows herself a little swoon (which looks absolutely silly, given her current tough shark-like vessel) as she regards your manhood.  ", false);
...
private  ghostGooGurlzDuckfaces():void {
	...
	//([if penis present] 
	if(player.hasCock() && !player.hasVagina()) outputText(" presenting your " + multiCockDescriptLight() + " to the spectral slime.", false);
...
private  letShouldraIn():void {
	spriteSelect(67);
	outputText("", true);
	outputText("The ghost girl squeals in excitement as you allow her partial control- only enough for her to feel your penis as if it were her own.  With an ecstatic, victorious scream, she impales herself upon your dick, taking the entire thing down her throat like it's nothing.  Your jet-stream of cum rockets into her gob, blasting her head straight off your dick to slam into your " + chestDesc() + " with an \"<i>Oof.</i>\"\n\n", false);
...
private  ghostBJFinisher(inside:boolean):void {
	...
	outputText("Like a backed up geyser, your gigantic testicles push hot, thick strands of seed out of your belaboured " + cockDescript(x) + " straight up in the air.  The cum splatters on both you and the ", false);
...
private  hermaphroditeGhostsCumEctoplasm():void {
	...
	outputText("Taking complete control of your body as if it was never actually yours, she removes your " + player.armorName + " and throws them carelessly to the ground. Grabbing up your " + cockDescript(x) + " in both hands and fondling it awkwardly, she strikes you as obviously inexperienced with the male anatomy, despite her levels of intelligence. She continues to grope your lengthening member, admitting, \"<i>Even with the rare male bodies I have possessed, I rarely got to play with their...</i>\"\n\n", false);
...
private  loseToShouldraAsHerm():void {
	...
	if(player.balls > 0) outputText("Stopping her double-handed stroke technique, she slips your hand under your obtrusive " + ballsDescriptLight() + " and gently pushes them aside to get a better look at your previously unnoticed female sex.  ", false);
	outputText("She chuckles evilly, and you groan, mind cycling through the possible outcomes of the girl's impulses. Your lips curl unbidden in an evil smile, then begin mouthing an archaic incantation, and you wince inwardly, bracing for the worst. She finishes and goes back to the vigorous stroking, and you are left to wonder what the spell was meant to do—that is, until you feel a tingling beginning at the base of your " + cockDescript(0) + ", slowly climbing up the shaft until your entire length is covered in the sensation.\n\n", false);
