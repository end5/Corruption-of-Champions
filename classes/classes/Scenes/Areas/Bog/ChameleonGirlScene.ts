...
// TIMES_MET_CHAMELEON:int = 561;
		...
		private  fuckDatChameleonAsACoolGuyGirlHerm():void
		{
			...
			outputText("\n\nTaking the hint, she starts playing with your dripping gash again, sometimes teasing your " + clitDescript() + " with her fingers.  Your throbbing cock aches for attention, though, and an interesting idea pops into your head; you pick her tail up off the ground and, though she tries to twitch it away instinctually, you hold tight.  It relaxes, and you guide it towards your needy member, then gently wrap its end around a few times.  With a mischievous smile, the girl tightens her grip more than you expected, slowly pumping your shaft up and down with her strong tail.  Pre-cum begins to leak from the tip of your " + cockDescript(x) + " and your pussy drools with sexual fluids as the extra the stimulation affects your body.");
			outputText("\n\nNot ");
		...
		private  giveTheChameleonASuccubiMilk():void
		{
			...
			outputText(" your cock aimed for her pillowy tits.  She pushes and squirms beneath you, but cannot get enough leverage to move you.  You take her breasts in your hands and shimmy up her torso towards them, squeezing them around your " + cockDescript(x) + ".");
