...
//*Summary: Male only scene for maximum prostate pounding - possible random choice between two positions, plain doggy style or the 'lucky' one, where he will curl you over yourself and fuck you so you can watch his foreskinned spiderboy cock slam your asshole -while- you drip all over your face.
		private  spiderBoyLossMaleButtfuck():void
		{
			...
			if (player.cumQ() < 500) outputText(SMultiCockDesc() + " bounces on your belly, leaking one last drop from its tip, utterly draining every drop from your " + ballsDescriptLight() + ".", false);
...
//*Summary: Vagoozles only!
		private  loseToSpiderBoyVagFucked():void
		{
			...
			outputText("You arch your back from the sensation, lifting your " + chestDesc() + " to provide him better access.  ", false);
			...
			outputText(", ", false);
			if (player.hasCock()) outputText(sMultiCockDesc() + " becomes so full and hard it feels like it could burst, ", false);
