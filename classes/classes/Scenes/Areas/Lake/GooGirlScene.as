...
//Defeat – Herm
		private  hermLoseToGooGal():void
		{
			...
			outputText(" in rippling walls of needy slime. Coils of hot and cold run up and down your " + cockDescript(x) + ", as playful tongues part your labia and trace every petal-like fold of your " + vaginaDescript(0) + ", filling you to your brim with gooey, thirsty ooze.\n\n", false);
...
//VICTORY
		public  beatUpGoo():void
		{
			...
			if (player.gender == 0 || player.lust < 33) {
				...
				var sex4S:string = "";
				var sex4N:() => void =null;
				var valeria:() => void = kGAMECLASS.valeria.valeriaAndGooThreeStuff;
...
//Victory – Male
		private  gooMaleRape(type:number = 1):void
		{
			...
			if (player.cocks[x].cockLength < 24) {
				...
				outputText("Noticing your hardening length, the goo-girl claps her hands in gushing pleasure and gently pushes you back onto your " + buttDescript() + ". Rubbing her moist cheek against yours, she slides down your " + chestDesc() + " and perches over your groin. Slowly, she moves back and forth, stroking your shaft with the perky wetness of her stiff nipples. She hovers over your manhood for a moment before dropping down, her sloping cleavage stroking your cock between her slimy pillows with a slurping squelch. Pressing her balled-up fists to either side, she squeezes your " + cockDescript(x) + " between her breasts and begins to slowly pump your stiffening organ. The natural lubrication of her gooey skin makes the tit-fuck pleasantly slick, softness sucking your flesh with wet gulps as she rolls from base to tip, your cockhead popping between her cleavage at a brisk pace, cooled by the air for only a moment before it is swallowed once more by the seething heat of her chest. Through her transparent skin, you can see your " + cockDescript(x) + " being massaged by the gooey embrace of her tits. Your body trembles to the precipice of an orgasm, muscle spasms and a shortness of breath makes each pump of your slime-oiled hardness more exquisite than the last, as if the girl's murky breasts were pulling the air from your lungs.\n\n", false);
...
//Victory – Herm
		private  victoryHermSex():void
		{
			...
			outputText("Quickly stripping, you let your " + multiCockDescriptLight() + " slap against her turbulent membrane, the warm muck gurgling wetly at your turgid stiffness. Sinking your fingers into the girl's yielding breasts, you push forward, pulsing flesh sliding into the " + gooColor2() + " depths of her expanded cleavage. The goo-girl's chest sucks eagerly at you, pliant slime drooling warm " + gooColor5() + " beads of unnecessary lubrication as you pick up your pace. Staring at your " + multiCockDescriptLight() + " moving in and out of the girl's chest through her transparent skin, you are surprised to see her body shifting further under your pounding. A vertical slit opens between her breasts and her membrane quickly folds itself in delicate petals around the edges. Your next thrust pushes into the new cavity and the organic texture confirms your suspicion: she's created a vagina between her breasts for you to fuck!\n\n", false);
