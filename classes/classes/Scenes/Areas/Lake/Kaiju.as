...
private  insultTheKaijuFirstMeeting():void {
	...
	if(kaijuCock()) {
		...
		if(player.findStatusAffect(StatusAffects.KnowsWhitefire) >= 0 && (player.findPerk(PerkLib.BloodMage) < 0 && player.fatigue + kGAMECLASS.spellCost(30) > 100)) {
...
private  letKaijuHaveWayWithYou():void {
	...
	if(player.gender == 3) outputText(multiCockDescriptLight() + " and [vagina]");
	else if(player.gender == 1) outputText(multiCockDescriptLight());
...
private  urethraFuckDatGiantCock():void {
	...
	if(player.hasCock()) outputText(" and your " + multiCockDescriptLight());
...
private  badEndPartTwo():void {
	...
	if(player.hasCock()) outputText("  More tentacles arrive and begin to wrap around your " + multiCockDescriptLight() + ", slowly jacking you off to the tempo set by the cocks in your ass and mouth, wracking you with further pleasure.");
